...
Ak ide o právnické osoby, ktoré nemajú aktivovanú elektronickú schránku a nie sú zapísané v obchodnom registri, správca modulu elektronických schránok vykoná úkon v procese aktivácie podľa [§ 13 ods. 1 písm. a)](#paragraf-13.odsek-1.pismeno-a) 1. februára 2019; to platí, aj ak pri právnickej osobe, ktorá nie je zapísaná v obchodnom registri, dôjde k splneniu podmienky na aktiváciu elektronickej schránky odo dňa účinnosti tohto zákona do 31. januára 2019. Na právnické osoby podľa prvej vety sa do 31. januára 2019 ustanovenia [§ 60a ods. 5](#paragraf-60a.odsek-5) nepoužijú. Ak právnická osoba podľa prvej vety požiada o skoršiu aktiváciu elektronickej schránky, správca modulu elektronických schránok žiadosti vyhovie a ustanovenia [§ 13 ods. 3](#paragraf-13.odsek-3) sa použijú primerane. Informáciu o tom, akých právnických osôb sa postup podľa prvej až tretej vety týka, zverejňuje a aktualizuje správca modulu elektronických schránok na ústrednom portáli.
