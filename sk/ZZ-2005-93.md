...
používa v kurzoch podľa [§ 2 ods. 1 písm. a)](#paragraf-2.odsek-1) neoznačené alebo nesprávne označené výcvikové vozidlo, alebo výcvikové vozidlo, ktorého označenie nie je v súlade so schválenými technickými požiadavkami alebo so schváleným typom komponentu,
...
používa v kurzoch podľa [§ 2 ods. 1 písm. a)](#paragraf-2.odsek-1.pismeno-a) neoznačené alebo nesprávne označené výcvikové vozidlo alebo výcvikové vozidlo, ktorého označenie nie je v súlade so schválenými technickými požiadavkami alebo so schváleným typom komponentu,

b)

používa v kurzoch podľa [§ 2 ods. 1 písm. a)](#paragraf-2.odsek-1.pismeno-a) výcvikové vozidlo bez platného osvedčenia o evidencii alebo bez platného osvedčenia o technickej kontrole alebo platného osvedčenia o emisnej kontrole, ak takejto kontrole podlieha,
