...
Ročný príspevok za stavbu jadrového zariadenia [[§ 5 ods. 3 písm. a)](#paragraf-5.odsek-3.pismeno-a)] podľa druhu jadrového zariadenia je vo výške podľa odseku 4 písm. a), b), c), d) alebo e), pričom

a)

pre jadrové zariadenie podľa [§ 2 písm. f) prvého bodu](#paragraf-2.pismeno-f.bod-1) sa nominálnym inštalovaným tepelným výkonom rozumie projektovaný nominálny inštalovaný tepelný výkon,

b)

pre jadrové zariadenia podľa [§ 2 písm. f) tretieho a štvrtého bodu](#paragraf-2.pismeno-f.bod-3), okrem jadrového zariadenia podľa odseku 4 písm. e), sa stavom ku koncu predchádzajúceho roka rozumie predpokladaný stav k 31. decembru roka, v ktorom uplynie dvanásť mesiacov prevádzky jadrového zariadenia.
