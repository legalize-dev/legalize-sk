...
Držiteľ povolenia podľa [§ 5 ods. 3](#paragraf-5.odsek-3) je povinný platiť ročný príspevok na výkon štátneho dozoru (ďalej len „ročný príspevok").

(2)

Ak je právnická osoba alebo fyzická osoba držiteľom viacerých povolení podľa [§ 5 ods. 3](#paragraf-5.odsek-3), je takýto držiteľ povinný platiť ročný príspevok za každú činnosť, na ktorú bolo vydané povolenie.
...
10 500 Sk za každý MWt nominálneho inštalovaného tepelného výkonu pre jadrové zariadenie podľa [§ 2 písm. f) prvého bodu](#paragraf-2.pismeno-f),

b)

1 000 Sk za každý palivový článok skladovaný ku koncu predchádzajúceho roka pre jadrové zariadenie podľa [§ 2 písm. f) druhého bodu](#paragraf-2.pismeno-f.bod-2),

c)

1 150 Sk za každý GBq prepracovanej aktivity upravenej do vláknobetónového kontajnera v priebehu predchádzajúceho roka v jadrovom zariadení podľa [§ 2 písm. f) tretieho bodu](#paragraf-2.pismeno-f.bod-3),

d)

2 500 Sk za každý vláknobetónový kontajner uložený v priebehu predchádzajúceho roka v jadrovom zariadení podľa [§ 2 písm. f) štvrtého bodu](#paragraf-2.pismeno-f.bod-4).

(4)

Ročný príspevok za stavbu jadrového zariadenia [[§ 5 ods. 3 písm. a)](#paragraf-5.odsek-3)] podľa druhu jadrového zariadenia je 50 % ročného príspevku podľa odseku 3 písm. a), b), c) alebo d), pričom

a)

pre jadrové zariadenie podľa [§ 2 písm. f) prvého bodu](#paragraf-2.pismeno-f) sa nominálnym inštalovaným tepelným výkonom rozumie projektovaný nominálny inštalovaný tepelný výkon,

b)

pre jadrové zariadenia podľa [§ 2 písm. f) druhého až štvrtého bodu](#paragraf-2.pismeno-f.bod-2) sa stavom ku koncu predchádzajúceho roka rozumie predpokladaný stav k 31. decembru roka, v ktorom uplynie dvanásť mesiacov prevádzky jadrového zariadenia.
...
Ročný príspevok za činnosti podľa [§ 5 ods. 3 písm. e) až n)](#paragraf-5.odsek-3.pismeno-e) je 5 000 Sk.
...
Týmto zákonom sa preberajú právne akty Európskych spoločenstiev a Európskej únie uvedené v [prílohe č. 5](#prilohy.priloha-priloha_c_4_k_zakonu_c_541_2004_z_z.oznacenie).
