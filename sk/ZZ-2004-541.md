...
dlhodobým skladovaním vyhoretého jadrového paliva jeho umiestnenie a uchovávanie v samostatnom jadrovom zariadení určenom na jeho skladovanie, a to od prevzatia vyhoretého jadrového paliva právnickou osobou podľa [§ 3 ods. 11](#paragraf-3.odsek-11) od držiteľa povolenia na prevádzku jadrového zariadenia podľa písmena f) prvého bodu až po jeho prepravu na úložisko,
...
určuje, eviduje, kontroluje a vymáha príspevky na výkon štátneho dozoru podľa [§ 34a](#paragraf-34a) a úroky z omeškania,
...
realizáciu zmien podľa [§ 2 písm. w)](#paragraf-2.pismeno-w),
...
držiteľovi povolenia tému a rozsah hodnotenia so špecifickým tematickým zameraním v oblasti jadrovej bezpečnosti jadrových zariadení podľa [§ 10 ods. 7](#paragraf-10.odsek-7),
...
či ide o zmeny na jadrových zariadeniach podľa [§ 2 písm. w)](#paragraf-2.pismeno-w) alebo [písm. x)](#paragraf-2.pismeno-x),
...
umiestnenie stavby jadrového zariadenia okrem stavby jadrového zariadenia podľa [§ 2 písm. f) prvého bodu](#paragraf-2.pismeno-f.bod-1),
...
spätnú prepravu rádioaktívnych odpadov podľa [§ 21 ods. 12 písm. a)](#paragraf-21.odsek-12.pismeno-a),

m)

dovoz rádioaktívnych odpadov podľa [§ 21 ods. 12 písm. b)](#paragraf-21.odsek-12.pismeno-b),
...
umiestnenie jadrového zariadenia podľa [§ 2 písm. f) prvého bodu](#paragraf-2.pismeno-f.bod-1).
...
preukázanie splnenia požiadaviek na jadrovú bezpečnosť podľa tohto zákona a jeho vykonávacích predpisov v dokumentácii priloženej k žiadosti podľa [prílohy č. 1](#prilohy.priloha-priloha_c_1_k_zakonu_c_541_2004_z_z) alebo [prílohy č. 2](#prilohy.priloha-priloha_c_2_k_zakonu_c_541_2004_z_z); rozsah a úroveň podrobností vypracovanej dokumentácie podľa [prílohy č. 1](#prilohy.priloha-priloha_c_1_k_zakonu_c_541_2004_z_z) musí primerane zodpovedať rozsahu a povahe uvažovaného rizika súvisiaceho s jadrovým zariadením a jeho umiestnením.
...
Osobitnými podmienkami vydania súhlasu podľa [§ 5 ods. 2](#paragraf-5.odsek-2) a povolenia podľa [§ 5 ods. 3 písm. o)](#paragraf-5.odsek-3.pismeno-o) sú
...
do štyroch mesiacov, ak ide o umiestnenie stavby jadrového zariadenia okrem stavby jadrového zariadenia podľa [§ 2 písm. f) prvého bodu](#paragraf-2.pismeno-f.bod-1) alebo úložiska,
...
do jedného roka, ak ide o povolenie na umiestnenie jadrového zariadenia podľa [§ 2 písm. f) prvého bodu](#paragraf-2.pismeno-f.bod-1), ak ide o stavebné povolenie, o umiestnenie a uzatvorenie úložiska alebo ak ide o povolenie nadväzujúce na skončenie platnosti povolenia vydaného s obmedzeniami podľa odseku 1 písm. d).
...
oznamovať úradu bezodkladne každú zmenu podľa [§ 2 písm. x)](#paragraf-2.pismeno-x),

l)

predkladať úradu na odsúhlasenie alebo schválenie každú zmenu podľa [§ 2 písm. w)](#paragraf-2.pismeno-w) najmenej jeden mesiac pred jej uvažovanou realizáciou,
...
zabezpečiť vykonanie kontrol podľa písmena w) a kontrol prác odovzdaných dodávateľmi osobami, ktoré majú odbornú spôsobilosť podľa [§ 24](#paragraf-24) alebo aspoň päť rokov odbornej praxe v príslušných oblastiach využívania jadrovej energie podľa [§ 2 písm. v) prvého](#paragraf-2.pismeno-v.bod-1) alebo [druhého](#paragraf-2.pismeno-v.bod-2) bodu získanú výkonom pracovných činností na obdobnom jadrovom zariadení,

z)

zabezpečiť v systéme odbornej prípravy zamestnancov, u ktorých sa vyžaduje odborná spôsobilosť alebo osobitná odborná spôsobilosť podľa [§ 24 ods. 1](#paragraf-24.odsek-1) a [2](#paragraf-24.odsek-2), získavanie, udržiavanie a rozvoj odborných vedomostí, praktických zručností a osobných postojov v oblasti jadrovej bezpečnosti a havarijnej pripravenosti na území jadrového zariadenia.
...
V záujme zabezpečenia jadrovej bezpečnosti a predchádzania neodôvodnenému hromadeniu rádioaktívnych odpadov a vyhoretého jadrového paliva je držiteľ povolenia povinný počas uvádzania jadrového zariadenia do prevádzky a počas prevádzky jadrového zariadenia odovzdať rádioaktívne odpady a vyhoreté jadrové palivo právnickej osobe podľa [§ 3 ods. 11](#paragraf-3.odsek-11) na ďalšie nakladanie s nimi. Ak ide o rádioaktívne odpady, odovzdanie sa musí uskutočniť najneskôr do 12 mesiacov od ich vzniku, a ak ide o vyhoreté jadrové palivo, odovzdanie sa musí uskutočniť po splnení požiadaviek na jeho bezpečnú, hospodárnu a efektívnu prepravu do jadrového zariadenia, ku ktorému má povolenie právnická osoba podľa [§ 3 ods. 11](#paragraf-3.odsek-11). Táto povinnosť sa nevzťahuje na prechodné rádioaktívne odpady a na rádioaktívne odpady skladované v jadrovom zariadení ich vzniku, ktoré vzhľadom na obsah rádioaktívnych nuklidov nie sú po spracovaní a úprave uložiteľné v Republikovom úložisku rádioaktívnych odpadov v lokalite Mochovce.
...
Držiteľ povolenia je povinný predložiť úradu správu o výsledkoch hodnotenia so špecifickým tematickým zameraním v oblasti jadrovej bezpečnosti jadrových zariadení určené rozhodnutím podľa [§ 4 ods. 2 písm. c) tretieho bodu](#paragraf-4.odsek-2.pismeno-c.bod-3).
...
vykonanie hodnotenia podľa [§ 4 ods. 1 písm. l)](#paragraf-4.odsek-1.pismeno-l),

b)

uskutočnenie partnerského hodnotenia podľa [§ 4 ods. 1 písm. m)](#paragraf-4.odsek-1.pismeno-m).
...
Súhlas s vykonaním letu vo vzdušnom priestore zriadenom na ochranu jadrového zariadenia vydáva držiteľ povolenia podľa [§ 5 ods. 3 písm. a) až d](#paragraf-5.odsek-3.pismeno-a)) na základe žiadosti prevádzkovateľa lietadla[14a)](#poznamky.poznamka-14a) alebo prevádzkovateľa bezpilotného leteckého systému;[14b)](#poznamky.poznamka-14b) v súhlase určí podmienky vykonania letu v súlade s podmienkami určenými v kladnom stanovisku úradu.

(2)

Prevádzkovateľ lietadla a prevádzkovateľ bezpilotného leteckého systému sú povinní žiadosť o vydanie súhlasu s vykonaním letu vo vzdušnom priestore zriadenom na ochranu jadrového zariadenia predložiť držiteľovi povolenia podľa [§ 5 ods. 3 písm. a) až d](#paragraf-5.odsek-3.pismeno-a)) najmenej 20 dní pred plánovaným vykonaním letu. Vzor žiadosti o vydanie súhlasu s vykonaním letu vo vzdušnom priestore zriadenom na ochranu jadrového zariadenia zverejňuje držiteľ povolenia podľa [§ 5 ods. 3 písm. a) až d](#paragraf-5.odsek-3.pismeno-a)) na svojom webovom sídle.

(3)

Držiteľ povolenia podľa [§ 5 ods. 3 písm. a) až d](#paragraf-5.odsek-3.pismeno-a)) je povinný pred vydaním súhlasu s vykonaním letu vo vzdušnom priestore zriadenom na ochranu jadrového zariadenia požiadať úrad o stanovisko k vykonaniu letu v lehote najmenej 15 dní pred plánovaným vykonaním letu. V žiadosti o stanovisko držiteľ povolenia podľa [§ 5 ods. 3 písm. a) až d](#paragraf-5.odsek-3.pismeno-a)) uvedie meno a priezvisko pilota, čas letu a typ lietadla, ktorým sa let vykoná.

(4)

Držiteľ povolenia podľa [§ 5 ods. 3 písm. a) až d](#paragraf-5.odsek-3.pismeno-a)) môže vydať súhlas s vykonaním letu vo vzdušnom priestore zriadenom na ochranu jadrového zariadenia len ak úrad vydá k vykonaniu letu kladné stanovisko.

(5)

Ak držiteľ povolenia podľa [§ 5 ods. 3 písm. a) až d](#paragraf-5.odsek-3.pismeno-a)) je prevádzkovateľom lietadla alebo prevádzkovateľom bezpilotného leteckého systému, ustanovenia odsekov 1 až 4 sa na vykonanie letu vo vzdušnom priestore zriadenom na ochranu jadrového zariadenia držiteľom povolenia podľa [§ 5 ods. 3 písm. a) až d)](#paragraf-5.odsek-3.pismeno-a) nevzťahujú.

(6)

Kladné stanovisko k vykonaniu letu vo vzdušnom priestore zriadenom na ochranu jadrového zariadenia vydáva úrad na základe žiadosti držiteľa povolenia podľa [§ 5 ods. 3 písm. a) až d)](#paragraf-5.odsek-3.pismeno-a), ktorý je prevádzkovateľom lietadla alebo prevádzkovateľom bezpilotného leteckého systému. Držiteľ povolenia podľa [§ 5 ods. 3 písm. a) až d)](#paragraf-5.odsek-3.pismeno-a) je povinný požiadať úrad o stanovisko v lehote najmenej 15 dní pred plánovaným vykonaním letu.
...
Na prepravu rádioaktívnych materiálov sa primerane vzťahujú ustanovenia [§ 21 ods. 4](#paragraf-21.odsek-4). Pri preprave rádioaktívnych materiálov musia byť splnené požiadavky vyplývajúce z medzinárodných zmlúv, ktorými je Slovenská republika viazaná.[20)](#poznamky.poznamka-20)
...
Úrad rozhodne o vydaní súhlasu na umiestnenie stavby jadrového zariadenia na základe písomnej žiadosti doloženej dokumentáciou uvedenou v [prílohe č. 1 bode A](#prilohy.priloha-priloha_c_1_k_zakonu_c_541_2004_z_z.op-dokumentacia_jadrovych_zariadeni_potrebna_k_jednotlivym_rozhodnutiam.op-odrazka_a) a na základe vyjadrenia Európskej komisie v súlade s medzinárodnou zmluvou, ktorou je Slovenská republika viazaná.[21)](#poznamky.poznamka-21)
...
Úrad vydá povolenie na umiestnenie jadrového zariadenia podľa [§ 2 písm. f) prvého bodu](#paragraf-2.pismeno-f.bod-1) na základe písomnej žiadosti doloženej dokumentáciou podľa [prílohy č. 1 bodu A](#prilohy.priloha-priloha_c_1_k_zakonu_c_541_2004_z_z.op-dokumentacia_jadrovych_zariadeni_potrebna_k_jednotlivym_rozhodnutiam.op-odrazka_a) a potvrdenia o zaplatení administratívnej úhrady nákladov úradu na výkon dozoru v konaní o vydanie povolenia na umiestnenie jadrového zariadenia v sume 950 000 eur žiadateľom. Administratívnu úhradu vyberá úrad.

(2)

Povolenie na umiestnenie jadrového zariadenia podľa odseku 1 nahrádza súhlas na umiestnenie stavby jadrového zariadenia podľa [§ 17](#paragraf-17).
...
Podrobnosti o rozsahu, obsahu a spôsobe vyhodnotenia dokumentácie uvedenej v [prílohe č. 1 bode A](#prilohy.priloha-priloha_c_1_k_zakonu_c_541_2004_z_z.op-dokumentacia_jadrovych_zariadeni_potrebna_k_jednotlivym_rozhodnutiam.op-odrazka_a) ustanoví všeobecne záväzný právny predpis, ktorý vydá úrad.
...
Ustanovenia odsekov 1 až 12 a 14 sa primerane vzťahujú aj na nakladanie s vyhoretým jadrovým palivom, pričom držiteľ povolenia, ktorý vyhoreté jadrové palivo vyprodukoval, zodpovedá za nakladanie s týmto vyhoretým jadrovým palivom až po jeho odovzdanie a jeho prevzatie právnickou osobou podľa [§ 3 ods. 11](#paragraf-3.odsek-11).
...
Inštitucionálna kontrola je súbor činností, ktorými právnická osoba podľa [§ 3 ods. 11](#paragraf-3.odsek-11) zabezpečuje kontrolu vstupu na územie úložiska a kontrolu a údržbu funkčnosti jeho bariér po uzatvorení úložiska v čase ustanovenom v bezpečnostnej dokumentácii.
...
vykonávať hodnotenie jadrovej bezpečnosti podľa písmena f) v intervaloch a v rozsahu ustanovenom všeobecne záväzným právnym predpisom, ktorý vydá úrad; toto posúdenie bezpečnosti má za cieľ zabezpečiť zachovanie aktuálnej projektovej bázy a identifikovať možnosti zvyšovania jadrovej bezpečnosti s prihliadnutím na starnutie jadrového zariadenia, prevádzkové skúsenosti, najnovšie výsledky výskumu a vývoj medzinárodných noriem, pričom ako referenčný cieľ sa použije cieľ podľa [§ 23a ods. 8](#paragraf-23a.odsek-8),
...
realizovať zmeny na jadrovom zariadení uvedené v [§ 2 písm. w)](#paragraf-2.pismeno-w) po vydaní súhlasu úradu a v prípadoch uvedených v osobitných predpisoch[21)](#poznamky.poznamka-21) aj po stanovisku Európskej komisie,

j)

realizovať zmeny na jadrovom zariadení uvedené v [§ 2 písm. x)](#paragraf-2.pismeno-x) len po ich predchádzajúcom ohlásení úradu a po posúdení úradom podľa [§ 4 ods. 2 písm. g) druhého bodu](#paragraf-4.odsek-2.pismeno-g.bod-2),

k)

viesť samostatnú evidenciu o zmenách na jadrovom zariadení podľa [§ 2 písm. w)](#paragraf-2.pismeno-w) alebo [písm. x)](#paragraf-2.pismeno-x),
...
zmeny boli riadne navrhnuté, preskúmané, kontrolované a zavedené po zohľadnení povinnosti podľa [§ 10 ods. 1 písm. u)](#paragraf-10.odsek-1.pismeno-u) a
...
zavedenie organizačných štruktúr pre havarijnú pripravenosť a havarijnú odozvu podľa [§ 28 ods. 7](#paragraf-28.odsek-7).
...
Pri overovaní spoľahlivosti inšpektora jadrovej bezpečnosti na účely výkonu jeho oprávnení podľa [§ 31](#paragraf-31) postupuje úrad podľa odseku 4 primerane. Preverovanie bezúhonnosti inšpektora jadrovej bezpečnosti vykonáva úrad každé dva roky výpisom z registra trestov. Za spoľahlivého a bezúhonného sa považuje aj inšpektor jadrovej bezpečnosti, ktorý je bezpečnostne spoľahlivý podľa osobitného predpisu.[20d)](#poznamky.poznamka-20d)
...
Ak sa na účely zabezpečenia fyzickej ochrany jadrového zariadenia alebo vykonávania kontroly a zisťovania stavu objektov a zariadení jadrového zariadenia využíva kamera na bezpilotnom lietadle, držiteľ povolenia podľa [§ 5 ods. 3 písm. a) až d)](#paragraf-5.odsek-3.pismeno-a) vyhotovuje obrazový záznam kamerou na bezpilotnom lietadle v stráženom priestore[37da)](#poznamky.poznamka-37da) jadrového zariadenia (ďalej len „záznam z letu“). Držiteľ povolenia podľa [§ 5 ods. 3 písm. a) až d)](#paragraf-5.odsek-3.pismeno-a) je povinný uchovávať informácie o dôvode, dátume, dĺžke trvania letu a trati letu, osobné údaje pilota na diaľku v rozsahu meno a priezvisko a osobné údaje osoby, ktorá nariadila alebo schválila vykonanie letu, v rozsahu titul, meno, priezvisko a funkcia.
...
Informácie podľa odseku 11 a údaje zo záznamu z letu sa uchovávajú v informačnom systéme držiteľa povolenia podľa [§ 5 ods. 3 písm. a) až d)](#paragraf-5.odsek-3.pismeno-a) dva mesiace odo dňa nasledujúceho po dni, v ktorom bol záznam z letu vyhotovený. Po uplynutí tejto lehoty držiteľ povolenia podľa [§ 5 ods. 3 písm. a) až d)](#paragraf-5.odsek-3.pismeno-a) zničí záznam z letu.

(14)

O zničení záznamu z letu vyhotoví držiteľ povolenia podľa [§ 5 ods. 3 písm. a) až d)](#paragraf-5.odsek-3.pismeno-a) záznam, v ktorom uvedie osobné údaje osoby, ktorá nariadila alebo schválila vykonanie letu v rozsahu titul, meno, priezvisko a funkcia, dôvod vykonania letu a spôsob využitia záznamu z letu, ak bol záznam z letu využitý, dátum a dĺžku trvania letu, trať letu, osobné údaje pilota na diaľku v rozsahu meno a priezvisko a dátum zničenia záznamu z letu.

(15)

Držiteľ povolenia podľa [§ 5 ods. 3 písm. a) až d)](#paragraf-5.odsek-3.pismeno-a) je prevádzkovateľom podľa osobitného predpisu.[37db)](#poznamky.poznamka-37db)
...
Držiteľ povolenia podľa [§ 5 ods. 3 písm. a) až d)](#paragraf-5.odsek-3.pismeno-a) je povinný realizovať primerané technické a organizačné opatrenia,[37dd)](#poznamky.poznamka-37dd) ktoré zabezpečia, aby informácie podľa odseku 11 a údaje zo záznamu z letu boli sprístupnené len orgánom činným v trestnom konaní, orgánom prejednávajúcim priestupky alebo správne delikty podľa tohto zákona alebo orgánom prejednávajúcim správne delikty podľa osobitných predpisov[37dc)](#poznamky.poznamka-37dc) alebo zamestnancom držiteľa povolenia podľa [§ 5 ods. 3 písm. a) až d)](#paragraf-5.odsek-3.pismeno-a) podieľajúcim sa na zabezpečení fyzickej ochrany jadrového zariadenia alebo na vykonávaní kontroly a zisťovaní stavu objektov a zariadení jadrového zariadenia.
...
Držitelia povolení alebo obvodné úrady v sídlach krajov sú povinné predložiť havarijné plány na opätovné posúdenie alebo schválenie v termíne kratšom ako päť rokov, ak nastali zmeny jadrového zariadenia podľa [§ 2 písm. w)](#paragraf-2.pismeno-w), organizačnej štruktúry podľa odseku 6 alebo prostriedkov určených na zvládnutie nehody alebo havárie jadrového zariadenia alebo pri preprave rádioaktívnych materiálov, zmeny vo veľkosti oblasti ohrozenia, zmeny vo veľkosti spoločnej oblasti ohrozenia alebo zmeny v zabezpečení prepravy rádioaktívnych materiálov, alebo zmeny na základe výsledkov cvičení a kontrol.
...
Držiteľ povolenia a okresné úrady v sídle kraja dotknuté havarijnou odozvou sú povinné pri vzniku udalosti podľa [§ 27 ods. 3 písm. b) a c)](#paragraf-27.odsek-3.pismeno-b) alebo pri hrozbe vzniku takejto udalosti bezodkladne informovať verejnosť o skutočnostiach týkajúcich sa nehody alebo havárie, o krokoch, ktoré treba podniknúť, a, ak je to potrebné, o opatreniach na ochranu zdravia, ktoré sa dotknutej verejnosti týkajú. Poskytované informácie zahŕňajú informácie podľa odseku 20 doplnené najmenej o informácie o
...
Úrad podľa [§ 4 ods. 1 písm. f) a g)](#paragraf-4.odsek-1.pismeno-f) zabezpečuje informovanie o jadrovej havárii[38a)](#poznamky.poznamka-38a) a radiačnom ohrození[38b)](#poznamky.poznamka-38b) na území Slovenskej republiky podľa osobitných predpisov.[4)](#poznamky.poznamka-4)
...
Úrad uloží pokutu až do 2 000 000 eur držiteľovi povolenia, ktorý poruší ustanovenie [§ 3 ods. 2](#paragraf-3.odsek-2), [9, 10](#paragraf-3.odsek-9) alebo [ods. 12](#paragraf-3.odsek-12).
...
Úrad uloží pokutu až do 332 000 eur držiteľovi povolenia za porušenie povinností podľa [§ 10](#paragraf-10) alebo [§ 20](#paragraf-20) alebo za nedodržanie podmienok uvedených v povolení alebo v súhlase alebo za nevykonanie opatrenia v určenej lehote uloženého rozhodnutím úradu alebo nevykonanie opatrenia inšpektora na odstránenie nedostatkov podľa [§ 31 ods. 11 písm. h)](#paragraf-31.odsek-11.pismeno-h).

(4)

Úrad uloží pokutu až do 33 200 eur právnickej osobe za nesplnenie povinností uložených v [§ 3 ods. 13](#paragraf-3.odsek-13) a [14](#paragraf-3.odsek-14), [§ 12 ods. 2 a 3](#paragraf-12.odsek-2) a v [§ 33 ods. 3](#paragraf-33.odsek-3).
...
Priestupku sa dopustí fyzická osoba, ktorá poruší ustanovenie [§ 3 ods. 6](#paragraf-3.odsek-6) alebo nesplní povinnosti uložené v [§ 3 ods. 13](#paragraf-3.odsek-13) a [14](#paragraf-3.odsek-14), v [§ 12 ods. 2 a 3](#paragraf-12.odsek-2) a v [§ 33 ods. 3](#paragraf-33.odsek-3). Úrad uloží za tieto priestupky pokutu do 3 320 eur. V konaní o priestupku úrad postupuje podľa osobitného predpisu.[44)](#poznamky.poznamka-44)

(7)

Úrad uloží pokutu až do 2 000 eur za porušenie povinnosti uvedenej v [§ 10a ods. 3](#paragraf-10a.odsek-3), [4](#paragraf-10a.odsek-4) a [6.](#paragraf-10a.odsek-6)
...
6,22 eura za každých sto TBq maximálnej projektovej aktivity skladovaných rádioaktívnych odpadov ustanovenej k 1. januáru predchádzajúceho roka, pre jadrové zariadenie podľa [§ 2 písm. f) štvrtého bodu](#paragraf-2.pismeno-f.bod-4).
...
lehôt na vydanie rozhodnutia v konaniach podľa [§ 8 ods. 5](#paragraf-8.odsek-5) a [§ 15 ods. 4](#paragraf-15.odsek-4),

b)

náležitostí rozhodnutia v konaniach podľa [§ 15 ods. 4](#paragraf-15.odsek-4), [§ 16 až 16l](#paragraf-16) a [§ 24](#paragraf-24),
...
doručenia podľa [§ 8 ods. 10](#paragraf-8.odsek-10),
...
vydávania stanoviska podľa [§ 4 ods. 2 písm. i)](#paragraf-4.odsek-2.pismeno-i).
...
Držiteľ povolenia zašle úradu na schválenie aktualizáciu plánu fyzickej ochrany podľa [§ 25a ods. 2](#paragraf-25a.odsek-2) do 15. januára 2025.

(2)

Spoľahlivosť fyzickej osoby, ktorá vstupuje bez sprievodu do vnútorného priestoru a životne dôležitého priestoru jadrového zariadenia, sa musí preveriť podľa [§ 25a ods. 4](#paragraf-25a.odsek-4) do 15. januára 2026.
...
Tento zákon nadobúda účinnosť 1. decembra 2004 s výnimkou [§ 3 ods. 9 a 10](#paragraf-3.odsek-11), ktoré nadobúdajú účinnosť 1. januára 2012.
