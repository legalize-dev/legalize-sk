...
Držitelia povolení alebo obvodné úrady v sídlach krajov sú povinné predložiť havarijné plány na opätovné posúdenie alebo schválenie v termíne kratšom ako päť rokov, ak nastali zmeny jadrového zariadenia podľa [§ 2 písm. u)](#paragraf-2.pismeno-u), organizačnej štruktúry podľa odseku 4 alebo prostriedkov určených na zvládnutie nehody alebo havárie jadrového zariadenia alebo pri preprave rádioaktívnych materiálov, zmeny vo veľkosti oblasti ohrozenia, zmeny vo veľkosti spoločnej oblasti ohrozenia alebo zmeny v zabezpečení prepravy rádioaktívnych materiálov, alebo zmeny na základe výsledkov cvičení a kontrol.
...
36,51 eura za každý palivový článok skladovaný ku koncu predchádzajúceho roka pre jadrové zariadenie podľa [§ 2 písm. f) druhého bodu](#paragraf-2.pismeno-f.bod-2),

c)

41,99 eura za každý GBq aktivity rádioaktívnych odpadov upravených na uloženie v priebehu predchádzajúceho roka v jadrovom zariadení podľa [§ 2 písm. f) tretieho bodu](#paragraf-2.pismeno-f.bod-3),
...
6,22 eura za každý TBq maximálnej projektovej aktivity skladovaných rádioaktívnych odpadov ustanovenej k 1. januáru predchádzajúceho roka, pre jadrové zariadenie podľa [§ 2 písm. f) tretieho bodu](#paragraf-2.pismeno-f.bod-3).
...
pre jadrové zariadenia podľa [§ 2 písm. f) druhého až štvrtého bodu](#paragraf-2.pismeno-f.bod-2), okrem jadrového zariadenia podľa odseku 4 písm. e), sa stavom ku koncu predchádzajúceho roka rozumie predpokladaný stav k 31. decembru roka, v ktorom uplynie dvanásť mesiacov prevádzky jadrového zariadenia.
...
Týmto zákonom sa preberajú právne akty Európskych spoločenstiev a Európskej únie uvedené v [prílohe č. 4](#prilohy.priloha-priloha_c_4_k_zakonu_c_541_2004_z_z.oznacenie).
