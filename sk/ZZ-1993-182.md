...
Ustanovenia odsekov 1 až 6 sa rovnako použijú aj na hlasovanie zhromaždenia podľa [§ 7c ods. 9](#paragraf-7c.odsek-9). Ak spoločenstvo tvorí viac domov, o úvere, rozdelení spoločenstva, súhlase so vstavbou alebo nadstavbou a o použití fondu prevádzky, údržby a opráv hlasujú iba vlastníci bytov a nebytových priestorov v dome, ktorého sa predmet hlasovania týka.
...
Ustanovenia tohto zákona s výnimkou [§ 6 až 8b](#predpis.clanok-1.cast-druha.skupinaParagrafov-sprava_domu_vlastnikmi_bytov_a_nebytovych_priestorov_v_dome), [§ 29](#paragraf-29) a [§ 29a ods. 1](#paragraf-29a.odsek-1) sa primerane vzťahujú aj na budovy, ktoré nemajú charakter bytového domu.
