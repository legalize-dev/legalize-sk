...
Účastníkovi, ktorý nesplnil podmienky na vyplácanie dávok uvedených v [§ 15 písm. a) a b)](#paragraf-15.pismeno-a) a požiada o predčasný výber, vyplatí sa suma predčasného výberu zodpovedajúca súčinu aktuálnej hodnoty doplnkovej dôchodkovej jednotky zo dňa predchádzajúceho dňu určenému v žiadosti o vyplatenie predčasného výberu a počtu všetkých doplnkových dôchodkových jednotiek z príspevkov zaplatených účastníkom; podanie žiadosti o výplatu dávok podľa [§ 15 písm. a) a b)](#paragraf-15.pismeno-a) sa na tento účel nepovažuje za podmienku vyplácania dávok.
