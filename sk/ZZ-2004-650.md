...
Účastníkovi sa vypláca doplnkový výsluhový dôchodok, ak získa minimálne obdobie doplnkového dôchodkového sporenia z dôvodu výkonu prác, ktoré sú zaradené na základe rozhodnutia orgánu na ochranu zdravia do kategórie 3 alebo 4, alebo z dôvodu výkonu prác tanečného umelca alebo hráča na dychový nástroj a dovŕši potrebný vek, ktoré určí dávkový plán.
...
Dočasný doplnkový výsluhový dôchodok sa vypláca najmenej do dovŕšenia veku potrebného na nárok na starobný dôchodok podľa osobitného predpisu.[5)](#poznamky.poznamka-5) Dovŕšenie veku potrebného na nárok na starobný dôchodok podľa osobitného predpisu[5)](#poznamky.poznamka-5) preukazuje účastník.
...
Jednorazové vyrovnanie podľa odseku 2 sa vyplatí najviac v sume zodpovedajúcej 50 % aktuálnej hodnoty osobného účtu účastníka ku dňu požiadania o jeho vyplatenie, ak k tomuto dňu účastník súčasne požiadal o vyplácanie doživotného doplnkového starobného dôchodku.

(4)

Jednorazové vyrovnanie podľa odseku 2 sa vyplatí najviac v sume zodpovedajúcej 25 % aktuálnej hodnoty osobného účtu účastníka ku dňu požiadania o jeho vyplatenie, ak k tomuto dňu účastník súčasne požiadal o vyplácanie dočasného doplnkového starobného dôchodku.

(5)

Jednorazové vyrovnanie sa vyplatí v sume zodpovedajúcej 100 % aktuálnej hodnoty osobného účtu účastníka ku dňu požiadania o jeho vyplatenie, ak účastník splnil podmienky uvedené v odseku 1.
...
Odstupné sa vyplatí v sume určenej dávkovým plánom, najmenej vo výške 80 % aktuálnej hodnoty osobného účtu účastníka ku dňu požiadania o jeho vyplatenie.
...
Odplata za prestup účastníka do inej doplnkovej dôchodkovej spoločnosti je v období troch rokov od uzatvorenia účastníckej zmluvy najviac 5 % aktuálnej hodnoty osobného účtu účastníka ku dňu prestupu a v ďalšom období najviac 1 % aktuálnej hodnoty osobného účtu účastníka ku dňu prestupu.

(4)

Odplata za odstupné je najviac 20 % aktuálnej hodnoty osobného účtu účastníka ku dňu požiadania o vyplatenie odstupného.
...
vyplatením poslednej splátky doplnkového starobného dôchodku, doplnkového výsluhového dôchodku alebo vyplatením jednorazového vyrovnania podľa [§ 18 ods. 1](#paragraf-18.odsek-1),
...
počet doplnkových dôchodkových jednotiek, ktoré vznikli podľa [§ 35 ods. 1 písm. b)](#paragraf-35.odsek-1.pismeno-b) a [c)](#paragraf-35.odsek-1.pismeno-c), a informáciu o aktuálnej percentuálnej výške odplaty podľa [§ 35 ods. 1 písm. a)](#paragraf-35.odsek-1.pismeno-a),
...
počet doplnkových dôchodkových jednotiek, ktoré vznikli podľa [§ 35 ods. 1 písm. b) a c)](#paragraf-35.odsek-1.pismeno-b), a informáciu o aktuálnej percentuálnej výške odplaty podľa [§ 35 ods. 1 písm. a)](#paragraf-35.odsek-1.pismeno-a),
...
výšku odplát podľa [§ 35 ods. 1](#paragraf-35.odsek-1), ktoré boli z osobného účtu účastníka uhradené, vyjadrenú v peniazoch,
...
výšku odplát podľa [§ 35 ods. 1](#paragraf-35.odsek-1), ktoré boli z osobného účtu poberateľa dávky uhradené, vyjadrenú v peniazoch,
...
Doplnková dôchodková spoločnosť je povinná zaslať účastníkovi a poberateľovi dávky súčasne s výpisom z osobného účtu podľa odsekov 7 a 8 informáciu o výške nákladov a poplatkov podľa [§ 35 ods. 5](#paragraf-35.odsek-5).
...
Ku dňu, kedy bol na bežný účet doplnkového dôchodkového fondu vedený u depozitára pripísaný príspevok a majetok prevedený podľa [§ 63](#paragraf-63) a [64](#paragraf-64), pripíše príslušná doplnková dôchodková spoločnosť účastníkovi na jeho osobný účet taký počet doplnkových dôchodkových jednotiek doplnkového dôchodkového fondu, ktorý zodpovedá podielu hodnoty príspevku a majetku prevedeného podľa [§ 63](#paragraf-63) a [64](#paragraf-64) a aktuálnej hodnoty doplnkovej dôchodkovej jednotky doplnkového dôchodkového fondu.
...
príležitostné poskytovanie informácií z oblasti doplnkového dôchodkového sporenia pri vykonávaní činnosti podľa osobitných predpisov^43a) alebo poskytovanie všeobecných informácií týkajúcich sa produktov doplnkového dôchodkového sporenia, ak sa tieto informácie neposkytujú s cieľom uzatvoriť alebo zmeniť účastnícku zmluvu alebo zamestnávateľskú zmluvu, ani sa neposkytujú pri vykonávaní účastníckej zmluvy alebo zamestnávateľskej zmluvy,
