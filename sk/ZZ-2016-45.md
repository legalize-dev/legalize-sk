...
Priestory autoškoly sú spôsobilé na prevádzkovanie, ak zodpovedajú všeobecným stavebnotechnickým požiadavkám na výstavbu podľa osobitného predpisu[1)](#poznamky.poznamka-1) a je povolené ich užívanie.
...
Kancelária je samostatná miestnosť, ktorá je miestom kontaktu medzi autoškolou a účastníkmi kurzu a slúži na administratívne zabezpečenie plnenia úloh vyplývajúcich najmä z [§ 6 ods. 1 písm. h) až j)](../../../../SK/ZZ/2005/93/#paragraf-6.odsek-1.pismeno-h) zákona. Kancelária je vybavená kancelárskou technikou, výpočtovou technikou a komunikačnou technikou v rozsahu potrebnom na zabezpečenie bezpečnej komunikácie s jednotným informačným systémom v cestnej doprave[2)](#poznamky.poznamka-2) (ďalej len „cestný informačný systém“).

(4)

Učebňa je samostatná miestnosť, ktorá umožňuje teoretickú výučbu, praktickú údržbu, výcvik na trenažéri a má také rozmery, aby na každého účastníka kurzu pripadla plocha najmenej 1 m^2 a na inštruktora autoškoly a učebné pomôcky pri teoretickej výučbe a praktickej údržbe najmenej 10 m^2.
...
Dokladom preukazujúcim splnenie požiadavky podľa odseku 1 písm. a) až c) je osvedčenie o schválení spôsobilosti trenažéra podľa [§ 12 ods. 1 písm. f) zákona](../../../../SK/ZZ/2005/93/#paragraf-12.odsek-1.pismeno-f). Dokladom preukazujúcim splnenie požiadavky podľa odseku 1 písm. d) je potvrdenie o vykonaní montáže identifikačného zariadenia trenažéra podľa [§ 5a ods. 9 zákona](../../../../SK/ZZ/2005/93/#paragraf-5a.odsek-9).
...
umožňuje vykonávať nácvik úkonov podľa metodiky v rozsahu učebnej osnovy, vykonať a preverovať ovládanie základných vodičských úkonov v rozsahu prvej časti skúšky z vedenia motorových vozidiel podľa osobitného predpisu, [4)](#poznamky.poznamka-4)
...
na nácvik úkonov podľa odseku 1 písm. b) spevnenou plochou s asfaltovým, betónovým alebo dláždeným povrchom s minimálnymi rozmermi autocvičiska pre skupiny vodičských oprávnení[4a)](#poznamky.poznamka-4a) AM, A1, A2, A, B1, B, B s harmonizovaným kódom, BE, T 15x50 m a pre skupiny vodičských oprávnení C1, C, C1E, CE, D1, D, D1E, DE 20x70 m,
...
Praktický výcvik v autoškole sa vykonáva na výcvikových vozidlách, ktoré súčasne spĺňajú podmienky podľa osobitného predpisu[5a)](#poznamky.poznamka-5a) a tieto požiadavky:
...
praktický výcvik pre skupinu B s harmonizovaným kódom[4a)](#poznamky.poznamka-4a) sa vykonáva na jazdnej súprave, ktorá pozostáva z ťažného výcvikového vozidla skupiny B podľa písmena c) a prípojného vozidla tak, aby najväčšia celková prípustná hmotnosť jazdnej súpravy bola viac ako 3 500 kg a najviac 4 250 kg,
...
Odnímateľný transparent a reflexná fólia musia byť schválené ako hromadne vyrábaný komponent.[5)](#poznamky.poznamka-5)

(3)

Vzory odnímateľného transparentu, reflexnej fólie a vesty, ako aj ich umiestnenie a technické požiadavky sú uvedené v [prílohe č. 1](#prilohy.priloha-priloha_c_1_k_vyhlaske_c_45_2016_z_z).
...
Počas výcviku v kurzoch podľa [§ 2 ods. 1 písm. a)](../../../../SK/ZZ/2005/93/#paragraf-2.odsek-1.pismeno-a) a [b) zákona](../../../../SK/ZZ/2005/93/#paragraf-2.odsek-1.pismeno-b) musí byť výcvikové vozidlo označené údajmi o prevádzkovateľovi autoškoly podľa odseku 7, ktoré je vyhotovené nezmazateľne písmomaliarsky na karosériu, alebo použitím odnímateľnej nálepky, prípadne mechanicky pripevnenou tabuľkou.
...
Inštruktor autoškoly a účastník kurzu podľa [§ 2 ods. 1 písm. a) až d) zákona](../../../../SK/ZZ/2005/93/#paragraf-2.odsek-1.pismeno-a), okrem náčuvov pri inštruktorských kurzoch, potvrdzuje svoju účasť na
...
Po ukončení vodičského kurzu sa účastníkovi kurzu vydá osvedčenie o absolvovaní kurzu podľa [§ 23](#paragraf-23) prostredníctvom cestného informačného systému.
...
Na účastníkov inštruktorského kurzu a doškoľovacieho kurzu inštruktorov autoškôl sa primerane vzťahuje [§ 8 ods. 6.](#paragraf-8.odsek-6)

##### § 13

##### Rozsah a členenie skupín inštruktorského oprávnenia

Inštruktorské oprávnenie sa člení podľa skupín motorových vozidiel[7a)](#poznamky.poznamka-7a) na tieto skupiny:
...
skupina BE oprávňuje inštruktora autoškoly vykonávať výučbu a výcvik v kurzoch pre skupiny B1, B a BE vodičských oprávnení a výučbu osobitného výcviku pre skupinu B s harmonizovaným kódom,[4a)](#poznamky.poznamka-4a)
...
##### Inštruktorská skúška [k [§ 21 ods. 1 písm. c) zákona](../../../../SK/ZZ/2005/93/#paragraf-21.odsek-1.pismeno-c)]
...
Podrobnosti o priebehu a hodnotení jednotlivých častí inštruktorskej skúšky sú upravené v skúšobnom poriadku podľa [§ 12 ods. 1 písm. d) zákona](../../../../SK/ZZ/2005/93/#paragraf-12.odsek-1.pismeno-d).

(7)

Ustanovenia odsekov 1 až 6 sa primerane vzťahujú aj na skúšku vykonanú po účasti na doškoľovacom kurze inštruktorov autoškôl podľa [§ 11 ods. 1 písm. b) zákona](../../../../SK/ZZ/2005/93/#paragraf-11.odsek-1.pismeno-b).

##### § 14a

(1)

Ustanovenia [§ 14](#paragraf-14) sa primerane vzťahujú na skúšku na vydanie preukazu skúšobného komisára a na skúšku na predĺženie platnosti preukazu skúšobného komisára.

(2)

Preukaz skúšobného komisára sa vydá účastníkovi, ktorý bol na skúške hodnotený stupňom „vyhovel“. Vzor preukazu skúšobného komisára je uvedený v [prílohe č. 2a](#prilohy.priloha-priloha_c_2a_k_vyhlaske_c_45_2016_z_z.oznacenie).

(3)

Vzor protokolu o vykonaní skúšky na vydanie preukazu skúšobného komisára je uvedený v [prílohe č. 2b](#prilohy.priloha-priloha_c_2b_k_vyhlaske_c_45_2016_z_z.oznacenie).
...
Požiadavky na identifikačné zariadenie učebne a trenažéra podľa odseku 1 písm. b) sú uvedené v [§ 29 ods. 4](#paragraf-29.odsek-4) a [7.](#paragraf-29.odsek-7)
...
Ustanovenia [§ 29 ods. 3](#paragraf-29.odsek-3), [6](#paragraf-29.odsek-6) a [7](#paragraf-29.odsek-7) sa primerane vzťahujú aj na odosielanie záznamu do cestného informačného systému z programového vybavenia autoškoly.
...
Ustanovenia [§ 31 ods. 1](#paragraf-31.odsek-1) a [4](#paragraf-31.odsek-4) sa primerane vzťahujú aj na testovanie kompatibility identifikačného zariadenia učebne a trenažéra okrem evidencie offline údajov.
...
Počas trvania krízovej situácie možno predpísaný počet vyučovacích hodín výučby teórie podľa [§ 8 ods. 6](#paragraf-8.odsek-6) a [7](#paragraf-8.odsek-7) nahradiť v rozsahu 100 % individuálne s inštruktorom autoškoly dištančnou formou alebo v cestnom informačnom systéme v elektronickej podobe podľa [§ 8 ods. 8.](#paragraf-8.odsek-8)
