...
fyzickú osobu, ktorá vykonáva pracovnú činnosť pre cirkevné, rehoľné a charitatívne spoločenstvo a nemá z tejto alebo z inej činnosti príjem[39s)](#poznamky.poznamka-39s) okrem vyňatých príjmov; za vyňaté príjmy sa na účely tohto zákona považujú
...
príjmy z prenájmu,[39t)](#poznamky.poznamka-39t)

3.

príjmy, z ktorých sa vyberá daň zrážkou,[39ta)](#poznamky.poznamka-39ta) okrem príjmu zo závislej činnosti, pri ktorom sa neuplatňujú nezdaniteľné časti základu dane a daňový bonus podľa osobitného predpisu,[39tb)](#poznamky.poznamka-39tb)
...
Štát je platiteľom poistného za osobu uvedenú v odseku 8 písm. a) až i), k), p) a q), ak

a)

je len zamestnancom, ak v období, v ktorom sa považuje za osobu podľa odseku 8 písm. a) až i), k), p) a q), jej vymeriavací základ podľa [§ 13 ods. 1 až 5](#paragraf-13.odsek-1) nepresahuje 1/2 úhrnu minimálnych miezd,[39v)](#poznamky.poznamka-39v)

b)

je len samostatne zárobkovo činnou osobou, ak v období, v ktorom sa považuje za osobu podľa odseku 8 písm. a) až i), k), p) a q), jej pomerná časť vymeriavacieho základu podľa [§ 13 ods. 6](#paragraf-13.odsek-6) nepresahuje 1/2 úhrnu minimálnych miezd,[39v)](#poznamky.poznamka-39v)

c)

nie je zamestnancom ani samostatne zárobkovo činnou osobou, ak v období, v ktorom sa považuje za osobu podľa odseku 8 písm. a) až i), k), p) a q), jej príjem, ktorý podlieha dani z príjmov[39s)](#poznamky.poznamka-39s) okrem vyňatých príjmov, nepresahuje 1/2 úhrnu minimálnych miezd,[39v)](#poznamky.poznamka-39v) alebo

d)

aj dochádza v rozhodujúcom období postupne alebo súčasne k súbehu skutočností podľa písmen a) až c), ak v období, v ktorom sa považuje za osobu podľa odseku 8 písm. a) až i), k), p) a q), úhrn jej vymeriavacích základov podľa písmen a) a b) a príjmu podľa písmena c) nepresahuje 1/2 úhrnu minimálnych miezd.[39v)](#poznamky.poznamka-39v)

(10)

Štát je platiteľom poistného za osobu uvedenú v odseku 8 písm. j), l) až n) a s), ak súčasne nie je zamestnancom ani samostatne zárobkovo činnou osobou a ak v tomto období jej príjem, ktorý podlieha dani z príjmov[39s)](#poznamky.poznamka-39s) okrem vyňatých príjmov, nepresahuje 1/2 úhrnu minimálnych miezd.[39v)](#poznamky.poznamka-39v)
...
Vymeriavací základ poistenca, ktorý bol v rozhodujúcom období poistencom štátu podľa [§ 11 ods. 8 písm. a) až i)](#paragraf-11.odsek-8.pismeno-a), [k)](#paragraf-11.odsek-8.pismeno-k), [p) a q)](#paragraf-11.odsek-8.pismeno-p) a splnil podmienky uvedené v [§ 11 ods. 9](#paragraf-11.odsek-9), je pomerná časť vymeriavacieho základu podľa [§ 13 ods. 1 až 10](#paragraf-13.odsek-1) prislúchajúca k počtu kalendárnych dní, počas ktorých nebol tento poistenec poistencom štátu.
...
samostatne zárobkovo činnej osoby, ktorá nie je súčasne zamestnancom ani osobou podľa [§ 11 ods. 8 písm. a) až i)](#paragraf-11.odsek-8.pismeno-a), [k)](#paragraf-11.odsek-8.pismeno-k), [p) a q)](#paragraf-11.odsek-8.pismeno-p), je najmenej vo výške určenej sadzbou poistného [[§ 12 ods. 1 písm. c)](#paragraf-12.odsek-1.pismeno-c)] z minimálneho základu podľa [§ 13 ods. 17 a 18](#paragraf-13.odsek-17) a najviac vo výške určenej sadzbou poistného [[§ 12 ods. 1 písm. c)](#paragraf-12.odsek-1.pismeno-c)] z trojnásobku priemernej mesačnej mzdy,

c)

samostatne zárobkovo činnej osoby, ktorá je súčasne zamestnancom alebo osobou podľa [§ 11 ods. 8 písm. a) až i)](#paragraf-11.odsek-8.pismeno-a), [k)](#paragraf-11.odsek-8.pismeno-k), [p) a q)](#paragraf-11.odsek-8.pismeno-p), je najviac vo výške určenej sadzbou poistného [[§ 12 ods. 1 písm. c)](#paragraf-12.odsek-1.pismeno-c)] z trojnásobku priemernej mesačnej mzdy,
...
v čase, keď bol poistencom, za ktorého platí poistné štát, a nebol zamestnancom, úhrn jeho vymeriavacích základov podľa [§ 13 ods. 1 až 8](#paragraf-13.odsek-1) nepresiahol 1/2 úhrnu minimálnych miezd,[39v)](#poznamky.poznamka-39v)

2.

v čase, keď bol platiteľom podľa [§ 11 ods. 2](#paragraf-11.odsek-2), jeho príjem podľa [§ 13 ods. 7](#paragraf-13.odsek-7) nepresiahol 1/2 úhrnu minimálnych miezd,[39v)](#poznamky.poznamka-39v) a
...
O sporoch vyplývajúcich z ročného zúčtovania poistného rozhoduje úrad. Na toto konanie sa vzťahujú všeobecné predpisy o správnom konaní.
...
plniť oznamovacie povinnosti podľa [§ 23 ods. 1](#paragraf-22.odsek-1), [3](#paragraf-23.odsek-3) a [5](#paragraf-23.odsek-5),
...
Preukazovanie skutočností podľa [§ 11 ods. 8 písm. b)](#paragraf-11.odsek-8.pismeno-b), [d), e)](#paragraf-11.odsek-8.pismeno-d), [o)](#paragraf-11.odsek-8.pismeno-o) a [q)](#paragraf-11.odsek-8.pismeno-q) sa upraví dohodou, ktorú uzatvorí Sociálna poisťovňa s úradom. Úrad je povinný tieto údaje oznámiť príslušnej zdravotnej poisťovni do ôsmich dní odo dňa ich prijatia.
...
Tento zákon nadobúda účinnosť 1. januára 2005 okrem [§ 25 ods. 1 písm. c)](#paragraf-25.odsek-1.pismeno-c), ktorý nadobúda účinnosť 1. januára 2006.
