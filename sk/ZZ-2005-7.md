...
Poskytnutím ochrany pred veriteľmi sa odkladajú všetky exekúcie, ktoré sa vedú voči dlžníkovi ohľadom pohľadávok, ktoré môžu byť uspokojené iba splátkovým kalendárom ([§ 166a](#paragraf-166a)). Ak súd určí splátkový kalendár, ide o dôvod, aby sa bez zbytočného odkladu v exekučnom konaní rozhodlo o zastavení exekúcie.
...
pohľadávky Fondu ochrany vkladov v rozsahu náhrad vyplatených vkladateľom podľa osobitného predpisu[32a)](#poznamky.poznamka-32a) alebo v rozsahu prostriedkov poskytnutých na riešenie krízovej situácie podľa osobitného predpisu,[32b)](#poznamky.poznamka-32b)

b)

pohľadávky z chránených vkladov fyzických osôb, mikropodnikov, malých a stredných podnikov,[32c)](#poznamky.poznamka-32c) ktoré prevyšujú úroveň krytia podľa osobitného predpisu,[32d)](#poznamky.poznamka-32d) a pohľadávky z vkladov fyzických osôb, mikropodnikov, malých a stredných podnikov,[32c)](#poznamky.poznamka-32c) ktoré by boli považované za chránené vklady, ak by neboli vložené do pobočky banky umiestnenej v inom ako členskom štáte.
