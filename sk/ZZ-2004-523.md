...
Ak z právnych aktov Európskych spoločenstiev a Európskej únie nevyplýva iné, prostriedky Európskej únie sa zaraďujú do príjmov štátneho rozpočtu okrem prostriedkov súvisiacich s intervenčnými opatreniami, o ktorých osobitný zákon[13)](#poznamky.poznamka-13) ustanoví, že sa vedú na samostatnom mimorozpočtovom účte.
...
výpisom z registra trestov nie starším ako tri mesiace, ak ide o splnenie podmienky podľa odseku 4 písm. f) a g).
