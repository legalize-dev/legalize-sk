...
podiel na zisku v rozsahu, v akom nie je daňovým výdavkom u daňovníka vyplácajúceho tento podiel na zisku, vyrovnací podiel, podiel na likvidačnom zostatku alebo podiel na výsledku podnikania, ak nie sú predmetom dane podľa [§ 3 ods. 2 písm. c)](#paragraf-3.odsek-2.pismeno-c) a sú vyplácané právnickej osobe,
...
Sadzba dane, okrem [§ 15a](#paragraf-15a), [43](#paragraf-43) a [44](#paragraf-44), pre
...
zo základu dane zisteného podľa [§ 4](#paragraf-4) je
...
z osobitného základu dane zisteného podľa [§ 7](#paragraf-7) je 19 %,
...
obchodného podielu na obchodnej spoločnosti alebo družstve s výnimkou vstupnej ceny podľa [§ 25a](#paragraf-25a) podielu na akciovej spoločnosti (akcie), pre ktorú platí ustanovenie písmena f), pri jeho predaji len do výšky príjmov z predaja, posudzovaným za každý predaj jednotlivo,
...
Ustanovenie [§ 5 ods. 7 písm. m)](#paragraf-5.odsek-7.pismeno-m) v znení účinnom od 1. januára 2016 sa použije prvýkrát na sociálnu výpomoc poskytnutú zamestnancovi po 31. decembri 2015.
