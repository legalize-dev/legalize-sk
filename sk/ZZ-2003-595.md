...
Základ dane (čiastkový základ dane) zistený z príjmov podľa [§ 5](#paragraf-5)alebo [§ 6 ods. 1 a 2](#paragraf-6.odsek-1)alebo súčet čiastkových základov dane z týchto príjmov sa znižuje o nezdaniteľné časti základu dane uvedené v odsekoch 2 a 3.
...
rozpočtových organizácií z prenájmu a z predaja majetku zahrnuté v rozpočte zriaďovateľa okrem príjmov, z ktorých sa daň vyberá podľa [§ 43](#paragraf-43)a okrem príjmov z predaja majetku zahrnutého v rozpočte zriaďovateľa, ak zriaďovateľom tejto rozpočtovej organizácie je obec alebo vyšší územný celok,
...
fyzických osôb zisteného podľa [§ 4](#paragraf-4),
...
iné druhy zdaniteľných príjmov podľa [§ 6 až 8](#paragraf-6)vrátane príjmov, z ktorých sa daň vyberá podľa [§ 43](#paragraf-43), pri ktorých daňovník uplatní postup podľa [§ 43 ods. 7](#paragraf-43.odsek-7).
...
Preddavok na daň zo zdaniteľnej mzdy zaokrúhlenej podľa [§ 47](#paragraf-47), zúčtovanej a vyplatenej za kalendárny mesiac alebo zdaňovacie obdobie je 19 %. Tento preddavok na daň sa zníži o sumu zodpovedajúcu sume daňového bonusu podľa [§ 33 ods. 1](#paragraf-33.odsek-1).
...
posledným rozhodnutím o priznaní dôchodku alebo dokladom o ročnom úhrne vyplateného dôchodku ([§ 11 ods.](#paragraf-11.odsek-6)6), ak suma takéhoto dôchodku v úhrne nepresahuje sumu ustanovenú v [§ 11 ods. 2](#paragraf-11.odsek-2).
...
Zamestnávateľ, ktorý je platiteľom dane, je povinný podávať miestne príslušnému správcovi dane v lehote podľa [§ 49](#paragraf-49)

a)

prehľad o príjmoch zo závislej činnosti, ktoré jednotlivým zamestnancom vyplatil, o zrazených a odvedených preddavkoch na daň z týchto príjmov a o daňovom bonuse za uplynulý kalendárny mesiac (ďalej len „prehľad“); v prehľade sa uvádzajú aj osobné údaje zamestnanca uvedené v [§ 32 ods. 6 písm. a) až c)](#paragraf-32.odsek-6.pismeno-a), ktorému bol príjem poskytnutý, ak nejde o osoby, na ktoré sa vzťahujú osobitné spôsoby vykazovania údajov podľa osobitného predpisu,[132)](#poznamky.poznamka-132)
...
v odseku 3 písm. h) je príjem znížený o výdavok vo výške ustanoveného percenta pre tento príjem podľa [§ 6 ods. 10](#paragraf-6.odsek-10),

c)

v [§ 16 ods. 1 písm. d)](#paragraf-16.odsek-1.pismeno-d) je príjem znížený o znížený o výdavok vo výške ustanoveného percenta pre tento príjem podľa [§ 6 ods. 10](#paragraf-6.odsek-10).
...
Na zabezpečenie dane zo zdaniteľných príjmov okrem príjmov, z ktorých sa daň vyberá zrážkou, sú platitelia príjmu, ktorí vyplácajú, poukazujú alebo pripisujú úhrady v prospech daňovníka s obmedzenou daňovou povinnosťou s výnimkou daňovníka podľa [§ 2 písm. t)](#paragraf-2.pismeno-t), povinní zrážať na zabezpečenie dane sumu zodpovedajúcu sadzbe dane podľa [§ 15](#paragraf-15) z peňažného plnenia, najviac však do výšky podľa medzinárodnej zmluvy, okrem prípadov, keď sa zráža preddavok na daň podľa [§ 35](#paragraf-35). Ak ide o podiel daňovníka, ktorý je spoločníkom verejnej obchodnej spoločnosti, komplementárom komanditnej spoločnosti alebo členom európskeho zoskupenia hospodárskych záujmov, suma na zabezpečenie dane sa zráža bez ohľadu na vyplatenie podielu na zisku najneskôr do troch mesiacov nasledujúcich po uplynutí zdaňovacieho obdobia. Ak ide o príjem z prenájmu nehnuteľností, plynúci daňovníkovi fyzickej osobe, na účely výpočtu sumy na zabezpečenie dane sa použije zdaniteľný príjem znížený o výdavok vo výške ustanoveného percenta pre tento príjem podľa [§ 6 ods. 10](#paragraf-6.odsek-10).
...
Ustanovenie [§ 50 ods. 1 písm. b)](#paragraf-50.odsek-1.pismeno-b) v znení účinnom od 1. januára 2011 sa použije po prvýkrát pri podávaní daňového priznania za zdaňovacie obdobie končiace najneskôr 31. decembra 2010 a pri podávaní daňového priznania za zdaňovacie obdobie končiace najneskôr 31. decembra 2012.
