...
Zariadením staveniska sa rozumejú objekty a zariadenia, ktoré v čase uskutočňovania stavby slúžia prevádzkovým a sociálnym účelom účastníkov výstavby; patria sem aj objekty a zariadenia, ktoré buduje alebo už vybudoval a požičal investor, dodávateľ alebo iná organizácia na účely zariadenia staveniska.
...
V odôvodnených prípadoch sa môžu pri rozsiahlych a zložitých stavbách v projektovej úlohe vymedziť etapy stavby, ktoré umožňujú postupné uvádzanie kapacít (stavby) do trvalej prevádzky (užívania).

(2)

Etapu môžu tvoriť len ucelená časť stavby schopná samostatnej prevádzky (užívania); etapa sa môže vymedziť inak, len ak to vyžadujú podmienky dovozu.
...
vyjadruje spôsob a postup ďalšej prípravy a uskutočňovania stavby a začiatočného obdobia prevádzky (užívania) stavby, najmä dodávateľský systém, časový plán a základné riešenie zariadenia staveniska.
...
So súhlasom ústredného orgánu investora sa môže v rámci úvodného projektu výnimočne spracovať projektová dokumentácia (jednostupňový projekt, príp. vykonávacie projekty) časti stavby potrebnej v roku plánovaného začatia stavby na rozvinutie výstavby,[25)](#poznamky.poznamka-25) a to pre stavebné objekty alebo prevádzkové súbory, ktoré možno využiť ako zariadenie staveniska (ide najmä o terénne úpravy, komunikácie, inžinierske siete, administratívne, bytové, skladové a halové objekty, transformačné stanice, kompresorovne).
