...
Na trh možno uviesť,[12a)](#poznamky.poznamka-12a) ponúkať alebo predávať len bezpečné výrobky; to neplatí pre použité výrobky dodané ako starožitnosti alebo pre výrobky, ktoré sa majú pred použitím opraviť alebo obnoviť, ak o tom dodávateľ preukázateľne informoval osobu, ktorej výrobok dodáva.
...
Zriaďuje sa komisia na posudzovanie podmienok v spotrebiteľských zmluvách[9)](#poznamky.poznamka-9) (ďalej len „komisia“) ako stály orgán. Komisia má právo vyžadovať od predávajúceho všeobecné zmluvné podmienky, ktoré dojednáva so spotrebiteľom, a predávajúci je povinný takejto žiadosti vyhovieť.
...
Na konanie podľa tohto zákona sa vzťahuje všeobecný predpis o správnom konaní[29)](#poznamky.poznamka-29) okrem [§ 20 ods. 3 písm. e) až h)](#paragraf-20.odsek-3.pismeno-e) a [§ 21](#paragraf-21).
