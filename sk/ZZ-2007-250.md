...
Tento zákon upravuje práva spotrebiteľov a povinnosti výrobcov, predávajúcich, dovozcov a dodávateľov, pôsobnosť orgánov verejnej správy v oblasti ochrany spotrebiteľa, postavenie právnických osôb založených alebo zriadených na ochranu spotrebiteľa (ďalej len „združenie“) a označovanie výrobkov cenami.
...
spotrebiteľom fyzická osoba, ktorá pri uzatváraní a plnení spotrebiteľskej zmluvy[1)](#poznamky.poznamka-1) nekoná v rámci predmetu svojej podnikateľskej činnosti,[2)](#poznamky.poznamka-2) zamestnania alebo povolania,[2a)](#poznamky.poznamka-2a)
...
osoba, ktorá má sídlo alebo miesto podnikania na území členského štátu a je splnomocnencom[3)](#poznamky.poznamka-3) výrobcu, ktorý nemá sídlo alebo miesto podnikania na území členského štátu,
...
dodávateľom podnikateľ, ktorý priamo alebo prostredníctvom iných podnikateľov dodal predávajúcemu výrobok a ktorého činnosť neovplyvňuje vlastnosti výrobku,
...
odborným posúdením písomné vyjadrenie znalca[6)](#poznamky.poznamka-6) alebo stanovisko vydané autorizovanou, notifikovanou alebo akreditovanou osobou,[7)](#poznamky.poznamka-7) alebo stanovisko osoby oprávnenej výrobcom na vykonávanie záručných opráv[7a)](#poznamky.poznamka-7a) (ďalej len „určená osoba“),
...
kódexom správania dohoda alebo súbor pravidiel, ktoré vymedzujú správanie predávajúceho, ktorý sa zaviazal dodržiavať tento kódex správania vo vzťahu k jednej alebo viacerým osobitným obchodným praktikám alebo obchodným odvetviam, ak tieto nie sú ustanovené zákonom alebo iným právnym predpisom alebo opatrením orgánu verejnej správy,
...
predajnou cenou konečná cena vrátane dane z pridanej hodnoty a všetkých ostatných daní za jednotku výrobku alebo za určené množstvo výrobku,

zb)

jednotkovou cenou konečná cena vrátane dane z pridanej hodnoty a ostatných daní za kilogram, liter, meter, meter štvorcový, meter kubický výrobku alebo inú jednotku množstva, ktorá sa často a bežne používa pri predaji výrobku,
...
Každý spotrebiteľ má právo na ochranu pred neprijateľnými podmienkami v spotrebiteľských zmluvách.[1)](#poznamky.poznamka-1)

(4)

Každý spotrebiteľ má právo združovať sa spolu s inými spotrebiteľmi v združeniach a prostredníctvom týchto združení v súlade so zákonom chrániť a presadzovať oprávnené záujmy spotrebiteľov, ako aj uplatňovať práva zo zodpovednosti voči osobám, ktoré spôsobili škodu na právach spotrebiteľov.
...
Každý spotrebiteľ má právo na zvýšenú ochranu svojich ekonomických záujmov v procese zavedenia meny euro v Slovenskej republike. Spotrebiteľ má právo najmä na informácie o cenách zároveň v slovenskej mene a tiež v eurách podľa osobitných predpisov[9a)](#poznamky.poznamka-9a) a na výrobky a služby za ceny, ktoré nie sú zvýšené z dôvodu nákladov a výdavkov súvisiacich so zavedením meny euro.
...
Ak predávajúci porušuje povinnosť uloženú súdom alebo osobitným predpisom[12a)](#poznamky.poznamka-12a) zdržať sa používania neprijateľnej zmluvnej podmienky,[12b)](#poznamky.poznamka-12b) považuje sa také konanie za osobitne závažné porušenie povinnosti predávajúceho.[12c)](#poznamky.poznamka-12c)

(11)

Predávajúci nesmie žiadať alebo prijať od spotrebiteľa úhradu za dodaný výrobok, poskytnutú službu alebo poskytnutý elektronický obsah,[12ca)](#poznamky.poznamka-12ca) ktorý si spotrebiteľ neobjednal. Nečinnosť spotrebiteľa po prijatí nevyžiadanej dodávky podľa prvej vety nemá za následok vznik akýchkoľvek nákladov ani iných povinností pre spotrebiteľa.
...
za použitie platobného prostriedku[12cb)](#poznamky.poznamka-12cb) alebo
...
Ustanovenie odseku 1 sa nepoužije, ak ide o poplatok účtovaný poskytovateľom platobných služieb[12cc)](#poznamky.poznamka-12cc) za poskytnutú platobnú službu.
...
dohodou o zrážkach zo mzdy a z iných príjmov v prospech predávajúceho alebo inej osoby,[12cd)](#poznamky.poznamka-12cd) ibaže táto dohoda bola uzavretá vo forme osobitnej listiny, spotrebiteľ bol poučený o dôsledkoch jej uzavretia a mal možnosť ju odmietnuť, alebo

b)

zmenkou alebo šekom.[12ce)](#poznamky.poznamka-12ce)
...
Na trh možno uviesť,[12d)](#poznamky.poznamka-12d) ponúkať alebo predávať len bezpečné výrobky; to neplatí pre použité výrobky dodané ako starožitnosti alebo pre výrobky, ktoré sa majú pred použitím opraviť alebo obnoviť, ak o tom dodávateľ preukázateľne informoval osobu, ktorej výrobok dodáva.
...
podstatne narušuje alebo môže podstatne narušiť ekonomické správanie priemerného spotrebiteľa vo vzťahu k produktu, ku ktorému sa dostane alebo ktorému je adresovaná, alebo priemerného člena skupiny, ak je obchodná praktika orientovaná na určitú skupinu spotrebiteľov.
...
právu spotrebiteľa vrátane práva na výmenu dodaného produktu alebo vrátenie peňazí podľa osobitného predpisu[14)](#poznamky.poznamka-14) alebo k rizikám, ktorým môže byť vystavený.
...
Povinnosti podľa [§ 4 ods. 2](#paragraf-4.odsek-2) a [8](#paragraf-4.odsek-8), [§ 4a až 5a](#paragraf-4a) a [§ 7 až 9](#paragraf-7) sa vzťahujú aj na osobu, ktorá v mene veriteľa alebo vo vlastnom mene vymáha pohľadávky vyplývajúce zo spotrebiteľskej zmluvy.
...
Ustanovenie [§ 9a](#paragraf-9a) sa netýka činnosti advokáta, súdneho exekútora a notára pri výkone ich povolania.
...
poučenie o zodpovednosti predávajúceho za vady výrobku alebo služby podľa všeobecného predpisu,[15a)](#poznamky.poznamka-15a)

g)

informáciu o existencii a podrobnostiach záruky poskytovanej výrobcom alebo predávajúcim podľa prísnejších zásad, ako ustanovuje všeobecný predpis,[15b)](#poznamky.poznamka-15b) ak ju výrobca alebo predávajúci poskytuje, ako aj informáciu o existencii a podmienkach pomoci a službách poskytovaných spotrebiteľom po predaji výrobku alebo poskytnutí služby, ak sa takáto pomoc poskytuje,
...
Ustanovenia odseku 1 sa nepoužijú, ak pre predávajúceho vyplýva z osobitného predpisu[15c)](#poznamky.poznamka-15c) povinnosť poskytnúť informácie spotrebiteľovi pred uzavretím zmluvy.
...
Ak pri balených výrobkoch ustanovenia osobitných predpisov[18a)](#poznamky.poznamka-18a) vyžadujú uviesť čistú hmotnosť a čistú hmotnosť po vysušení, jednotkovú cenu stačí uviesť pre čistú hmotnosť po vysušení.
...
Ak sa v reklame[18b)](#poznamky.poznamka-18b) uvádza predajná cena výrobku, musí sa uviesť aj jednotková cena.
...
Predávajúci je povinný počas obdobia duálneho zobrazovania cien, platieb a iných hodnôt (ďalej len „duálne zobrazovanie“) predávané výrobky a ponúkané služby označiť cenami zároveň v slovenskej mene a tiež v eurách podľa osobitných predpisov.[9a)](#poznamky.poznamka-9a)

(2)

Predávajúci je povinný odo dňa stanovenia konverzného kurzu predložiť orgánom dozoru na základe výzvy cenovú evidenciu podľa osobitného predpisu.[18c)](#poznamky.poznamka-18c)

(3)

Predávajúci nesmie zvyšovať ceny za predávané výrobky a ponúkané služby z dôvodu nákladov a výdavkov súvisiacich so zavedením meny euro a je povinný zaokrúhľovať ceny pri duálnom zobrazovaní podľa pravidiel podľa osobitného predpisu.[9a)](#poznamky.poznamka-9a)
...
kategória a trieda ubytovacieho zariadenia,[19a)](#poznamky.poznamka-19a) ak ide o ubytovacie zariadenie.
...
Ak spotrebiteľ uplatní reklamáciu, predávajúci alebo ním poverený zamestnanec alebo určená osoba je povinný poučiť spotrebiteľa o jeho právach podľa všeobecného predpisu;[22)](#poznamky.poznamka-22) na základe rozhodnutia spotrebiteľa, ktoré z týchto práv spotrebiteľ uplatňuje, je povinný určiť spôsob vybavenia reklamácie podľa [§ 2 písm. m)](#paragraf-2.pismeno-m) ihneď, v zložitých prípadoch najneskôr do 3 pracovných dní odo dňa uplatnenia reklamácie, v odôvodnených prípadoch, najmä ak sa vyžaduje zložité technické zhodnotenie stavu výrobku alebo služby, najneskôr do 30 dní odo dňa uplatnenia reklamácie. Po určení spôsobu vybavenia reklamácie sa reklamácia vybaví ihneď, v odôvodnených prípadoch možno reklamáciu vybaviť aj neskôr; vybavenie reklamácie však nesmie trvať dlhšie ako 30 dní odo dňa uplatnenia reklamácie. Po uplynutí lehoty na vybavenie reklamácie má spotrebiteľ právo od zmluvy odstúpiť alebo má právo na výmenu výrobku za nový výrobok.
...
Predávajúci je povinný pri uplatnení reklamácie vydať spotrebiteľovi potvrdenie. Ak je reklamácia uplatnená prostredníctvom prostriedkov diaľkovej komunikácie,[22a)](#poznamky.poznamka-22a) predávajúci je povinný potvrdenie o uplatnení reklamácie doručiť spotrebiteľovi ihneď; ak nie je možné potvrdenie doručiť ihneď, musí sa doručiť bez zbytočného odkladu, najneskôr však spolu s dokladom o vybavení reklamácie; potvrdenie o uplatnení reklamácie sa nemusí doručovať, ak spotrebiteľ má možnosť preukázať uplatnenie reklamácie iným spôsobom.
...
Ustanovenia uvedené v odsekoch 4 až 10 sa použijú na vybavenie reklamácií, ak osobitný predpis[22b)](#poznamky.poznamka-22b) neustanovuje inak.

(13)

Vybavením reklamácie nie je dotknuté právo spotrebiteľa na náhradu škody podľa osobitného predpisu.[22c)](#poznamky.poznamka-22c)
...
orgány dozoru[8)](#poznamky.poznamka-8) a iné príslušné orgány podľa osobitných predpisov,[22d)](#poznamky.poznamka-22d)
...
informuje príslušné orgány členských štátov o sťažnostiach na porušenie právne záväzných aktov Európskej únie v oblasti ochrany spotrebiteľa,[23)](#poznamky.poznamka-23)
...
orgánoch, ktoré sú zodpovedné za vykonávanie právne záväzných aktov Európskej únie a dozoru na vnútornom trhu,
...
Príslušné orgány pri cezhraničnej spolupráci v oblasti ochrany spotrebiteľa postupujú podľa osobitného predpisu[24a)](#poznamky.poznamka-24a) a konajú na základe vlastného alebo iného podnetu, pričom sú oprávnené zakázať zistené protiprávne konanie,[24b)](#poznamky.poznamka-24b) ktorého sa dopustila osoba, ktorá podlieha ich dohľadu podľa osobitných predpisov,[24c)](#poznamky.poznamka-24c) na území členského štátu Európskej únie, a ktoré poškodzujú alebo môžu poškodiť spoločný záujem spotrebiteľov,[24d)](#poznamky.poznamka-24d) a vydávať záväzné pokyny na odstránenie zistených nedostatkov.

(4)

Príslušné orgány na základe výzvy ministerstva každý druhý rok zasielajú ministerstvu súhrnné informácie za uplynulé dva roky týkajúce sa činnosti príslušných orgánov podľa osobitného predpisu;[24a)](#poznamky.poznamka-24a) obsah informácie upresní ministerstvo vo výzve.

(5)

Príslušné orgány zasielajú ministerstvu priebežne aj informácie o zmene svojej pôsobnosti na výkon osobitného predpisu[24a)](#poznamky.poznamka-24a) a o zmene poverených zamestnancov[24e)](#poznamky.poznamka-24e) a ich kontaktných údajov.
...
nariadiť alebo organizovať okamžité stiahnutie výrobku, série výrobku alebo služby z trhu[25a)](#poznamky.poznamka-25a) alebo stiahnutie z predaja,[25b)](#poznamky.poznamka-25b) ak je preukázané, že nie sú bezpečné a sú uvedené na trh; ak je to potrebné, nariadiť aj ich zničenie,
...
vydať na požiadanie colného orgánu záväzné stanovisko[25c)](#poznamky.poznamka-25c) o tom, či dovážaný výrobok
...
má pripojenú sprievodnú dokumentáciu podľa osobitného predpisu, ktorý harmonizuje podmienky uvádzania výrobkov na trh[25d)](#poznamky.poznamka-25d) a je označený v súlade s týmto osobitným predpisom, alebo

3.

má správne umiestnené označenie CE.[25e)](#poznamky.poznamka-25e)
...
Orgán dozoru môže zakázať poskytnutie služby, uvádzanie výrobku z predaja na trh alebo jeho predaj alebo nariadiť okamžité stiahnutie výrobku z predaja alebo služby z trhu, alebo stiahnutie výrobku z predaja aj vtedy, ak je preukázané, že napriek posúdenej alebo preukázanej zhode[4)](#poznamky.poznamka-4) výrobku z predaja alebo služby s požiadavkami na ich bezpečnosť nie sú výrobok alebo služba bezpečné.
...
Odseky 7 až 14 sa nevzťahujú na Národnú banku Slovenska, ktorá postupuje podľa osobitného predpisu.[25ea)](#poznamky.poznamka-25ea)

##### § 20a

(1)

Orgán dozoru rozhodnutím nariadi predávajúcemu alebo osobe podľa [§ 9a](#paragraf-9a) odstrániť zistené nedostatky a zdržať sa protiprávneho konania.
...
nadobudnutím právoplatnosti rozhodnutia orgánu dozoru v správnom konaní vo veci porušenia tohto zákona alebo osobitného predpisu,[25f)](#poznamky.poznamka-25f) ktoré bolo začaté v súvislosti s vydaním predbežného opatrenia podľa odseku 2,
...
Odseky 2 až 5 sa nevzťahujú na Národnú banku Slovenska, ktorá postupuje podľa osobitného predpisu.[25ea)](#poznamky.poznamka-25ea)
...
Odseky 1 a 4 sa nevzťahujú na Národnú banku Slovenska, ktorá postupuje podľa osobitného predpisu.[25ea)](#poznamky.poznamka-25ea)
...
Za porušenie povinností ustanovených týmto zákonom alebo právne záväznými aktmi Európskej únie v oblasti ochrany spotrebiteľa[28)](#poznamky.poznamka-28) uloží orgán dozoru výrobcovi, predávajúcemu, dovozcovi, dodávateľovi alebo osobe podľa [§ 9a](#paragraf-9a) alebo [§ 26](#paragraf-26a) pokutu do 66 400 eur; za opakované porušenie povinnosti počas 12 mesiacov uloží pokutu do 166 000 eur.

(2)

Orgán dozoru uloží výrobcovi, predávajúcemu, dovozcovi, dodávateľovi alebo osobe uvedenej v [§ 26](#paragraf-26), ktorá vyrobila, predala, doviezla alebo dodala výrobok, ktorého vada spôsobila ujmu na živote alebo zdraví, pokutu do 332 000 eur. Rovnakú pokutu uloží tomu, kto takú ujmu spôsobil vadným poskytnutím služby. Pokutu nemožno uložiť osobe, ktorá preukáže, že ujme nemohla zabrániť ani pri vynaložení všetkého úsilia, ktoré od nej bolo možné požadovať.

(3)

Výrobcovi, predávajúcemu, dovozcovi, dodávateľovi alebo osobe podľa [§ 9a](#paragraf-9a) alebo [§ 26](#paragraf-26), ktorá marí, ruší alebo inak sťažuje výkon dozoru, prípadne nesplní záväzný pokyn podľa [§ 20 ods. 3 písm. h)](#paragraf-20.odsek-3.pismeno-h), uloží orgán dozoru poriadkovú pokutu do 1 660 eur, a to aj opakovane.
...
Opakované marenie, rušenie alebo sťažovanie výkonu dozoru podľa odseku 3 sa považuje za závažné porušenie povinnosti.[28a)](#poznamky.poznamka-28a)

(9)

Odseky 1 až 8 sa nevzťahujú na Národnú banku Slovenska, ktorá postupuje podľa osobitného predpisu.[25ea)](#poznamky.poznamka-25ea)
...
Združenie môže podať návrh na vydanie predbežného opatrenia podľa [§ 21 ods. 1](#paragraf-21.odsek-1) orgánu dozoru alebo návrh na začatie konania na súde vo veci ochrany práv spotrebiteľov, a to vrátane konania vo veci ochrany kolektívnych záujmov spotrebiteľov, alebo môže byť účastníkom konania
...
je uvedené v zozname oprávnených osôb vedenom Európskou komisiou (ďalej len „zoznam oprávnených osôb“), bez toho, aby bolo dotknuté právo súdu preskúmať, či je tento subjekt oprávnený v danom prípade podať návrh na začatie konania.
...
Združenie spĺňajúce podmienky podľa odseku 3 ministerstvo navrhne Európskej komisii na zaradenie do zoznamu oprávnených osôb.
...
Pri zistení porušenia zákona alebo iného všeobecne záväzného právneho predpisu má komisia právo podať podnet príslušným štátnym orgánom a obrátiť sa na združenie s podnetom na uplatnenie práv na príslušnom štátnom orgáne.
...
Na konanie podľa tohto zákona sa vzťahuje všeobecný predpis o správnom konaní[29)](#poznamky.poznamka-29) okrem [§ 20 ods. 3 písm. e) až h)](#paragraf-20.odsek-3.pismeno-e) a [§ 21](#paragraf-21) a [§ 26a](#paragraf-26a), ak osobitný zákon neustanovuje inak.[30)](#poznamky.poznamka-30)

##### § 28

Týmto zákonom sa preberajú právne záväzné akty Európskej únie uvedené v [prílohe č. 2](#prilohy.priloha-priloha_c_2_k_zakonu_c_250_2007_z_z.oznacenie).
...
Ustanovenie [§ 4 ods. 10](#paragraf-4.odsek-10) sa použije vo veciach, v ktorých súd uloží povinnosť zdržať sa používania neprijateľnej zmluvnej podmienky po 28. februári 2010.

##### § 29b

##### Prechodné ustanovenie k úpravám účinným od 1. mája 2014

Ustanoveniami [§ 5a ods. 1 písm. b)](#paragraf-5a.odsek-1.pismeno-b) a [ods. 2 až 4](#paragraf-5a.odsek-2) sa spravujú aj právne vzťahy vzniknuté pred 1. májom 2014; vznik týchto právnych vzťahov, ako aj nároky z nich vzniknuté pred 1. májom 2014 sa však posudzujú podľa predpisov účinných do 30. apríla 2014.

##### § 29c

##### Prechodné ustanovenie k úpravám účinným od 13. júna 2014

Ustanoveniami [§ 4a ods. 1 až 3](#paragraf-4a.odsek-1) sa spravujú aj právne vzťahy vzniknuté pred 13. júnom 2014; vznik týchto právnych vzťahov, ako aj nároky z nich vzniknuté pred 13. júnom 2014 sa však posudzujú podľa predpisov účinných do 12. júna 2014.
...
Dozor a kontrola začatá a neskončená Slovenskou obchodnou inšpekciou pred 1. januárom 2015 v oblasti ochrany finančných spotrebiteľov[31)](#poznamky.poznamka-31) sa dokončí podľa predpisov účinných do 31. decembra 2014. Právne účinky úkonov, ktoré pri tomto dozore a kontrole nastali pred 1. januárom 2015, zostávajú zachované.
...
Zrušuje sa nariadenie vlády Slovenskej republiky č. [387/2007 Z. z.](../../../../SK/ZZ/2007/387/) o označovaní výrobkov cenami.

##### § 30b

Zrušuje sa vyhláška Ministerstva hospodárstva Slovenskej republiky č. [370/2008 Z. z.](../../../../SK/ZZ/2008/370/), ktorou sa ustanovujú podrobnosti o označovaní materiálového zloženia textilných výrobkov v znení vyhlášky Ministerstva hospodárstva Slovenskej republiky č. 284/2009 Z. z., vyhlášky Ministerstva hospodárstva Slovenskej republiky č. 53/2010 Z. z. a vyhlášky Ministerstva hospodárstva Slovenskej republiky č. 85/2012 Z. z.
