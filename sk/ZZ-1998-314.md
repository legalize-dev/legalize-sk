...
Centrálne zabezpečovaný materiál podľa [prílohy č. 1](#prilohy.priloha-priloha_c_1_k_vyhlaske_c_314_1998_z_z.oznacenie) obstaráva[2)](#poznamky.poznamka-2) a spravuje[3)](#poznamky.poznamka-3) Ministerstvo vnútra Slovenskej republiky (ďalej len „ministerstvo").

(2)

Ostatný materiál obstaráva[2)](#poznamky.poznamka-2) a spravuje[3)](#poznamky.poznamka-3) okresný úrad.

##### § 2a

(1)

Okresný úrad na základe výsledkov analýzy územia z hľadiska možných mimoriadnych udalostí môže prenechať materiál okrem prístrojov na monitorovanie radiačnej situácie a zariadení a prostriedkov na zabezpečenie hlásnej a informačnej služby do výpožičky[4)](#poznamky.poznamka-4) právnickej osobe vrátane obce alebo fyzickej osobe. Prednostne ho prenecháva právnickej osobe alebo fyzickej osobe, ktoré zriaďujú jednotky pre potrebu územia.

(2)

Prístroje na monitorovanie radiačnej situácie a zariadenia a prostriedky na zabezpečenie hlásnej a informačnej služby prenecháva ministerstvo do výpožičky[4)](#poznamky.poznamka-4) okresnému úradu a krajskému úradu.
