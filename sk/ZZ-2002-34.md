...
Nadácia je právnická osoba, ktorá sa zapisuje do registra mimovládnych neziskových organizácií[1)](#poznamky.poznamka-1) (ďalej len „register“).
...
K návrhu na zápis nadácie do registra musí byť priložená nadačná listina v dvoch vyhotoveniach, písomné vyhlásenie správcu nadácie o splatení peňažného vkladu zakladateľom, písomné vyhlásenie zakladateľa, že do nadačného imania vkladá nehnuteľnosť, a písomné vyhlásenie zakladateľa o konečnom užívateľovi výhod s údajmi podľa osobitného predpisu;[1a)](#poznamky.poznamka-1a) pravosť podpisu správcu nadácie na písomnom vyhlásení musí byť úradne osvedčená a údaje správcu nadácie potrebné na vyžiadanie výpisu z registra trestov.[1b)](#poznamky.poznamka-1b) Údaje podľa prvej vety ministerstvo bezodkladne zašle v elektronickej podobe prostredníctvom elektronickej komunikácie Generálnej prokuratúre Slovenskej republiky na vydanie výpisu z registra trestov.
...
Konanie o zápis nadácie do registra sa začína odo dňa, keď bol ministerstvu doručený návrh, ktorý obsahuje podklady podľa [§ 6](#paragraf-6).

(2)

Ak návrh na zápis nadácie do registra neobsahuje podklady podľa [§ 6 ods. 2 až 5](#paragraf-6.odsek-2), ministerstvo správcu nadácie do 15 dní od doručenia návrhu upozorní, že konanie o zápis nadácie do registra začne až po odstránení nedostatkov.

##### § 8

(1)

Ministerstvo zápis nadácie do registra odmietne, ak z podkladov podľa [§ 6 ods. 2 až 4](#paragraf-6.odsek-2) vyplýva, že
...
Zoznam údajov, ktoré sa zapisujú do registra, upravuje osobitný predpis.[1c)](#poznamky.poznamka-1c)
...
Identifikačné číslo organizácie prideľuje nadácii Štatistický úrad Slovenskej republiky na žiadosť ministerstva podľa osobitného predpisu.[1d)](#poznamky.poznamka-1d)
...
v lehote určenej v rozhodnutí o uložení pokuty podľa [§ 36 ods. 7](#paragraf-36.odsek-7) nadácia neuloží výročnú správu do verejnej časti registra účtovných závierok,[1e)](#poznamky.poznamka-1e)
...
schvaľuje účtovnú závierku, výročnú správu nadácie a výkaz,
...
na prevádzku charitatívnej lotérie,[2a)](#poznamky.poznamka-2a)
...
hypotekárnych záložných listov a krytých dlhopisov podľa osobitného predpisu,[4a)](#poznamky.poznamka-4a)
...
Ak hodnota daru alebo výška príspevku presiahne 331 eur, je nadácia povinná oznámiť darcovi presnú špecifikáciu jeho použitia do 60 dní odo dňa použitia tohto daru alebo príspevku, ak darca neustanoví inak.
...
Nadácia je povinná mať účtovnú závierku a výročnú správu overenú štatutárnym audítorom,[6a)](#poznamky.poznamka-6a) ak

a)

príjem[6b)](#poznamky.poznamka-6b) verejných prostriedkov a podielov zaplatenej dane v účtovnom období, za ktoré je účtovná závierka zostavená, presiahne 200 000 eur, alebo

b)

všetky príjmy nadácie v účtovnom období, za ktoré je účtovná závierka zostavená, presiahnu 500 000 eur; tým nie je dotknutá povinnosť overenia účtovnej závierky podľa osobitného predpisu.[6c)](#poznamky.poznamka-6c)
...
ročnú účtovnú závierku, zhodnotenie základných údajov zahrnutých v nej a výrok štatutárneho audítora k ročnej účtovnej závierke,
...
zmeny vykonané v nadačnej listine, ktoré nastali v hodnotenom období,
...
Nadácia uloží výročnú správu do verejnej časti registra účtovných závierok najneskôr do 15. júla.
...
Nadácia je povinná vypracovať výkaz za kalendárny rok do 30. júna nasledujúceho kalendárneho roka.
...
prehľad príjmov podľa zdrojov a prehľad výdavkov (nákladov) v členení na výdavky podľa jednotlivých druhov činností nadácie a osobitne výšku výdavkov (nákladov) na správu nadácie vrátane rozhodnutia správnej rady podľa [§ 28 ods. 1](#paragraf-28.odsek-1) a v členení podľa [§ 28 ods. 2](#paragraf-28.odsek-2) a [3](#paragraf-28.odsek-3); ak ich nadácia použije mimo územia členských štátov Európskej únie, štátov, ktoré sú zmluvnou stranou Dohody o Európskom hospodárskom priestore a Švajčiarskej konfederácie, uvedie aj krajinu ich použitia,

b)

prehľad o osobách, ktoré prispeli na činnosť nadácie, vrátane výšky peňažného daru, peňažného príspevku alebo hodnoty prijatej pôžičky a identifikačných údajov osoby, ktorá prispela na činnosť nadácie, v rozsahu

1.

meno a priezvisko, ak ide o fyzickú osobu; to neplatí, ak hodnota peňažných darov, peňažných príspevkov a prijatých pôžičiek poskytnutých touto fyzickou osobou nadácii nepresiahne v úhrne 5 000 eur za príslušný kalendárny rok,
...
identifikačné údaje fyzickej osoby, ktorá je orgánom alebo členom orgánu nadácie, v rozsahu meno a priezvisko s uvedením dňa vzniku alebo zániku jej funkcie, ak táto funkcia vznikla alebo zanikla v priebehu kalendárneho roka.

(3)

Do sumy podľa odseku 2 písm. b) prvého bodu sa nezapočítava hodnota peňažného daru alebo peňažného príspevku poskytnutého na účel pomoci konkrétnej osobe so zdravotným postihnutím alebo iným nepriaznivým zdravotným stavom, suma úhrady za poskytovanie sociálnych služieb v zariadení sociálnych služieb podľa osobitného predpisu[6d)](#poznamky.poznamka-6d) ani suma úhrady za poskytovanie zdravotnej starostlivosti podľa osobitného predpisu.[6e)](#poznamky.poznamka-6e)
...
Nadácia uloží výkaz do verejnej časti registra účtovných závierok do 15. júla kalendárneho roka, v ktorom je povinná výkaz vypracovať.

(6)

Ak sa po zverejnení výkazu zistia skutočnosti, ktoré sú dôvodom na jeho opravu, je nadácia povinná túto opravu bezodkladne vykonať.
...
Ak nadácia neuloží výročnú správu podľa [§ 35 ods. 4](#paragraf-35.odsek-4), ministerstvo môže uložiť nadácii za porušenie tejto povinnosti pokutu do 1 000 eur.

(2)

Ak nadácia neuloží výkaz do verejnej časti registra účtovných závierok podľa [§ 35a ods. 5](#paragraf-35a.odsek-5), registrový úrad uloží nadácii za porušenie tejto povinnosti pokutu do 1 000 eur. Ak uloženie pokuty neviedlo k náprave v lehote 30 dní odo dňa nadobudnutia vykonateľnosti rozhodnutia o uložení pokuty, registrový úrad uloží ďalšiu pokutu až do výšky desaťnásobku hornej hranice sadzby pokuty podľa prvej vety, a to aj opakovane; pri ukladaní tretej a ďalšej pokuty je dolná hranica sadzby pokuty 5 000 eur.

(3)

Ak nadácia v určenej lehote nevykoná nápravu podľa [§ 37 ods. 2](#paragraf-37.odsek-2), registrový úrad uloží nadácii za porušenie tejto povinnosti pokutu do 1 000 eur. Ak uloženie pokuty neviedlo k náprave v lehote 30 dní odo dňa nadobudnutia vykonateľnosti rozhodnutia o uložení pokuty, registrový úrad uloží ďalšiu pokutu až do výšky desaťnásobku hornej hranice sadzby pokuty podľa prvej vety, a to aj opakovane; pri ukladaní tretej a ďalšej pokuty je dolná hranica sadzby pokuty 5 000 eur.
...
V rozhodnutí o uložení pokuty podľa odseku 1 a podľa odseku 2 druhej vety ministerstvo určí primeranú lehotu na uloženie výročnej správy alebo výkazu, ktorá nesmie byť kratšia ako 30 dní a dlhšia ako 60 dní.
...
Ministerstvo dohliada, či nadácia plní verejnoprospešný účel, na ktorý bola založená. Na tento účel ministerstvo je oprávnené vyhodnocovať obsah výročnej správy.

(2)

Ministerstvo je oprávnené vyhodnocovať obsah výkazu. Ak ministerstvo zistí nedostatky alebo skutočnosti, ktoré sú dôvodom na opravu výkazu, vyzve nadáciu, aby v určenej lehote, ktorá nesmie byť kratšia ako 30 dní a dlhšia ako 60 dní, odstránila zistené nedostatky alebo vykonala opravu výkazu a súčasne informovala ministerstvo o prijatých opatreniach.

(3)

Nadácia je povinná poskytnúť ministerstvu súčinnosť pri výkone dohľadu podľa tohto zákona a na tento účel na požiadanie ministerstva v určenej lehote predložiť doklady, podať informáciu, vysvetlenie alebo poskytnúť iný údaj.
...
Ak nadácia nevykonala nápravu podľa [§ 36 ods. 7](#paragraf-36.odsek-7), ministerstvo podá návrh podľa [§ 15 ods. 1.](#paragraf-15.odsek-1)
...
Ustanovenie [§ 34 ods. 3](#paragraf-34.odsek-3) v znení účinnom od 1. januára 2014 sa prvýkrát použije pri overení účtovnej závierky zostavenej k 31. decembru 2014.

##### § 42b

##### Prechodné ustanovenie k úprave účinnej od 1. novembra 2018

Nadácia, ktorá vznikla do 31. októbra 2018, je povinná do 31. decembra 2019 podať návrh na zápis údajov o konečnom užívateľovi výhod podľa [§ 11 ods. 2](#paragraf-11.odsek-2) v znení účinnom od 1. novembra 2018.

##### § 42c

##### Prechodné ustanovenie k úpravám účinným od 1. mája 2018

Ustanovenie [§ 34 ods. 3](#paragraf-34.odsek-3) v znení účinnom od 1. mája 2018 sa prvýkrát použije pri overení účtovnej závierky a výročnej správy zostavenej k 31. decembru 2018.
...
Ustanovenie [§ 36 ods. 1](#paragraf-36.odsek-1) v znení účinnom od 1. januára 2019 sa prvýkrát použije pri ukladaní pokuty za neuloženie výročnej správy do verejnej časti registra účtovných závierok za rok 2018; konania o uložení pokuty za porušenie povinnosti podľa [§ 35 ods. 4](#paragraf-35.odsek-4) za predchádzajúce roky sa dokončia podľa predpisov účinných do 31. decembra 2018.

(2)

Do uvedenia registra do prevádzky[10)](#poznamky.poznamka-10) sa údaje zapisujú do registra nadácií vedeného podľa tohto zákona v znení účinnom do 31. decembra 2018.
...
Ustanovenie [§ 35 ods. 2](#paragraf-35.odsek-2) v znení účinnom od 1. júna 2025 sa prvýkrát použije pri vypracovaní výročnej správy za kalendárny rok 2026.

(2)

Výkaz sa vypracuje podľa [§ 35a ods. 1](#paragraf-35a.odsek-1) prvýkrát za obdobie od 1. júna 2025 do 31. decembra 2025.
...
Týmto zákonom sa preberajú právne záväzné akty Európskej únie uvedené v [prílohe](#prilohy.priloha-priloha_k_zakonu_c_34_2002_z_z).
