...
žiadateľ nebol právoplatne odsúdený pre trestný čin; táto skutočnosť sa preukazuje a dokladuje výpisom z registra trestov nie starším ako tri mesiace.
...
Ak poklesne hodnota založenej nehnuteľnosti až do výšky aktuálne nesplatenej istiny hypotekárneho úveru podľa [§ 70 ods. 1](#paragraf-70.odsek-1) spolu s príslušenstvom, pohľadávka z tohto hypotekárneho úveru sa započítava do základných aktív len do výšky, ktorá nepresahuje 80 % hodnoty založenej nehnuteľnosti. Ak poklesne hodnota založenej nehnuteľnosti pod výšku nesplatenej istiny hypotekárneho úveru podľa [§ 70 ods. 1](#paragraf-70.odsek-1) spolu s príslušenstvom, pohľadávka z takého hypotekárneho úveru sa nezapočítava do základných aktív. Banka, ktorá je emitentom krytých dlhopisov, toto aktívum z registra krytých dlhopisov bezodkladne vymaže.
...
služby kriminálnej polície a služby finančnej polície Policajného zboru na účely odhaľovania trestných činov, zisťovanie ich páchateľov a pátrania po nich[84)](#poznamky.poznamka-84) a na účely úloh finančnej polície podľa osobitného predpisu[84a)](#poznamky.poznamka-84a) o preukazovaní pôvodu majetku,
...
Kriminálnemu úradu finančnej správy na účely plnenia úloh pri odhaľovaní trestných činov, zisťovaní ich páchateľov a pátraní po nich,[86db)](#poznamky.poznamka-86db)
