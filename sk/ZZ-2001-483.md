...
finančná holdingová spoločnosť, ktorá nie je materskou spoločnosťou, alebo zmiešaná finančná holdingová spoločnosť, ktorá nie je materskou spoločnosťou, ak je povinná dodržiavať tento zákon alebo osobitný predpis[30x)](#poznamky.poznamka-30x) na subkonsolidovanom základe.
...
finančná holdingová spoločnosť alebo zmiešaná finančná holdingová spoločnosť nie je v rámci skupiny určená v žiadnej zo skupín, ktorých krízová situácia sa rieši, za subjekt, ktorého krízová situácia sa rieši podľa osobitného predpisu,[62)](#poznamky.poznamka-62)
...
Finančné holdingové spoločnosti alebo zmiešané finančné holdingové spoločnosti, ktoré spĺňajú podmienky podľa odseku 8, nie sú vyňaté z rozsahu konsolidácie podľa tohto zákona a osobitného predpisu.[30x)](#poznamky.poznamka-30x)
...
Na účely odsekov 4, 6, 7 a [§ 122yc](#paragraf-122yc) celkovou hodnotou aktív skupiny mimo územia členského štátu, ktoré má vo všetkých členských štátoch, je súčet celkovej hodnoty aktív
...
každej pobočky inštitúcie patriacej do skupiny mimo územia členského štátu, ktorej bolo udelené povolenie podľa tohto zákona, osobitných predpisov[24i)](#poznamky.poznamka-24i) alebo ktorej bolo udelené povolenie v súlade s právnymi predpismi iného členského štátu.
...
Ustanoveniami o konsolidovanom dohľade podľa odsekov 1 až 14 nie sú dotknuté ustanovenia [§ 20a](#paragraf-20a).
