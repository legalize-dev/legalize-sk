...
Pri tranzite[5)](#poznamky.poznamka-5) exemplárov druhov uvedených v prílohe III dohovoru[4)](#poznamky.poznamka-4) sa povolenie na dovoz alebo oznámenie o dovoze[6)](#poznamky.poznamka-6) nevyžaduje, ak ich sprevádza platné povolenie na vývoz, potvrdenie na opätovný vývoz[7)](#poznamky.poznamka-7) alebo iný doklad preukazujúci pôvod exemplára vydaný v súlade s dohovorom[8)](#poznamky.poznamka-8) s uvedením miesta určenia exemplárov mimo územia Európskej únie.

(2)

Dovoz, vývoz, opätovný vývoz a tranzit exemplárov druhov uvedených v prílohách A až D osobitného predpisu[9)](#poznamky.poznamka-9) sa môže uskutočniť len cez určené colné úrady a colné priechody (ďalej len „určený colný úrad“).

(3)

Ministerstvo životného prostredia Slovenskej republiky (ďalej len „ministerstvo“) vydá povolenie na vývoz exemplárov druhov uvedených v prílohách A až C osobitného predpisu,[9)](#poznamky.poznamka-9) iba ak

a)

sú splnené podmienky ustanovené osobitným predpisom,[7)](#poznamky.poznamka-7)
...
sú, ak ide o živé exempláre pôvodných druhov chránených živočíchov,[10)](#poznamky.poznamka-10) exemplármi narodenými a odchovanými v zajatí;[11)](#poznamky.poznamka-11) táto podmienka sa nevzťahuje na vývoz exemplárov na vedecké účely a na účely záchrany daného druhu.

(4)

Ministerstvo vydá potvrdenie na opätovný vývoz exemplárov druhov uvedených v prílohách A až C osobitného predpisu,[9)](#poznamky.poznamka-9) iba ak sú splnené podmienky ustanovené v osobitnom predpise[7)](#poznamky.poznamka-7) a ak sú exempláre vybraných druhov nezameniteľne označené podľa [§ 13](#paragraf-13).
...
Ak dovozca nesprevádza dovážané exempláre sám, povinnosť podľa odseku 5 a povinnosti ustanovené v osobitnom predpise[12)](#poznamky.poznamka-12) sa nevzťahujú na dopravcu exemplárov.

(7)

Na vývozcu alebo opätovného vývozcu exemplárov druhov uvedených v prílohách A až C osobitného predpisu[9)](#poznamky.poznamka-9) sa primerane vzťahujú odseky 5 a 6.
...
komu nebola uložená pokuta alebo iná sankcia za porušenie povinností podľa tohto zákona alebo osobitného predpisu[17)](#poznamky.poznamka-17) vo veciach ochrany exemplárov druhov chránených podľa tohto zákona a osobitného predpisu[3)](#poznamky.poznamka-3) v období dvoch rokov pred podaním žiadosti o zapísanie do osobitného zoznamu.
...
Na účel preukázania bezúhonnosti podľa odseku 3 písm. c) a odseku 5 písm. b) poskytne fyzická osoba údaje potrebné na vyžiadanie výpisu z registra trestov;[18a)](#poznamky.poznamka-18a) u právnickej osoby poskytne údaje potrebné na vyžiadanie výpisu z registra trestov osoba, ktorá je štatutárnym orgánom alebo členom štatutárneho orgánu a zodpovedným zástupcom, ak bol ustanovený. Údaje podľa prvej vety ministerstvo bezodkladne zašle v elektronickej podobe prostredníctvom elektronickej komunikácie Generálnej prokuratúre Slovenskej republiky na vydanie výpisu z registra trestov.
...
Exempláre druhov živočíchov uvedených v prílohe A alebo v prílohe B osobitného predpisu[9)](#poznamky.poznamka-9) uvedených vo vykonávacom predpise [[§ 15 ods. 5 písm. e)](#paragraf-15.odsek-5.pismeno-e)] je zakázané
...
zoologické záhrady,[19)](#poznamky.poznamka-19)

b)

chovné stanice a rehabilitačné stanice pôvodných druhov živočíchov,[19a)](#poznamky.poznamka-19a)

c)

záchytné strediská,[19a)](#poznamky.poznamka-19a)

d)

zariadenia prevádzkované osobou zapojenou do programu starostlivosti[19b)](#poznamky.poznamka-19b) pre druhy alebo poddruhy, na ktoré sa vzťahuje odsek 1,

e)

zariadenia na chov alebo držbu exemplárov druhov živočíchov používaných na vedecké účely alebo vzdelávacie účely podľa osobitného predpisu,[19c)](#poznamky.poznamka-19c)

f)

zariadenia, ktoré držia exempláre druhov živočíchov podľa odseku 1 z dôvodov podľa osobitného predpisu,[19d)](#poznamky.poznamka-19d)
...
Podnikateľ,[20)](#poznamky.poznamka-20) ktorý predáva[21)](#poznamky.poznamka-21) exempláre, je povinný zverejniť na vhodnom a trvale viditeľnom mieste

a)

prevádzkarne podmienky na chov a pestovanie ním predávaných živých exemplárov druhov uvedených v prílohách A až D osobitného predpisu,[9)](#poznamky.poznamka-9)

b)

prevádzkarne informácie o povinnostiach vyplývajúcich z tohto zákona alebo osobitných predpisov[3)](#poznamky.poznamka-3) pre kupujúceho, ktoré sa vzťahujú na držbu kupovaného exemplára,

c)

chovného zariadenia exemplára umiestneného v prevádzkarni vedecké meno druhu exemplára, jeho zaradenie do príloh A až D osobitného predpisu[9)](#poznamky.poznamka-9) spolu s označením „Chránené podľa CITES“.
...
je bezúhonná [[§ 3 ods. 4 písm. a)](#paragraf-3.odsek-4)]; bezúhonnosť sa preukazuje výpisom z registra trestov.
...
ktorá spĺňa podmienku podľa [§ 3 ods. 4 písm. b)](#paragraf-3.odsek-4.pismeno-b) a [ods. 5 písm. b)](#paragraf-3.odsek-5.pismeno-b),

b)

ak fyzická osoba, ktorá je štatutárnym orgánom alebo členom štatutárneho orgánu, je bezúhonnou osobou ([§ 3 ods. 4](#paragraf-3.odsek-4)); bezúhonnosť sa preukazuje výpisom z registra trestov.
...
bola odsúdená za úmyselný trestný čin alebo za nedbanlivostný trestný čin porušovania ochrany rastlín a živočíchov,[16)](#poznamky.poznamka-16) alebo
...
Ministerstvo rozhodne o zrušení licencie aj vtedy, ak právnickej osobe bola uložená pokuta alebo iná sankcia za porušenie povinností podľa tohto zákona alebo osobitného predpisu[17)](#poznamky.poznamka-17) vo veciach ochrany exemplárov druhov chránených podľa tohto zákona a osobitného predpisu.[3)](#poznamky.poznamka-3)
...
Na účel preukázania bezúhonnosti podľa odseku 2 písm. b) a odseku 3 poskytne fyzická osoba údaje potrebné na vyžiadanie výpisu z registra trestov;[18a)](#poznamky.poznamka-18a) u právnickej osoby poskytne údaje potrebné na vyžiadanie výpisu z registra trestov osoba, ktorá je štatutárnym orgánom alebo členom štatutárneho orgánu a zodpovedným zástupcom, ak bol ustanovený. Údaje podľa prvej vety ministerstvo bezodkladne zašle v elektronickej podobe prostredníctvom elektronickej komunikácie Generálnej prokuratúre Slovenskej republiky na vydanie výpisu z registra trestov.
...
podmienky určené v súlade s týmto zákonom alebo osobitným predpisom,[26)](#poznamky.poznamka-26)
...
Ak sú splnené podmienky podľa tohto zákona a osobitného predpisu,[3)](#poznamky.poznamka-3) ministerstvo vydá povolenie alebo potvrdenie podľa odseku 1. Na rozhodnutie o vydaní povolenia alebo potvrdenia podľa odseku 1 sa nevzťahuje ustanovenie osobitného predpisu,[27)](#poznamky.poznamka-27) ak sa žiadateľovi vyhovuje v plnom rozsahu. Rozhodnutie o vydaní povolenia alebo potvrdenia nadobúda právoplatnosť dňom doručenia.

(8)

Uzavretá kúpna zmluva nemá vplyv na rozhodovanie o udelení povolenia alebo potvrdenia podľa tohto zákona alebo podľa osobitného predpisu[3)](#poznamky.poznamka-3) s výnimkou prípadov, keď bola kúpna zmluva uzatvorená pred obmedzením dovozu exemplárov, ktoré sú predmetom kúpnej zmluvy.
...
Ministerstvo žiadosť o vydanie povolenia alebo potvrdenia podľa odseku 1 zamietne z dôvodov ustanovených osobitným predpisom,[29)](#poznamky.poznamka-29) alebo ak nie sú splnené podmienky na jeho vydanie podľa tohto zákona alebo osobitného predpisu.[3)](#poznamky.poznamka-3)
...
Ministerstvo vydá potvrdenie o putovnej výstave,[29a)](#poznamky.poznamka-29a) potvrdenie o osobnom vlastníctve,[29b)](#poznamky.poznamka-29b) potvrdenie o hudobnom nástroji[29c)](#poznamky.poznamka-29c) alebo ďalší druh potvrdenia podľa osobitných predpisov[29d)](#poznamky.poznamka-29d) druhov uvedených v prílohách A až C osobitného predpisu,[9)](#poznamky.poznamka-9) iba ak sú splnené podmienky ustanovené v osobitných predpisoch[3)](#poznamky.poznamka-3) a ak sú exempláre vybraných druhov nezameniteľne označené podľa [§ 13](#paragraf-13) a neexistujú iné dôvody týkajúce sa ochrany exemplárov druhov voľne žijúcich živočíchov a voľne rastúcich rastlín, ktoré by bránili vydaniu potvrdenia.

(2)

Potvrdenie o putovnej výstave[29a)](#poznamky.poznamka-29a) sa vydáva na základe žiadosti. Žiadateľ podáva žiadosť vo forme vyplneného formulára žiadosti.[29e)](#poznamky.poznamka-29e)
...
doklad o zaplatení správneho poplatku,[29f)](#poznamky.poznamka-29f)
...
preukaz o pôvode podľa [§ 12 ods. 4 písm. b)](#paragraf-12.odsek-4.pismeno-b) a potvrdenie podľa osobitného predpisu,[29g)](#poznamky.poznamka-29g) ak boli vydané,

2.

kópia písomného vyhlásenia o spôsobe nadobudnutia podľa [§ 12a](#paragraf-12a),

3.

kópia povolenia na dovoz[6)](#poznamky.poznamka-6) alebo
...
doklad preukazujúci vedenie evidencie podľa [§ 10](#paragraf-10) a [11](#paragraf-11),

f)

listinný dôkaz preukazujúci, že exemplár bol nadobudnutý v súlade s osobitnými predpismi,[3)](#poznamky.poznamka-3)
...
Na konanie vo veci vydania potvrdenia podľa odseku 2 sa primerane použijú ustanovenia [§ 6 ods. 4](#paragraf-6.odsek-4), [5](#paragraf-6.odsek-5), [7 až 15](#paragraf-6.odsek-7) a [§ 7](#paragraf-7).
...
Potvrdenie o osobnom vlastníctve,[29b)](#poznamky.poznamka-29b) potvrdenie o hudobnom nástroji[29c)](#poznamky.poznamka-29c) alebo ďalší druh potvrdenia podľa osobitných predpisov[29d)](#poznamky.poznamka-29d) sa vydáva na základe žiadosti. Žiadateľ podáva žiadosť vo forme vyplneného formulára žiadosti.[29h)](#poznamky.poznamka-29h) Žiadosť o vydanie potvrdenia obsahuje náležitosti primerane podľa odseku 3.

(8)

Na konanie vo veci vydania potvrdenia podľa odseku 7 sa primerane použijú ustanovenia [§ 6](#paragraf-6) a [8](#paragraf-8).
...
to vyžadujú záujmy chránené týmto zákonom alebo osobitným predpisom[3)](#poznamky.poznamka-3) alebo

c)

oprávnený nedodržuje podmienky určené v povolení alebo v potvrdení, alebo závažným spôsobom či opakovane porušuje ustanovenia tohto zákona alebo osobitného predpisu.[3)](#poznamky.poznamka-3)
...
ak vydávajúci orgán alebo Európska komisia po konzultácii s týmto orgánom ustanoví, že bolo vydané na základe nesprávneho predpokladu splnenia podmienok na jeho vydanie.[30)](#poznamky.poznamka-30)
...
Ministerstvo udelí výnimku zo zákazu komerčných činností vydaním potvrdenia, ak sú splnené podmienky podľa osobitného predpisu[31)](#poznamky.poznamka-31) a neexistujú iné dôvody týkajúce sa ochrany exemplárov druhov voľne žijúcich živočíchov a voľne rastúcich rastlín, ktoré by bránili vydaniu potvrdenia.
...
Ministerstvo udelí súhlas na premiestnenie[34)](#poznamky.poznamka-34) živých exemplárov na území Európskej únie vydaním potvrdenia, ak

a)

sú splnené podmienky ustanovené v osobitnom predpise,[34)](#poznamky.poznamka-34)
...
Ustanovenie [§ 6 ods. 2 písm. f)](#paragraf-6.odsek-2.pismeno-f), odseky 4, 5, 7, 8, 11 až 15 a [§ 7](#paragraf-7) platia rovnako aj pri rozhodovaní o udelení výnimky zo zákazu komerčných činností alebo o udelení súhlasu na premiestnenie živých exemplárov na území Európskej únie.
...
Ak sú splnené podmienky podľa tohto zákona, ministerstvo udelí licenciu podľa [§ 5a ods. 1](#paragraf-5a.odsek-1) a pridelí evidenčný kód.
...
Evidenciu podľa odseku 1 písm. a) vedie držiteľ živého exemplára plazov, vtákov a cicavcov okrem exemplára druhov, ktoré sú uvedené v zozname [[§ 15 ods. 5 písm. g)](#paragraf-15.odsek-5.pismeno-g)]. Držiteľ exemplára druhu uvedeného v prílohe A osobitného predpisu[9)](#poznamky.poznamka-9) oznamuje písomne alebo elektronicky každú zmenu údajov v druhovej karte vedeckému orgánu[38a)](#poznamky.poznamka-38a) ([§21](#paragraf-21)) doručením kópie časti druhovej karty s vyznačenou zmenou do 30 dní odo dňa zápisu zmeny. Držiteľ exemplára druhu uvedeného v prílohe B osobitného predpisu[9)](#poznamky.poznamka-9) oznamuje písomne alebo elektronicky každú zmenu údajov v druhovej karte vedeckému orgánu doručením kópie časti druhovej karty s vyznačenou zmenou do 14 dní odo dňa zápisu zmeny.
...
Podnikateľ,[20)](#poznamky.poznamka-20) ktorý predáva a nakupuje exempláre, vedie evidenciu v druhovej karte ním označenej v záhlaví slovom „obchod“ oddelene od druhových kariet exemplárov živočíchov určených na iné účely. Prevádzkovateľ chovnej stanice alebo rehabilitačnej stanice[38b)](#poznamky.poznamka-38b) vedie pre exemplár hendikepovaného chráneného živočícha[38c)](#poznamky.poznamka-38c) evidenciu v druhovej karte ním označenej v záhlaví slovom „rehabilitácia“ oddelene od druhových kariet exemplárov živočíchov určených na iné účely.

(6)

Evidenciu podľa odseku 1 písm. b) vedie držiteľ živých exemplárov bezstavovcov, rýb a obojživelníkov okrem exemplárov druhov, ktoré sú uvedené v zozname [[§ 15 ods. 5 písm. g)](#paragraf-15.odsek-5.pismeno-g)]. Okresný úrad overí a potvrdí správnosť evidencie a pravdivosť údajov v nej pečiatkou úradu, podpisom zodpovedného pracovníka a uvedie dátum potvrdenia.
...
Pôvod uvedený v odseku 1 písm. a) až h) sa označuje kódom v súlade s osobitným predpisom.[42)](#poznamky.poznamka-42) Pôvod označený v odseku 1 písm. i) sa označuje kódom „N“.

(3)

Držiteľ exemplára podľa [§ 29 ods. 2](#paragraf-29.odsek-2) je povinný na požiadanie orgánu štátnej správy podľa [§ 14 písm. a) až d)](#paragraf-14.text) preukázať oznámenie jeho držby preukazom o pôvode chráneného živočícha.
...
písomným dokladom,[43)](#poznamky.poznamka-43) alebo

b)

preukazom o pôvode exemplára živočícha (ďalej len „preukaz o pôvode“), ak ide o živý exemplár plazov, vtákov a cicavcov druhov uvedených v prílohe A osobitného predpisu,[9)](#poznamky.poznamka-9) ktorý nemá vydaný doklad podľa písmena a) okrem exemplára druhov, ktoré sú uvedené v zozname [[§ 15 ods. 5 písm. g)](#paragraf-15.odsek-5.pismeno-g)].

(5)

Ak držiteľ živého exemplára plazov, vtákov a cicavcov druhov uvedených v prílohe A osobitného predpisu[9)](#poznamky.poznamka-9) písomne nepožiadal ministerstvo o udelenie výnimky alebo súhlasu podľa [§ 8](#paragraf-8) alebo nemá vydaný písomný doklad[43)](#poznamky.poznamka-43) podľa odseku 4 písm. a), písomne požiada okresný úrad príslušný podľa miesta držby exemplára o vydanie preukazu o pôvode podľa odseku 4 písm. b) bez zbytočného odkladu
...
po nezameniteľnom označení exemplára živočícha, u ktorého je povinnosť nezameniteľného označenia podľa [§ 13 ods. 1](#paragraf-13.odsek-1), alebo

c)

po určení okresným úradom podľa [§ 13 ods. 5](#paragraf-13.odsek-5), že exemplár nie je možné nezameniteľne označiť.
...
zhodný s pôvodom uvedeným v povolení na dovoz vydanom ministerstvom na exemplár druhu uvedeného v prílohe A osobitného predpisu,[9)](#poznamky.poznamka-9)
...
a označí ho kódom „C“, ak ani jeden z rodičov nemá v preukaze o pôvode vydanom v súlade s písmenami a) a b) uvedený kód pôvodu „W“, „R“, „O“ ani „N“ a exemplár po konzultácii s vedeckým orgánom spĺňa kritériá uvedené v osobitnom predpise,[11)](#poznamky.poznamka-11)
...
Držiteľ živého exemplára živočícha, na ktorého sa nevzťahuje povinnosť podľa [§ 12 ods. 4](#paragraf-12.odsek-4), je povinný orgánu štátnej správy preukázať spôsob nadobudnutia exemplára písomným vyhlásením o spôsobe nadobudnutia, ktoré obsahuje najmä
...
Držiteľ neživého exemplára živočícha, na ktorého sa nevzťahuje povinnosť podľa [§ 12 ods. 4](#paragraf-12.odsek-4), je povinný orgánu štátnej správy preukázať spôsob nadobudnutia exemplára písomným vyhlásením o spôsobe nadobudnutia, ktoré obsahuje najmä
...
Písomné vyhlásenie o spôsobe nadobudnutia podľa odseku 1 alebo odseku 3 nie je úradným potvrdením o tom, že exemplár bol nadobudnutý v členskom štáte Európskej únie alebo dovezený do členského štátu Európskej únie v súlade s osobitnými predpismi.[3)](#poznamky.poznamka-3)
...
Držiteľ neživého exemplára vybraných druhov živočíchov uvedených vo vykonávacom predpise [[§ 15 ods. 5 písm. j)](#paragraf-15.odsek-5.pismeno-j)] a ich krížencov je povinný
...
Držiteľ exemplára vybraných druhov živočíchov je povinný oznámiť písomne alebo elektronicky Štátnej ochrane prírody Slovenskej republiky (ďalej len „štátna ochrana prírody“)[43a)](#poznamky.poznamka-43b) termín a miesto odovzdania uhynutého exemplára fyzickej osobe, fyzickej osobe – podnikateľovi alebo právnickej osobe, ktorá prevádzkuje spracovateľský závod alebo vykonáva zber a prepravu vedľajších živočíšnych produktov[43aa)](#poznamky.poznamka-43aa) kategórie 1,[43ab)](#poznamky.poznamka-43ab) a odovzdať ho pod dohľadom štátnej ochrany prírody, ktorá vykoná fyzickú identifikáciu exemplára a jeho nezameniteľného označenia. Štátna ochrana prírody vyhotoví záznam o odovzdaní a jeho kópiu zašle ministerstvu do 30 dní odo dňa jeho vyhotovenia. Držiteľ neživého exemplára vybraných druhov živočíchov je povinný poskytnúť súčinnosť pri identifikácii exemplára.

(8)

Schválený prevádzkovateľ,[43ac)](#poznamky.poznamka-43ac) ktorý spracováva telá živočíchov taxidermiou,[43ad)](#poznamky.poznamka-43ad) vedie záznam o nakladaní s neživým exemplárom vybraných druhov živočíchov podľa osobitného predpisu.[43ae)](#poznamky.poznamka-43ae) Múzeá s prírodovedným zameraním pri zbierkovej činnosti vedú záznam o nakladaní s neživým exemplárom vybraných druhov živočíchov podľa osobitných predpisov.[36)](#poznamky.poznamka-36)
...
Nezameniteľné označenie exemplárov vtákov[43c)](#poznamky.poznamka-43c) môže pochádzať len od výrobcov alebo distribútorov, ktorým bola rozhodnutím ministerstva udelená licencia na výrobu krúžkov alebo distribúciu krúžkov (ďalej len „licencia na krúžky“); to neplatí pre exempláre vtákov, ktoré boli nadobudnuté a označené v súlade s osobitným predpisom[43b)](#poznamky.poznamka-43b) mimo územia Slovenskej republiky. Licenciu na krúžky nemožno previesť na inú osobu a ani neprechádza na právneho nástupcu.
...
spĺňa podmienku bezúhonnosti podľa [§ 3 ods. 4](#paragraf-3.odsek-4); ak je žiadateľom právnická osoba, podmienku bezúhonnosti musí spĺňať táto právnická osoba a jej štatutárny orgán alebo člen štatutárneho orgánu, a

b)

popis jedinečnosti a nedeliteľnosti krúžkov je v súlade s osobitným predpisom.[43c)](#poznamky.poznamka-43c)

(3)

Žiadosť o udelenie licencie na krúžky podáva podnikateľ písomne na ministerstve alebo na okresnom úrade, ktorý plní úlohy jednotného kontaktného miesta,[43d)](#poznamky.poznamka-43d) a obsahuje
...
údaje o druhu krúžkov, spôsobe ich výroby a popis zabezpečenia ich jedinečnosti a nedeliteľnosti podľa osobitného predpisu,[43c)](#poznamky.poznamka-43c)
...
Na účel preukázania bezúhonnosti podľa odseku 2 písm. a) poskytne fyzická osoba údaje potrebné na vyžiadanie výpisu z registra trestov;[18a)](#poznamky.poznamka-18a) u právnickej osoby poskytne údaje potrebné na vyžiadanie výpisu z registra trestov osoba, ktorá je štatutárnym orgánom alebo členom štatutárneho orgánu a zodpovedným zástupcom, ak bol ustanovený. Údaje podľa prvej vety ministerstvo bezodkladne zašle v elektronickej podobe prostredníctvom elektronickej komunikácie Generálnej prokuratúre Slovenskej republiky na vydanie výpisu z registra trestov.
...
podnikateľ alebo fyzická osoba, ktorá je oprávnená konať v mene právnickej osoby, prestala spĺňať podmienku bezúhonnosti podľa [§ 3 ods. 4](#paragraf-3.odsek-4),
...
držiteľovi licencie na krúžky bola uložená pokuta alebo iná sankcia alebo bol exemplár zhabaný za porušenie povinností pri ochrane exemplárov druhov voľne žijúcich živočíchov a voľne rastúcich rastlín alebo v oblasti obchodu s výrobkami z tuleňov za porušenie povinnosti podľa tohto zákona alebo osobitného predpisu.[3)](#poznamky.poznamka-3)
...
prijíma a eviduje oznámenia o dovoze exemplárov a záznamy podľa [§12b](#paragraf-12b),

i)

v súčinnosti s okresným úradom, inšpekciou a colnými úradmi vedie evidenciu fyzických osôb, podnikateľov a právnických osôb, ktorým bola uložená sankcia za protiprávne konanie podľa tohto zákona, osobitného predpisu[3)](#poznamky.poznamka-3) alebo osobitného predpisu[44)](#poznamky.poznamka-44) pre potreby orgánov štátnej správy,

j)

ustanovuje najmenej jeden vedecký orgán alebo taký počet vedeckých orgánov, ktorý je nevyhnutný na plnenie úloh vyplývajúcich z dohovoru,[4)](#poznamky.poznamka-4) osobitných predpisov[3)](#poznamky.poznamka-3) a tohto zákona,
...
je správcom exemplárov, ktoré sa stali vlastníctvom štátu na základe rozhodnutia orgánu štátnej správy alebo súdu a môže také exempláre uvedené v prílohách B až D osobitného predpisu[9)](#poznamky.poznamka-9) predať,
...
monitoruje v spolupráci s inšpekciou, okresným úradom, políciou a colnými orgánmi dodržiavanie ustanovení dohovoru[4)](#poznamky.poznamka-4) a osobitného predpisu,[3)](#poznamky.poznamka-3) informuje Sekretariát dohovoru[4)](#poznamky.poznamka-4) a Európsku komisiu o krokoch prijatých príslušnými orgánmi v súvislosti so závažnými porušeniami osobitného predpisu[3)](#poznamky.poznamka-3) a o výsledkoch šetrenia na základe upozornenia Európskej komisie,
...
je orgánom príslušným na komunikáciu s Európskou komisiou a Sekretariátom dohovoru,[4)](#poznamky.poznamka-4)

v)

prijíma potrebné kroky na informovanie verejnosti o ustanoveniach dohovoru,[4)](#poznamky.poznamka-4) osobitného predpisu[3)](#poznamky.poznamka-3) a tohto zákona,
...
spoluprácu pri identifikácii exemplárov uvedených v prílohách A až D osobitného predpisu[9)](#poznamky.poznamka-9) pre potreby orgánov štátnej správy na úseku ochrany exemplárov, najmä pri colných kontrolách na hraniciach,
...
vydáva stanovisko pri určovaní pôvodu podľa [§ 12 ods. 6 písm. e)](#paragraf-12.odsek-6.pismeno-e),

y)

plní ďalšie úlohy vo veciach ochrany exemplárov ustanovené v dohovore,[4)](#poznamky.poznamka-4) osobitných predpisoch[3)](#poznamky.poznamka-3) a v tomto zákone,

z)

rozhoduje o udelení licencie ([§ 8a](#paragraf-8a)), zariadeniam prideľuje jedinečný evidenčný kód[45a)](#poznamky.poznamka-45a) a vedie o tom evidenciu,

za)

overuje osvedčenia podľa osobitného predpisu[45b)](#poznamky.poznamka-45b) a rozhoduje o výnimke podľa [§ 5 ods. 2](#paragraf-5.odsek-2),
...
vydáva písomné vyhlásenie, ktorým povoľuje použitie exemplára osobného charakteru alebo rodinného charakteru druhov uvedených v prílohe B na komerčné činnosti podľa podmienok stanovených osobitným predpisom.[45c)](#poznamky.poznamka-45c)
...
adresu miesta povoleného chovu alebo pestovania živých exemplárov druhov uvedených v prílohe A osobitného predpisu[9)](#poznamky.poznamka-9) z voľnej prírody [názov ulice, orientačné (súpisné) číslo domu, názov obce (časti obce), poštové smerovacie číslo, názov okresu, názov štátu],
...
o vzore úradného tlačiva inventárneho listu k potvrdeniu o putovnej výstave,[45d)](#poznamky.poznamka-45d)
...
zoznam druhov, pre ktoré sa nemusí viesť evidencia podľa [§ 11 ods. 1](#paragraf-11.odsek-1), [2](#paragraf-11.odsek-2) a [6](#paragraf-11.odsek-6), pre ktoré sa nevydáva preukaz o pôvode alebo ktoré sa nezameniteľne neoznačujú,
...
zoznam vybraných druhov živočíchov podľa [§12b ods. 1](#paragraf-12b.odsek-1),

k)

podrobnosti o zázname o nakladaní s neživým exemplárom vybraných druhov živočíchov podľa [§12b](#paragraf-12b).
...
plní úlohu výkonného orgánu pri určení vhodnej metódy označenia exemplára,[47)](#poznamky.poznamka-47) a vykonáva fyzickú identifikáciu exemplára a jeho nezameniteľného označenia,

i)

podnikne primerané kroky na zabezpečenie dodržiavania ustanovení osobitného predpisu[48)](#poznamky.poznamka-48) a tohto zákona a začne konanie v prípade podozrenia z ich porušovania,

j)

vydáva preukaz o pôvode podľa [§ 12 ods. 8](#paragraf-12.odsek-8) a určuje pôvod podľa [§ 12 ods. 6 písm. a) až d)](#paragraf-12.odsek-6.pismeno-a),

k)

je príslušným orgánom podľa osobitného predpisu,[49)](#poznamky.poznamka-49)
...
je výkonným orgánom podľa osobitného predpisu vo veciach kontroly záznamov vedených zariadeniami na spracovanie, balenie alebo opätovné balenie kaviáru,[49a)](#poznamky.poznamka-49a)

h)

kontroluje vydávanie osvedčení podľa osobitného predpisu[49b)](#poznamky.poznamka-49b) vo veciach obchodovania s výrobkami z tuleňov,

i)

komunikuje s kontrolnými orgánmi strán dohovoru[4)](#poznamky.poznamka-4) v rozsahu svojej pôsobnosti.
...
bez zbytočného odkladu zašle ministerstvu ostatné doklady, ktoré mu boli predložené v súlade s týmto zákonom, osobitným predpisom[3)](#poznamky.poznamka-3) alebo dohovorom,[4)](#poznamky.poznamka-4)

g)

bez zbytočného odkladu písomne informuje ministerstvo o tom, že zistil dovoz, vývoz, opätovný vývoz alebo tranzit exemplárov alebo výrobkov z tuleňov v rozpore s týmto zákonom alebo osobitným predpisom,[3)](#poznamky.poznamka-3) vyhotoví o tom zápis, zásielku zaistí a zabezpečí umiestnenie živých zaistených exemplárov vo vhodných priestoroch,
...
podnikne primerané kroky na zabezpečenie dodržiavania ustanovení tohto zákona a osobitného predpisu[3)](#poznamky.poznamka-3) a začne konanie v prípade predpokladu ich porušovania,[48)](#poznamky.poznamka-48)

k)

zabezpečuje v spolupráci s ministerstvom a vedeckým orgánom informovanie verejnosti na určených colných úradoch o ustanoveniach dohovoru[4)](#poznamky.poznamka-4) a osobitného predpisu,[3)](#poznamky.poznamka-3)
...
Úlohy na úseku ochrany exemplárov plní aj colný kriminálny úrad.[51)](#poznamky.poznamka-51) Colný kriminálny úrad

a)

zabezpečuje úlohy vyplývajúce z tohto zákona a osobitného predpisu,[3)](#poznamky.poznamka-3)
...
Úlohy na úseku ochrany exemplárov plní aj štátna ochrana prírody, ktorá vykonáva dohľad a fyzickú identifikáciu exemplára a jeho nezameniteľného označenia podľa [§12b ods. 7.](#paragraf-12b.odsek-7)
...
zisťovanie, ako fyzické osoby, podnikatelia [20)](#poznamky.poznamka-20) a právnické osoby (ďalej len „kontrolovaná osoba“) dodržiavajú tento zákon, všeobecne záväzné právne predpisy vydané na jeho vykonanie, osobitné predpisy[3)](#poznamky.poznamka-3)^a povinnosti vyplývajúce z povolenia, potvrdenia alebo z iného rozhodnutia vydaného na základe tohto zákona alebo osobitných predpisov,[3)](#poznamky.poznamka-3)

b)

objasňovanie spočívajúce v prešetrovaní podozrení alebo podnetov poukazujúcich na porušenie tohto zákona, všeobecne záväzného právneho predpisu vydaného na jeho vykonanie, osobitných predpisov[3)](#poznamky.poznamka-3) a povinností vyplývajúcich z povolenia, potvrdenia alebo z iného rozhodnutia vydaného na základe tohto zákona alebo osobitných predpisov.[3)](#poznamky.poznamka-3)

(2)

Zamestnanci orgánov štátneho dozoru vo veciach ochrany exemplárov podľa [§ 14](#paragraf-14) sú oprávnení na účely výkonu štátneho dozoru

a)

vstupovať na pozemky, do stavieb, objektov, prevádzkových priestorov a iných zariadení, kde sa nakladá s exemplármi, vrátane obydlí používaných na podnikanie alebo na inú hospodársku činnosť, ak to nie je osobitnými predpismi[55)](#poznamky.poznamka-55) zakázané alebo sa na to nevyžaduje povolenie, súhlas alebo oprávnenie podľa osobitných predpisov, [55)](#poznamky.poznamka-55)
...
požadovať potrebné vyjadrenia, informácie, údaje a vysvetlenia o skutočnostiach dôležitých na výkon štátneho dozoru; tým nie sú dotknuté ustanovenia osobitného predpisu,[56)](#poznamky.poznamka-56)

e)

požadovať predloženie prvopisov dokladov, spisov a iných písomností potrebných na výkon štátneho dozoru a požadovať ich kópie; tým nie sú dotknuté ustanovenia osobitného predpisu,[56)](#poznamky.poznamka-56)
...
používať technické prostriedky na zhotovenie fotodokumentácie, videodokumentácie a zvukových záznamov potrebných na výkon štátneho dozoru, ak ich použitie nezakazujú osobitné predpisy. [55)](#poznamky.poznamka-55)
...
zastaviť vozidlo[57)](#poznamky.poznamka-57) na účel overenia oprávnenosti držby, kúpy a predaja exemplárov, ak je dôvodné podozrenie, že vo vozidle sa nachádza exemplár v rozpore s osobitnými predpismi,[3)](#poznamky.poznamka-3)

e)

kontrolovať vozidlo[57)](#poznamky.poznamka-57) na účel overenia oprávnenosti držby, kúpy a predaja exemplárov a prehľadať vozidlo a obsah batožiny v ňom, ak je dôvodné podozrenie, že vo vozidle sa nachádza exemplár v rozpore s osobitnými predpismi,[3)](#poznamky.poznamka-3)

f)

získavať informácie a osobné údaje podľa osobitného predpisu[58)](#poznamky.poznamka-58) od útvarov Policajného zboru s cieľom zistenia identity používateľa elektronických komunikačných služieb, ktorý ponúka na predaj, kúpu alebo výmenu exempláre, na účely kontroly dodržiavania právnych predpisov na úseku ochrany exemplárov.

(4)

Na plnenie úloh v rámci výkonu štátneho dozoru sú zamestnanci orgánu štátneho dozoru vo veciach ochrany exemplárov oprávnení poveriť ďalšie osoby, a to najmä na účel identifikácie exemplárov, manipulácie s exemplármi vrátane ich prevozu a odberu vzoriek. Poverené osoby môžu vykonávať štátny dozor iba na základe písomného poverenia na vykonanie kontrolnej úlohy a pod vedením zamestnanca orgánu štátnej správy oprávneného vykonaním kontroly. Poverené osoby majú oprávnenia podľa odseku 2 písm. a), f) a h) až n) a povinnosti podľa odseku 6 písm. d). Poverené osoby majú nárok na cestovné náhrady podľa osobitného predpisu.^59a) Účasť poverených osôb na výkone štátneho dozoru sa považuje za úkon vo všeobecnom záujme podľa osobitných predpisov.[59b)](#poznamky.poznamka-59b)
...
podať vysvetlenie o skutočnostiach dôležitých na výkon štátneho dozoru; vysvetlenie môže odoprieť ten, kto by ním spôsobil nebezpečenstvo trestného stíhania sebe alebo blízkej osobe, [59c)](#poznamky.poznamka-59c)
...
umožniť používanie technických prostriedkov na zhotovenie fotodokumentácie, videodokumentácie a zvukových záznamov potrebných na výkon štátneho dozoru, ak ich použitie nezakazujú osobitné predpisy,[55)](#poznamky.poznamka-55)
...
Na predpojatosť pri výkone štátneho dozoru podľa tohto zákona sa primerane vzťahuje osobitný predpis.[59e)](#poznamky.poznamka-59e)

(19)

Ak príslušník spravodajskej služby pri plnení služobných úloh alebo v súvislosti s nimi preukáže svoju príslušnosť podľa osobitných predpisov,[59f)](#poznamky.poznamka-59f) ustanovenia odseku 2 písm. b), odseku 3 písm. e) a odseku 5 písm. b) a n) sa nepoužijú.
...
poskytuje odbornú pomoc orgánom štátnej správy pri uplatňovaní tohto zákona a osobitného predpisu,[3)](#poznamky.poznamka-3)
...
navrhuje ministerstvu primerané opatrenia na obmedzenie vydávania povolení na vývoz exemplárov druhov uvedených v prílohe B osobitného predpisu,[9)](#poznamky.poznamka-9) napríklad navrhnutím vývozných kvót,
...
je orgánom príslušným na komunikáciu so Sekretariátom dohovoru[4)](#poznamky.poznamka-4) a s Európskou komisiou v rozsahu svojej pôsobnosti,

n)

plní ďalšie úlohy vo veciach ochrany exemplárov ustanovené v tomto zákone, osobitnom predpise[3)](#poznamky.poznamka-3) a v dohovore.[4)](#poznamky.poznamka-4)
...
Pokutu od 80 eur do 16 600 eur alebo prepadnutie exemplára uloží okresný úrad alebo inšpekcia podnikateľovi[20)](#poznamky.poznamka-20) alebo právnickej osobe, ktorá sa dopustí protiprávneho konania tým, že

a)

poruší podmienky určené v povolení alebo v potvrdení vydanom podľa tohto zákona a podľa osobitného predpisu,[60)](#poznamky.poznamka-60)
...
použije falzifikované alebo neplatné povolenie alebo potvrdenie alebo povolenie alebo potvrdenie, ktoré bolo zmenené bez súhlasu vydávajúceho orgánu ako podklad na vydanie iného povolenia alebo potvrdenia na akýkoľvek iný úradný účel v súvislosti s týmto zákonom alebo osobitným predpisom,[61)](#poznamky.poznamka-61)

f)

použije exempláre druhov uvedených v prílohe A osobitného predpisu[9)](#poznamky.poznamka-9) na iný účel, ako je uvedené v povolení na dovoz,
...
sfalšuje alebo zmení povolenie, potvrdenie alebo rozhodnutie, alebo si dá vykonať neoprávnené zmeny v povolení, potvrdení alebo rozhodnutí vydanom podľa tohto zákona alebo osobitného predpisu,[3)](#poznamky.poznamka-3)
...
nesplní povinnosti uvedené v [§ 10 ods. 3](#paragraf-10.odsek-3), [4](#paragraf-10.odsek-4) alebo [ods. 5](#paragraf-10.odsek-5) alebo [§ 11 ods. 3](#paragraf-11.odsek-3), [4](#paragraf-11.odsek-4) alebo [ods. 5](#paragraf-11.odsek-5),
...
bezodkladne nevráti ministerstvu originál a všetky kópie neplatného alebo nepoužitého povolenia alebo potvrdenia vrátane ich príloh,[66)](#poznamky.poznamka-66)

p)

nesplní povinnosti uvedené v [§ 4 ods. 3](#paragraf-4.odsek-3) alebo [ods. 4](#paragraf-4.odsek-4),

q)

nesplní povinnosti uvedené v [§ 12 ods. 5](#paragraf-12.odsek-5), [13](#paragraf-12.odsek-13) alebo [ods. 15](#paragraf-12.odsek-15),

r)

nesplní povinnosť podľa [§ 28 ods. 8](#paragraf-28.odsek-8) alebo [ods. 9](#paragraf-28.odsek-9) uloženú orgánom štátnej správy [[§ 15 ods. 2 písm. l)](#paragraf-15.odsek-2.pismeno-i), [§ 16 písm. c)](#paragraf-16.pismeno-c), [§ 17 písm. c)](#paragraf-17.pismeno-c) a [§ 18 písm. c)](#paragraf-18.pismeno-c)],

s)

vyrába alebo distribuuje krúžky bez licencie na krúžky alebo v rozpore s rozhodnutím o jej udelení alebo poruší povinnosti výrobcu krúžkov alebo distribútora krúžkov podľa [§ 13a](#paragraf-13a),

t)

nezabezpečí nezameniteľné označenie v súlade s požiadavkami podľa tohto zákona a osobitného predpisu,[43b)](#poznamky.poznamka-43b)

u)

vyrába, spracováva, balí alebo opätovne balí kaviár bez platnej licencie na kaviár určený na vývoz, opätovný vývoz alebo obchod v rámci Európskej únie alebo neplní povinnosti pri vedení záznamov podľa [§ 5a](#paragraf-5a),

v)

nesplní iné povinnosti ustanovené týmto zákonom alebo osobitným predpisom,[3)](#poznamky.poznamka-3) ak sa nepostihujú podľa odseku 2.
...
dovezie na územie Európskej únie alebo vyvezie alebo opätovne vyvezie z územia Európskej únie exemplár bez povolenia alebo potvrdenia, alebo bez oznámenia o dovoze,[64)](#poznamky.poznamka-64)
...
kúpi, ponúkne na kúpu, nadobudne na komerčné účely, vystavuje na verejnosti na komerčné účely, využíva na komerčný zisk a predaj, drží na predaj, ponúka na predaj alebo prepravuje na účely predaja exemplár v rozpore s osobitným predpisom,[31)](#poznamky.poznamka-31)

d)

drží alebo odovzdá do držby exemplár v rozpore s [§ 4 ods. 1](#paragraf-4.odsek-1),

e)

premiestni exemplár v rozpore s osobitným predpisom,[68)](#poznamky.poznamka-68)

f)

nepreukáže pôvod exemplára podľa [§ 12](#paragraf-12), nepreukáže spôsob nadobudnutia podľa [§ 12a](#paragraf-12a), nesplní inú povinnosť podľa [§ 12a](#paragraf-12a) alebo nesplní povinnosť podľa [§12b](#paragraf-12b),
...
drží exemplár, ktorého držba je zakázaná alebo obmedzená podľa tohto zákona a osobitného predpisu,[3)](#poznamky.poznamka-3)

i)

nevydá zaistený exemplár podľa [§ 24 ods. 5](#paragraf-24.odsek-5) alebo zhabaný exemplár podľa [§ 25](#paragraf-25),
...
koná v rozpore s nariadením okresného úradu alebo inšpekcie podľa [§ 24 ods. 8](#paragraf-24.odsek-8),

l)

dovezie výrobky z tuleňov bez výnimky udelenej ministerstvom podľa [§ 5](#paragraf-5) alebo obchoduje s výrobkami z tuleňov v rozpore s osobitnými predpismi.[68a)](#poznamky.poznamka-68a)
...
Konanie o uložení sankcie možno začať najneskôr do dvoch rokov odo dňa, keď sa o porušení alebo nesplnení povinnosti podľa tohto zákona a osobitného predpisu[3)](#poznamky.poznamka-3) dozvedel príslušný okresný úrad alebo inšpekcia, najneskôr do troch rokov odo dňa, keď došlo k porušeniu alebo nesplneniu povinnosti.
...
Pokarhanie alebo pokutu od 16,59 eura do 4 979,08 eura uloží okresný úrad alebo inšpekcia fyzickej osobe, ktorá sa dopustí protiprávneho konania uvedeného v [§ 22 ods. 1](#paragraf-22.odsek-1).

(2)

Pokutu od 66,38 eura do 9 958,17 eura uloží okresný úrad alebo inšpekcia fyzickej osobe, ktorá sa dopustí protiprávneho konania uvedeného v [§ 22 ods. 2](#paragraf-22.odsek-2).
...
Okresný úrad alebo inšpekcia, ktoré zaistia živý exemplár, sú povinné zabezpečiť vhodné podmienky na jeho umiestnenie a starostlivosť. Ak okresný úrad alebo inšpekcia sama nemôže zabezpečiť také podmienky, zabezpečia ich najmä prostredníctvom právnickej osoby alebo podnikateľa podľa osobitného predpisu.[70)](#poznamky.poznamka-70)
...
bol exemplár nadobudnutý alebo sa s ním nakladá v rozpore s týmto zákonom alebo osobitným predpisom.[70a)](#poznamky.poznamka-70a)
...
Okresný úrad alebo inšpekcia, ktoré rozhodli o zhabaní exemplára, to oznámia bez zbytočného odkladu ministerstvu a zabezpečia v súčinnosti so správcom majetku štátu podľa [§ 26](#paragraf-26) alebo s orgánmi štátnej správy vo veterinárnej oblasti,[70b)](#poznamky.poznamka-70b) ak je to potrebné, jeho umiestnenie v záchytnom stredisku.[45)](#poznamky.poznamka-45) Fyzická osoba, podnikateľ[20)](#poznamky.poznamka-20) alebo právnická osoba, ktorej bol exemplár zhabaný, je povinná zhabaný exemplár vydať.
...
po konzultácii s výkonným orgánom štátu vývozu vrátiť do štátu, z ktorého boli dovezené na územie Slovenskej republiky v rozpore s týmto zákonom alebo osobitným predpisom,[3)](#poznamky.poznamka-3)

c)

po konzultácii s výkonným orgánom iného členského štátu Európskej únie vrátiť do tohto štátu, ak boli z neho premiestnené v rozpore s týmto zákonom alebo osobitným predpisom,[3)](#poznamky.poznamka-3)
...
na neštátny subjekt, ak ide o exempláre druhov uvedených v prílohe A osobitného predpisu,[9)](#poznamky.poznamka-9) ktoré sa nenarodili a neodchovali v zajatí alebo umelo nevypestovali.
...
Všeobecný predpis o správnom konaní s výnimkou ustanovení o miestnej príslušnosti sa nevzťahuje na konanie podľa [§ 6 ods. 15](#paragraf-6.odsek-15), [§ 12 ods. 6](#paragraf-12.odsek-6), [8](#paragraf-12.odsek-8), [ods. 9 písm. b)](#paragraf-12.odsek-9.pismeno-b), [ods. 10](#paragraf-12.odsek-10) a [12](#paragraf-12.odsek-12), [§13 ods. 2](#paragraf-13.odsek-2), [3](#paragraf-13.odsek-3) a [5](#paragraf-13.odsek-5), [§ 20 ods. 1 až 15](#paragraf-20.odsek-1) a [ods. 17](#paragraf-20.odsek-17) a [18](#paragraf-20.odsek-18), [§ 24 ods. 8](#paragraf-24.odsek-8), [§ 26 ods. 3 písm. k)](#paragraf-26.odsek-3.pismeno-k) a [§ 28 ods. 3.](#paragraf-28.odsek-3) Na doručovanie sa vzťahuje [Správny poriadok](../../../../SK/ZZ/1967/71/).
...
nebol zaplatený správny poplatok a sú splnené podmienky podľa osobitného predpisu,[29f)](#poznamky.poznamka-29f)
...
Ustanovenie odseku 5 sa nevzťahuje na exemplár chráneného druhu živočícha.[10)](#poznamky.poznamka-10) Ak je predmetom nálezu takýto exemplár, postupuje sa podľa osobitného predpisu.[78)](#poznamky.poznamka-78)
...
Držiteľ exemplára je povinný zabezpečiť odobratie krvi alebo iného tkaniva na účely stanovenia DNA profilu a vykonanie analýzy krvi alebo iného tkaniva na preukázanie identity exemplára, rodičovstva a dosiahnutej generácie, ak to nariadi inšpekcia podľa [§ 18 písm. c)](#paragraf-18.pismeno-c); úkony sa vykonajú pod dohľadom inšpekcie, ktorá o tom vyhotoví záznam.

(9)

Držiteľ exemplára je povinný zabezpečiť odobratie krvi alebo iného tkaniva na účely stanovenia DNA profilu a vykonanie analýzy krvi alebo iného tkaniva na preukázanie identity exemplára, rodičovstva a dosiahnutej generácie, ak to nariadi ministerstvo alebo okresný úrad pri vydávaní preukazu o pôvode podľa [§ 17 písm. j)](#paragraf-17.pismeno-j); úkony sa vykonajú pod dohľadom ministerstva alebo okresného úradu, ktoré o tom vyhotovia záznam. Držiteľ exemplára je povinný zabezpečiť zaslanie odobratej vzorky krvi alebo iného tkaniva do laboratória pod dohľadom ministerstva alebo okresného úradu a predložiť výsledok analýzy krvi alebo iného tkaniva ministerstvu alebo okresnému úradu. Ak nariaďuje vykonanie stanovenia DNA profilu ministerstvo, môže dohľadom poveriť okresný úrad.

(10)

Na držiteľa exemplára, ktorý nemá trvalý pobyt alebo sídlo na území Slovenskej republiky, sa nevzťahujú povinnosti [§ 9](#paragraf-9), [§ 12 ods. 4 písm. b)](#paragraf-12.odsek-4.pismeno-b), [§ 12b](#paragraf-12b) a [§ 13](#paragraf-13), ak sa na území Slovenskej republiky držiteľ nezdržuje dlhšie ako šesť mesiacov.
...
Povinnosť zabezpečiť nezameniteľné označenie exemplára krúžkom od výrobcu krúžkov alebo distribútora krúžkov, ktorým sa udeľuje licencia podľa [§ 13a](#paragraf-13a), sa nevzťahuje na držiteľa exemplára, ktorý nadobudol exemplár pred 1. októbrom 2013.
...
Ten, kto k 1. januáru 2019 má v držbe neživý exemplár vybraných druhov živočíchov podľa [§12b](#paragraf-12b), je povinný zaslať záznam o nakladaní s neživým exemplárom vybraných druhov živočíchov ministerstvu do 30. júna 2019.
...
Držiteľ exemplára druhu uvedeného v prílohe A osobitného predpisu[9)](#poznamky.poznamka-9) oznamuje písomne alebo elektronicky každú zmenu údajov v druhovej karte od 1. januára 2019 do 31. decembra 2020 ministerstvu doručením kópie časti druhovej karty s vyznačenou zmenou do 30 dní odo dňa zápisu zmeny.

(4)

Držiteľ exemplára druhu uvedeného v prílohe B osobitného predpisu[9)](#poznamky.poznamka-9) oznamuje písomne alebo elektronicky každú zmenu údajov v druhovej karte od 1. januára 2019 do 31. decembra 2020 ministerstvu doručením kópie časti druhovej karty s vyznačenou zmenou do 14 dní odo dňa zápisu zmeny.
...
Zákaz podľa [§ 4 ods. 1 písm. a)](#paragraf-4.odsek-1.pismeno-a) v znení účinnom od 1. februára 2022 sa nevzťahuje na exemplár, ktorý bol v držbe na území Slovenskej republiky ku dňu zákazu držby, a na exemplár nadobudnutý vlastným odchovom na území Slovenskej republiky od 1. februára 2022 do 31. októbra 2022.
...
Týmto zákonom sa preberajú právne záväzné akty Európskej únie uvedené v [prílohe č. 2](#prilohy.priloha-priloha_c_2_k_zakonu_c_15_2005_z_z.oznacenie).
