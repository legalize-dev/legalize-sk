...
Policajtovi v stálej štátnej službe za výkon štátnej služby patrí služobný príjem, ktorý tvoria tieto zložky:
...
Policajtovi v stálej štátnej službe, ktorý vykonáva riadiacu funkciu, patrí príplatok za riadenie v rozpätí od 5 % do 70 % zo súčtu funkčného platu a hornej hranice prídavku za výsluhu rokov platovej triedy určenej pre funkciu, do ktorej je policajt zaradený. Minister určí podľa stupňa riadenia a náročnosti riadiacej práce príplatok za riadenie podľa [prílohy č. 2](#prilohy.priloha-priloha_c_2.oznacenie).
...
O priznaní, zvýšení, znížení alebo odňatí osobného príplatku podľa odseku 1 rozhoduje príslušný nadriadený a podľa odseku 2 minister. Súbeh osobných príplatkov podľa odseku 1 a 2 nie je možný.
...
Ak má vodič referent alebo vodič referent špecialista pridelený do trvalej starostlivosti osobný automobil, nákladný automobil, autobus, obrnený transportér, vyprosťovací tank, pásový transportér, traktor alebo buldozér, patrí mu príplatok vo výške 300 Sk mesačne. Príplatok patrí len za jedno pridelené vozidlo.

(2)

Ak má vodič referent pridelený do trvalej starostlivosti motocykel, služobný motorový čln alebo príves nad 750 kg, patrí mu príplatok vo výške 100 Sk mesačne. Príplatok patrí len za jeden motocykel, služobný motorový čln alebo príves.

(3)

Ak má vodič referent pridelené do trvalej starostlivosti ostatné služobné cestné vozidlá, patrí mu príplatok vo výške 50 Sk mesačne. Príplatok patrí len za jedno cestné vozidlo.
...
patrí mu príplatok vo výške 300 Sk mesačne.

(5)

Ak vodič referent alebo vodič referent špecialista skutočne jazdí služobným cestným vozidlom alebo motorovým člnom, patrí mu príplatok vo výške 200 Sk mesačne.
...
Policajtovi, ktorý má kvalifikáciu potápača a je ustanovený do funkcie, s ktorou je spojený výkon potápačskej činnosti, patrí príplatok vo výške
...
Ak je policajtovi nariadená služobná pohotovosť podľa [§ 69](#paragraf-69), patrí mu za každú hodinu tejto pohotovosti peňažná náhrada vo výške
...
vyplácaním služobného príjmu podľa [§ 84 ods. 1](#paragraf-84.odsek-1), ktorý sa policajtovi poskytoval počas denného štúdia,
