...
technický opis virtualizovanej časti centrálneho počítačového systému, ak je centrálny počítačový systém úplne alebo čiastočne virtualizovaný, pričom z tohto opisu musí byť zrejmé, že spĺňa požiadavky pre centrálny počítačový systém podľa osobitného predpisu,[1)](#poznamky.poznamka-1)

p)

technický opis virtualizovanej časti záložného počítačového systému, ak je záložný počítačový systém úplne alebo čiastočne virtualizovaný, pričom z tohto opisu musí byť zrejmé, že spĺňa požiadavky pre záložný počítačový systém podľa osobitného predpisu.[1a)](#poznamky.poznamka-1a)
...
písomné vyhlásenie o zhode a skúšobné protokoly alebo certifikáty od notifikovaných osôb, vydané na základe osobitného predpisu,[1b)](#poznamky.poznamka-1b) ak ešte neboli zaregistrované poverenou skúšobňou,
