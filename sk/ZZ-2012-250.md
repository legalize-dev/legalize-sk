...
kontrolu uplatnenia cien určených nariadením vlády podľa [§ 16a ods. 3](#paragraf-16a.odsek-3) a [§ 45j](#paragraf-45j),
...
uplatní cenu v rozpore s nariadením vlády podľa [§ 16a ods. 3](#paragraf-16a.odsek-3) alebo [v](#paragraf-16a.odsek-5) rozpore s [§ 45j](#paragraf-45j).
...
od 500 eur do 100 000 eur za správny delikt podľa odseku 1 písm. a), b), c), e), f) až m), p), q), s) až w), x), z), ab), ad) až af), ah) až ak),
