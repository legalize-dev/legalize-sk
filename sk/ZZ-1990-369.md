...
Obec má svoj názov a právo na svoj znak. Pravidlá určovania názvov obcí a ich častí, ako aj názvov ulíc a iných verejných priestranstiev a číslovania budov upravujú osobitné predpisy.[1)](#poznamky.poznamka-1)
...
Majetok obce možno použiť najmä pre verejné účely, na podnikateľskú činnosť[9)](#poznamky.poznamka-9) a na výkon samosprávy obce.
...
petície[11)](#poznamky.poznamka-11) skupiny obyvateľov obce v počte 20 % všetkých oprávnených voličov.
...
Do funkcie ho vymenúva[16)](#poznamky.poznamka-16) na dobu neurčitú obecné zastupiteľstvo na návrh starostu. Za svoju činnosť zodpovedá obecnému zastupiteľstvu.
...
Príslušník obecnej polície pri plnení svojich úloh je oprávnený požadovať od každého potrebné vysvetlenia na objasnenie priestupku, ukladať blokové pokuty, zisťovať totožnosť osôb a zadržať podozrivú osobu.[17)](#poznamky.poznamka-17)
...
Na konanie, v ktorom o právach, právom chránených záujmoch alebo povinnostiach právnických a fyzických osôb rozhodujú starostovia obcí, sa vzťahujú všeobecné predpisy o správnom konaní[19)](#poznamky.poznamka-19) s týmito odchýlkami:
...
Tento zákon nadobúda účinnosť dňom volieb do orgánov samosprávy obcí v roku 1990; ustanovenie [§ 30 ods. 1 tohto zákona](#paragraf-30.odsek-1) nadobúda účinnosť dňom vyhlásenia.
