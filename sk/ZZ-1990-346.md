...
Kandidátna listina obsahuje meno, priezvisko a akademický titul, vek, povolanie, trvalý pobyt kandidáta a názov politickej strany, ktorá kandidáta navrhla, alebo údaj o tom, že ide o nezávislého kandidáta. Ku kandidátnej listine sa pripojí vyhlásenie podľa [§ 16 ods. 8](#paragraf-16.odsek-8) a doklad osvedčujúci splnenie predpokladu na výkon funkcie podľa osobitného predpisu[3aa)](#poznamky.poznamka-3aa).
...
ku ktorého návrhu nie je pripojený doklad osvedčujúci splnenie predpokladu na výkon funkcie podľa osobitného predpisu.[3aa)](#poznamky.poznamka-3aa)
