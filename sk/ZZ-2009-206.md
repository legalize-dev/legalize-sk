...
Štandardy múzeí a galérií sú merateľné, porovnateľné alebo iné hodnotiace ukazovatele odporúčaného priestorového, finančného a personálneho zabezpečenia múzeí a galérií a úrovne kvality plnenia základných odborných činností a iných činností múzeí a galérií.
...
Štatutárny orgán múzea alebo galérie podľa [§ 3 ods. 1](#paragraf-3.odsek-1) vymenúva a odvoláva štatutárny orgán zriaďovateľa múzea alebo galérie. Štatutárny orgán múzea alebo galérie podľa [§ 3 ods. 1](#paragraf-3.odsek-1) sa vymenúva na základe výsledku výberového konania.
...
Zriaďovateľ múzea alebo galérie podľa [§ 3 ods. 1](#paragraf-3.odsek-1) je povinný
...
zabezpečiť pred zrušením múzea alebo galérie nadobudnutie zbierkových predmetov iným múzeom alebo galériou v súlade so zameraním a špecializáciou tohto múzea alebo galérie, ktorých zriaďovateľom je osoba podľa [§ 3 ods. 1](#paragraf-3.odsek-1),
...
Zakladateľ múzea alebo galérie podľa [§ 3 ods. 2](#paragraf-3.odsek-2), je povinný

a)

najmenej 180 dní pred zrušením múzea alebo galérie ponúknuť zbierkové predmety na nadobudnutie inému múzeu alebo galérii, ktoré sú zapísané v registri a ktorých zriaďovateľom je osoba podľa [§ 3 ods. 1](#paragraf-3.odsek-1) vybraným podľa ich zamerania a špecializácie, a túto skutočnosť oznámiť ministerstvu,
...
Na úkony týkajúce sa registra sa nevzťahuje všeobecný predpis o správnom konaní.[4)](#poznamky.poznamka-4)
...
udeľuje súhlas podľa [§ 3 ods. 5](#paragraf-3.odsek-5) a [§ 4 ods. 3 písm. a)](#paragraf-4.odsek-3.pismeno-a) a [b)](#paragraf-4.odsek-3.pismeno-b),

h)

vydáva povolenie podľa [§ 17 ods. 2 a 3](#paragraf-17.odsek-2) na trvalý vývoz zbierkového predmetu (ďalej len „povolenie“) z územia Slovenskej republiky a povolenie podľa osobitného predpisu[6)](#poznamky.poznamka-6) na vývoz zbierkového predmetu z colného územia Európskej únie,
...
odborná evidencia zbierkových predmetov a vyraďovanie zbierkových predmetov z odbornej evidencie podľa [§ 10](#paragraf-10),

c)

odborná revízia zbierkových predmetov podľa [§ 11](#paragraf-11),
...
sprístupňovanie zbierkových predmetov a zbierok podľa [§ 15](#paragraf-15) a historických objektov v správe múzea alebo galérie.
...
člen Komory reštaurátorov[22)](#poznamky.poznamka-22) alebo
...
Evidenciu predmetov kultúrnej hodnoty vedie ministerstvo. Žiadosť o zápis do evidencie predmetov kultúrnej hodnoty, ktorého vzor je uvedený v [prílohe č. 3](#prilohy.priloha-priloha_c_3_k_zakonu_c_206_2009_z_z.oznacenie), sa podáva ministerstvu.
...
prevedie predmet kultúrnej hodnoty bez toho, aby ho ponúkol múzeu alebo galérii podľa [§ 16 ods. 6 písm. a)](#paragraf-16.odsek-6.pismeno-a),

b)

nepožiada o výmaz predmetu kultúrnej hodnoty z evidencie predmetov kultúrnej hodnoty, ak nastane skutočnosť podľa [§ 16 ods. 6 písm. c)](#paragraf-16.odsek-6.pismeno-c),

c)

nechráni predmet kultúrnej hodnoty podľa [§ 16 ods. 7](#paragraf-16.odsek-7).
...
do výšky 1 000 eur za porušenie povinností podľa [§ 5 ods. 6](#paragraf-5.odsek-6) a [7](#paragraf-5.odsek-7), [§ 10 ods. 1](#paragraf-10.odsek-1) a [3 až 6](#paragraf-10.odsek-3), [§ 16 ods. 6 a 7](#paragraf-16.odsek-6),
...
Ak sa na štatutárny orgán múzea alebo galérie podľa [§ 3 ods. 1](#paragraf-3.odsek-1) alebo na vedúceho zamestnanca riadiaceho múzeum, ktoré nie je právnickou osobou, alebo galériu, ktorá nie je právnickou osobou, vzťahuje osobitný predpis upravujúci štátnu službu,[35)](#poznamky.poznamka-35) ustanovenia [§ 3a](#paragraf-3a) a [3b](#paragraf-3b) sa nepoužijú.
...
Na štatutárny orgán múzea alebo galérie podľa [§ 3 ods. 1](#paragraf-3.odsek-1) vymenovaný pred 1. januárom 2022 sa funkčné obdobie podľa § 3a ods. 2 nevzťahuje.
...
Ustanovenia [§ 3a](#paragraf-3a) a [3b](#paragraf-3b) v znení účinnom od 1. augusta 2024 sa vzťahujú aj na štatutárny orgán múzea alebo galérie podľa [§ 3 ods. 1](#paragraf-3.odsek-1) vymenovaný pred 1. augustom 2024 a na vedúceho zamestnanca riadiaceho múzeum, ktoré nie je právnickou osobou, alebo galériu, ktorá nie je právnickou osobou, vymenovaného pred 1. augustom 2024.

(2)

Štatutárny orgán múzea alebo galérie podľa [§ 3 ods. 1](#paragraf-3.odsek-1) a vedúci zamestnanec riadiaci múzeum, ktoré nie je právnickou osobou, alebo galériu, ktorá nie je právnickou osobou, vymenovaný medzi 1. januárom 2022 a 31. júlom 2024, vykonáva po 31. júli 2024 svoju funkciu bez časového obmedzenia.
