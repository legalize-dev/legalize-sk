...
náhradu hotových výdavkov účelne vynaložených v súvislosti s vykonaním notárskeho úkonu (najmä cestovné a telekomunikačné výdavky, zaplatená odmena za znalecký posudok, preklad, odpis, náhrada hotových výdavkov Notárskej komory Slovenskej republiky za prístup do Centrálneho informačného systému a iné),
...
Ak je notár platiteľom dane z pridanej hodnoty, zvyšuje sa jeho príjem[5)](#poznamky.poznamka-5) určený podľa tejto vyhlášky o daň z pridanej hodnoty.
