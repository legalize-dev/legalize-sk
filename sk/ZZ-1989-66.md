...
Vyhláška upravuje postup orgánov a organizácií pri navrhovaní, projektovaní, konštruovaní, výrobe, montáži, údržbe, opravách, rekonštrukciách, pri uskutočňovaní výstavby, vrátane skúšok, prevádzke, trvalom vyradení z prevádzky a dovoze zariadení v jadrovej energetike (ďalej len „zariadenia").
...
elektrické zariadenia, ktoré zabezpečujú činnosť havarijných systémov a systémov dochladzovania reaktora (ich napájania, ovládania, regulácie, ochrany, signalizácie a merania),
...
návrh projektovej úlohy, 30 dní pred podaním návrhu na vydanie územného rozhodnutia,[3)](#poznamky.poznamka-3)

b)

úvodný projekt vrátane technických správ obsahujúcich požiadavky na zariadenia podľa tejto vyhlášky, 30 dní pred podaním žiadosti o stavebné povolenie,[4)](#poznamky.poznamka-4)

c)

30 dní pred začatím stavebných prác časti vykonávacích projektov vyžiadaných orgánom dozoru,
...
požiadavky na bezpečné a nezávislé trasy elektrických vedení zariadení uvedených v [§ 1 ods. 2 písm. d)](#paragraf-1.odsek-2.pismeno-d),

g)

požiadavky na ukladanie betónov a kontrolu ich akosti, na vyhotovenie betonárskej výstuže, priechodiek dverí, príklopov, uzáverov, povrchových úprav stavebných konštrukcií a vyhotovenie stavebnej elektroinštalácie,
...
Generálny projektant je povinný pri spracovaní úvodného projektu vypracovať zoznam zariadení uvedených v [§ 1 ods. 2](#paragraf-1.odsek-2) a predložiť ho orgánu dozoru pred jeho odovzdaním stavebníkovi. Zariadenia uvedené v zozname musí zaradiť do príslušných bezpečnostných tried.[6)](#poznamky.poznamka-6)

(2)

Stavebník je povinný v spolupráci s príslušnými dodávateľmi zabezpečiť, aby generálny projektant upresnil, rozšíril, prípadne vykonal ďalšie úpravy a zmeny zoznamu zariadení a zmeny ich zaradenia do bezpečnostných tried v nadväznosti na spracovanie ďalšieho stupňa projektovej dokumentácie.
...
výpočty (pevnostné, dimenzovanie elektrických obvodov a pod.) vypracované podľa príslušných technických noriem, technických podmienok, prípadne nových poznatkov vedy a techniky, ak sa zainteresované organizácie nedohodnú s orgánom dozoru inak,
...
pri zariadeniach uvedených v [§ 1 ods. 2 písm. d)](#paragraf-1.odsek-2.pismeno-d) vykonať:

1.

revízie podľa osobitných predpisov,[9)](#poznamky.poznamka-9)
...
vykonať individuálne testnostné skúšky, ktoré zodpovedajú prevádzkovým podmienkam vrátane odchýlok od hodnôt určených projektom;

c)

pri zariadeniach podľa [§ 1 ods. 2 písm. e)](#paragraf-1.odsek-2.pismeno-e):
...
Pre zariadenia uvedené v [§ 1 ods. 2 písm. d)](#paragraf-1.odsek-2.pismeno-d) sprievodná technická dokumentácia musí obsahovať

a)

pasport zariadenia vypracovaný oprávnenou organizáciou, ktorý obsahuje:

1.

atesty čiastkových zariadení,

2.

protokoly vyhotovené podľa [§ 7 ods. 1 písm. b)](#paragraf-7.odsek-1.pismeno-b),

3.

protokoly o individuálnom vyskúšaní zabudovaného zariadenia alebo prvku,

4.

montážne výkresy s vyznačením odchýlok zodpovedajúcich skutočnému vyhotoveniu,
...
Pre zariadenia uvedené v [§ 1 ods. 2 písm. e)](#paragraf-1.odsek-2.pismeno-e) musí byť pasport spracovaný pre jednotlivé priestory a miestnosti. Podkladom pasportu sú technické dokumentácie podľa [§ 6 ods. 11](#paragraf-6.odsek-11). Sprievodná technická dokumentácia pozostáva
...
Konštruovať, vykonávať predpísané vstupné, medzioperačné a výstupné skúšky zariadení, ako aj skúšky zariadení podľa [§ 7](#paragraf-7), potvrdzovať sprievodnú technickú dokumentáciu podľa [§ 7, § 8](#paragraf-7) a [§ 14](#paragraf-14), vykonávať skúšky a revízie prevádzkových zariadení podľa [§ 14 a § 15](#paragraf-14) môžu len pracovníci, ktorých na túto činnosť organizácia určila a ktorí majú
...
elektrotechnického smeru pre zariadenia uvedené v [§ 1 ods. 2 písm. d)](#paragraf-1.odsek-2.pismeno-d),

c)

stavebného, strojníckeho, hutníckeho alebo podobného technického smeru pre zariadenia a ich časti uvedené v [§ 1 ods. 2 písm. e)](#paragraf-1.odsek-2.pismeno-e) a [ods. 3](#paragraf-1.odsek-3) podľa predpokladanej činnosti.
...
Organizácia zodpovedná za bezpečnú prevádzku zariadenia predkladá orgánu dozoru

a)

do 30 dní po vypracovaní ročný harmonogram prevádzky jadrovej elektrárne, v ktorom sú určené plánované odstávky počas kalendárneho roku,

b)

rozbor vzniknutých porúch za uplynulý mesiac s uvedením vykonaných opatrení, a to do 15 dňa nasledujúceho mesiaca,

c)

do 30 po dodaní zoznam zariadení a ich častí určených ako náhradné dielce na opravy a rekonštrukcie.
...
do 30 dní po vypracovaní plán na kalendárny rok pre vykonávanie údržby, revízií, skúšok a kontrol zariadení,
...
K úspešne vykonanej skúške vydá orgán dozoru stanovisko.
...
stanovisko do 14 dní od úspešného vykonania skúšky podľa [§ 15](#paragraf-15).
...
Organizácie vykonávajúce činnosť podľa [§ 5](#paragraf-5), ktoré nemajú na túto činnosť oprávnenie vydané orgánom dozoru, sú povinné požiadať o vydanie oprávnenia do 6 mesiacov od nadobudnutia účinnosti tejto vyhlášky.
