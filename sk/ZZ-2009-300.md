...
zriaďovanie podrobných geodetických bodov podľa [§ 24](#paragraf-24).
...
Spôsob použitia bodov podrobného polohového bodového poľa na vybrané geodetické činnosti uvedené v [§ 6 písm. a), b) a c) zákona](../../../../SK/ZZ/1995/215/#paragraf-6.pismeno-a) ustanoví úrad vo všeobecne záväznom právnom predpise na vykonanie osobitného predpisu.[4a)](#poznamky.poznamka-4a) Na ostatné vybrané geodetické činnosti sa po určení novej národnej realizácie body podrobného polohového bodového poľa prestanú používať.
...
Podrobnosti o vyhotovení a obsahu výsledného operátu sú uvedené v [prílohe č. 1](#prilohy.priloha-priloha_c_1_k_vyhlaske_c_300_2009_z_z.oznacenie).
...
Konfiguráciu a štruktúru vytyčovacej siete navrhne autorizovaný geodet a kartograf v súlade s tvarom a charakterom stavby alebo súboru stavieb tak, aby boli určené súradnice a výšky bodov vytyčovacej siete v platných národných realizáciách záväzných geodetických systémov v súlade s [§ 2](#paragraf-2).
...
zoznam súradníc a výšok bodov aj v platnej národnej realizácii geodetického systému a ich geodetické údaje,
...
Výsledné elaboráty a operáty geodetických činností na vyhotovenie a vykonanie projektu pozemkových úprav podľa [§ 21 písm. d) až h)](#paragraf-21.pismeno-d) sa predkladajú na úradné overenie príslušnej správe katastra, a to najmenej v dvoch vyhotoveniach; jeden exemplár výsledných elaborátov a operátov zostáva v dokumentácii správy katastra.
...
Správa katastra pred úradným overením výsledkov vybraných geodetických a kartografických činností podľa [§ 6 písm. a), b)](../../../../SK/ZZ/1995/215/#paragraf-6.pismeno-a), [d) a e) zákona](../../../../SK/ZZ/1995/215/#paragraf-6.pismeno-d) preskúma súlad východiskových údajov s platnými údajmi katastra nehnuteľností a informačného systému geodetických základov ku dňu overenia. Správa katastra preskúma súlad označenia nových parciel s pridelenými parcelnými číslami, súlad čísel novourčených podrobných geodetických bodov s pridelenými číslami, súlad označenia záznamov podrobného merania zmien s pridelenými číslami.
...
Ak výsledný operát vybraných geodetických a kartografických činností uvedených v [§ 44](#paragraf-44) nie je spôsobilý na úradné overenie, správa katastra ho bez úradného overenia vráti navrhovateľovi spolu s protokolom o zistených nedostatkoch v lehotách uvedených v odsekoch 2 a 3.
