...
spôsob určenia nákladov na pripojenie k distribučnej sieti,[8a)](#poznamky.poznamka-8a)
...
závažná priemyselná havária,[14a)](#poznamky.poznamka-14a)
...
Zľava počas skúšobnej prevádzky sa uplatňuje najviac za obdobie troch mesiacov. Užívateľ distribučnej siete žiada o zľavu podľa [§ 5 ods. 5](#paragraf-5.odsek-5).

(5)

Výška dennej distribučnej kapacity a množstvo distribuovaného plynu sa na žiadosť užívateľa distribučnej siete predloženej v lehote podľa [§ 5 ods. 5](#paragraf-5.odsek-5) upraví v zmluve o distribúcii plynu do dvoch mesiacov po ukončení skúšobnej prevádzky.
...
Zaregistrovaná zmena dodávateľa plynu u prevádzkovateľa distribučnej siete nadobúda účinnosť k prvému plynárenskému dňu kalendárneho mesiaca, ktorý nasleduje po uplynutí siedmich dní od doručenia žiadosti o vykonanie zmeny dodávateľa plynu podľa [§ 20 ods. 2](#paragraf-20.odsek-2). Pre účastníkov trhu s plynom v odberných miestach s meraním typu C môže dôjsť k zmene dodávateľa plynu raz za šesť mesiacov.
...
Pri začatí dodávky plynu podľa záväzného diagramu dodávky plynu, pri ukončení dodávky plynu podľa záväzného diagramu dodávky plynu a pri zmene počtu dodávateľov plynu do odberného miesta sa postupuje podľa [§ 19 až 21](#paragraf-19).
...
Účastník trhu s plynom, ktorý je zodpovedný za odchýlku na základe dohody s koncovým odberateľom plynu, zasiela oznámenie záväzných diagramov dodávky plynu priradených k príslušnému odbernému miestu v čase nominácií podľa [§ 16](#paragraf-16) prevádzkovateľovi distribučnej siete.

(7)

Pri zmene dodávateľa plynu pri dodávke plynu zabezpečovanej viacerými dodávateľmi plynu do jedného odberného miesta podáva žiadosť o zmenu dodávateľa plynu prevádzkovateľovi distribučnej siete súčasne účastník trhu s plynom, ktorý si zabezpečuje dodávku plynu viacerými dodávateľmi plynu, a dodávateľ plynu, ktorý za odberné miesto prevzal zodpovednosť za odchýlku. Pri požiadavkách na meranie pri zmene dodávateľa plynu na dodávku plynu viacerými dodávateľmi plynu do jedného odberného miesta sa postupuje podľa [§ 21](#paragraf-21).
...
Ak absolútna hodnota výšky dennej odchýlky užívateľa distribučnej siete prevyšuje výšku povolenej dennej odchýlky podľa odseku 4 alebo odseku 5, užívateľ distribučnej siete je povinný zaplatiť poplatok za prekročenie povolenej dennej odchýlky vo výške 0,03 eura za každý 1 m^3 plynu, o ktorý bola prekročená povolená denná odchýlka.
