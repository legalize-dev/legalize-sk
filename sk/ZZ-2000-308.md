...
práva a povinnosti vysielateľa, prevádzkovateľa retransmisie, poskytovateľa audiovizuálnej mediálnej služby na požiadanie a právnických osôb alebo fyzických osôb uvedených v [§ 2 ods. 3 a 4](#paragraf-2.odsek-3).
...
Ak osobnú pôsobnosť tohto zákona nie je možné určiť podľa [§ 2 ods. 3 a 4](#paragraf-2.odsek-2), je daná právomoc členského štátu Európskej únie, v ktorom je vysielateľ alebo poskytovateľ audiovizuálnej mediálnej služby na požiadanie usadený podľa osobitného predpisu.[2)](#poznamky.poznamka-2)
...
štatistiky o odvysielaných programoch, štatistiky televízneho vysielania európskych diel a nezávislej produkcie, štatistiky rozhlasového vysielania slovenských hudobných diel a štatistiky podielu európskych diel v oblasti poskytovania audiovizuálnych mediálnych služieb na požiadanie a ich vyhodnotenie [[§ 5 ods. 1 písm. l)](#paragraf-5.odsek-1.pismeno-l)],
...
Vysielanie bez udelenej licencie sa zakazuje; to sa nevzťahuje na analógové vysielanie osôb podľa [§ 2 ods. 3 a 4](#paragraf-2.odsek-3), a na analógové vysielanie vysielateľa na základe zákona a vysielanie prostredníctvom internetu.
...
viesť štatistiku o odvysielaných programoch rozhlasovej programovej služby obsahujúcu vyhodnotenie podielu slovenských hudobných diel; štatistiku o programovej službe za kalendárny mesiac je vysielateľ povinný doručiť rade do 15 dní po skončení príslušného kalendárneho mesiaca okrem vysielateľa s licenciou udelenou podľa tohto zákona na iné ako terestriálne vysielanie, ktorý je povinný doručiť štatistiku do 15 dní odo dňa doručenia žiadosti rady o túto štatistiku. To sa nevzťahuje na vysielateľa rozhlasovej programovej služby podľa [§ 28d](#paragraf-28d).
...
Povinnosti podľa odseku 1 sa nevzťahujú na prevádzkovateľa retransmisie, ktorý poskytuje retransmisiu bez registrácie retransmisie v súlade s [§ 56 ods. 5 písm. a)](#paragraf-56.odsek-5.pismeno-a), [b)](#paragraf-56.odsek-5.pismeno-b), [d)](#paragraf-56.odsek-5.pismeno-d) alebo [písm. e)](#paragraf-56.odsek-5.pismeno-e). Povinnosti podľa odseku 1 písm. f) až h) sa nevzťahujú na prevádzkovateľa retransmisie, ktorý poskytuje retransmisiu bez registrácie retransmisie v súlade s [§ 56 ods. 5 písm. c)](#paragraf-56.odsek-5.pismeno-c). Povinnosti podľa odseku 1 písm. a) a b) sa vzťahujú len na prevádzkovateľa káblovej retransmisie.
...
Podiel programov podľa [§ 18 a 18a](#paragraf-18) sa určí ako podiel vysielacieho času z celkového vysielacieho času programov za kalendárny mesiac.
...
Vysielateľ je povinný poskytovať rade na požiadanie údaje potrebné na kontrolu plnenia povinností podľa [§ 18 a 18a](#paragraf-18), a to
...
Poskytovateľ audiovizuálnej mediálnej služby na požiadanie je na účel kontroly plnenia povinností podľa [§ 18b](#paragraf-18b) povinný poskytovať rade na požiadanie zoznam poskytovaných programov sprevádzaných titulkami pre osoby so sluchovým postihnutím, hlasovým komentovaním pre nevidiacich, tlmočených do posunkovej reči nepočujúcich, v posunkovej reči nepočujúcich s uvedením dátumu a času ich zaradenia v rámci poskytovanej audiovizuálnej mediálnej služby na požiadanie.
...
štatistiku podľa [§ 16 ods. 4](#paragraf-16.odsek-4),
...
Ustanovenia [§ 27a](#paragraf-27a) sa nevzťahujú na audiovizuálne mediálne služby na požiadanie, pri ktorých je určenie podielu európskych diel zameraním audiovizuálnej mediálnej služby na požiadanie úplne vylúčené.
...
Vysielateľ rozhlasovej programovej služby je povinný poskytovať rade na požiadanie údaje potrebné na kontrolu plnenia povinností podľa [§ 28b](#paragraf-28b), a to
...
výzve na pozorné prečítanie poučenia o správnom použití lieku obsiahnutého v písomnej informácii pre používateľov liekov pribalenej k lieku a odporúčaniu poradiť sa o použití lieku s osobou oprávnenou predpisovať lieky alebo vydávať lieky, ktoré sú vysielané v rozhlasovom vysielaní podľa [§ 33 ods. 4.](#paragraf-33.odsek-4)
...
Sponzorom programu alebo programovej služby nesmie byť právnická osoba ani fyzická osoba, ktorej hlavnou činnosťou je výroba, predaj alebo nájom tovarov, alebo poskytovanie služieb, ktorých reklama sa zakazuje podľa [§ 33 ods. 3](#paragraf-33.odsek-3) a 6. Osoba, ktorej hlavnou činnosťou je výroba, predaj alebo nájom tovarov, alebo poskytovanie služieb, ktorých reklama sa obmedzuje podľa § 33 ods. 1 a [§ 32 ods. 6](#paragraf-32.odsek-6), nesmie byť sponzorom programu alebo programovej služby vysielanej počas tohto obmedzenia.
...
nespĺňa náležitosti podľa [§ 46 ods. 1 až 3](#paragraf-46.odsek-1) a [5](#paragraf-46.odsek-6) a v lehote určenej radou nenastala náprava,

c)

nespĺňa kritériá a podmienky podľa [§ 47 ods. 1](#paragraf-47.odsek-1), ktoré rada posudzuje a je povinná na ne prihliadať,
...
podmienky označovania programov na základe ich klasifikácie podľa vekovej vhodnosti ([§ 20 ods. 3](#paragraf-20.odsek-3)),
...
licencia má byť prevedená alebo má prejsť na osobu, ktorá nespĺňa podmienky podľa [§ 45 ods. 2 až 4](#paragraf-45.odsek-2),
...
uplynutím 60 dní odo dňa, keď vysielateľ s licenciou, ktorý je právnickou osobou, mal podať návrh na zápis do obchodného registra podľa [§ 45 ods. 2](#paragraf-45.odsek-2) a neurobil tak,
...
ak bez súhlasu rady nastali skutočnosti podľa [§ 50 ods. 2 a 3](#paragraf-50.odsek-2).
...
žiadateľ o registráciu retransmisie nespĺňa predpoklady uvedené v [§ 56 ods. 2 až 4](#paragraf-56.odsek-2),
...
ak prevádzkovateľ retransmisie, ktorý je právnickou osobou, nepodal návrh na zápis do obchodného registra do 60 dní odo dňa nadobudnutia právoplatnosti rozhodnutia o registrácii retransmisie,

d)

ak prevádzkovateľ retransmisie, ktorý je právnickou osobou, nepodal návrh na zápis prevádzkovania retransmisie do predmetu svojej činnosti v obchodnom registri do 60 dní odo dňa nadobudnutia právoplatnosti rozhodnutia o registrácii retransmisie,
...
údaje podľa [§ 16 ods. 1 písm. b) a c)](#paragraf-16.odsek-1.pismeno-b),
...
Sankciu podľa odseku 1 písm. d) rada uloží, ak vysielateľ, prevádzkovateľ retransmisie, poskytovateľ audiovizuálnej mediálnej služby na požiadanie alebo právnická osoba alebo fyzická osoba podľa [§ 2 ods. 3 a 4](#paragraf-2.odsek-3) aj napriek písomnému upozorneniu rady opakovane porušila povinnosť. Rada uloží pokutu bez predchádzajúceho upozornenia, ak bola porušená povinnosť uložená v [§ 19](#paragraf-19). Rada môže uložiť pokutu aj bez predchádzajúceho upozornenia, ak bola porušená povinnosť uložená v [§ 16 ods. 2 písm. a)](#paragraf-16.odsek-2.pismeno-c) a [c)](#paragraf-16.odsek-2.pismeno-c), [ods. 3 písm. k)](#paragraf-16.odsek-3.pismeno-k), [§ 20 ods. 1](#paragraf-20.odsek-1) a [4](#paragraf-20.odsek-4), [§ 30](#paragraf-30), ako aj v prípade vysielania bez oprávnenia [[§ 2 ods. 1 písm. b)](#paragraf-2.odsek-1.pismeno-b)] alebo prevádzkovania retransmisie bez oprávnenia [[§ 2 ods.1 písm. e)](#paragraf-2.odsek-1.pismeno-e)].
...
nesplnil povinnosti ustanovené v [§ 17 ods.1 písm. a) až d)](#paragraf-17.odsek-1.pismeno-a), [h)](#paragraf-17.odsek-1.pismeno-h) a [i)](#paragraf-17.odsek-1.pismeno-i) a [ods. 8](#paragraf-17.odsek-8),

b)

neoznámil zmenu údajov uvedených v žiadosti o registráciu retransmisie v určenej lehote podľa [§ 60 ods. 1](#paragraf-60.odsek-1), [8 a 9](#paragraf-60.odsek-8),
...
nesplnil povinnosť podľa [§ 16 ods. 3 písm. l)](#paragraf-16.odsek-3.pismeno-l),

b)

nezabezpečil označenie programovej služby, ktorú vysiela [[§ 16 ods. 3 písm. f) a g)](#paragraf-16.odsek-3.pismeno-f)],
...
nesplnil povinnosť podľa [§ 16 ods. 3 písm. m)](#paragraf-16.odsek-3.pismeno-m) alebo [písm. o)](#paragraf-16.odsek-3.pismeno-o),
...
neposkytol rade údaje o odvysielaní európskych diel a nezávislej produkcie ([§ 27](#paragraf-27)) alebo údaje o odvysielaní slovenských hudobných diel ([§ 28c](#paragraf-28c)),
...
nesplnil povinnosť zaradiť do vysielania ustanovený podiel európskych diel ([§ 23](#paragraf-23)), nezávislej produkcie ([§ 25](#paragraf-25)) alebo slovenských hudobných diel ([§ 28b](#paragraf-28b)),
...
nezabezpečil klasifikáciu a označenie programov alebo iných zložiek programovej služby ([§ 20 ods. 3](#paragraf-20.odsek-3)),
...
nesplnil povinnosť podľa [§ 18d ods. 3](#paragraf-18d.odsek-3).
...
nezohľadnil vekovú vhodnosť programov a iných zložiek programovej služby pre maloletých a nezabezpečil ich časové zaradenie v súlade s podmienkami ustanovenými osobitným predpisom[28a)](#poznamky.poznamka-28a) ([§ 20 ods. 4](#paragraf-20.odsek-4)),
...
nezabezpečil, aby zvuková zložka ním vysielanej programovej služby bola v súlade s ustanovenými technickými požiadavkami [[§ 16 ods. 3 písm. n)](#paragraf-16.odsek-3.pismeno-n)].
...
Rada uloží pokutu od 1 659 eur do 165 969 eur osobám podľa [§ 2 ods. 3 a 4](#paragraf-2.odsek-2), ak porušia povinnosti uložené týmto zákonom.
...
nesplnil povinnosť podľa [§ 16 ods. 1](#paragraf-16.odsek-1) alebo [§ 63a ods. 1 a 2](#paragraf-63a.odsek-1),
...
nesplnil povinnosť podľa [§ 16 ods. 3 písm. m)](#paragraf-16.odsek-3.pismeno-m),
...
nesplnil povinnosť podľa [§ 76dc ods. 3](#paragraf-76dc.odsek-3).
...
porušil podmienky na vysielanie významných podujatí ([§ 31](#paragraf-31)) alebo porušil povinnosť neprerušovať program iným vysielaním [[§ 16 ods. 3 písm. i)](#paragraf-16.odsek-3.pismeno-j)],
...
porušil podmienky na vysielanie programových služieb vyhradených na vlastnú propagáciu alebo na reklamu a telenákup ([§ 40 a 41](#paragraf-40)).
...
vysiela programy a iné zložky programovej služby, ktorých obsah je v rozpore s povinnosťami podľa [§ 19 alebo § 20 ods. 1](#paragraf-19),
...
nesplnil povinnosť podľa [§ 63a ods. 1 a 2](#paragraf-63a.odsek-1),
...
nezabezpečil klasifikáciu a označenie programov ([§ 20 ods. 3](#paragraf-20.odsek-3)) v rámci katalógu programov jeho audiovizuálnej mediálnej služby na požiadanie,

e)

nevedie štatistiku o podiele európskych diel na celkovom čase všetkých programov ponúkaných v katalógu programov za kalendárny mesiac ([§ 16 ods. 4](#paragraf-16.odsek-4)),

f)

nesplnil povinnosť podľa [§ 27a ods. 1](#paragraf-27a.odsek-1),

g)

nesplnil povinnosť podľa [§ 27a ods. 3](#paragraf-27a.odsek-3),
...
Ak vysielateľ aj napriek uloženým sankciám opakovane úmyselne a závažným spôsobom porušuje povinnosti ustanovené v [§ 19 ods. 1 písm. b) alebo c)](#paragraf-19.odsek-1.pismeno-b), rada mu odníme licenciu.
...
O požiadavkách vysielateľa na základe zákona nad rámec [§ 69](#paragraf-69) na frekvencie na analógové terestriálne vysielanie rozhlasovej programovej služby rozhoduje rada vo výberovom konaní, na ktoré sa primerane vzťahuje [§ 48](#paragraf-48).
...
v období najmenej dvoch rokov, odkedy je možné frekvenciu prideliť, o frekvenciu neprejavil záujem žiaden vysielateľ na základe licencie ani iný žiadateľ o licenciu najmenej v troch po sebe nasledujúcich výberových konaniach o frekvencie podľa [§ 48](#paragraf-48).
...
Na konanie podľa tohto zákona sa vzťahuje všeobecný predpis o správnom konaní[49)](#poznamky.poznamka-49) okrem ustanovení [§ 23 v časti nesprístupnenia zápisníc o hlasovaní](../../../../SK/ZZ/1967/71/#paragraf-23) a [§ 49](../../../../SK/ZZ/1967/71/#paragraf-49), [53, 54](../../../../SK/ZZ/1967/71/#paragraf-53), [56 až 68 zákona o správnom konaní](../../../../SK/ZZ/1967/71/#paragraf-56).
...
Splnenie podmienok podľa [§ 45 ods. 4](#paragraf-45.odsek-4) a [§ 56 ods. 4](#paragraf-56.odsek-4) overuje podľa osobitného predpisu[50d)](#poznamky.poznamka-50d) rada.
...
Podiely podľa [§ 18 ods. 3](#paragraf-18.odsek-2) alebo [§ 18b](#paragraf-18b) nie je vysielateľ povinný dosiahnuť pred uplynutím troch rokov odo dňa, v ktorom začal svoju programovú službu vysielať digitálne; to sa nevzťahuje na vysielateľov, ktorí začnú vysielať svoju programovú službu digitálne po 31. máji 2009.
...
Vysielateľ prostredníctvom internetu a poskytovateľ audiovizuálnej mediálnej služby na požiadanie, ktorý vysiela alebo poskytuje audiovizuálnu mediálnu službu na požiadanie k 15. decembru 2009, je povinný splniť povinnosť podľa [§ 63a](#paragraf-63) do 28. februára 2010.

##### § 76dd

##### Prechodné ustanovenia k úpravám účinným od 1. septembra 2011

Žiadosť o odvysielanie opravy ([§ 21](#paragraf-21)) týkajúca sa údaja, ktorý bol odvysielaný pred 1. septembrom 2011, sa posudzuje podľa predpisov účinných do 31. augusta 2011.

##### § 76de

##### Prechodné ustanovenie k úprave účinnej od 1. januára 2014

Ak žiadateľ podáva žiadosť o licenciu od 1. januára 2014 do 31. januára 2014, považuje sa povinnosť podľa [§ 46 ods. 5](#paragraf-46.odsek-5) za splnenú, aj ak je účtovná závierka prílohou k žiadosti o licenciu.
...
Do podielu programov sprevádzaných titulkami pre osoby so sluchovým postihnutím podľa § 18 ods. 2 písm. a) a [§ 18a písm. a)](#paragraf-18a.pismeno-a) možno v období od 1. januára 2016 do 31. decembra 2021 započítať aj program sprevádzaný titulkami, ktoré nie sú titulkami pre osoby so sluchovým postihnutím podľa [§ 18aa](#paragraf-18aa), ale spĺňajú podmienky uvedené v [§18aa ods. 1 písm. a) a b)](#paragraf-18aa.odsek-1.pismeno-a) a zároveň približujú ostatné zvuky obsiahnuté v programe spôsobom, ktorý osobám so sluchovým postihnutím umožňuje porozumieť jeho obsahu, ak bol prvýkrát odvysielaný na území Slovenskej republiky pred 1. januárom 2016. V období od 1. januára 2016 do 31. decembra 2021 môžu programy sprevádzané titulkami podľa prvej vety tvoriť najviac 25 % z celkového podielu programov sprevádzaných titulkami pre osoby so sluchovým postihnutím.
...
Ustanovenia [§ 31a ods. 8](#paragraf-31a.odsek-8), [§ 39 ods. 7](#paragraf-39.odsek-7) a [§ 39a ods. 7](#paragraf-39a.odsek-7) v znení účinnom od 20. mája 2016 sa nevzťahujú na programy vyrobené pred 20. májom 2016.
...
Podľa [§ 69a](#paragraf-69a) sa postupuje aj v konaní začatom pred účinnosťou tohto zákona, ktoré nebolo právoplatne skončené.

##### § 76dn

##### Prechodné ustanovenie účinné dňom vyhlásenia

Konania o udelenie alebo zmenu licencie na rozhlasové terestriálne vysielanie podľa ustanovenia [§ 48](#paragraf-48), ktoré sa začali podľa doterajších právnych predpisov a ktoré sa ku dňu nadobudnutia účinnosti tohto zákona neskončili, sa týmto dňom prerušujú do ukončenia núdzového stavu vyhláseného v súvislosti s ochorením COVID-19 (ďalej len „núdzový stav“). Lehoty podľa tohto zákona v čase prerušenia konania neplynú; lehoty určené radou podľa [§ 48](#paragraf-48) sa predlžujú o čas trvania núdzového stavu, lehota na predkladanie žiadostí však neuplynie skôr než na 45. deň odo dňa skončenia núdzového stavu.
...
V konaní prerušenom podľa [§ 76dn](#paragraf-76dn) určí rada nový termín verejného vypočutia tak, aby sa verejné vypočutie uskutočnilo do 31. marca 2021; druhá veta [§ 76dn](#paragraf-76dn) sa neuplatňuje na lehoty určené radou podľa [§ 48](#paragraf-48), ktoré uplynuli do dňa účinnosti [§ 76dn](#paragraf-76dn).

##### § 76e

Týmto zákonom sa preberajú právne záväzné akty Európskej únie uvedené v [prílohe](#prilohy.priloha-priloha_k_zakonu_c_308_2000_z_z.oznacenie).
