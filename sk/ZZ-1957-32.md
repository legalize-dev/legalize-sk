...
Slobodnému, ovdovenému alebo rozvedenému (rozlúčenému) vojakovi z povolania a príslušníkovi bezpečnostného zboru, ktorý neplní voči nikomu vyživovaciu povinnosť, náleží po uplynutí jedného mesiaca neschopnosti na službu za dni, keď je v ústavnom ošetrovaní alebo keď je mu poskytované kúpeľné liečenie mimo riadnej dovolenky, len polovica nemocenského, prípadne služobného príjmu ([§ 15 ods. 2](#paragraf-15.odsek-2)), určeného podľa predchádzajúcich ustanovení.
