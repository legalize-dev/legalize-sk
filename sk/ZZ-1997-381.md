...
Iným dokladom je doklad, ktorý sa na základe medzinárodnej zmluvy[3)](#poznamky.poznamka-3) považuje za cestovný doklad. Iným dokladom na vycestovanie občana do členského štátu Európskej únie alebo iného zmluvného štátu Dohody o európskom hospodárskom priestore je aj občiansky preukaz, ak ho tento štát uznal ako cestovný doklad.
...
Cestovný doklad sa vydáva na základe žiadosti. Vydanie cestovného dokladu podľa [§ 14a](#paragraf-14a) je bezplatné. V ostatných prípadoch sa vydanie cestovného dokladu spoplatňuje podľa osobitného predpisu.[5)](#poznamky.poznamka-5)
...
V cestovnom doklade možno vykonať zmeny údajov o zápise občana mladšieho ako 15 rokov do cestovného dokladu rodiča, ak tým cestovným dokladom je cestovný pas, diplomatický pas, služobný pas, cestovný preukaz alebo cestovný doklad cudzinca. Zmenu v časovej platnosti cestovného dokladu možno vykonať, ak je tým cestovným dokladom cestovný doklad cudzinca.
...
štátna príslušnosť; to sa nevzťahuje na cestovný doklad cudzinca,
