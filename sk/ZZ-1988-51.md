...
geologický prieskum ložísk vyhradených nerastov (ďalej len „výhradné ložisko"),[1)](#poznamky.poznamka-1)
...
Banskú činnosť uvedenú v [§ 2 písm. b) až h)](#paragraf-2.pismeno-b) a činnosť vykonávanú banským spôsobom uvedenú v [§ 3 písm. a)](#paragraf-3.text) s výnimkou geologického prieskumu ložísk nevyhradených nerastov možno vykonávať len na základe oprávnenia vydaného rozhodnutím obvodného banského úradu (ďalej len „banské oprávnenie").
...
prestal spĺňať niektorú z podmienok uvedených v [§ 4a ods. 2](#paragraf-4a.odsek-2),
...
závažným spôsobom porušuje povinnosti vyplývajúce z tohto zákona a z predpisov uvedených v [§ 39 ods. 1](#paragraf-39.odsek-1),
...
Organizácii, ktorej bolo banské oprávnenie zrušené podľa odseku 4, obvodný úrad odníme dobývací priestor a na základe výberového konania podľa osobitného predpisu[3i)](#poznamky.poznamka-3i) ho pridelí inej organizácii.
...
vybrané banské stroje, zariadenia, prístroje a pomôcky, ktoré nie sú určenými výrobkami podľa osobitného predpisu,[3c)](#poznamky.poznamka-3c) a postup pri ich povoľovaní,

b)

postup pri určovaní podmienok používania vybraných banských strojov, zariadení, prístrojov a pomôcok, ktoré sú určenými výrobkami podľa osobitného predpisu,[3c)](#poznamky.poznamka-3c)
...
Výbušninami podľa tohto zákona sú látky a predmety, ktoré sa považujú za výbušné v I. triede podľa osobitného predpisu.[13b)](#poznamky.poznamka-13b)
...
Výbušniny a pomôcky sa uvádzajú na trh podľa podmienok ustanovených osobitným predpisom.[13d)](#poznamky.poznamka-13d)
...
##### Preprava, prenášanie a prevoz výbušnín
...
pyrotechnických výrobkov určených na ohňostrojné práce, na ktoré sa vyžaduje osobitné povolenie podľa [§ 27 ods. 1](#paragraf-27.odsek-1),

f)

bezdymového prachu alebo čierneho poľovníckeho prachu, ak sa majú použiť na trhacie práce alebo na ohňostrojné práce, na ktoré sa vyžaduje osobitné povolenie podľa [§ 27 ods. 1](#paragraf-27.odsek-1).

(6)

Orgánom príslušným na vydanie povolenie na prevoz výbušnín podľa osobitného predpisu[13e)](#poznamky.poznamka-13e) je

a)

pri prevoze na území Slovenskej republiky obvodný banský úrad príslušný na povolenie trhacích prác alebo ohňostrojných prác podľa [§ 27 ods. 1](#paragraf-27.odsek-1), pri ktorých sa má výbušnina určená na prevoz použiť,
...
Ak organizácia súčasne so žiadosťou o vydanie povolenia na odber výbušnín podľa [§ 25 ods. 1](#paragraf-25.odsek-1) žiada aj o vydanie povolenia na prevoz výbušnín, obvodný banský úrad rozhodne o oboch žiadostiach v jednom spoločnom konaní a jedným rozhodnutím.
...
Predávať, nadobúdať a používať možno len tie pyrotechnické výrobky, ktoré boli uvedené na trh podľa osobitného predpisu.[15)](#poznamky.poznamka-15) Pyrotechnické výrobky sa môžu používať len v súlade s návodom na ich používanie.

(2)

Na predaj pyrotechnických výrobkov sa vzťahujú osobitné predpisy.[16)](#poznamky.poznamka-16)

(3)

Pyrotechnické výrobky na zábavné a oslavné účely sa zaraďujú podľa stupňa nebezpečenstva do tried I, II, III a IV. Pyrotechnické výrobky na technické účely sa zaraďujú podľa stupňa nebezpečenstva do podtried T0, T1 a T2. Parametre na zaradenie pyrotechnických výrobkov do tried a podtried ustanovuje osobitný predpis.[16a)](#poznamky.poznamka-16a)
...
Pyrotechnické výrobky triedy III a IV a podtriedy T2 môžu nadobúdať a používať len osoby s oprávnením odpaľovača ohňostrojov podľa [§ 35](#paragraf-35).

(9)

Na prepravu pyrotechnických výrobkov sa vzťahujú osobitné predpisy.[14)](#poznamky.poznamka-14)
...
Ničiť a zneškodňovať výbušniny pri ich výrobe alebo spracúvaní vrátane výskumu, vývoja, pokusnej výroby a vyhľadávať nevybuchnutú muníciu môžu len osoby staršie ako 21 rokov, ktoré majú oprávnenie pyrotechnika.
...
Ustanovenia [§ 21 až 36](#paragraf-21)sa nevzťahujú na používanie výbušnín, pyrotechnických výrobkov a pomôcok v ozbrojených silách, v ozbrojených bezpečnostných zboroch a v Hasičskom a záchrannom zbore.
...
Ministerstvo hospodárstva Slovenskej republiky riadi činnosť obvodných banských úradov a rozhoduje o odvolaniach proti ich rozhodnutiam.
...
povoľujú sprístupňovanie banských diel pre muzeálne účely a práce na ich udržiavaní v bezpečnom stave, osobitné zásahy do zemskej kôry a zabezpečenie alebo likvidáciu starých banských diel,
...
Úlohy štátnej banskej správy na úseku hlavného dozoru vykonáva Ministerstvo hospodárstva Slovenskej republiky ústrednými banskými inšpektormi a obvodné banské úrady obvodnými banskými inšpektormi (ďalej len „banský inšpektor“). Banských inšpektorov ustanovuje predseda Hlavného banského úradu.
...
Hlavný banský úrad a obvodné banské úrady uložia pokutu až do 1 000 000 Sk organizácii, ktorá porušila predpisy uvedené v [§ 39 ods. 1](#paragraf-39.odsek-1)alebo ktorá nesplnila opatrenia uložené jej rozhodnutím orgánu štátnej banskej správy (ďalej len „porušenie povinnosti“).
...
Hlavný banský úrad a obvodné banské úrady uložia pokutu až do 10 000 Sk zamestnancovi organizácie, ktorý zavinene porušil závažné povinnosti vyplývajúce z predpisov uvedených v [§ 39 ods. 1](#paragraf-39.odsek-1)alebo ktorý zatajil skutočnosti dôležité pre výkon hlavného dozoru.
...
Všeobecné predpisy o správnom konaní[21)](#poznamky.poznamka-21) sa nevzťahujú na konanie podľa [§ 4](#paragraf-4), [8](#paragraf-8), [§ 24, 25](#paragraf-24) a [§ 40 ods. 5 písm. b)](#paragraf-40.odsek-5.pismeno-b).
