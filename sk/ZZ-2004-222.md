...
je vymáhaná v exekučnom konaní[6aca)](#poznamky.poznamka-6aca) a v priebehu 12 mesiacov od začatia exekučného konania nebola uspokojená, a to dňom, ktorý nasleduje po uplynutí 12 mesiacov od začatia exekučného konania, a v rozsahu, v akom nebola uspokojená,
...
by dovoz takého tovaru bol oslobodený od dane podľa [§ 48 ods. 1](#paragraf-48.odsek-1) a [2](#paragraf-48.odsek-2) a [ods. 4 až 9](#paragraf-48.odsek-4) a [13](#paragraf-48.odsek-13) alebo
...
Ak po skončení zdaňovacieho obdobia, v ktorom platiteľ uplatnil odpočítanie dane, nastane skutočnosť podľa [§ 25a ods. 2 písm. a) až c)](#paragraf-25a.odsek-2.pismeno-a) a [f)](#paragraf-25a.odsek-2.pismeno-f) a [g)](#paragraf-25a.odsek-2.pismeno-g) a platiteľ dostal doklad o oprave základu dane podľa [§ 25a ods. 7 písm. a)](#paragraf-25a.odsek-7.pismeno-a), je platiteľ povinný opraviť odpočítanú daň v tom zdaňovacom období, v ktorom dostal tento doklad. Pri oprave odpočítanej dane platiteľ zohľadní pomerné odpočítanie dane a vykonané úpravy odpočítanej dane.

(2)

Ak po oprave odpočítanej dane podľa odseku 1 nastane akákoľvek skutočnosť, na základe ktorej je dodávateľ povinný vykonať opravu zníženého základu dane podľa [§ 25a ods. 6](#paragraf-25a.odsek-6) a platiteľ dostal doklad o oprave základu dane podľa [§ 25a ods. 7 písm. b)](#paragraf-25a.odsek-7.pismeno-b), má platiteľ právo opraviť opravenú odpočítanú daň. Opravu opravenej odpočítanej dane podľa prvej vety platiteľ vykoná v tom zdaňovacom období, v ktorom dostal doklad podľa prvej vety. Pri oprave opravenej odpočítanej dane platiteľ zohľadní pomerné odpočítanie dane a vykonané úpravy odpočítanej dane; ak platiteľ opravil odpočítanú daň podľa odseku 1 z dôvodu, že za dodanie tovaru alebo služby úplne nezaplatil, zohľadní aj úpravy odpočítanej dane, ktoré by bol povinný vykonať, ak by neopravil odpočítanú daň podľa odseku 1.

(3)

Ak platiteľ opravil odpočítanú daň podľa odseku 1 alebo opravil opravenú odpočítanú daň podľa odseku 2, zohľadní tieto opravy pri úprave odpočítanej dane podľa [§ 54](#paragraf-54), [§ 54a](#paragraf-54a) alebo podľa [§ 54d](#paragraf-54d).

(4)

Platiteľ je povinný uviesť opravu odpočítanej dane podľa odseku 1 a opravu opravenej odpočítanej dane podľa odseku 2 v záznamoch podľa [§ 70 ods. 2 písm. j)](#paragraf-70.odsek-2.pismeno-j).
...
oprave odpočítanej dane podľa [§ 53](#paragraf-53), [§ 53a](#paragraf-53a) a [§ 53b ods. 1](#paragraf-53b.odsek-1) a oprave opravenej odpočítanej dane podľa [§ 53b ods. 2.](#paragraf-53b.odsek-2)
...
Do 25 dní po skončení každého zdaňovacieho obdobia je povinný podať daňové priznanie každý platiteľ okrem platiteľa registrovaného podľa [§ 5](#paragraf-5), ktorý je povinný podať daňové priznanie, ak mu vznikla v zdaňovacom období povinnosť platiť daň, ak v zdaňovacom období dodal tovar oslobodený od dane podľa [§ 43](#paragraf-43) alebo [§ 47](#paragraf-47), dodal tovar podľa [§ 45](#paragraf-45), nadobudol tovar s oslobodením od dane podľa [§ 44](#paragraf-44) alebo ak uplatňuje odpočítanie dane. Platiteľ je povinný zaplatiť vlastnú daňovú povinnosť do 25 dní po skončení zdaňovacieho obdobia.
...
Pri oprave odpočítanej dane a oprave opravenej odpočítanej dane podľa [§ 53b](#paragraf-53b) sa v kontrolnom výkaze uvádzajú tieto údaje:
...
Ak platiteľ opraví základ dane alebo zmení výšku dane pri tovare alebo službe, ktoré dodal osobe, ktorá prestala byť platiteľom, je táto osoba povinná vrátiť daňovému úradu odpočítanú daň alebo jej pomernú časť viažucu sa na vykonanú opravu základu dane, ak táto suma dane nebola zahrnutá v daňovej povinnosti podľa odseku 5. Odpočítanú daň alebo jej pomernú časť vráti do desiatich dní odo dňa vyhotovenia faktúry alebo odo dňa prijatia opravného dokladu podľa [§ 25a ods. 7 písm. a)](#paragraf-25a.odsek-7.pismeno-a).
