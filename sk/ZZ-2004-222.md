...
Daňový úrad je povinný osobu podľa odseku 1 alebo 2 registrovať pre daň, vydať jej osvedčenie o registrácii pre daň a prideliť jej identifikačné číslo pre daň najneskôr do siedmich dní odo dňa doručenia žiadosti o registráciu pre daň; ak zdaniteľná osoba má identifikačné číslo pre daň na účely uplatňovania osobitnej úpravy podľa [§ 68b ods. 2](#paragraf-68b.odsek-2), daňový úrad jej pridelí to isté identifikačné číslo pre daň.
...
Ak po oprave odpočítanej dane podľa odseku 1 nastane akákoľvek skutočnosť, na základe ktorej je dodávateľ povinný vykonať opravu zníženého základu dane podľa [§ 25a ods. 6](#paragraf-25a.odsek-6) a platiteľ dostal doklad o oprave základu dane podľa [§ 25a ods. 7 písm. b)](#paragraf-25a.odsek-7.pismeno-b), má platiteľ právo opraviť opravenú odpočítanú daň. Opravu opravenej odpočítanej dane podľa prvej vety platiteľ vykoná v tom zdaňovacom období, v ktorom dostal doklad podľa prvej vety.
...
Daňový úrad doručuje zdaniteľnej osobe, ktorá uplatňuje osobitnú úpravu podľa [§ 68a](#paragraf-68a), [§ 68b](#paragraf-68b) alebo [§ 68c](#paragraf-68c), písomnosti týkajúce sa uplatňovania osobitnej úpravy elektronickými prostriedkami; písomnosti sa doručujú na elektronickú adresu uvedenú v oznámení o začatí činnosti a za deň doručenia sa považuje deň odoslania dátovej správy.
...
je fyzickou osobou pokračujúcou v živnosti po úmrtí platiteľa podľa [§ 83](#paragraf-83), a to posledným dňom posledného zdaňovacieho obdobia, v ktorom sa skončí konanie o dedičstve,
