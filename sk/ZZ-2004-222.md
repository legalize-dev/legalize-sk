...
prepravné služby, ktoré sú oslobodené od dane podľa [§ 46](#paragraf-46),
...
Miestom dodania kultúrnych, umeleckých, športových, vedeckých, výchovných, vzdelávacích, zábavných a podobných služieb vrátane ich organizovania a služieb s nimi súvisiacich je miesto, kde sa tieto služby fyzicky vykonajú.
...
Oslobodené od dane je dodanie stavby alebo jej časti vrátane dodania stavebného pozemku,[19)](#poznamky.poznamka-19) na ktorom stavba stojí, ak je dodanie uskutočnené po piatich rokoch od prvej kolaudácie stavby, na základe ktorej bolo povolené užívanie stavby alebo po piatich rokoch odo dňa začatia prvého užívania stavby; platiteľ sa môže rozhodnúť, že dodanie uvedenej nehnuteľnosti nebude oslobodené od dane.
...
Platiteľ, ktorý kupuje osobné automobily, a to aj formou zmluvy podľa [§ 8 ods. 1 písm. c)](#paragraf-8.odsek-1.pismeno-c) na účely ich ďalšieho predaja alebo nájmu, a kúpa a predaj osobných automobilov a nájom osobných automobilov je predmetom podnikania platiteľa, môže odpočítať daň pri ich kúpe, ako aj pri kúpe tovaru tvoriaceho ich príslušenstvo vrátane montáže.
...
prepravných služieb, ktoré sú oslobodené od dane podľa [§ 46](#paragraf-46),

2.

prepravných služieb a s nimi súvisiacich doplnkových služieb, ktoré sú oslobodené od dane podľa [§ 47 ods. 6](#paragraf-47.odsek-6) a [§ 48 ods. 8](#paragraf-48.odsek-8),

3.

služieb a tovaru dodaného s inštaláciou alebo montážou, ak je osobou povinnou platiť daň príjemca ([§ 69 ods. 2 až 4](#paragraf-69.odsek-2)),

4.

dodania zemného plynu a elektriny, ak je osobou povinnou platiť daň platiteľ alebo osoba registrovaná pre daň podľa [§ 7](#paragraf-7) ([§ 69 ods. 9](#paragraf-69.odsek-9)),

5.

dodania tovaru z tuzemska do iného členského štátu, ktorý bol dovezený z tretieho štátu, ak zahraničná osoba bola zastúpená daňovým zástupcom podľa [§ 69a](#paragraf-69a),

6.

dodania tovaru v rámci trojstranného obchodu podľa [§ 45](#paragraf-45), na ktorom sa zahraničná osoba zúčastnila ako prvý odberateľ,

d)

daň by bola odpočítateľná podľa [§ 49](#paragraf-49).
...
originál faktúry vyhotovenej platiteľom, v ktorej je uvedená suma dane v eurách, a v prípade dovozu tovaru príslušný dovozný doklad a doklad preukazujúci platbu dane,
...
Ak Daňový úrad Bratislava I rozhodne o vrátení dane, vráti daň v lehote na rozhodnutie o žiadosti podľa odseku 1. Daň vráti v eurách na účet vedený v banke v tuzemsku alebo na náklady zahraničnej osoby na účet vedený v banke v zahraničí; daň môže vrátiť aj prostredníctvom zástupcu zahraničnej osoby, ak zástupca predloží daňovému úradu plnomocenstvo na zastupovanie zahraničnej osoby.
...
Platiteľ alebo osoba registrovaná pre daň podľa [§ 7](#paragraf-7), ktorej je dodaný tovar podľa [§ 13 ods. 1 písm. e) a f)](#paragraf-13.odsek-1.pismeno-e), je povinný platiť daň pri tomto tovare, ak je dodaný zahraničnou osobou.
...
Faktúra môže byť vyhotovená písomne alebo so súhlasom zákazníka elektronicky. Vierohodnosť pôvodu a neporušenosť obsahu elektronicky vyhotovenej faktúry musí byť zaručená elektronickým podpisom podľa osobitného predpisu.[29)](#poznamky.poznamka-29)
...
V súhrnnom výkaze je platiteľ povinný uviesť svoje identifikačné číslo pre daň pridelené v tuzemsku, identifikačné číslo pre daň nadobúdateľa, pod ktorým mu bol tovar dodaný, a celkovú hodnotu dodaného tovaru pre každého nadobúdateľa osobitne. Pri dodaní tovaru podľa [§ 8 ods. 4](#paragraf-8.odsek-4) je platiteľ povinný v súhrnnom výkaze uviesť svoje identifikačné číslo pre daň pridelené v tuzemsku, identifikačné číslo pre daň, ktoré má pridelené v členskom štáte, v ktorom sa skončí odoslanie alebo preprava tovaru, a hodnotu zodpovedajúcu základu dane určeného podľa [§ 22 ods. 6](#paragraf-22.odsek-6). Pri trojstrannom obchode je prvý odberateľ povinný v súhrnnom výkaze uviesť svoje identifikačné číslo pre daň, pod ktorým tovar nadobudol a následne dodal, identifikačné číslo pre daň druhého odberateľa pridelené v členskom štáte, v ktorom sa skončí odoslanie alebo preprava tovaru, a celkovú hodnotu dodaného tovaru pre každého nadobúdateľa osobitne. Údaje v súhrnnom výkaze sa uvádzajú v eurách a zaokrúhľujú na celé eurá do 0,5 eura nadol a od 0,5 eura vrátane nahor.
...
Týmto zákonom sa preberajú právne akty Európskych spoločenstiev a Európskej únie uvedené v [prílohe č. 6](#prilohy.priloha-priloha_c_6_k_zakonu_c_222_2004_z_z_v_zneni_zakona_c_656_2006_z_z.oznacenie).
