...
Pri tovare prepustenom do colného režimu dočasné použitie s čiastočným oslobodením od cla sa daň vypočíta vo výške, v akej by sa vypočítala pri tomto tovare, ak by tovar v okamihu prepustenia do colného režimu dočasné použitie s čiastočným oslobodením od cla bol prepustený do colného režimu voľný obeh. Colný úrad bezodkladne po prepustení tovaru do colného režimu dočasné použitie s čiastočným oslobodením od cla oznámi osobe povinnej platiť daň sumu dane podľa prvej vety a daň je splatná do desiatich dní odo dňa oznámenia sumy dane; to neplatí, ak sa pri dovoze tovaru uplatňuje postup podľa § 84a ods. 3.
...
Na úrok z omeškania podľa odseku 5 sa použijú colné predpisy okrem dane priznanej podľa § 84a ods. 3, keď sa na úrok z omeškania použijú ustanovenia osobitného predpisu.[6abba)](#poznamky.poznamka-6abba)
...
uplatnil odpočítanie dane, nastane skutočnosť podľa [§ 25 ods. 1](#paragraf-25.odsek-1), ktorá má za následok zníženie základu dane, je platiteľ, ktorý odpočítal daň, povinný opraviť odpočítanú daň,

b)

uplatnil odpočítanie dane, nastane skutočnosť podľa [§ 25 ods. 1](#paragraf-25.odsek-1) alebo [§ 68d](#paragraf-68d), ktorá má za následok zvýšenie základu dane, má platiteľ, ktorý odpočítal daň, právo opraviť odpočítanú daň,
...
odseku 1 písm. b) platiteľ vykoná v tom zdaňovacom období, v ktorom dostal doklad o oprave základu dane, a ak sa oprava základu dane vykoná podľa [§ 68d ods. 8](#paragraf-68d.odsek-8), oprava odpočítanej dane sa vykoná v tom zdaňovacom období, v ktorom platiteľ zaplatil, a to vo výške zodpovedajúcej sume, ktorú zaplatil,
