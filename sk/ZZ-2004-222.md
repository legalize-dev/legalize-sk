...
Zdaniteľné osoby, ktoré majú sídlo, miesto podnikania alebo prevádzkareň v tuzemsku a ktoré spoločne podnikajú na základe zmluvy o združení[3)](#poznamky.poznamka-3) alebo inej obdobnej zmluvy (ďalej len „zmluva o združení“), sú povinné podať žiadosť o registráciu pre daň, ak za najviac 12 predchádzajúcich po sebe nasledujúcich kalendárnych mesiacov dosiahnu celkový obrat 35 000 eur. Do celkového obratu sa započítavajú obraty jednotlivých osôb a obrat z ich spoločného podnikania. Zdaniteľné osoby sú povinné podať jednotlivo žiadosť o registráciu pre daň do 20. dňa kalendárneho mesiaca nasledujúceho po mesiaci, v ktorom dosiahli obrat 35 000 eur. Ak zdaniteľná osoba, ktorá nie je platiteľom dane, uzavrie zmluvu o združení s platiteľom dane, je povinná podať žiadosť o registráciu pre daň najneskôr do desiatich dní odo dňa uzavretia tejto zmluvy.
...
ním uplatnená zo služieb a z tovarov dodaných s inštaláciou alebo montážou dodávateľom alebo na jeho účet, pri ktorých je povinný platiť daň podľa [§ 69 ods. 2 až 4](#paragraf-69.odsek-2) a ním uplatnená z tovaru, pri ktorom je povinný platiť daň podľa [§ 69 ods. 7](#paragraf-69.odsek-7) a [9](#paragraf-69.odsek-9),
...
Platiteľ registrovaný podľa [§ 4](#paragraf-4)môže požiadať o zrušenie registrácie pre daň najskôr po uplynutí jedného roka odo dňa, keď sa stal platiteľom, ak jeho obrat nedosiahol za 12 predchádzajúcich po sebe nasledujúcich kalendárnych mesiacov sumu 35 000 eur. Platitelia, ktorí podnikajú spoločne na základe zmluvy o združení, započítavajú do obratu svoje obraty a obrat zo spoločného podnikania.
