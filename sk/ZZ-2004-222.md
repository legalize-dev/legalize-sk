...
dodaní služby podľa [§ 9 ods. 2 a 3](#paragraf-9.odsek-2).
...
Povinnosť vyhotoviť faktúru podľa odsekov 1 a 2 sa nevzťahuje na dodanie tovaru alebo služby s miestom dodania v tuzemsku, ktoré sú oslobodené od dane podľa [§ 28 až 42](#predpis.skupinaParagrafov-oslobodenie_od_dane).
...
Faktúry podľa odsekov 1 až 3 sa musia uchovávať v pôvodnej forme, v akej sa poslali alebo sprístupnili. Zdaniteľná osoba, ktorá uchováva faktúry elektronicky, je povinná umožniť daňovému úradu na účely kontroly prístup k týmto faktúram, ich sťahovanie a používanie.
