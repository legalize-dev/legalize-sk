...
Výšku výdavkov fondu podľa odseku 1 písm. b) určuje na každý účtovný rok správna rada, najviac však do 15 % celkových výdavkov fondu za účtovné obdobie. Výdavky za vykonaný audit, výdavky na zisťovanie spôsobu použitia prostriedkov fondu a úhrady za zverejnenie údajov zapisovaných do registra sa do takto určenej výšky výdavkov na správu fondu nezapočítavajú.
