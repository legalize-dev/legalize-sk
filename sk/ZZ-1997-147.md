...
Na konanie a rozhodovanie o registrácii sa vzťahujú ustanovenia všeobecných predpisov o správnom konaní,[1)](#poznamky.poznamka-1) ak tento zákon neustanovuje inak.
...
príjmy z verejných zbierok,[4)](#poznamky.poznamka-4)
...
Fond je oprávnený usporiadať verejnú zbierku[4)](#poznamky.poznamka-4) na získanie peňažných prostriedkov na financovanie svojho účelu ([§ 2 ods. 1](#paragraf-2)).

(2)

Úmysel usporiadať verejnú zbierku[4)](#poznamky.poznamka-4) písomne oznámi správca registrovému úradu s uvedením účelu, na ktorý sa použije jej výnos.

(3)

Oznámenie podľa odseku 2 musí byť registrovému úradu odoslané najneskôr 15 dní pred začatím verejnej zbierky.[4)](#poznamky.poznamka-4)

(4)

Registrový úrad zakáže usporiadanie ohlásenej verejnej zbierky,[4)](#poznamky.poznamka-4) ak z oznámenia podľa odseku 2 vyplýva, že uvedený účel zbierky nie je v súlade s účelom fondu ustanoveným v jeho štatúte.

(5)

Registrový úrad, ktorému bolo usporiadanie verejnej zbierky[4)](#poznamky.poznamka-4) oznámené, môže jej konanie dočasne zastaviť, ak zistí, že fond nedodržiava právne predpisy o verejných zbierkach.[4)](#poznamky.poznamka-4)

(6)

Ak tento zákon neustanovuje inak, na usporiadanie verejnej zbierky[4)](#poznamky.poznamka-4) a spôsob jej konania sa primerane použijú ustanovenia právnych predpisov o verejných zbierkach.[4)](#poznamky.poznamka-4)
...
Výnos z verejnej zbierky[4)](#poznamky.poznamka-4) môže fond použiť len na účel, na ktorý sa verejná zbierka usporiadala, a vo vymedzenom rozsahu na správu fondu. O použití nevyčerpaných prostriedkov verejnej zbierky rozhodne správna rada fondu a o svojom rozhodnutí informuje verejnosť spôsobom ako pri vyhlásení verejnej zbierky.
...
Ročná účtovná závierka musí byť overená audítorom, ak úhrn celkových príjmov a výdavkov fondu za kalendárny rok prevýši sumu 165 969 eur.

(3)

Fond uloží ročnú účtovnú závierku overenú audítorom podľa odseku 2 vo verejnej časti registra účtovných závierok[9)](#poznamky.poznamka-9) najneskôr do 15. apríla.
...
Fond uloží výročnú správu do verejnej časti registra účtovných závierok[9)](#poznamky.poznamka-9) najneskôr do 15. apríla.
