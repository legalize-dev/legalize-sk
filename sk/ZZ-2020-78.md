...
poskytnutie zrozumiteľného a aktuálneho vyhlásenia o prístupnosti mobilnej aplikácie v prístupnom formáte a s obsahom primerane podľa [§ 15 písm. a)](#paragraf-15.odsek-1.pismeno-a), a to na webovom sídle orgánu riadenia, ktorý zabezpečuje vývoj mobilnej aplikácie alebo spolu s inými informáciami, ktoré sa poskytujú pri sťahovaní mobilnej aplikácie.
...
opis mechanizmu s uvedením odkazu naň, prostredníctvom ktorého môže každá osoba oznámiť správcovi obsahu webového sídla zlyhanie webového sídla, ak ide o plnenie požiadaviek na prístupnosť podľa [§ 14](#paragraf-14) a požiadať o informáciu, ktoré časti webového sídla nemusia spĺňať štandardy prístupnosti a z akého dôvodu alebo požiadať o poskytnutie alternatívneho archívneho textového dokumentu zverejneného na webovom sídle podľa [§ 18 ods. 2 písm. a)](#paragraf-18.odsek-2.pismeno-a),
...
optimalizácia webových stránok, ktoré obsahujú elektronické služby verejnej správy alebo povinne zverejňované informácie podľa osobitných predpisov,[5)](#poznamky.poznamka-5) pre aktuálne podporované webové prehliadače s podielom zastúpenia na trhu v Slovenskej republike viac ako 5 % vypočítaných aritmetickým priemerom za obdobie posledných šiestich po sebe nasledujúcich kalendárnych mesiacov (ďalej len „podporovaný webový prehliadač“), a to
...
Štandardom grafického používateľského rozhrania hlavného webového sídla je vytvorenie komponentov, funkcionalít, ich vzhľadu a zobrazenia v rozsahu a spôsobom uvedeným v [prílohe č. 12](#prilohy.priloha-priloha_c_12_k_vyhlaske_c_78_2020_z_z).
...
používanie správnych prípon súborov v názvoch súborov a hodnôt mimetype,[8)](#poznamky.poznamka-8) ktoré patria danému formátu súboru, a to aj pri elektronických dokumentoch v podpisových kontajneroch,
...
Štandardy podľa [§ 14](#paragraf-14) a [§ 18 písm. d)](#paragraf-18.odsek-1.pismeno-d) sa neuplatňujú na archívny textový dokument zverejnený na webovom sídle, ak sa

a)

na základe žiadosti zabezpečí poskytnutie prístupnej alternatívy archívneho textového dokumentu spĺňajúcej štandardy prístupnosti webových sídiel a mobilných aplikácií podľa [§ 14](#paragraf-14) a štandardy všeobecného použitia formátov podľa [§ 18 písm. d)](#paragraf-18.odsek-1.pismeno-d) do 10 pracovných dní od doručenia žiadosti a
...
poskytovanie dereferenciácie referencovateľných identifikátorov číselníkov používaných v elektronických formulároch podľa [prílohy č. 1](#prilohy.priloha-priloha_c_1_k_vyhlaske_c_78_2020_z_z) bodov 2.3.13 a 2.6.16, ak číselník nie je poskytovaný ako súčasť elektronického formulára.
...
určenie úrovne autentifikácie podľa podmienok ustanovených osobitným predpisom[23aa)](#poznamky.poznamka-23aa) takto:
...
registrovanie cloudovej služby v centrálnom metainformačnom systéme podľa [§ 12 ods. 1 písm. b)](../../../../SK/ZZ/2019/95/#paragraf-12.odsek-1.pismeno-b) zákona,

c)

registrovanie cloudovej služby v evidencii vládnych cloudových služieb podľa [§ 24a ods. 2](../../../../SK/ZZ/2019/95/#paragraf-24a.odsek-2) zákona s poskytnutím metaúdajov cloudovej služby.
...
Ak orgán riadenia používa cloudové služby podľa [§ 44a ods. 1 písm. a) druhého až štvrtého bodu](#paragraf-44a.odsek-1.pismeno-a.bod-2), tieto cloudové služby sú vládnymi cloudovými službami podľa [§ 24a ods. 5](../../../../SK/ZZ/2019/95/#paragraf-24a.odsek-5) zákona.
...
Pri použití autorizácie podľa osobitného predpisu[34a)](#poznamky.poznamka-34a) je štandardom potvrdenia o vykonanej autorizácii vytvorenie elektronického dokumentu s údajmi o spôsobe vykonanej autorizácie vyplneného podľa elektronického formulára zverejneného po dohode s orgánom vedenia v module elektronických formulárov,[34b)](#poznamky.poznamka-34b) ktorý je zapečatený kvalifikovanou elektronickou pečaťou prístupového miesta s pripojenou kvalifikovanou časovou pečiatkou v podpisovom kontajneri podľa [§ 47 písm. a)](#paragraf-47.odsek-1.pismeno-a) a ktorý je odosielaný spolu s autorizovaným elektronickým podaním alebo iným autorizovaným elektronickým dokumentom.
...
dátová štruktúra Security Assertion Markup Language (SAML) Assertion pre prenos autentifikačných informácií medzi poskytovateľom služby a poskytovateľom identity má atribúty podľa [prílohy č. 10](#prilohy.priloha-priloha_c_10_k_vyhlaske_c_78_2020_z_z),
...
Na hlavné webové sídlo zverejnené do 31. decembra 2021 sa neuplatní štandard podľa [§ 17 ods. 2](#paragraf-17.odsek-2); to neplatí, ak ide o zmenu takéhoto hlavného webového sídla spočívajúcu v podstatnej zmene jeho vizuálnej podoby, najmä v zmene typografie, farieb a rozloženia prvkov hlavičky, farieb a rozloženia prvkov päty a zároveň ide o webové sídlo, ktorého počet zobrazení vrátane opakovaných zobrazení, prekročil za kalendárny rok predchádzajúci zmene 500 000 zobrazení.

(2)

Pri uplatňovaní štandardu audio a video súboru podľa § 21 písm. a) piateho bodu a [§ 21 písm. d) šiesteho až ôsmeho bodu](#paragraf-21.odsek-1.pismeno-d.bod-6) sa postupuje najneskôr od 1. januára 2023.

(3)

Pri uplatňovaní štandardu súborov audio a video streamingu podľa [§ 22 písm. a)](#paragraf-22.odsek-1.pismeno-a) formát Opus pre audio streaming sa použije najneskôr od 1. januára 2023.

(4)

Pri uplatňovaní štandardu súborov audio a video streamingu podľa [§ 22 písm. b)](#paragraf-22.odsek-1.pismeno-b) formáty AV1 a VP9 pre video streaming sa použijú najneskôr od 1. januára 2023.

(5)

Pri uplatňovaní štandardu súborov audio a video streamingu podľa [§ 22 písm. c)](#paragraf-22.odsek-1.pismeno-c) formát WebM pre kontajnerové formáty stramingu sa použije najneskôr od 1. januára 2023.

(6)

Pri poskytovaní dereferenciácie referencovateľných identifikátorov číselníkov používaných v elektronických formulároch podľa [§ 32 písm. l)](#paragraf-32.odsek-1.pismeno-l) sa postupuje najneskôr od 1. januára 2023.

(7)

Na elektronickú službu verejnej správy zverejnenú do 31. decembra 2021 sa neuplatní štandard podľa [§ 35a](#paragraf-35a); to neplatí, ak ide o zmenu grafického používateľského rozhrania takejto elektronickej služby.

(8)

Na mobilnú aplikáciu zverejnenú do 31. decembra 2021 sa neuplatní štandard podľa [§ 36a](#paragraf-36a); to neplatí, ak ide o zmenu takejto mobilnej aplikácie.

(9)

Pri uplatňovaní štandardu prijímania a čítania podpísaných elektronických dokumentov podľa [§ 46 ods. 2 písm. i)](#paragraf-46.odsek-2.pismeno-i) sa postupuje najneskôr od 1. januára 2023.

(10)

Pri spracovaní podpísaných elektronických dokumentov podľa [§ 49 ods. 4 až 6](#paragraf-49.odsek-4) sa postupuje najneskôr od 1. januára 2023.

(11)

Pri prenose dátových prvkov alebo ich atribútov podľa [§ 51 ods. 4](#paragraf-51.odsek-4) sa postupuje najneskôr od 1. januára 2023.

(12)

Pri uplatňovaní štandardov pre elektronické formuláre sa podľa [prílohy č. 1](#prilohy.priloha-priloha_c_1_k_vyhlaske_c_78_2020_z_z)
...
Pri uplatňovaní štandardov pre štruktúru údajov kontajnera XML údajov sa podľa [prílohy č. 7](#prilohy.priloha-priloha_c_7_k_vyhlaske_c_78_2020_z_z)
...
Pre podpísané elektronické dokumenty podľa [§ 46 ods. 2 písm. c)](#paragraf-46.odsek-2.pismeno-c) vytvorené do 31. decembra 2022 sa môže na identifikovanie formátu podpísaného elektronického dokumentu podľa [§ 49 ods. 1](#paragraf-49.odsek-1) používať aj identifikátor vo forme prípony súboru „.xml“.
...
Elektronické služby verejnej správy, ktoré sú podľa [§ 34 písm. d)](#paragraf-34.odsek-1.pismeno-d) v znení účinnom do 31. marca 2024 rozdelené podľa úrovní autentifikácie do
...
Pre elektronické služby verejnej správy, ktoré sú podľa [§ 34 písm. d)](#paragraf-34.odsek-1.pismeno-d) v znení účinnom do 31. marca 2024 rozdelené podľa úrovní autentifikácie do úrovne 1, sa neurčuje úroveň autentifikácie podľa [§ 34 písm. d)](#paragraf-34.odsek-1.pismeno-d) v znení účinnom od 1. apríla 2024 a na účely [§ 34 písm. e)](#paragraf-34.odsek-1.pismeno-e) v znení účinnom od 1. apríla 2024 sa označujú úrovňou autentifikácie 1. Elektronické služby verejnej správy podľa prvej vety možno pri splnení podmienok ustanovených pre úroveň autentifikácie 1 podľa predpisov účinných do 31. marca 2024, poskytovať aj po 31. marci 2024.

(3)

Elektronické služby verejnej správy, označené podľa úrovní autentifikácie podľa [§ 34 písm. e)](#paragraf-34.odsek-1.pismeno-e) do 31. marca 2024, sa najneskôr do 1. januára 2026 označia príslušnou úrovňou autentifikácie podľa [§ 34 písm. d)](#paragraf-34.odsek-1.pismeno-d) v znení účinnom od 1. apríla 2024; to neplatí pre elektronické služby verejnej správy podľa odseku 2.

(4)

Pri uplatňovaní štandardov pre elektronické formuláre podľa [prílohy č. 1](#prilohy.priloha-priloha_c_1_k_vyhlaske_c_78_2020_z_z) bodu 4.4.10 sa postupuje pri platných elektronických formulároch publikovaných v module elektronických formulárov alebo na inom mieste do 31. marca 2024, najneskôr od 1. januára 2026.
...
Ak je elektronická služba podľa § 17a vytvorená ako súčasť webového sídla, ktoré využíva minimálne povinné komponenty grafického používateľského rozhrania podľa [prílohy č. 12](#prilohy.priloha-priloha_c_12_k_vyhlaske_c_78_2020_z_z) účinnej do 30. júna 2024, na jej vytvorenie sa použijú minimálne povinné komponenty grafického používateľského rozhrania podľa [prílohy č. 12](#prilohy.priloha-priloha_c_12_k_vyhlaske_c_78_2020_z_z) účinnej do 30. júna 2024.

(3)

Pri uplatňovaní štandardu špecifikácie minimálnych povinných komponentov grafického používateľského rozhrania podľa [prílohy č. 12](#prilohy.priloha-priloha_c_12_k_vyhlaske_c_78_2020_z_z) bodu 6.1.8 sa postupuje najneskôr od 1. januára 2026.
...
Táto vyhláška nadobúda účinnosť 1. mája 2020 okrem [§ 14 ods. 2](#paragraf-14.odsek-2), ktorý nadobúda účinnosť 23. júna 2021.
