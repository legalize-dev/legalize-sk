...
používanie komponentu s funkcionalitou, štýlu, vzhľadu a zobrazenia pre grafické používateľské rozhranie webovej stránky zobrazujúcej elektronickú službu, grafické používateľské rozhranie elektronickej služby a hlavné webové sídlo v rozsahu a spôsobom uvedeným v [prílohe č. 12](#prilohy.priloha-priloha_c_12_k_vyhlaske_c_78_2020_z_z),
...
Ak sa nepostupuje podľa [§ 17a](#paragraf-17a), elektronické služby a hlavné webové sídla, ktorých vytvorenie alebo zmena sú súčasťou projektu alebo zmenovej požiadavky začatých podľa predpisov účinných do 30. júna 2024, v ktorých
