...
Podnikateľovi, ktorý spotreboval elektrinu oslobodenú od dane na iný účel, ako je uvedený v [§ 7](#paragraf-7) alebo ktorý spotreboval uhlie oslobodené od dane na iný účel, ako je uvedený v [§ 19](#paragraf-19), alebo ktorý spotreboval zemný plyn oslobodený od dane na iný účel, ako je uvedený v [§ 31](#paragraf-31), colný úrad uloží pokutu vo výške 50 % dane pripadajúcej na množstvo spotrebovanej elektriny, množstvo spotrebovaného uhlia alebo množstvo spotrebovaného zemného plynu, najmenej však 10 000 Sk.
