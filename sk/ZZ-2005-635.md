...
Výrobky uvedené v [§ 2](#paragraf-2) nesmú pri umiestňovaní na trh Slovenskej republiky prekročiť najvyššie prípustné hodnoty uvedené v [prílohách č. 1 až 4](#prilohy.priloha-priloha_c_1_k_vyhlaske_c_635_2005_z_z.oznacenie).

##### § 5

(1)

Bezpečnosť výrobku výrobca, dovozca alebo dodávateľ preukazuje vykonaním skúšky bezpečnosti výrobku v akreditovanom skúšobnom laboratóriu[6)](#poznamky.poznamka-6) alebo dá posúdiť zhodu akreditovanému certifikačnému orgánu na výrobky; o výsledkoch tejto skúšky vedie písomnú evidenciu[7)](#poznamky.poznamka-7) a na požiadanie orgánu dohľadu[8)](#poznamky.poznamka-8) mu ju predloží na nahliadnutie.
...
Bezpečnosť výrobku výrobca, dovozca alebo dodávateľ môže preukázať vyhlásením o zhode výrobku s ustanoveniami tejto vyhlášky, vydaným v súlade s technickou normou[8a)](#poznamky.poznamka-8a) na základe skúšok vykonaných v akreditovanom skúšobnom laboratóriu alebo posúdením zhody akreditovaným certifikačným orgánom na výrobky.
