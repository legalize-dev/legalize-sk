...
pri prijatí služby a požadovaní úhrady za ňu od inej osoby ([§ 8 ods. 4 až 7](#paragraf-8.odsek-4)) dňom vyhotovenia dokladu, ktorým platiteľ požaduje úhradu za službu od inej osoby, alebo dňom jej úhrady, a to tým dňom, ktorý nastane skôr,
...
Ak pri pôvodnom zdaniteľnom plnení vyhotovil platiteľ daňový doklad, musí daňový dobropis alebo daňový ťarchopis obsahovať údaje ustanovené v [§ 15 ods. 2 písm. a), b), c)](#paragraf-15.odsek-2), [e), f)](#paragraf-15.odsek-2.pismeno-e) a [h)](#paragraf-15.odsek-2.pismeno-h) a ak ide
...
cena bez dane za služby v prípade, že ich platiteľ prijal ako oslobodené od dane, požaduje za tieto služby úhradu od inej osoby a nie je povinný uplatniť daň ([§ 8 ods. 6 a 7](#paragraf-8.odsek-7)), v tomto prípade sa táto cena neuvádza ani v čitateli koeficientu,
...
Vývoz tovaru do zahraničia je oslobodený od dane u toho platiteľa, ktorý je predávajúci vo vzťahu k zahraničnej osobe. Tovar oslobodený od dane podľa [§ 26](#paragraf-26) sa pri jeho vývoze považuje za oslobodený podľa tohto odseku.
