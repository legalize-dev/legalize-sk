...
Náhradné výživné, na ktoré má nárok oprávnená osoba podľa [§ 2 ods. 1 písm. a)](#paragraf-2.odsek-1.pismeno-a), je vo výške výživného určeného právoplatným rozhodnutím súdu alebo súdom schválenou dohodou, najviac vo výške 1,2 násobku sumy životného minima pre nezaopatrené dieťa.[3)](#poznamky.poznamka-3)

(2)

Ak povinná osoba neplní vyživovaciu povinnosť v plnej výške, náhradné výživné je vo výške rozdielu medzi výškou výživného určeného právoplatným rozhodnutím súdu alebo súdom schválenou dohodou, najviac vo výške 1,2 násobku sumy životného minima pre nezaopatrené dieťa[3)](#poznamky.poznamka-3) a výškou zaplateného výživného povinnou osobou.
...
potvrdenie súdneho exekútora, že exekučné konanie na vymoženie pohľadávky na výživnom trvá najmenej tri mesiace od doručenia návrhu na vykonanie exekúcie,
...
súdny exekútor povinný predložiť potvrdenie o priebehu exekučného konania a o stave exekúcie ku dňu vydania tohto dokladu,
