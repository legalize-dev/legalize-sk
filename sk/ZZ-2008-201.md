...
preukáže potvrdením Centra pre medzinárodnoprávnu ochranu detí a mládeže[5)](#poznamky.poznamka-5) (ďalej len „centrum“) ako prijímajúceho orgánu a odosielajúceho orgánu v oblasti vymáhania výživného podľa osobitného predpisu[5a)](#poznamky.poznamka-5a) alebo podľa medzinárodných dohovorov, [6)](#poznamky.poznamka-6) že
...
úhrn súm sirotského dôchodku a sirotského výsluhového dôchodku po jednom rodičovi je nižší ako 0,7-násobok sumy životného minima pre nezaopatrené dieťa, [2)](#poznamky.poznamka-2)

b)

plní povinnú školskú dochádzku, ak je oprávnenou osobou dieťa, ktoré je povinné plniť povinnú školskú dochádzku;[4)](#poznamky.poznamka-4) podmienka sa považuje za splnenú, kým z písomného oznámenia riaditeľa školy nevyplynie, že zákonný zástupca nedbá o riadne plnenie povinnej školskej dochádzky tejto oprávnenej osoby. [4a)](#poznamky.poznamka-4a)
...
prechodný pobyt, ak ide o oprávnenú osobu, ktorej sa poskytla doplnková ochrana.[2a)](#poznamky.poznamka-2a)
...
podľa [§ 2 ods. 1 písm. a) prvého bodu](#paragraf-2.odsek-1.pismeno-a.bod-1) alebo [druhého bodu](#paragraf-2.odsek-1.pismeno-a.bod-2) a [písm. b) až d)](#paragraf-2.odsek-1.pismeno-b), je vo výške
...
podľa [§ 2 ods. 1 písm. a) tretieho bodu](#paragraf-2.odsek-1.pismeno-a.bod-3) a [písm. b) až d)](#paragraf-2.odsek-1.pismeno-b), je vo výške 0,7-násobku sumy životného minima pre nezaopatrené dieťa, [2)](#poznamky.poznamka-2)

c)

podľa [§ 2 ods. 1 písm. a) štvrtého bodu](#paragraf-2.odsek-1.pismeno-a.bod-4) a písm. [b) až d)](#paragraf-2.odsek-1.pismeno-b), je vo výške rozdielu medzi 0,7-násobkom sumy životného minima pre nezaopatrené dieťa, [2)](#poznamky.poznamka-2) a úhrnom súm sirotského dôchodku a sirotského výsluhového dôchodku po jednom rodičovi.
...
Náhradné výživné priznané podľa [§ 2 ods. 1 písm. a) prvého bodu](#paragraf-2.odsek-1.pismeno-a.bod-1) alebo [druhého bodu](#paragraf-2.odsek-1.pismeno-a.bod-2) a [písm. b) až d)](#paragraf-2.odsek-1.pismeno-b) sa vypláca preddavkovo.
...
bez zbytočného odkladu oznámiť úradu meno, priezvisko a adresu súdneho exekútora, ktorý bol poverený vykonaním exekúcie na vymoženie pohľadávky na výživnom,
...
do troch pracovných dní odo dňa doručenia oznámenia súdneho exekútora podľa osobitného predpisu[10a)](#poznamky.poznamka-10a) alebo oznámenia centra podľa [§ 15 ods. 4 písm. c) druhého bodu](#paragraf-15.odsek-4.pismeno-c.bod-2) oznámiť súdnemu exekútorovi alebo centru sumu preddavkovo vyplateného náhradného výživného, najviac v sume oznámenej vymoženej istiny pohľadávky na výživnom zníženej o sumu bežného výživného, ktorú má poukázať úradu,

c)

po uplynutí najmenej dvoch kalendárnych mesiacov od priznania náhradného výživného podľa [§ 2 ods. 1 písm. a) prvého bodu](#paragraf-2.odsek-1.pismeno-a.bod-1) alebo [druhého bodu](#paragraf-2.odsek-1.pismeno-a.bod-2) a písm. [b) až d)](#paragraf-2.odsek-1.pismeno-b) oznámiť orgánom činným v trestnom konaní[10)](#poznamky.poznamka-10) podozrenie zo spáchania trestného činu zanedbania povinnej výživy, ak tak už neurobila oprávnená osoba alebo žiadateľ o náhradné výživné,
...
Priestupku sa dopustí poberateľ náhradného výživného, ak opakovane a neodôvodnene nesplní povinnosť ustanovenú v [§ 12 ods. 1 písm. b)](#paragraf-12.odsek-1.pismeno-c).
