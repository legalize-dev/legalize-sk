...
Železničná polícia spolupôsobí na pozemných komunikáciách pri kontrole úhrady mýta, pri kontrole dodržiavania povinností označenia motorového vozidla nálepkou, pri meraní hmotnosti vozidla, nápravových tlakov vozidla a rozmerov vozidla podľa osobitných predpisov.[1a)](#poznamky.poznamka-1a)
...
ústnym vyhlásením „Železničná polícia“ a v prípade plnenia úloh podľa [§ 2 ods. 2](#paragraf-2.odsek-2) „služba mýtnej polície“ (ďalej len „ústne vyhlásenie“).
...
Pri plnení úloh vyplývajúcich z tohto zákona a úloh súvisiacich s výkonom kontroly podľa [§ 2 ods. 2](#paragraf-2.odsek-2) je policajt služby mýtnej polície oprávnený
...
Policajt služby mýtnej polície je oprávnený použiť prenosné zvislé dopravné značenie a prenosné dopravné zariadenia aj bez predchádzajúceho určenia ich použitia príslušným orgánom, ak je to potrebné na plnenie úloh súvisiacich s výkonom kontroly podľa [§ 2 ods. 2](#paragraf-2.odsek-2).
...
Policajt služby mýtnej polície je oprávnený pri plnení úloh súvisiacich s výkonom kontroly podľa [§ 2 ods. 2](#paragraf-2.odsek-2) prikázať vodičovi motorového vozidla jazdu na určené miesto.
...
Ak je to nevyhnutné pre bezpečnosť štátu, udržanie verejného poriadku, ochranu života, zdravia, majetku alebo ochranu práv a slobôd iných osôb, alebo ak je to nevyhnutné na zabezpečenie výkonu kontroly podľa [§ 2 ods. 2](#paragraf-2.odsek-2) policajt je oprávnený každému prikázať, aby
...
Policajt je oprávnený v obvode železničných dráh a pri plnení úloh podľa [§ 2 ods. 2](#paragraf-2.odsek-2) použiť zastavovací pás alebo iné prostriedky na násilné zastavenie vozidla, ktorého vodič po opakovanej výzve alebo na znamenie dané podľa osobitného predpisu[24)](#poznamky.poznamka-24) nezastaví, a ak je
...
Policajt je oprávnený v obvode železničných dráh alebo pri plnení úloh podľa [§ 2 ods. 2](#paragraf-2.odsek-2) použiť technické prostriedky na zabránenie odjazdu vozidla v prípade, ak
...
je to potrebné na plnenie úloh súvisiacich s výkonom kontroly podľa [§ 2 ods. 2](#paragraf-2.odsek-2).
...
Železničná polícia pri plnení úloh podľa osobitných predpisov[1a)](#poznamky.poznamka-1a) používa motorové vozidlá, ktoré majú označenie „Mýtna polícia“.
