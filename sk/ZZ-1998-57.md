...
Železničná polícia je v rozsahu potrebnom na plnenie svojich úloh podľa [§ 2 ods. 1](#paragraf-2) oprávnená žiadať z informačného systému prevádzkovaného na základe osobitného zákona[27)](#poznamky.poznamka-27) poskytovanie informácií a osobných údajov od prevádzkovateľa informačného systému,[32)](#poznamky.poznamka-32) a to na náklady prevádzkovateľa informačného systému. Prevádzkovateľ informačného systému je povinný písomnej žiadosti Železničnej polície bez zbytočného odkladu vyhovieť.
...
držiteľov občianskych preukazov, informačného systému cestovných dokladov a informačného systému dopravných evidencií je povinný Železničnej polícii na plnenie jej úloh umožniť prístup k spracúvaným informáciám a osobným údajom podľa osobitných predpisov,[33)](#poznamky.poznamka-33)

b)

verejnej telefónnej služby[34)](#poznamky.poznamka-34) a informačného systému obyvateľov[35)](#poznamky.poznamka-35) je povinný žiadosti Železničnej polície bez zbytočného odkladu vyhovieť a poskytnúť požadované informácie na plnenie jej úloh podľa [§ 2 ods. 1](#paragraf-2).

(3)

Železničná polícia je pri odhaľovaní a dokumentovaní trestnej činnosti oprávnená žiadať na nevyhnutný čas a v rozsahu potrebnom na splnenie konkrétnej úlohy od právnických osôb a fyzických osôb, ktoré zaisťujú telekomunikačnú činnosť,[36)](#poznamky.poznamka-36) súčinnosť pri zisťovaní údajov súvisiacich s poskytovaním telekomunikačnej služby[37)](#poznamky.poznamka-37) v rozsahu podľa osobitného predpisu.[38)](#poznamky.poznamka-38) Právnické osoby a fyzické osoby, ktoré zaisťujú telekomunikačnú činnosť, sú povinné písomnej žiadosti Železničnej polície bez zbytočného odkladu vyhovieť.
