...
Týmto zákonom sa preberajú právne záväzné akty Európskej únie uvedené v [prílohe č. 1](#prilohy.priloha-priloha_c_1_k_zakonu_c_578_2004_z_z_v_zneni_zakona_c_464_2007_z_z.oznacenie).
...
pracovné postupy a procesy na vykonávanie riadenia kvality a bezpečnosti zamerané na všetky činnosti, ktoré poskytovateľ vykonáva,

c)

pracovné postupy, ktoré opisujú špecifické procesy, materiály a metódy na získanie očakávaného výsledku,

d)

popis postupu overovania vybavenia, prostredia a procesov so zavedením dôkazovej dokumentácie, ktorá poskytuje vysoký stupeň istoty, že vybavenie, prostredie a procesy, ktoré sústavne produkujú produkt, spĺňajú vopred určené špecifikácie a kvalitatívne parametre,

e)

postup vysledovateľnosti tkaniva a bunky od ich odoberania, spracovania, testovania, skladovania po distribúciu príjemcovi alebo ich likvidáciu vrátane identifikácie darcu a príjemcu a identifikovania všetkých relevantných údajov o produktoch a materiáloch, ktoré prichádzajú do styku s tkanivami a bunkami,

f)

popis používania jedinečného číselného kódu z jednotného systému kódovania darcov, príjemcov, tkanív a buniek,

g)

definovanie kritického stupňa vybavenia, prostredia a procesov s možným účinkom na kvalitu a bezpečnosť buniek a tkanív,

h)

postupy bezodkladného oznamovania všetkých relevantných dostupných informácií o závažných nežiaducich reakciách a závažných nežiaducich udalostiach príslušnému orgánu,[13aa)](#poznamky.poznamka-13aa)

i)

postupy bezodkladného oznamovania záveru prešetrenia závažných nežiaducich reakcií a závažných nežiaducich udalostí príslušnému orgánu,[13aa)](#poznamky.poznamka-13aa)

j)

postupy uchovávania záznamov o odobratých tkanivách a bunkách vrátane záznamov o všetkých závažných nežiaducich reakciách a závažných nežiaducich udalostiach u žijúceho darcu,

k)

postupy uchovávania záznamov o použitých tkanivách a bunkách vrátane záznamov o všetkých závažných nežiaducich reakciách a závažných nežiaducich udalostiach zistených počas ich klinického použitia alebo po ňom.
...
Ministerstvo zdravotníctva uzná doklad o špecializácii, ktorý získal žiadateľ v treťom štáte, ak žiadateľ predložil doklad vydaný príslušným orgánom členského štátu o vykonávaní príslušných špecializovaných pracovných činností najmenej tri roky na území členského štátu, ktorý žiadateľovi takýto doklad o špecializácii uznal a názov špecializačného odboru uvedený v doklade vydanom príslušným orgánom členského štátu zodpovedá názvu špecializačného odboru v Slovenskej republike podľa [prílohy č. 3](#prilohy.priloha-priloha_c_3_k_zakonu_c_578_2004_z_z_v_zneni_zakona_c_464_2007_z_z.oznacenie).
...
oznamovať údaje o potenciálnom darcovi orgánov určených na transplantáciu podľa osobitného predpisu[55jag)](#poznamky.poznamka-55jag) národnej transplantačnej organizácii,
...
vytvoriť a dodržiavať systém kvality a bezpečnosti tkanivového zariadenia ([§ 9a](#paragraf-9a)) a priebežne ho aktualizovať,
...
používať jedinečný číselný kód podľa osobitného predpisu,[55jak)](#poznamky.poznamka-55jak)
...
odseku 1 písm. zz) až af) sa vzťahujú len na poskytovateľa podľa [§ 7 ods. 3 písm. h)](#paragraf-7.odsek-3.pismeno-h).
...
v [§ 79 ods. 1 písm. e), f)](#paragraf-79.odsek-1.pismeno-e), [h)](#paragraf-79.odsek-1.pismeno-h), [k)](#paragraf-79.odsek-1.pismeno-k), [p)](#paragraf-79.odsek-1.pismeno-p), [s), t), u)](#paragraf-79.odsek-1.pismeno-s), [w)](#paragraf-79.odsek-1.pismeno-w), [z)](#paragraf-79.odsek-1.pismeno-z), [zc)](#paragraf-79.odsek-1.pismeno-zc), ze) až zj), [zq), zr)](#paragraf-79.odsek-1.pismeno-zq) a [zt)](#paragraf-79.odsek-1.pismeno-zt), [odseku 6](#paragraf-79.odsek-6), v [§ 79a ods. 1 písm. a), b)](#paragraf-79a.odsek-1.pismeno-a), [d) a e)](#paragraf-79a.odsek-1.pismeno-d) až do 663 eur,
...
v [§ 79 ods. 1 písm. a) až c)](#paragraf-79.odsek-1.pismeno-a), [zx)](#paragraf-79.odsek-1.pismeno-zx), [zz)](#paragraf-79.odsek-1.pismeno-zz), [af) a ag)](#paragraf-79.odsek-1.pismeno-af) až do 16 596 eur.
...
Do 31. decembra 2017 je poskytovateľ oprávnený nesprístupniť elektronický zdravotný záznam v elektronickej zdravotnej knižke osobe, ktorej sa poskytuje zdravotná starostlivosť v špecializačnom odbore psychiatria alebo v špecializačnom odbore klinická psychológia, ak by jeho sprístupnenie negatívne ovplyvnilo jej liečbu.
...
Poskytovateľ, ktorý má povolenie na prevádzkovanie tkanivového zariadenia alebo biobanky vydané do 31. decembra 2015, je povinný vytvoriť systém kvality a bezpečnosti podľa [§ 9a](#paragraf-9a) najneskôr do 31. decembra 2016. Na poskytovateľa podľa prvej vety sa povinnosť podľa [§ 79 ods. 1 písm. zz)](#paragraf-79.odsek-1.pismeno-zz) vzťahuje od 1. januára 2017.
