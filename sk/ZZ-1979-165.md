...
Do doby zamestnania rozhodnej pre sadzbu nemocenského[3)](#poznamky.poznamka-3) a do doby zamestnania potrebnej pre vznik nároku na nemocenské u pracujúcich dôchodcov[4)](#poznamky.poznamka-4) sa započítajú len kalendárne mesiace, prípadne ich časti, v ktorých bol sezónny pracovník poistený.
...
Do doby zamestnania rozhodnej pre sadzbu nemocenského[3)](#poznamky.poznamka-3) a do doby zamestnania potrebnej pre vznik nároku na nemocenské u pracujúcich dôchodcov[4)](#poznamky.poznamka-4) sa započítajú len kalendárne mesiace, prípadne ich časti, v ktorých bol pracovník na nepravidelnú výpomoc poistený.
...
Nemocenské sa poskytuje za kalendárne dni, jeho denná výška sa rovná pomernej časti, ktorá z priznaného mesačného štipendia ([§ 49](#paragraf-49)) pripadá na kalendárny deň, ale je najviac 78 Kčs. Pokiaľ štipendium podlieha dani zo mzdy, určí sa jeho pomerná časť pripadajúca na kalendárny deň až po odpočítaní tejto dane od štipendia.
...
Výška peňažnej pomoci v materstve za kalendárny deň je u študentiek, ktoré získali vysokoškolské vzdelanie, 32 Kčs, u študentiek, ktoré získali úplné stredné alebo vyššie vzdelanie, 24 Kčs a u ostatných študentiek 21 Kčs. U študentky, ktorej sa štipendium priznáva ([§ 49](#paragraf-49)), sa denná výška peňažnej pomoci v materstve určí rovnakým spôsobom, ako denná výška nemocenského ([§ 50 ods.2](#paragraf-50.odsek-2)), ak takto určená peňažná pomoc v materstve je za kalendárny deň vyššia ako peňažná pomoc v materstve, ktorá by jej patrila podľa predchádzajúcej vety.
...
Do doby zamestnania rozhodnej pre sadzbu nemocenského[3)](#poznamky.poznamka-3) sa započítajú len kalendárne mesiace, prípadne ich časti, v ktorých bol pracovník na dohodu poistený.
...
Do doby zamestnania rozhodnej pre sadzbu nemocenského[3)](#poznamky.poznamka-3) a do doby zamestnania potrebnej pre vznik nároku na nemocenské u pracujúcich dôchodcov[4)](#poznamky.poznamka-4) sa započítajú len kalendárne mesiace, prípadne ich časti, v ktorých bol opatrovateľ poistený.
...
Nemocenské sa poskytuje za kalendárne dni. Jeho denná výška sa rovná pomernej časti, ktorá z určeného mesačného príspevku ([§ 96](#paragraf-96)) pripadá na kalendárny deň, ale je najviac 78 Kčs.
...
Denná výška peňažnej pomoci v materstve sa určí rovnakým spôsobom ako denná výška nemocenského ([§ 97 ods.2](#paragraf-97.odsek-2)), je však najmenej 21 Kčs.
