...
Zoznam druhov vtákov, ktoré sa môžu chytať, zraňovať, usmrtiť, držať, chovať v ľudskej opatere a premiestňovať alebo prepravovať, ak boli nadobudnuté v súlade s osobitnými predpismi,[1)](#poznamky.poznamka-1) je uvedený v [prílohe č. 7](#prilohy.priloha-priloha_c_7_k_vyhlaske_c_24_2003_z_z.oznacenie).

(2)

Zoznam druhov vtákov, ktoré sa môžu chytať, zraňovať, usmrtiť, držať, chovať v ľudskej opatere, predávať, kupovať alebo vymieňať, ponúkať s cieľom predaja alebo výmeny a premiestňovať alebo prepravovať, ak boli nadobudnuté v súlade s osobitnými predpismi,[1)](#poznamky.poznamka-1) je uvedený v [prílohe č. 8](#prilohy.priloha-priloha_c_8_k_vyhlaske_c_24_2003_z_z.oznacenie).
...
Okrem tabule podľa odsekov 1, 2 a 5 sa chránené územia s druhým až piatym stupňom ochrany a ich ochranné pásma s druhým až štvrtým stupňom ochrany okrem chránených krajinných oblastí a národných parkov, ako aj zóny označujú pruhovým označením ich hraníc na stromoch lesných porastov alebo na drevených hraničných stĺpikoch mimo lesných porastov umiestnených najmä na lomových bodoch hranice. V lesných porastoch sa pruhové označenie vykoná aj na niektorých stromoch v dostatočne viditeľnej vzdialenosti medzi lomovými bodmi. Ak sa hranice chráneného územia (zóny) prekrývajú s hranicami ochranného lesa,[13)](#poznamky.poznamka-13) treba označenie chráneného územia (zóny) vykonať takým spôsobom, aby nedochádzalo k zámene s označením ochranného lesa.
...
starostlivosti podľa odseku 1 je uvedený v [prílohe č. 18](#prilohy.priloha-priloha_c_18_k_vyhlaske_c_24_2003_z_z.oznacenie),

b)

starostlivosti podľa odseku 2 je uvedený v [prílohách č. 19 a 20](#prilohy.priloha-priloha_c_19_k_vyhlaske_c_24_2003_z_z.oznacenie),
...
návrhu chráneného vtáčieho územia a návrhu územia európskeho významu je uvedený v [prílohe č. 26](#prilohy.priloha-priloha_c_26_k_vyhlaske_c_24_2003_z_z.oznacenie),
...
na orgáne príslušnom na jej schválenie; dokumentácia podľa [§ 21 ods. 1](#paragraf-21) a [§ 22 ods. 1](#paragraf-22) je uložená na ministerstve,
...
Spoločenská hodnota chránených živočíchov a ich poškodených alebo zničených jedincov vrátane vývinových štádií sa zvýši až o 300 % spoločenskej hodnoty uvedenej v [prílohách č. 6](#prilohy.priloha-priloha_c_6_k_vyhlaske_c_24_2003_z_z.oznacenie) a [32](#prilohy.priloha-priloha_c_32_k_vyhlaske_c_24_2003_z_z.oznacenie) v závislosti od stupňa ich ohrozenosti, stupňa ochrany územia, v ktorom sa vyskytujú, alebo ak ide o druhy vyskytujúce sa len v jednej lokalite alebo vo viacerých izolovaných lokalitách v Slovenskej republike. Za poškodenie chránených živočíchov sa považujú aj rušivé zásahy do ich prirodzeného vývinu, najmä nepovolený odchyt, držba, chov v zajatí, premiestnenie, narušenie rozmnožovania a podmienok na rozmnožovanie, ako aj rušivé zásahy do bezprostredného okolia ich prirodzeného výskytu.
...
Táto vyhláška nadobúda účinnosť 1. februára 2003 okrem § 9 ods. 1 písm. a) bodu 14, ktorý nadobúda účinnosť dňom nadobudnutia platnosti zmluvy o pristúpení Slovenskej republiky k Európskej únii. [Bod 9 prílohy č. 7](#prilohy.priloha-priloha_c_7_k_vyhlaske_c_24_2003_z_z.op-zoznam_druhov_vtakov_ktore_sa_mozu_chytat_zranovat_usmrtit_drzat_chovat_v_ludskej_opatere_a_premiestnovat_alebo_prepravovat.op-bod_9) stráca účinnosť dňom nadobudnutia platnosti zmluvy o pristúpení Slovenskej republiky k Európskej únii.
