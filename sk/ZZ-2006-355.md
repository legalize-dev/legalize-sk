...
chemický faktor, ktorý spĺňa kritériá klasifikácie ako nebezpečná chemická látka alebo ako nebezpečná chemická zmes podľa osobitného predpisu[3)](#poznamky.poznamka-3) bez ohľadu na to, či je alebo nie je tento faktor klasifikovaný podľa tohto predpisu,[3)](#poznamky.poznamka-3)

2.

chemický faktor, ktorý nespĺňa kritériá klasifikácie ako nebezpečná chemická látka alebo nebezpečná chemická zmes podľa osobitného predpisu,[3)](#poznamky.poznamka-3) ale ktorý môže pre svoje fyzikálno-chemické, chemické alebo toxikologické vlastnosti a spôsob použitia alebo výskytu na pracovisku predstavovať riziko pre zdravie a bezpečnosť zamestnancov, vrátane chemického faktora, pre ktorý sa ustanovuje najvyššie prípustný expozičný limit ([§ 3 ods. 1](#paragraf-3.odsek-1)),
...
Najvyššie prípustné expozičné limity sú uvedené v prílohe č. 1.
...
vyžiadať si dodatočné informácie o bezpečnosti a ochrane zdravia potrebné na posúdenie akéhokoľvek rizika uvedené v karte bezpečnostných údajov a jej rozšírenej forme od dodávateľov alebo z iných dostupných zdrojov; tieto informácie musia obsahovať špecifické posúdenie týkajúce sa rizika pre užívateľov podľa osobitného predpisu.[4)](#poznamky.poznamka-4)
...
identifikáciu nebezpečných vlastností chemických faktorov s uvedením klasifikácie podľa osobitného predpisu[3)](#poznamky.poznamka-3) a ďalších významných vlastností chemických faktorov z hľadiska bezpečnosti a zdravia poskytovanú dodávateľom podľa osobitného predpisu,[4)](#poznamky.poznamka-4)
...
porovnanie s najvyššie prípustnými expozičnými limitmi alebo biologickými medznými hodnotami ([§ 3](#paragraf-3)) a ich dodržanie,
...
zaradenie zamestnancov na výkon riadiacej práce alebo samostatnej práce, ak získali odbornú spôsobilosť na prácu s veľmi toxickými látkami a zmesami a toxickými látkami a zmesami,[9a)](#poznamky.poznamka-9a) ktoré sú zaradené do triedy a kategórie nebezpečnosti[9b)](#poznamky.poznamka-9b)
...
výbušniny[19)](#poznamky.poznamka-19) a

f)

horľavé látky.[19)](#poznamky.poznamka-19)

(2)

Veľmi toxické látky a zmesi možno skladovať v jednej miestnosti s inými látkami a zmesami, ktoré nie sú toxické, okrem látok uvedených v odseku 1 písm. a) až f), len za predpokladu, že sú uložené v uzamknutej schránke určenej výhradne na skladovanie veľmi toxických látok a zmesí. S toxickými látkami a zmesami sa môžu veľmi toxické látky a zmesi skladovať v jednej miestnosti, prípadne v jednej schránke, ak sú uložené oddelene a je vylúčené ich vzájomné škodlivé pôsobenie alebo zámena, ak taký spôsob skladovania schválil príslušný orgán verejného zdravotníctva.[21)](#poznamky.poznamka-21)
...
Na predchádzanie riziku zamestnancov z expozície vybraným chemickým faktorom a z pracovných činností súvisiacich s takýmito faktormi je zakázaná výroba a používanie vybraných chemických faktorov na účely uvedené v [prílohe č. 3](#prilohy.priloha-priloha_c_3_k_nariadeniu_vlady_c_355_2006_z_z.oznacenie).
...
prístup ku kartám bezpečnostných údajov, ktoré poskytuje dodávateľ chemických látok alebo zmesí podľa osobitného predpisu,[4)](#poznamky.poznamka-4)
...
Zamestnávateľ vypracuje prevádzkový poriadok pre pracovné činnosti s nebezpečnými chemickými faktormi podľa [§ 2 písm. b)](#paragraf-2.odsek-1.pismeno-b), ktorý obsahuje
...
Zamestnávateľ je povinný zabezpečiť zdravotný dohľad podľa osobitného predpisu[25b)](#poznamky.poznamka-25b) pre zamestnancov pri práci, pri ktorej dochádza k expozícii chemickým faktorom, ak na základe posúdenia rizík podľa [§ 4](#paragraf-4) zistí riziko pre ich zdravie; súčasťou zdravotného dohľadu sú lekárske preventívne prehliadky vo vzťahu k práci.[25c)](#poznamky.poznamka-25c)
...
V období od 1. mája 2018 do 30. septembra 2020 pre podzemnú ťažbu a razenie tunelov platia hodnoty najvyššie prípustných expozičných limitov plynov, pár a aerosólov s prevažne toxickým účinkom v pracovnom ovzduší uvedené v [prílohe č. 1](#prilohy.priloha-priloha_c_1_k_nariadeniu_vlady_c_355_2006_z_z) prvom bode tabuľke č. 1a.

##### § 13b

##### Prechodné ustanovenie k úprave účinnej od 1. októbra 2020

V období od 1. októbra 2020 do 21. augusta 2023 pre podzemnú ťažbu a razenie tunelov platia hodnoty najvyššie prípustných expozičných limitov plynov, pár a aerosólov s prevažne toxickým účinkom v pracovnom ovzduší uvedené v [prílohe č. 1](#prilohy.priloha-priloha_c_1_k_nariadeniu_vlady_c_355_2006_z_z) tabuľke č. 2.

##### § 14

##### Záverečné ustanovenie

Týmto nariadením vlády sa preberajú právne záväzné akty Európskej únie uvedené v [prílohe č. 4](#prilohy.priloha-priloha_c_4_k_nariadeniu_vlady_c_355_2006_z_z.oznacenie).
