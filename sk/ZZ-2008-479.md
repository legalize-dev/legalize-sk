...
Usporiadateľ plní úlohy podľa pokynov organizátora podujatia alebo iných oprávnených orgánov uvedených v [§ 4 ods. 3 písm. b)](#paragraf-4.odsek-3.pismeno-b) a [m)](#paragraf-4.odsek-3.pismeno-m).
...
Vyhotovený záznam z kamerového systému možno využiť len na účely trestného konania, objasňovania priestupku, v konaní o priestupku alebo na vedenie informačného systému podľa [§ 11](#paragraf-11).
