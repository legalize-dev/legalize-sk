...
dôchodkové fondy spravované dôchodkovou správcovskou spoločnosťou.
...
Daň z príjmov podľa osobitného predpisu[12)](#poznamky.poznamka-12) sa ako náklad účtovej jednotky účtuje na účtoch účtovej skupiny 68 Daň z príjmov.
...
daňovej straty, ktorá sa bude v súlade s osobitným predpisom[12)](#poznamky.poznamka-12) v budúcich zdaňovacích obdobiach umorovať; umorovaním daňovej straty sa rozumie postupné odpočítavanie častí daňovej straty od základov dane budúcich zdaňovacích období,
...
Daňovou základňou na účely účtovania o odloženej dani z príjmov je hodnota aktíva alebo hodnota pasíva podľa osobitného predpisu[12)](#poznamky.poznamka-12).
...
účtovná hodnota dlhodobého hmotného majetku je vyššia než jeho daňová základňa, napríklad účtovná zostatková cena dlhodobého hmotného majetku je vyššia než je jeho zostatková cena podľa osobitného predpisu[12)](#poznamky.poznamka-12),
...
účtovná hodnota dlhodobého hmotného majetku je nižšia než je jeho daňová základňa, napríklad účtovná zostatková cena dlhodobého hmotného majetku je nižšia než je jeho zostatková cena podľa osobitného predpisu[12)](#poznamky.poznamka-12),
...
daňová strata, ktorá sa bude v súlade s osobitným predpisom[12)](#poznamky.poznamka-12) v budúcich zdaňovacích obdobiach umorovať,
...
vklady, úvery a pôžičky prijaté od účtovných jednotiek, ktoré nie sú bankami vrátane repo obchodov (účtové skupiny 22, 23),
...
úvery, krátkodobé a dlhodobé vrátane úverov poskytnutých podľa osobitného predpisu[21)](#poznamky.poznamka-21) a hypotekárne úvery a pôžičky,
...
Na účtoch účtovej skupiny 23 - Prijaté úvery a pôžičky sa účtujú prijaté úvery a pôžičky od fyzických osôb a právnických osôb, ktoré nie sú bankami, vrátane repo obchodov.

(6)

Na účtoch účtovej skupiny 24 – Štandardné úvery s výhradou, klasifikované úvery a ostatné pohľadávky sa v účtovných jednotkách, ktorými sú banky, účtujú štandardné úvery s výhradou, klasifikované úvery a ostatné pohľadávky voči klientom a opravné položky ku klasifikovaným úverom a ostatným pohľadávkam. Ako ostatné pohľadávky voči klientom sa účtujú napríklad pohľadávky zo záruk, akreditívov a faktoringu.
...
Na účtoch účtovej skupiny 63 – Všeobecné prevádzkové náklady sa účtujú najmä mzdové náklady zamestnancov účtovnej jednotky a odmeny za vykonanie práce, náklady na poistné do Sociálnej poisťovne, náklady na poistné do zdravotných poisťovní, odstupné poskytnuté pri skončení pracovného pomeru, dane a poplatky, vrátane miestnych daní a miestnych poplatkov, clo iné poplatky, nakupované výkony, ktorými sú materiál, služby, cestovné, odpisy hmotného majetku a odpisy nehmotného majetku. V tejto účtovej skupine sa účtujú tiež i náklady na rôzne činnosti zamestnancov, ktoré vyplývajú z kolektívnej zmluvy, ktoré nie sú hradené zo sociálneho fondu[24)](#poznamky.poznamka-24).
...
##### Osobitné ustanovenia pre podielové fondy a dôchodkové fondy

(1)

Na účtovanie činností ustanovených osobitnými predpismi[19)](#poznamky.poznamka-19) účtovných jednotiek, ktorými sú podielové fondy alebo dôchodkové fondy sa vzťahujú postupy podľa [§ 2 až 42](#predpis.skupinaParagrafov-podrobnosti_o_postupoch_uctovania) s odchýlkami uvedenými v odsekoch 2 až 9.
