...
identifikačné údaje účastníka podľa [§ 83 ods. 2 zákona](../../../../SK/ZZ/2005/473/#paragraf-83.odsek-2),
...
tému vyučovacej hodiny podľa [§ 4 ods. 1 až 3](#paragraf-4.odsek-1) s vyznačením prítomnosti alebo neprítomnosti účastníka na jednotlivých vyučovacích hodinách.
...
Učebný plán obsahuje konkretizáciu obsahu jednotlivých vyučovacích hodín podľa tém uvedených v [§ 4 ods. 1 až 3](#paragraf-4.odsek-1) s uvedením, či budú vyučovacie hodiny prednášané samostatne alebo budú spojené podľa [§ 4 ods. 4.](#paragraf-4.odsek-4)

##### § 5

(1)

Skúšobný test na skúšku typu S obsahuje 40 otázok s tromi odpoveďami, z ktorých len jedna je správna.

(2)

Skúšobný test na skúšku typu P a CIT obsahuje 50 otázok s tromi odpoveďami, z ktorých len jedna je správna.

(3)

Jednotlivé otázky sa hodnotia podľa náročnosti jedným až tromi bodmi. Na úspešné zvládnutie skúšobného testu skúšky typu S je potrebné dosiahnuť najmenej 80 % z celkového súčtu bodov otázok skúšobného testu. Na úspešné zvládnutie skúšobného testu skúšky typu P a CIT je potrebné dosiahnuť najmenej 90 % z celkového súčtu bodov otázok skúšobného testu.

##### § 6

(1)

Dohľad nad riadnym priebehom skúšky, overovanie totožnosti uchádzača a poučenie uchádzača o spôsobe vykonania skúšky vykonáva poverený zástupca ministerstva (ďalej len „zástupca ministerstva“). Vzor prihlášky na skúšku je uvedený v prílohe č. 1b.

(2)

Skúška typu S trvá 40 minút. Skúšky typu P a CIT trvajú 50 minút.
...
Uchádzač na skúške vyhovie, ak úspešne zvládne skúšobný test.

(2)

Výsledok skúšky oznámi uchádzačovi zástupca ministerstva po skončení skúšky.

(3)

Ak sa uchádzač na skúške správa nedovoleným spôsobom, zástupca ministerstva môže uchádzača vylúčiť zo skúšky. Na vylúčenie zo skúšky sa vzťahuje [§ 3 ods. 3.](#paragraf-3.odsek-3)
...
##### Obsah štatistických údajov a vzor tlačiva štatistických údajov

Obsah štatistických údajov a vzor tlačiva štatistických údajov je uvedený v [prílohe č. 14](#prilohy.priloha-priloha_c_14_k_vyhlaske_c_634_2005_z_z.oznacenie).
