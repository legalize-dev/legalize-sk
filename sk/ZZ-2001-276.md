...
aa) sleduje dodržiavanie povinností prevádzkovateľa sústavy alebo siete určených v osobitnom zákone[1)](#poznamky.poznamka-1) a prijíma opatrenia na ochranu odberateľov,
...
cc) udeľuje výnimku z povinností prístupu do sústavy a siete pre nové spojovacie vedenia alebo pre existujúce spojovacie vedenia podľa osobitného predpisu,[1)](#poznamky.poznamka-1)

dd) schvaľuje prevádzkový poriadok prevádzkovateľa sústavy a siete a prevádzkovateľa zásobníka plynu,

ee) určuje štandardy kvality dodávaných tovarov a služieb poskytovaných podľa tohto zákona, spôsob ich sledovania, vyhodnocovania a zverejňovania; stanovuje podmienky a hodnotu kompenzačnej platby za nedodržanie jednotlivých štandardov kvality dodávaných tovarov a služieb,
...
ii) prijíma opatrenia na zabezpečenie vykonávania osobitných predpisov,[1l)](#poznamky.poznamka-1l)

jj) schvaľuje výšku poplatkov za nevyvážený vstup do siete a odber zo siete[1m)](#poznamky.poznamka-1m) a poplatky za poskytovanie informácií,[1n)](#poznamky.poznamka-1n)

kk) rozhoduje o regulácii iného tovaru alebo služby podľa [§ 12 ods. 12](#paragraf-12.odsek-12),

ll) schvaľuje pravidlá rozdeľovania príjmov z uvoľnenej prerušiteľnej kapacity pri preprave plynu a môže určiť primeranú cenu za uvoľnenú prerušiteľnú kapacitu,[1na)](#poznamky.poznamka-1na) mm) rozhoduje o výnimke z povinnosti zabezpečiť prístup tretích strán do nových prepojovacích vedení, o vyňatí z regulácie podľa tohto zákona pre nové prepojovacie vedenia a o výnimke z použitia príjmov vyplývajúcich z pridelenia nových prepojovacích vedení podľa osobitného predpisu,[1nb)](#poznamky.poznamka-1nb)

nn) prijíma opatrenia pri nedodržaní povinností podľa písmen v), x) a y).
...
Účastníkom konania podľa [§ 5 ods. 1 písm. e)](#paragraf-5.odsek-1.pismeno-e), [j)](#paragraf-5.odsek-1.pismeno-j), [bb)](#paragraf-5.odsek-1.np-2) a [dd)](#paragraf-5.odsek-1.np-4) je navrhovateľ, vo veciach podľa [§ 5 ods. 1 písm. g), h), i)](#paragraf-5.odsek-1.pismeno-g) a [k)](#paragraf-5.odsek-1.pismeno-k) navrhovateľ a prevádzkovateľ sústavy, siete alebo zásobníka.
...
od 10 miliónov Sk do 100 miliónov Sk za porušenie povinností podľa [§ 11 ods. 1](#paragraf-11.odsek-1), [§ 12a ods. 6](#paragraf-12a.odsek-6), [§ 13 ods. 2 písm. a)](#paragraf-13.odsek-2), [g)](#paragraf-13.odsek-2.pismeno-g) a [i)](#paragraf-13.odsek-2.pismeno-i), a od 500 000 Sk do 5 miliónov Sk pre regulované subjekty, ktoré prevádzkujú III. kategóriu verejného vodovodu alebo III. kategóriu verejnej kanalizácie,[11b)](#poznamky.poznamka-11b)

b)

od 1 milióna Sk do 100 miliónov Sk za porušenie povinností podľa [§ 13 ods. 2 písm. b), c), d)](#paragraf-13.odsek-2.pismeno-b), [f)](#paragraf-13.odsek-2.pismeno-f), [h)](#paragraf-13.odsek-2.pismeno-h), [j)](#paragraf-13.odsek-2.pismeno-j), [l)](#paragraf-13.odsek-2.pismeno-l), [o), p) a q)](#paragraf-13.odsek-2.pismeno-o), a za porušenie povinností podľa osobitných predpisov[1l)](#poznamky.poznamka-1l) a od 50 000 Sk do 500 000 Sk pre regulované subjekty, ktoré prevádzkujú III. kategóriu verejného vodovodu alebo III. kategóriu verejnej kanalizácie,[11b)](#poznamky.poznamka-11b)
