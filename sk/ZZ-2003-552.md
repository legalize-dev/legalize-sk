...
Bezúhonnosť sa preukazuje výpisom z registra trestov[10)](#poznamky.poznamka-10) nie starším ako tri mesiace. O zabezpečenie výpisu z registra trestov môže fyzická osoba podľa odseku 1 písomne alebo elektronicky požiadať zamestnávateľa, ktorý je súčasne služobným úradom podľa osobitného predpisu;[10a)](#poznamky.poznamka-10a) žiadosť musí obsahovať údaje potrebné na vyžiadanie výpisu z registra trestov. Údaje určené na zabezpečenie výpisu z registra trestov zamestnávateľ, ktorý je súčasne služobným úradom podľa osobitného predpisu, bezodkladne zašle v elektronickej podobe prostredníctvom centrálneho informačného systému[10b)](#poznamky.poznamka-10b) Generálnej prokuratúre Slovenskej republiky.
