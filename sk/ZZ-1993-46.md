...
V prípadoch, že údaje uchovávané v evidenciách informačnej služby už nie sú na plnenie ustanovených úloh potrebné, alebo pokiaľ je na to iný zákonný dôvod, je informačná služba oprávnená tieto údaje uložiť spôsobom, ktorý zabráni každému, s výnimkou súdu, v prístupe k nim.
