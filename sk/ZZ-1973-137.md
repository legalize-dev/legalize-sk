...
Priamy materiál sa oceňuje platnými veľkoobchodnými cenami alebo odbytovými cenami určenými podľa [§ 45 ods. 5](#paragraf-45.odsek-5); veľkoobchodnými cenami s daňou z obratu alebo maloobchodnými cenami sa priamy materiál oceňuje v prípadoch, keď je organizácia povinná nakupovať za tieto ceny. Použitie iných druhov cien a základných cien v čase, keď sú platné zvýhodnené alebo znevýhodnené ceny, sa spravuje rozhodnutím príslušného cenového úradu. Za podmienok uvedených v odseku 4 sa priamy materiál oceňuje plánovanými cenami podľa platných odvetvových, odborových alebo vnútropodnikových cenníkov.
...
Výrobná organizácia je povinná navrhnúť zníženie ceny výrobku mesiac pred uplynutím lehoty technicko-ekonomickej životnosti alebo do jedného mesiaca po tom, čo dostane rozhodnutie orgánov uvedených v [§ 122](#paragraf-122) a [126](#paragraf-126). Veľkoobchodná cena sa znižuje o skutočný zisk výrobku zistený výslednou kalkuláciou zostavenou v poslednom roku výroby, najmenej však o 15 % ceny.
...
ak cena bola určená pred vydaním rozhodnutia o zaradení do prvého stupňa akosti a nebola určená niektorá z cien podľa [§ 5](#paragraf-5),
...
v prípade, keď sa predbežný limit veľkoobchodnej ceny utvoril podľa [§ 47 ods. 3 písm. a)](#paragraf-47.odsek-3), tvorí sa konečný limit veľkoobchodnej ceny rovnakým spôsobom; pritom sa vychádza z technicko-ekonomických parametrov dosiahnutých pri schválenom prototype,

b)

v prípade, keď sa predbežný limit veľkoobchodnej ceny utvoril podľa [§ 47 ods. 3 písm. b)](#paragraf-47.odsek-3.pismeno-b), tvorí sa konečný limit veľkoobchodnej ceny rovnakým spôsobom s tým, že sa jeho výška zdôvodní prepočtom obdobným spôsobu uvedenému v písmene a) alebo c) tohto odseku,
...
ktoré sú výsledkom riešenia štátnych, rezortných a odborových úloh plánu rozvoja vedy a techniky a úloh podnikových plánov rozvoja vedy a techniky, pre ktoré sa mal podľa [§ 47 ods. 1 písm. a)](#paragraf-47.odsek-1) určiť predbežný limit veľkoobchodnej ceny,
...
zdôvodnenie výberu iného porovnateľného výrobku, než ktorý sa zvolil pre návrh veľkoobchodnej ceny podľa [§ 63 ods. 4](#paragraf-63.odsek-5),
...
Návrh konečného limitu veľkoobchodnej ceny predkladá budúci výrobca výrobku najneskoršie do 3 mesiacov od rozhodnutia o zavedení do výroby podľa [§ 48 ods. 1](#paragraf-48.odsek-1). Ak výrobca nie je určený, predkladá návrh organizácia určená dodávateľským ústredným orgánom, prípadne národným výborom. Organizácia navrhujúca konečný limit veľkoobchodnej ceny spotrebného výrobku v prípadoch, keď nebol určený predbežný limit maloobchodnej ceny, alebo v prípadoch podľa [§ 48 ods. 5 písm. b)](#paragraf-48.odsek-5.pismeno-b) zašle návrh konečného limitu veľkoobchodnej ceny aj ministerstvám obchodu republík alebo inému ústrednému orgánu nadriadenému budúcemu odberateľovi, ak ide o výrobok, ktorý organizácie štátneho obchodu nepredávajú. Tieto orgány určia orgán alebo organizáciu, ktorá predloží návrh konečného limitu maloobchodnej ceny, ak sa o jeho určení rozhodne podľa [§ 48 ods. 5](#paragraf-48.odsek-5). Pre cenové konanie o konečných cenových limitoch platia primerane ustanovenia tejto časti vyhlášky; náležitosti návrhu konečného limitu veľkoobchodnej ceny upravuje rozhodnutie cenových úradov.[73)](#poznamky.poznamka-73) Návrhy konečných cenových limitov, ktoré určí príslušný cenový úrad, predkladajú ústredné orgány nadriadené organizáciám, ktoré návrhy vypracovali.

(4)

Predbežný cenový limit pri úlohách plánu rozvoja vedy a techniky je súčasťou návrhu na zaradenie úloh do plánu a určí sa súčasne s rozhodnutím o zaradení úlohy do tohto plánu. Pre určenie konečného cenového limitu platia lehoty podľa [§ 98 ods. 1 a 2](#paragraf-98.odsek-1).

(5)

Registrácii na príslušnom cenovom úrade podliehajú návrhy predbežných limitov veľkoobchodných cien určovaných podľa [§ 129 ods. 1 písm. c)](#paragraf-129.odsek-1.pismeno-c) pri úlohách odborových a podnikových plánov rozvoja vedy a techniky, ďalej návrhy predbežných limitov maloobchodných cien a návrhy konečných cenových limitov veľkoobchodných a maloobchodných cien, na určenie ktorých majú podľa ôsmej časti pôsobnosť organizácie a iné orgány než cenové úrady. Podmienky registrácie ustanovuje príslušný cenový úrad.[73)](#poznamky.poznamka-73)

(6)

Predpísané údaje[73)](#poznamky.poznamka-73) o určení predbežného alebo konečného limitu veľkoobchodnej ceny, ktorý neurčuje príslušný cenový úrad a ktorý nie je uvedený v odseku 5, zasiela organizácia, ktorá ho navrhla, do jedného mesiaca od jeho určenia príslušnému cenovému úradu na evidenciu.

(7)

O určených konečných cenových limitoch vedú orgány a organizácie evidenciu v rozsahu podľa [§ 98 ods. 4](#paragraf-98.odsek-4).

(8)

Pre riešenie sporov o výške predbežných limitov maloobchodných cien a konečných cenových limitov platia ustanovenia [§ 99](#paragraf-99).
...
zabezpečujú pri výrobkoch predávaných súbežne s inými organizáciami opatrenia pre dopredaje podľa [§ 126 ods. 9](#paragraf-126.odsek-9) po dohode s ústrednými orgánmi týchto organizácií.
...
určujú evidenčné veľkoobchodné ceny vývozu, pokiaľ príslušný cenový úrad nerozhodne inak, predbežné limity veľkoobchodných cien pri odborových a podnikových plánoch rozvoja vedy a techniky, pokiaľ si ich určenie nevyhradí nadriadené ministerstvo, konečné limity veľkoobchodných cien podľa [§ 48 ods. 4 písm. e)](#paragraf-48.odsek-4.pismeno-e), ďalej predbežné a konečné cenové limity v rozsahu podľa poverenia,
...
Výrobné organizácie priamo riadené ústrednými orgánmi majú pôsobnosť podľa odseku 1 písm. b) až g) a i) až s). Výrobné organizácie uvedené v [§ 127 ods. 3 až 5](#paragraf-127.odsek-3) majú pôsobnosť podľa odseku 1 písm. b) až g), i) okrem opráv výrobných prostriedkov a cien prác priemyselnej povahy, podľa písmena j) až s), podľa odseku 7 a [§ 48 ods. 4 písm. e)](#paragraf-48.odsek-4.pismeno-e).
