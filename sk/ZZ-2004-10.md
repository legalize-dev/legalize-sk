...
Drahými kameňmi sú na účely tohto zákona prírodné substancie anorganického pôvodu a organického pôvodu používané v šperkárstve, uvedené v [prílohe k zákonu](#prilohy.priloha-1.text).
...
vedie register výrobcov a obchodníkov s drahými kovmi, a obchodníkov s neopracovanými diamantmi,[5a)](#poznamky.poznamka-5a)
...
na vyžiadanie vykonáva expertíznu činnosť v odbore drahých kameňov pre potreby colného úradu alebo colného kriminálneho úradu,[6a)](#poznamky.poznamka-6a)

p)

vykonáva kontrolu vnútorného trhu s neopracovanými diamantmi podľa osobitného predpisu.[6b)](#poznamky.poznamka-6b)
...
Ak osobitný predpis neustanovuje inak, Puncový úrad vykonáva správu majetku štátu pri tovare podľa [§ 3 ods. 1 písm. a)](#paragraf-3.odsek-1.pismeno-a), drahých kovoch a drahých kameňoch,
...
ktoré boli prenechané v prospech štátu, alebo pri tovare alebo veci, pri ktorých štát nadobudol vlastnícke právo podľa osobitného predpisu.[6c)](#poznamky.poznamka-6c)

(2)

Puncový úrad je oprávnený tovar alebo vec uvedené v odseku 1 predať, spravidla na dražbe, pričom postupuje podľa osobitného predpisu.[6d)](#poznamky.poznamka-6d)

(3)

Ak tento zákon neustanovuje inak, pri nakladaní s majetkom štátu podľa odsekov 1 a 2 sa postupuje podľa osobitného predpisu.[6e)](#poznamky.poznamka-6e)
...
Výrobca je povinný pri predložení písomne oznámiť druh, hmotnosť, počet kusov a rýdzosť tuzemského tovaru. Ak je predkladaný tovar kombinovaný s inými materiálmi, jeho hmotnosť určí Puncový úrad odhadom. Ak je tuzemský tovar vyrobený z inej než registrovanej zliatiny, je výrobca povinný pri predložení takisto oznámiť druh a hmotnostný obsah kovov použitých v zliatine.
...
Predložený cudzí tovar musí obchodník trvanlivo označiť alebo nechať trvanlivo označiť pridelenou zodpovednostnou značkou ([§ 50](#paragraf-50)) na mieste, ktoré určí Puncový úrad, a to takým spôsobom, aby sa vedľa nej mohla umiestniť puncová značka.

(4)

Cudzí tovar, ktorý pochádza z členského štátu Európskej únie a ktorý nie je úradne označený podľa [§ 54 ods. 2](#paragraf-54.odsek-2), predkladá na puncovú kontrolu obchodník, ktorý ho doviezol, spolu s dokladmi preukazujúcimi jeho pôvod.
...
Ak osoba, ktorá má povinnosť alebo záujem tovar predložiť (ďalej len „predkladateľ“), nesplní povinnosti uvedené v [§ 12](#paragraf-12), [§ 13 ods. 1](#paragraf-13.odsek-1), [3 až 5](#paragraf-13.odsek-3) a [§ 14](#paragraf-14), neprijme Puncový úrad tovar na puncovú kontrolu.
...
Na spájkovanie tovaru s výnimkou platinového sa musí použiť spájka z rovnakého drahého kovu, z akého je zhotovený tovar. Na spájkovanie platinového tovaru možno použiť zlatú spájku. Použitie iných spájok môže v technologicky odôvodnených prípadoch povoliť Puncový úrad.
...
Puncový úrad nevykoná zistenie a overenie obsahu drahých kovov, ak vykonanie požadovaných úkonov nie je v jeho technických možnostiach alebo ak vykonanie požadovaných úkonov nie je možné z dôvodov ochrany zdravia.
...
Na výkon identifikácie drahých kameňov sa vzťahuje ustanovenie [§ 35 ods. 3](#paragraf-35.odsek-3) obdobne.
...
Puncový úrad vedie register výrobcov a obchodníkov s drahými kovmi a obchodníkov s neopracovanými diamantmi podľa [§ 37](#paragraf-37) (ďalej len „register“).
...
predmet podnikania s drahými kovmi alebo neopracovanými diamantmi,
...
dátum začatia a ukončenia činnosti s drahými kovmi alebo neopracovanými diamantmi,
...
Na priestupky a ich prejednávanie sa vzťahuje všeobecný predpis o priestupkoch.[17a)](#poznamky.poznamka-17a)
...
Tento zákon nadobúda účinnosť 1. marca 2004 s výnimkou [§ 13 ods. 3](#paragraf-13.odsek-3), ktorý nadobúda účinnosť 1. septembra 2004, a [§ 54 ods. 2](#paragraf-54.odsek-2), ktorý nadobúda účinnosť dňom nadobudnutia platnosti zmluvy o pristúpení Slovenskej republiky k Európskej únii.
