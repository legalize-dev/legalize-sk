...
Výrobca^1) vykonáva výrobu tabakových výrobkov, ak výrobca alebo ním ustanovený zodpovedný zástupca

a)

absolvoval vysokoškolské vzdelanie v potravinárskom odbore alebo stredné odborné vzdelanie v potravinárskom odbore, alebo má uznané obdobné vzdelanie[1a)](#poznamky.poznamka-1a) a
...
Živnostenský úrad[1b)](#poznamky.poznamka-1b) do 30 dní odo dňa vydania osvedčenia o živnostenskom oprávnení zašle Ministerstvu pôdohospodárstva a rozvoja vidieka Slovenskej republiky (ďalej len „ministerstvo“) zoznam vydaných, pozastavených, zaniknutých a zrušených oprávnení na výrobu tabakových výrobkov.

(4)

Výrobca, dovozca[1c)](#poznamky.poznamka-1c) alebo distribútor[1d)](#poznamky.poznamka-1d) tabakových výrobkov (ďalej len „prevádzkovateľ“) je povinný pred začatím činnosti oznámiť na účely registrácie podľa odseku 6 príslušnej regionálnej veterinárnej a potravinovej správe prevádzkareň, v ktorej vykonáva činnosť na ktoromkoľvek stupni výroby tabakových výrobkov alebo ich uvádzania na trh (ďalej len „prevádzkareň“).
...
používať na výrobu tabakových výrobkov povolené prídavné látky[1e)](#poznamky.poznamka-1e) a zložky[1f)](#poznamky.poznamka-1f) v určenom množstve,
...
viesť evidenciu o všetkých použitých zložkách tabakových výrobkov,[1g)](#poznamky.poznamka-1g) polovýrobkoch a o hotových výrobkoch,
...
Ten, kto vyrába tabakové výrobky alebo ich uvádza na trh, je povinný ich označiť na každom spotrebiteľskom balení, okrem údajov podľa osobitného predpisu,[1h)](#poznamky.poznamka-1h) v kodifikovanej podobe štátneho jazyka[2)](#poznamky.poznamka-2) údajmi o:
...
zákaz uvádzania tabakových výrobkov na trh na čas potrebný na vykonanie nevyhnutných kontrol a analýz; orgán úradnej kontroly ďalej postupuje podľa osobitného predpisu,[3)](#poznamky.poznamka-3)
...
nesplnil povinnosť registrácie podľa [§ 3 ods. 4](#paragraf-3.odsek-4),

f)

neoznámil zmenu činnosti prevádzkarne alebo jej uzatvorenie podľa [§ 3 ods. 5](#paragraf-3.odsek-5).
...
Prevádzkovateľ je povinný do 31. decembra 2016 aktualizovať údaje podľa [§ 3 ods. 5](#paragraf-3.odsek-5), inak registrácia zanikne.
...
Zrušuje sa zákon č. [63/1950 Zb.](../../../../SK/ZZ/1950/63/) o úprave hospodárenia s tabakom, soľou a liehom a o zrušení štátnych finančných monopolov v znení neskorších predpisov.
