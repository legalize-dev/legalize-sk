...
ktorými mu boli oznámené existujúce účinné látky ako látky základné na účely zmeny autorizácie alebo registrácie podľa [§ 11](#paragraf-11) alebo predĺženia doby na zaradenie alebo zmeny požiadaviek na zaradenie účinnej látky do zoznamu podľa § 13 a od ich predĺženia uplynulo menej ako 5 rokov; tým nie je dotknutá povinnosť dodržať lehoty uvedené v písmenách a) až d).
