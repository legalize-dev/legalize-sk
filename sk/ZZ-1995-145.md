...
Tento zákon upravuje správne poplatky (ďalej len „poplatky“), ktoré sa platia za úkony a konania orgánov štátnej správy, vyšších územných celkov, obcí, štátnych archívov,[1)](#poznamky.poznamka-1) uznaných vzdelávacích inštitúcií[1aa)](#poznamky.poznamka-1aa) a DataCentra (ďalej len „správny orgán“).
...
Poplatky možno platiť aj prostredníctvom integrovaného obslužného miesta alebo akreditovaného platiteľa podľa osobitného predpisu.[6ab)](#poznamky.poznamka-6ab)
...
Platba vykonaná prostredníctvom integrovaného obslužného miesta alebo akreditovaného platiteľa podľa osobitného predpisu[6ab)](#poznamky.poznamka-6ab) sa považuje za uhradenú dňom doručenia zaručenej informácie o úhrade podľa osobitného predpisu.[7aa)](#poznamky.poznamka-7aa)
...
Ak sa poplatok platí prostredníctvom integrovaného obslužného miesta alebo akreditovaného platiteľa podľa osobitného predpisu,[6ab)](#poznamky.poznamka-6ab) lehota je zachovaná, ak je zaručená informácia o úhrade podľa osobitného predpisu[7aa)](#poznamky.poznamka-7aa) doručená najneskôr v posledný deň lehoty.
