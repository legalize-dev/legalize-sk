...
Ak sa úkony a konania vykonávajú na základe návrhu podaného elektronickými prostriedkami alebo prostredníctvom integrovaného obslužného miesta[5)](#poznamky.poznamka-5) a ak tento zákon pri jednotlivých položkách sadzobníka neustanovuje inak, sadzba poplatku je 50 % z poplatku určeného podľa sadzobníka; v týchto prípadoch sa však poplatok znižuje najviac o 70 eur. Ak sú súčasťou návrhu prílohy, uplatní sa znížená sadzba poplatkov podľa prvej vety len vtedy, ak sú tieto prílohy v elektronickej podobe.
...
Poplatky možno platiť aj prostredníctvom integrovaného obslužného miesta[6ab)](#poznamky.poznamka-6ab) alebo platobnej brány Štátnej pokladnice.[6)](#poznamky.poznamka-6)
...
Ak sa vo veci spoplatneného úkonu alebo konania komunikuje elektronicky prostredníctvom ústredného portálu verejnej správy,[7ac)](#poznamky.poznamka-7ac) špecializovaného portálu[7ad)](#poznamky.poznamka-7ad) alebo integrovaného obslužného miesta,[7ae)](#poznamky.poznamka-7ae) správne orgány, okrem správnych orgánov podľa odsekov 4, 5, 7 a 8, umožnia poplatníkovi zaplatiť poplatok prostredníctvom prevádzkovateľa systému a na účely identifikácie poplatku používajú číselník poplatkov orgánom verejnej moci. Ak ide o poplatky za úkony vykonávané obcami alebo vyššími územnými celkami v rámci preneseného výkonu štátnej správy, správny orgán môže postupovať podľa prvej vety.

(11)

Platba vykonaná prostredníctvom integrovaného obslužného miesta podľa osobitného predpisu[6ab)](#poznamky.poznamka-6ab) sa považuje za uhradenú dňom doručenia zaručenej informácie o úhrade podľa osobitného predpisu.[7aa)](#poznamky.poznamka-7aa)
...
Poplatok alebo preplatok, ktorý neprevyšuje 1,70 eura a ktorý nemožno podľa odseku 9 prvej vety vrátiť, je príjmom podľa [§ 17 ods. 1.](#paragraf-17.odsek-1)
...
Ak sa poplatok platí prostredníctvom integrovaného obslužného miesta podľa osobitného predpisu,[6ab)](#poznamky.poznamka-6ab) lehota je zachovaná, ak je zaručená informácia o úhrade podľa osobitného predpisu[7aa)](#poznamky.poznamka-7aa) doručená najneskôr v posledný deň lehoty.
...
Ustanovenia v Sadzobníku správnych poplatkov [časti VIII](#prilohy.priloha-priloha_zakona_narodnej_rady_slovenskej_republiky_c_145_1995_z_z.op-prehlad.op-cast_8) Finančná správa a obchodná činnosť [položke 152 písmeno n)](#prilohy.priloha-priloha_zakona_narodnej_rady_slovenskej_republiky_c_145_1995_z_z.op-prehlad.op-cast_8.np-15) a [al) až aq)](#prilohy.priloha-priloha_zakona_narodnej_rady_slovenskej_republiky_c_145_1995_z_z.op-prehlad.op-cast_8.np-15) sa do 25. mája 2021 neuplatňujú.
