...
Výbor pre nezlučiteľnosť funkcií najmä a) preskúmava, či poslanec nevykonáva funkciu nezlučiteľnú s funkciou poslanca alebo funkciu, pre ktorú sa mandát poslanca neuplatňuje,[46)](#poznamky.poznamka-46) b) plní úlohy súvisiace s preskúmavaním, či konanie štátneho funkcionára[47)](#poznamky.poznamka-47) je v rozpore s osobitným predpisom,[14)](#poznamky.poznamka-14) c) podáva národnej rade správy o výsledku preskúmavania podľa písmen a) a b) a navrhuje uznesenie, ktoré by mala schváliť.
...
Národná rada si zriaďuje z poslancov osobitné kontrolné výbory na kontrolu činnosti služieb vykonávaných podľa osobitných predpisov.[30)](#poznamky.poznamka-30) Práva a povinnosti osobitných kontrolných výborov a ich členov upravujú osobitné predpisy.[50)](#poznamky.poznamka-50)
