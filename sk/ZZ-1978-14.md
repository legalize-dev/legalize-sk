...
Spôsoby zisťovania porastových zásob drevnej hmoty sa rozlišujú podľa kategórií lesov, hospodárskeho tvaru lesa, hospodárskeho spôsobu, stavu lesného porastu, požadovanej presnosti a hospodárnosti; zisťujú sa v m^3 bez kôry na pni

a)

vo vysokom hospodárskom lese s hospodárskym spôsobom rúbaňovým v lesných porastoch poslednej vekovej triedy a starších, t. j. od veku rubnej doby mínus 20 rokov a viac, s predpisom obnovnej ťažby sa porastové zásoby zisťujú priemerkovaním naplno, v lesných porastoch poslednej vekovej triedy a starších, v ktorých nie je predpísaná obnovná ťažba, štatistickými reprezentatívnymi metódami; v ostatných lesných porastoch štatistickými reprezentatívnymi metódami alebo pomocou rastových tabuliek na podklade plochy zastúpenia lesných drevín, veku, bonity a zakmenenia,

b)

vo vysokom hospodárskom lese s hospodárskym spôsobom výberkovým sa porastové zásoby zisťujú priemerkovaním naplno,
...
v lesoch osobitného určenia sa porastové zásoby zisťujú obdobne ako v hospodárskych lesoch,

e)

vo všetkých lesoch výmladkového pôvodu sa porastové zásoby odvodia z predchádzajúcich ťažbových výsledkov alebo pomocou rastových tabuliek.
...
Výška obnovnej ťažby pre hospodárske súbory sa z hľadiska rozšírenej reprodukcie odvodí vo vekových stupňoch týmito ťažbovými percentami:

| Počet desaťročí, o ktoré je vekový stupeň vzdialený od rubnej doby | Obnovná doba (roky) | | | | | | --- | --- | --- | --- | --- | --- | | 10 | 20 | 30 | 40 | 50 | | | -4 | - | - | - | - | 2 | | -3 | - | - | 4 | 12 | 18 | | -2 | 12 | 25 | 30 | 29 | 25 | | -1 | 86 | 67 | 50 | 40 | 33 | | +1 | 100 | 100 | 88 | 67 | 50 | | +2 | - | - | 100 | 100 | 88 | | +3 | - | - | - | - | 100 |

(5)

Na zabezpečenie ťažbovej vyrovnanosti sa výška obnovných ťažieb, odvodená pre tri nasledujúce desaťročia podľa odseku 4, vyrovná v jednotlivých kategóriách lesov tak, aby sa dosiahol rovnomerný vývoj ťažieb drevnej hmoty a zloženie vekových stupňov; porovná sa s plochou normálneho rúbaniska a s priemerným rubným prírastkom.

(6)

Ak sa výška obnovných ťažieb podľa odseku 5 v hospodárskych lesoch odchyľuje o viac ako ± 5 % od výšky obnovných ťažieb odvodených pomocou ťažbového percenta, je potrebné schválenie ministerstva.
...
Vypracúvanie návrhov lesných hospodárskych plánov s platnosťou od 1. januára 1978 sa dokončí podľa doterajších predpisov.
