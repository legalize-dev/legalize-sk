...
rozdelenie účelovej dotácie zo štátneho rozpočtu na spolufinancovanie príspevkov na aktívnu politiku trhu práce podľa [§ 84a](#paragraf-84a), [86](#paragraf-86), [90a](#paragraf-90a), [91a](#paragraf-91a) a [§ 93a](#paragraf-93a),
...
výšku stravnej jednotky pre občanov so zmenenou pracovnou schopnosťou pri celodennom stravovaní v zariadeniach na pracovnú rehabilitáciu zriadených Národným úradom práce alebo ministerstvom,
...
schvaľovať výkon dohodnutej práce nadčas nad rozsah ustanovený osobitným predpisom.[1a)](#poznamky.poznamka-1a)
...
návrh na rozdelenie účelovej dotácie zo štátneho rozpočtu na spolufinancovanie príspevkov na aktívnu politiku trhu práce podľa [§ 84a](#paragraf-84a), [86](#paragraf-86), [90a](#paragraf-90a), [91a](#paragraf-91a) a [§ 93a](#paragraf-93a),
...
návrh výšky stravnej jednotky pre občanov so zmenenou pracovnou schopnosťou pri celodennom stravovaní v zariadeniach na pracovnú rehabilitáciu zriadených Národným úradom práce alebo ministerstvom,
...
kontrolovať dodržiavanie právnych predpisov o zamestnanosti a kontrolovať hospodárenie úradov práce,
...
Krajský úrad práce je výkonným orgánom Národného úradu práce pre územný obvod schválený predstavenstvom.
...
kontrolovať dodržiavanie právnych predpisov o zamestnanosti a kontrolovať hospodárenie okresných úradov práce,
...
Okresný úrad práce je výkonným orgánom Národného úradu práce pre územný obvod schválený predstavenstvom.
...
kontrolovať dodržiavanie právnych predpisov o zamestnanosti vo svojom územnom obvode,
...
predkladať správnemu výboru okresného úradu práce na schválenie žiadosti o povolenie výkonu dohodnutej práce nadčas nad rozsah ustanovený osobitným predpisom[1a)](#poznamky.poznamka-1a) a po ich schválení vydávať povolenia na výkon dohodnutej práce nadčas,
...
o povinnosti zamestnávateľa zaplatiť odvod za neplnenie povinného podielu zamestnávania občanov so zmenenou pracovnou schopnosťou a občanov so zmenenou pracovnou schopnosťou s ťažším zdravotným postihnutím podľa [§ 114 ods. 1](#paragraf-114).
...
prijímať žiadosti o poskytnutie peňažných náhrad z garančného fondu, uskutočňovať výplaty týchto peňažných náhrad, uplatňovať pohľadávky Národného úradu práce voči zamestnávateľom, ktorí sú platobne neschopní,[2b)](#poznamky.poznamka-2b)

x)

zabezpečovať úlohy spojené s hromadným prepúšťaním,[2c)](#poznamky.poznamka-2c)
...
osoby, ktoré boli vedené ako dlhodobo nezamestnané pred nástupom na dohodnuté verejnoprospešné pracovné miesto podľa [§ 91a](#paragraf-91a),

4.

absolventi škôl, ktorí boli vedení ako nezamestnaní viac ako šesť mesiacov pred nástupom na dohodnuté pracovné miesto pre absolventa školy na určitú dobu podľa [§ 90a](#paragraf-90a).

za) spolupracovať s obcou v rozsahu podľa [§ 22a](#paragraf-22a).
...
Do pôsobnosti okresného úradu práce patrí aj uzatváranie dohôd o náhradách cestovných výdavkov podľa [§ 86 ods. 2 a 3](#paragraf-86.odsek-2) a poskytovanie náhrad cestovných výdavkov podľa [§ 86 ods. 4](#paragraf-86.odsek-4).
...
sústavnej prípravy na povolanie, ak občan platil príspevok na poistenie v nezamestnanosti najmenej šesť mesiacov podľa [§ 57](#paragraf-57),
...
povinnej vojenskej služby, ďalšej vojenskej služby, ktorá sa vykonáva ako prípravná služba, mimoriadnej vojenskej služby[8a)](#poznamky.poznamka-8a) a civilnej služby,[8b)](#poznamky.poznamka-8b)
...
starostlivosti o dieťa do piatich rokov veku, ak osoba starajúca sa o dieťa bola v posledných troch rokoch pred začatím tejto starostlivosti platiteľom príspevku na poistenie v nezamestnanosti najmenej 24 mesiacov,
...
priemerný mesačný vymeriavací základ, ak občan platil príspevok na poistenie v nezamestnanosti podľa [§ 57](#paragraf-57) aspoň za šesť celých kalendárnych mesiacov v posledných troch rokoch pred jeho zaradením do evidencie nezamestnaných, alebo
...
Podpora v nezamestnanosti sa poskytuje najviac do výšky 1,5-násobku životného minima pre plnoletú fyzickú osobu ustanoveného osobitným predpisom.[9)](#poznamky.poznamka-9)

(7)

Podpora v nezamestnanosti sa poskytuje najviac do výšky 5 400 Sk.
...
Do podpornej doby sa nezapočítava doba, počas ktorej evidovaný nezamestnaný poberal nemocenské alebo peňažnú pomoc v materstve.
...
občania, ktorí vykonávajú osobnú asistenciu podľa osobitného predpisu[7a)](#poznamky.poznamka-7a) v rozsahu najmenej 90 hodín mesačne.

(3)

Príspevok na poistenie v nezamestnanosti neplatia zamestnanci, samostatne zárobkovo činné osoby, spolupracujúce osoby a dobrovoľní platitelia príspevku na poistenie v nezamestnanosti, ak im bol priznaný starobný dôchodok alebo invalidný dôchodok s výnimkou invalidného dôchodku invalidného občana, ktorý je schopný vykonávať sústavné zamestnanie iba za celkom mimoriadnych podmienok. Poberanie týchto dôchodkov preukazuje fyzická osoba rozhodnutím o priznaní starobného dôchodku, rozhodnutím o priznaní invalidného dôchodku.
...
Zamestnávateľ platí príspevok na poistenie v nezamestnanosti vo výške 2,75 % z úhrnu vymeriavacích základov svojich zamestnancov. Do vymeriavacieho základu zamestnávateľa sa na päť mesiacov nezahŕňa vymeriavací základ zamestnanca, ktorému bolo vydané potvrdenie podľa [§ 20 ods. 2 písm. z)](#paragraf-20.odsek-2.pismeno-z) a s ktorým zamestnávateľ uzatvoril pracovnú zmluvu aspoň na päť mesiacov.

(3)

Zamestnávateľ, u ktorého podiel zamestnaných občanov so zmenenou pracovnou schopnosťou a občanov so zmenenou pracovnou schopnosťou s ťažším zdravotným postihnutím na celkovom priemernom evidenčnom počte zamestnancov vo fyzických osobách je vyšší ako 25 %, platí príspevok na poistenie v nezamestnanosti vo výške 0,9 % z úhrnu vymeriavacích základov všetkých svojich zamestnancov.
...
Dobrovoľní platitelia príspevku na poistenie v nezamestnanosti platia príspevok na poistenie v nezamestnanosti vo výške 3 % z určeného vymeriavacieho základu.
...
Vymeriavacím základom na určenie výšky príspevku na poistenie v nezamestnanosti samostatne zárobkovo činnej osoby, ktorá sa rozhodla pre osobitný spôsob zdaňovania a platenia dane (ďalej len „paušálna daň“) podľa osobitného predpisu,[11a)](#poznamky.poznamka-11a) je ňou určená suma najmenej v sume ustanovenej v [§ 63 ods. 1 až 3](#paragraf-63).

(3)

Vymeriavacím základom na určenie výšky príspevku na poistenie v nezamestnanosti samostatne zárobkovo činnej osoby, ktorá sa rozhodla pre paušálnu daň podľa osobitného predpisu[11a)](#poznamky.poznamka-11a) a ktorej sa poskytne úľava na paušálnej dani podľa osobitného predpisu[11b)](#poznamky.poznamka-11b) v prvých troch rokoch vykonávania alebo prevádzkovania samostatnej zárobkovej činnosti, je ňou určená suma najmenej v sume polovice vymeriavacieho základu ustanoveného v [§ 63 ods. 1 až 3](#paragraf-63).
...
Vymeriavací základ na určenie výšky príspevku na poistenie v nezamestnanosti, samostatne zárobkovo činnej osoby, spolupracujúcej osoby a dobrovoľného platiteľa príspevku na poistenie v nezamestnanosti nesmie byť nižší, ako 3 000 Sk, ak zákon ďalej neustanovuje inak.

(2)

Ak je osoba uvedená v odseku 1 čiastočne invalidná,[12)](#poznamky.poznamka-12) jej vymeriavací základ na určenie výšky príspevku na poistenie v nezamestnanosti nesmie byť nižší ako 2 250 Sk.

(3)

Ak je osoba uvedená v odseku 1 invalidná,[12a)](#poznamky.poznamka-12a) jej vymeriavací základ na určenie výšky príspevku na poistenie v nezamestnanosti nesmie byť nižší ako 1 500 Sk.

(4)

Vymeriavací základ zamestnanca, samostatne zárobkovo činnej osoby, spolupracujúcej osoby a dobrovoľného platiteľa príspevku na poistenie v nezamestnanosti je najviac 24 000 Sk.

##### § 64

Ak obdobie uvedené v [§ 57 ods. 4](#paragraf-57.odsek-4) u samostatne zárobkovo činnej osoby a spolupracujúcej osoby netrvá celý kalendárny mesiac, ale len jeho časť, vymeriavací základ za tento kalendárny mesiac sa znižuje o pomernú sumu, ktorá pripadá na toto obdobie. Takto zistený vymeriavací základ môže byť nižší, ako je vymeriavací základ ustanovený v [§ 63 ods. 1 až 3](#paragraf-63.odsek-1).

##### § 65

##### Vymeriavací základ zamestnávateľa

Vymeriavacím základom zamestnávateľa je úhrn vymeriavacích základov jeho zamestnancov vrátane vymeriavacích základov zamestnancov, ktorí sú poberateľmi starobného dôchodku alebo invalidného dôchodku. Do vymeriavacieho základu zamestnávateľa sa nezahŕňa vymeriavací základ zamestnanca na dohodnutom verejnoprospešnom pracovnom mieste pre dlhodobo nezamestnaného podľa [§ 91a](#paragraf-91a).
...
Samostatne zárobkovo činná osoba a dobrovoľný platiteľ príspevku na poistenie v nezamestnanosti odvádzajú príspevok na poistenie v nezamestnanosti na účet okresného úradu práce príslušného podľa miesta svojho trvalého pobytu.
...
bezhotovostným prevodom z účtu odvádzateľa príspevku na poistenie v nezamestnanosti na účet okresného úradu práce v Štátnej pokladnici alebo
...
úroky z vkladov v Štátnej pokladnici znížené o osobitnú sadzbu dane,[12b)](#poznamky.poznamka-12b)
...
účelové dotácie zo štátneho rozpočtu na spolufinancovanie príspevkov na aktívnu politiku trhu práce podľa [§ 84a](#paragraf-84a), [86](#paragraf-86), [90a](#paragraf-90a), [91a](#paragraf-91a) a [§ 93a](#paragraf-93a), ak tak určí zákon o štátnom rozpočte na príslušný rozpočtový rok.
...
najviac vo výške 16 % zo súčtu príjmov základného fondu bežného roka podľa [§ 75 ods. 1 písm. a) až f)](#paragraf-75.odsek-1) a [h)](#paragraf-75.odsek-1.pismeno-h) a príjmov garančného fondu v bežnom kalendárnom roku podľa [§ 77a ods. 2 písm. a)](#paragraf-77a.odsek-2), [c) až g)](#paragraf-77a.odsek-2.pismeno-c),
...
Garančný fond je určený na uspokojovanie nárokov z pracovného pomeru vo forme peňažnej náhrady, ak zamestnávateľ nemôže uspokojiť tieto nároky, lebo sa stal platobne neschopným.[2b)](#poznamky.poznamka-2b)
...
úroky z finančných prostriedkov garančného fondu uložených v Štátnej pokladnici znížené o osobitnú sadzbu dane,[12a)](#poznamky.poznamka-12a)
...
Účelová dotácia zo štátneho rozpočtu do garančného fondu sa poskytne štvrťročne k poslednému dňu prvého mesiaca príslušného štvrťroku vo výške jednej štvrtiny zo sumy podľa [§ 77a ods. 2 písm. b)](#paragraf-77a.odsek-2.pismeno-b). Ročné zúčtovanie účelovej dotácie zo štátneho rozpočtu sa riadi osobitným predpisom.[12ba)](#poznamky.poznamka-12ba)
...
Účelová dotácia zo štátneho rozpočtu Národnému úradu práce na spolufinancovanie príspevkov na aktívnu politiku trhu práce podľa [§ 84a](#paragraf-84a), [86](#paragraf-86), [90a](#paragraf-90a), [91a](#paragraf-91a) a [§ 93a](#paragraf-93a) sa môže poskytnúť na základe žiadosti Národného úradu práce štvrťročne vo forme preddavku. Ročné zúčtovanie účelovej dotácie zo štátneho rozpočtu sa riadi osobitným predpisom.[12ba)](#poznamky.poznamka-12ba)
...
zariadenie zriadené podľa [§ 16 ods. 2 písm. i)](#paragraf-16.odsek-2.pismeno-i),
...
| miera evidovanej nezamestnanosti v okrese na konci kalendárneho mesiaca pred vznikom nového pracovného miesta | celková suma príspevku na jedno vytvorené nové pracovné miesto | | --- | --- | | nad 30 % | 160 000 Sk, | | nad 25 % do 30 % | 130 000 Sk, | | nad 20 % do 25 % | 100 000 Sk, | | nad 15 % do 20 % | 70 000 Sk, | | nad 10 % do 15 % | 40 000 Sk, | | 10 % a menej | 30 000 Sk, |
...
Výška penále podľa odsekov 1 a 2 nemôže presiahnuť dlžnú sumu za kontrolované obdobie. Penále je splatné do 15 dní odo dňa nadobudnutia právoplatnosti rozhodnutia. Okresný úrad práce penále nepredpíše, ak nepresiahne v úhrne sumu 100 Sk za kontrolované obdobie.
...
Zamestnávateľ je povinný mesačne odvádzať príspevok do garančného fondu vo výške 0,25 % z vymeriavacieho základu ustanoveného v [§ 65](#paragraf-65).

(2)

Zamestnávateľ, u ktorého podiel zamestnaných občanov so zmenenou pracovnou schopnosťou a občanov so zmenenou pracovnou schopnosťou s ťažším zdravotným postihnutím na celkovom priemernom evidenčnom počte zamestnancov vo fyzických osobách je vyšší ako 25 %, odvádza príspevok do garančného fondu mesačne vo výške 0,1 % z vymeriavacieho základu ustanoveného v [§ 65](#paragraf-65).
...
Po uskutočnení výplaty peňažných náhrad z garančného fondu sa zamestnávateľ stáva dlžníkom Národného úradu práce a Národný úrad práce sa stáva veriteľom dlžníka. Pohľadávka Národného úradu práce, ktorá vznikla vyplatením peňažných náhrad z garančného fondu, voči zamestnávateľovi, u ktorého bol právoplatným rozhodnutím súdu zamietnutý návrh na vyhlásenie konkurzu pre nedostatok majetku, a pohľadávka podľa odseku 6 sa považujú pre Národný úrad práce za nevymožiteľné; odpíšu sa z účtovnej evidencie a operatívnej evidencie.
...
Ostatné pohľadávky na príspevkoch na poistenie v nezamestnanosti podľa tohto zákona sa považujú za pohľadávky na príspevkoch na poistenie v nezamestnanosti, ktoré vznikli po vyhlásení konkurzu alebo po povolení vyrovnania.[20b)](#poznamky.poznamka-20b)

(6)

Príslušný okresný úrad práce po vyhlásení konkurzu alebo po povolení vyrovnania prihlási pohľadávky na príspevkoch na poistenie v nezamestnanosti vrátane pokút a penále spôsobom a v lehotách ustanovených osobitným predpisom.[20c)](#poznamky.poznamka-20c)
...
Ostatné účinky vyhlásenia konkurzu a povolenia vyrovnania upravuje osobitný predpis.[20a)](#poznamky.poznamka-20a)

##### § 128d

Ustanovenia [§ 128c](#paragraf-128c) sa rovnako použijú aj vo vzťahu k pohľadávkam Národného úradu práce na príspevky do garančného fondu.
...
povinnosti zamestnávateľa zaplatiť odvod za neplnenie povinného podielu zamestnávania občanov so zmenenou pracovnou schopnosťou a občanov so zmenenou pracovnou schopnosťou s ťažším zdravotným postihnutím podľa [§ 114 ods. 1](#paragraf-114).
