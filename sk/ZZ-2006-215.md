...
poškodeným osoba, ktorej bola v dôsledku trestného činu spôsobená ujma na zdraví; ak táto osoba v dôsledku tohto činu zomrela (ďalej len „zomretý“), pozostalý manžel po zomretom a pozostalé dieťa po zomretom, a ak ich niet, pozostalý rodič po zomretom, a ak ho niet, osoba, ku ktorej mal zomretý vyživovaciu povinnosť,

b)

ujmou na zdraví ublíženie na zdraví, ťažká ujma na zdraví alebo smrť spôsobené trestným činom spáchaným inou osobou a morálna škoda spôsobená trestným činom znásilnenia, sexuálneho násilia alebo sexuálneho zneužívania spáchaným inou osobou,
...
trestným činom aj čin inak trestný, spáchaný osobou, ktorá nie je trestne zodpovedná pre nepríčetnosť alebo pre vek.
...
Na výpočet odškodnenia, ak ide o ujmu na zdraví, sa primerane použijú ustanovenia osobitného predpisu upravujúceho poskytovanie náhrady za bolesť a náhrady za sťaženie spoločenského uplatnenia;[1)](#poznamky.poznamka-1) náhradu za sťaženie spoločenského uplatnenia nemožno zvýšiť.[2)](#poznamky.poznamka-2) Ak bola trestným činom spôsobená smrť, poškodený má nárok na vyplatenie odškodnenia v sume päťdesiatnásobku minimálnej mzdy. Ak právo na odškodnenie majú viacerí poškodení, rozdelí sa uvedená suma medzi nich rovnakým dielom. Poškodený trestným činom znásilnenia, sexuálneho násilia alebo sexuálneho zneužívania má nárok aj na vyplatenie odškodnenia za spôsobenú morálnu škodu v sume desaťnásobku minimálnej mzdy.
...
Odškodnenie vypočítané podľa [§ 5 a 6](#paragraf-5) možno primerane znížiť, ak poškodený spoluzavinil ujmu na zdraví alebo neprijal opatrenia, aby odškodnenie získal od páchateľa trestného činu, ktorým mu bola spôsobená ujma na zdraví.
...
Žiadosť treba podať orgánu podľa odseku 1 do šiestich mesiacov odo dňa nadobudnutia právoplatnosti rozsudku alebo trestného rozkazu uvedeného v [§ 4 ods. 1](#paragraf-4.odsek-1), alebo iného rozhodnutia orgánu činného v trestnom konaní alebo súdu, ktorý v prípadoch uvedených v [§ 4 ods. 2](#paragraf-4.odsek-2) vo veci naposledy konal. Na žiadosti podané po tejto lehote sa nebude prihliadať.

(3)

Ak súd v trestnom konaní poškodeného s jeho nárokom odkázal na civilný proces alebo konanie pred iným orgánom, žiadosť treba podať do šiestich mesiacov odo dňa nadobudnutia právoplatnosti rozhodnutia, ktorým sa rozhodlo o nároku poškodeného v civilnom procese alebo konaní pred iným orgánom. Na žiadosti podané po tejto lehote sa nebude prihliadať.
...
Žiadosť podľa [§ 8 ods. 1](#paragraf-8.odsek-1) obsahuje meno a priezvisko, dátum narodenia, bydlisko a rodné číslo poškodeného. Žiadosť sa podáva na tlačive, ktorého vzor určí ministerstvo; tlačivá žiadosti sú k dispozícii na ministerstve, ktoré ich zverejní aj na svojom webovom sídle.
...
Ministerstvo zverejní informácie o podmienkach na získanie odškodnenia podľa tohto zákona na svojom webovom sídle.
...
Týmto zákonom sa preberajú právne záväzné akty Európskej únie uvedené v [prílohe](#prilohy.priloha-priloha_k_zakonu_c_215_2006_z_z.oznacenie).
