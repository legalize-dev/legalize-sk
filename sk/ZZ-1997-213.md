...
Za riaditeľa môže byť zvolená fyzická osoba, ktorá je spôsobilá na právne úkony a je bezúhonná; bezúhonnosť sa preukazuje výpisom z registra trestov. Na účely preukázania bezúhonnosti poskytne riaditeľ údaje potrebné na vyžiadanie výpisu z registra trestov.[8a)](#poznamky.poznamka-8a) Údaje podľa druhej vety registrový úrad bezodkladne zašle v elektronickej podobe prostredníctvom elektronickej komunikácie Generálnej prokuratúre Slovenskej republiky na vydanie výpisu z registra trestov.
