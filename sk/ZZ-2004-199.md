...
Colný orgán pri výkone činnosti podľa odseku 3 postupuje podľa osobitného predpisu[5)](#poznamky.poznamka-5) a osobitného predpisu únie.[8)](#poznamky.poznamka-8)
...
Osoba podľa odseku 1 je povinná uchovávať všetky doklady súvisiace priamo alebo nepriamo s dovozom, vývozom alebo tranzitom tovaru počas desiatich kalendárnych rokov. Začiatok plynutia tejto lehoty ustanovuje osobitný predpis únie.[11)](#poznamky.poznamka-11)
...
Banky a pobočky zahraničných bánk sú povinné podľa osobitného predpisu[13)](#poznamky.poznamka-13) poskytnúť colnému úradu a colnému riaditeľstvu na ich písomnú žiadosť informácie podliehajúce bankovému tajomstvu.
...
Podnikateľ poskytujúci elektronickú komunikačnú sieť alebo elektronickú komunikačnú službu je povinný oznámiť colnému úradu alebo colnému riaditeľstvu na účely vykonania colného dohľadu a uplatňovania osobitného predpisu[14)](#poznamky.poznamka-14) na ich písomnú žiadosť údaje, ktoré sú predmetom telekomunikačného tajomstva.[15)](#poznamky.poznamka-15)
...
tovar oslobodený od vývozného cla podľa osobitného predpisu únie.[22)](#poznamky.poznamka-22)
...
tovar neobchodného charakteru, ktorý je oslobodený od dovozného cla podľa osobitného predpisu únie upravujúceho oslobodenie tovaru prepravovaného cestujúcim v jeho batožine[26)](#poznamky.poznamka-26) alebo je oslobodený od dovozného cla ako vrátený tovar,
...
tovar, ktorý je oslobodený od dovozného cla podľa osobitného predpisu únie upravujúceho oslobodenie poľnohospodárskych výrobkov, semien, hnojív a výrobkov na obrábanie pôdy a pestovanie plodín od dovozného cla,[28)](#poznamky.poznamka-28)
...
zásielky, najmä tlačivá, listy a balíky obsahujúce tovar neobchodného charakteru, ktoré sú oslobodené od dovozného cla podľa osobitného predpisu únie upravujúceho oslobodenie zásielok zasielaných fyzickou osobou z tretieho štátu inej fyzickej osobe na colné územie únie,[29)](#poznamky.poznamka-29)
...
Žiadosť o záväznú informáciu sa podáva colnému úradu, ktorý je príslušný podľa osobitného predpisu.[2)](#poznamky.poznamka-2) Vzor tlačiva žiadosti o vydanie záväznej informácie a vzor tlačiva záväznej informácie sú uvedené v osobitnom predpise únie.[31)](#poznamky.poznamka-31)
...
Prijatie písomného colného vyhlásenia osvedčí colník[19)](#poznamky.poznamka-19) svojím podpisom.
...
Zápis sumy dovozného cla alebo vývozného cla do účtovnej evidencie sa nevykoná, ak ide o sumu, ktorá sa už podľa osobitných predpisov únie[50)](#poznamky.poznamka-50) nemusí dlžníkovi oznámiť.
...
tovar iný, ako je uvedený v písmenách a) a b), ak jeho hodnota nepresahuje spolu 20 EUR, do ktorej sa nezapočítavajú štyri EUR na potraviny, pivo a nealkoholické nápoje; pri parfumoch a toaletných vodách nesmú byť prekročené množstvové obmedzenia ustanovené v osobitnom predpise únie.[54)](#poznamky.poznamka-54)
...
Ak colný úrad zistí, že dlžné čiastky zodpovedajúce ustanoveným nárokom Spoločenstva[63a)](#poznamky.poznamka-63a) na vlastné zdroje nemožno vybrať z dôvodov uvedených v osobitnom predpise únie,[63b)](#poznamky.poznamka-63b) vydá za podmienok ustanovených v tomto osobitnom predpise únie rozhodnutie, na základe ktorého sa čiastky zodpovedajúce ustanoveným nárokom Spoločenstva[63a)](#poznamky.poznamka-63a) na vlastné zdroje vyhlásia za čiastky, ktoré nemožno vybrať.
...
Na účely konkurzného konania a vyrovnacieho konania[64)](#poznamky.poznamka-64) je
...
nezaplatené dovozné clo zodpovedajúce colnému dlhu, ktorý vznikol podľa osobitného predpisu únie;[65)](#poznamky.poznamka-65) to sa vzťahuje aj na colnú pohľadávku, ktorá vznikla iným spôsobom ako prijatím colného vyhlásenia alebo ktorú nevymeral colný úrad,
...
colnou pohľadávkou alebo colným záväzkom vzniknutým po vyhlásení konkurzu alebo po povolení vyrovnania[64)](#poznamky.poznamka-64) colná pohľadávka neuvedená v písmene c) alebo colný záväzok neuvedený v odseku 2.
...
V konkurznom konaní môže colný úrad uplatňovať colnú pohľadávku vzniknutú pred vyhlásením konkurzu aj bez predchádzajúceho vymerania. To sa vzťahuje aj na colnú pohľadávku, ktorá vznikne na základe následnej kontroly[66)](#poznamky.poznamka-66) vykonanej po vyhlásení konkurzu.

(4)

Vo vyrovnacom konaní môže colný úrad uplatňovať colnú pohľadávku vzniknutú pred povolením vyrovnania aj bez predchádzajúceho vymerania. To sa vzťahuje aj na colnú pohľadávku, ktorá vznikne na základe následnej kontroly[66)](#poznamky.poznamka-66) vykonanej po povolení vyrovnania.

(5)

Po vyhlásení konkurzu alebo po povolení vyrovnania colný úrad prihlási colnú pohľadávku spôsobom a v lehote ustanovenej v osobitnom predpise.[67)](#poznamky.poznamka-67)
...
ak ide o dočasne uskladnený tovar a ak úkony potrebné na pridelenie colne schváleného určenia alebo použitia sa nevykonali v lehote ustanovenej v osobitnom predpise únie,[68)](#poznamky.poznamka-68)

d)

ak tovar nebol po prepustení do navrhovaného colného režimu v primeranej lehote vyzdvihnutý alebo nemôže byť prepustený do navrhovaného colného režimu z dôvodov ustanovených v osobitnom predpise únie,[69)](#poznamky.poznamka-69)
...
Ak zaistený tovar alebo vec už nie sú na ďalšie konanie potrebné a ak neprichádza do úvahy ich prepadnutie alebo zhabanie v konaní o colnom priestupku alebo v konaní o colnom delikte, alebo predaj podľa [§ 69 ods. 3 až 7](#paragraf-69.odsek-3), osobe, ktorej boli odňaté, sa vrátia; ustanovenie [§ 56](#paragraf-56) tým nie je dotknuté.
...
Ak predaj tovaru nie je s prihliadnutím na okolnosti prípadu možný, najmä ak je tovar nepredajný, možno dočasne uskladnený tovar poskytnúť na charitatívne účely v súlade s príslušnými ustanoveniami osobitného predpisu únie.[70)](#poznamky.poznamka-70)
...
Ak pokuta uložená na základe vykonateľného rozhodnutia o colnom priestupku alebo o colnom delikte nebola uhradená do 30 dní odo dňa, v ktorom sa rozhodnutie stalo vykonateľné, na účely jej úhrady colný úrad tovar zaistený podľa [§ 64 ods. 1 písm. b)](#paragraf-64.odsek-1.pismeno-b), ktorý neprepadol alebo nebol zhabaný v prospech štátu, predá.

##### § 67a

Z výnosu, ktorý sa získal predajom tovaru, sa prednostne uhradí colný dlh a úrok, náklady konania, skladné a pokuta uložená podľa tohto zákona alebo podľa osobitných predpisov.[5)](#poznamky.poznamka-5) Zvyšok výnosu vyplatí colný úrad oprávnenej osobe. Ak sa táto osoba neprihlási do troch rokov odo dňa predaja tovaru, prepadne zvyšok výnosu z predaja v prospech štátu.
...
ktorý bol prenechaný v prospech štátu, alebo pri tovare, pri ktorom štát nadobudol vlastnícke právo podľa osobitného predpisu,[71)](#poznamky.poznamka-71) ak podlieha colnému dohľadu,

d)

ktorý prepadol štátu alebo bol zhabaný podľa [§ 65 ods. 2](#paragraf-65.odsek-2).

(2)

Ak tento zákon neustanovuje inak, pri nakladaní s majetkom štátu podľa odsekov 1 a 3 sa postupuje podľa osobitného predpisu.[72)](#poznamky.poznamka-72)
...
Ak sa s tovarom podľa odseku 1 nenaložilo spôsobom podľa odseku 3, môže colný úrad bezodplatne previesť správu alebo vlastníctvo na zariadenie sociálnych služieb,[74)](#poznamky.poznamka-74) zdravotnícke zariadenie,[75)](#poznamky.poznamka-75) predškolské zariadenie alebo školu,[76)](#poznamky.poznamka-76) neziskovú organizáciu [77)](#poznamky.poznamka-77) alebo inú právnickú osobu, ktorá nie je podnikateľom,[12)](#poznamky.poznamka-12) ak tá osoba preukázateľne počas najmenej jedného roka poskytuje starostlivosť v zariadeniach sociálnych služieb alebo v zdravotníckych zariadeniach alebo zabezpečuje výchovu a vzdelávanie v predškolských zariadeniach alebo v školách. Na tie účely colné riaditeľstvo zverejňuje ponuky o tovare podľa odseku 1 na svojej internetovej stránke.

(5)

Colný úrad je oprávnený predať tovar podľa odseku 3 ihneď, ak predmetom predaja je tovar, ktorý podlieha rýchlej skaze, alebo živé zvieratá. Ak ide o chránené rastliny, chránené živočíchy a exempláre, môže ich colný úrad predať len so súhlasom Ministerstva životného prostredia Slovenskej republiky.

(6)

Colný úrad predá tovar podľa odseku 3 spravidla na dražbe, pričom postupuje podľa osobitného predpisu.[78)](#poznamky.poznamka-78) Ak nie je možné alebo vhodné predať tovar na dražbe, môže colný úrad predať tento tovar inak.

(7)

S tovarom, ktorý nemožno predať alebo používať zo zdravotných, z veterinárnych, rastlinolekárskych, bezpečnostných, morálnych alebo z iných dôvodov, bude colný úrad zaobchádzať spôsobom ustanoveným osobitnými predpismi.[79)](#poznamky.poznamka-79)

(8)

Z výnosu, ktorý sa získal predajom tovaru, sa prednostne uhradí colný dlh a úrok, náklady konania, skladné a pokuta uložená podľa tohto zákona alebo podľa osobitných predpisov.[5)](#poznamky.poznamka-5)

(9)

Ak nie je možné alebo vhodné s tovarom podľa odseku 1 naložiť spôsobom podľa odsekov 3 až 5, colný úrad môže majetok štátu podľa odseku 1 zničiť, ak náklady na jeho zničenie nie sú vyššie ako náklady na splnenie podmienok podľa osobitných predpisov[73)](#poznamky.poznamka-73) a ak osobitný zákon neustanovuje inak.
...
Nezákonným dovozom a vývozom tovaru sa na účely odseku 1 rozumie dovoz a vývoz tovaru uskutočnený v rozpore s ustanoveniami osobitného predpisu únie.[82)](#poznamky.poznamka-82)
...
Na konanie podľa tohto zákona alebo podľa osobitného predpisu únie[83)](#poznamky.poznamka-83) sa vzťahuje všeobecný predpis o správnom konaní,[25)](#poznamky.poznamka-25) ak tento zákon, osobitný zákon[84)](#poznamky.poznamka-84) alebo osobitný predpis únie[83)](#poznamky.poznamka-83) neustanovuje inak.
...
Ak je žiadateľom o vydanie záväznej informácie podľa osobitného predpisu únie[30)](#poznamky.poznamka-30) fyzická osoba, je povinná na účely vydania záväznej informácie uviesť colnému riaditeľstvu svoje rodné číslo.
...
Ak pri dovoze tovaru vznikne alebo môže vzniknúť daňová povinnosť, na zabezpečenie dane sa použijú colné predpisy; ak je však dovážaný tovar predmetom spotrebnej dane,[85)](#poznamky.poznamka-85) colný orgán vyžaduje zabezpečenie tejto dane vždy.
