...
do 90 kalendárnych dní odo dňa ich dočasného zadržania, ak colný úrad na základe písomnej žiadosti Finančnej spravodajskej jednotky rozhodol o predĺžení dočasného zadržania podľa osobitného predpisu.[3j)](#poznamky.poznamka-3j)
...
Na mieste schválenom colným orgánom rozhodnutím o schválení alebo rozhodnutím o povolení vydanom podľa osobitného predpisu[33a)](#poznamky.poznamka-33a) sa colná kontrola tovaru vykonáva za podmienok určených v takomto rozhodnutí.
...
Colný úrad vykoná colnú kontrolu tovaru prednostne, a to aj mimo určených úradných hodín, ak ide o tovar, ktorý podlieha rýchlej skaze, živé zvieratá, tovar určený na odstránenie následkov havárie, živelnej pohromy[24)](#poznamky.poznamka-24) a podobných udalostí, tovar predkladaný Ministerstvom obrany Slovenskej republiky označený ako naliehavo potrebný, alebo ak hrozí nebezpečenstvo z omeškania.
...
Ustanovenia odsekov 1 až 13 sa primerane použijú aj pri ukončení osobitného colného režimu, vývoze tovaru, spätnom vývoze tovaru a pri preprave v rámci dočasného uskladnenia tovaru.
...
Tovar sa predkladá a colné vyhlásenie sa podáva vnútrozemskej pobočke colného úradu,[41)](#poznamky.poznamka-41) ak odsek 3 neustanovuje inak, okrem
...
Pravidlá a údaje na vypĺňanie colných vyhlásení, vyhlásení na dočasné uskladnenie, oznámení, dôkazov colného statusu tovaru únie, žiadostí a rozhodnutí, ktoré dopĺňajú pravidlá a údaje podľa osobitného predpisu,[42)](#poznamky.poznamka-42) vzor formulára dovozného, vývozného a tranzitného colného vyhlásenia na tovar, ktorý je alebo bude používaný ozbrojenými silami Slovenskej republiky (FORM 302), a vzor formulára NATO - cestovný rozkaz ustanoví všeobecne záväzný právny predpis, ktorý vydá ministerstvo. Zoznam kódov používaných pri vypĺňaní colných vyhlásení, vyhlásení na dočasné uskladnenie, oznámení, dôkazov colného statusu tovaru únie, žiadostí a rozhodnutí, ktorý dopĺňa zoznam kódov podľa osobitného predpisu,[43)](#poznamky.poznamka-43) finančné riaditeľstvo zverejní na svojom webovom sídle; kódy pre údajové prvky, ktorými sú druh obchodu, región určenia a región odoslania, určuje finančné riaditeľstvo po dohode so Štatistickým úradom Slovenskej republiky.
...
Za schválenú charitatívnu organizáciu alebo schválenú dobročinnú organizáciu sa na účely priznania oslobodenia od dovozného cla podľa osobitného predpisu[59c)](#poznamky.poznamka-59c) považuje právnická osoba podľa osobitného predpisu,[59d)](#poznamky.poznamka-59d) ktorá podľa zakladajúceho dokumentu vykonáva činnosť charitatívnej povahy alebo činnosť dobročinnej povahy, alebo medzinárodná organizácia, ktorej predmet činnosti podľa zakladajúceho dokumentu zahŕňa aj činnosť charitatívnej povahy alebo činnosť dobročinnej povahy.

(2)

Na účely odseku 1 sa za zakladajúci dokument považuje štatút, zakladacia listina, zriaďovacia zmluva, zriaďovacia listina, nadačná listina a stanovy; ak ide o medzinárodnú organizáciu, zakladajúcim dokumentom je aj iný obdobný dokument, podľa ktorého bola medzinárodná organizácia založená.

(3)

Ak v období podľa osobitného predpisu[59e)](#poznamky.poznamka-59e) organizácia podľa odseku 1 požiada o oslobodenie od dovozného cla, colný úrad použije postup podľa osobitného predpisu;[59e)](#poznamky.poznamka-59e) podaním žiadosti o oslobodenie od dovozného cla vzniká záväzok podľa osobitného predpisu.[59e)](#poznamky.poznamka-59e)
...
Ručiteľské vyhlásenie pri ručení vo forme jednotlivej záruky v elektronickej podobe musí byť podpísané kvalifikovaným elektronickým podpisom alebo zapečatené kvalifikovanou elektronickou pečaťou.
...
pri použití záruky podľa [§ 54 ods. 2](#paragraf-54.odsek-2) prvej vety posledný deň lehoty ustanovenej colnými predpismi alebo určenej colným úradom na úhradu colného dlhu.
...
Ak sa s tovarom alebo vecou uvedenými v odseku 1 nenaložilo spôsobom podľa odseku 2, môže colný úrad za podmienok podľa colných predpisov darovať tovar alebo vec vo vlastníctve štátu osobám podľa osobitného predpisu[74)](#poznamky.poznamka-74) alebo na účel podľa osobitného predpisu.[75)](#poznamky.poznamka-75) Na tieto účely finančné riaditeľstvo zverejňuje ponuky o tovare alebo veciach uvedených v odseku 1 na svojej internetovej stránke.
...
spôsobí, že bol tovar prepustený na základe nepravých dokladov, pozmenených dokladov alebo falšovaných dokladov alebo nesprávnych údajov alebo nepravdivých údajov a v dôsledku toho sa vymerala nižšia ako skutočne dlžná suma colného dlhu, dane z pridanej hodnoty alebo spotrebnej dane pri dovoze, alebo sa neuplatnili opatrenia týkajúce sa obchodu s tovarom alebo sa neuplatnili iné zákazy a obmedzenia,
...
Za colný priestupok možno podľa závažnosti porušenia colných predpisov uložiť pokutu do 10 000 eur; ak ide o colný priestupok podľa [§ 72 ods. 1 písm. n)](#paragraf-72.odsek-1.pismeno-n) a [o)](#paragraf-72.odsek-1.pismeno-o), do 35 000 eur a ak ide o colný priestupok podľa [§ 72 ods. 1 písm. l)](#paragraf-72.odsek-1.pismeno-l) a [m)](#paragraf-72.odsek-1.pismeno-m), do 5 000 eur.

(3)

V rozkaznom konaní možno uložiť pokutu do 5 000 eur; ak ide o colný priestupok podľa [§ 72 ods. 1 písm. n)](#paragraf-72.odsek-1.pismeno-n) a [o)](#paragraf-72.odsek-1.pismeno-o), do 17 500 eur.

(4)

V blokovom konaní možno uložiť pokutu do 1 000 eur; ak ide o colný priestupok podľa [§ 72 ods. 1 písm. n)](#paragraf-72.odsek-1.pismeno-n) a [o)](#paragraf-72.odsek-1.pismeno-o), do 5 000 eur.
...
Elektronické správy a elektronické dokumenty doručované prostredníctvom informačného systému zriadeného Európskou úniou sa považujú za doručené okamihom ich sprístupnenia prostredníctvom funkcionality tohto informačného systému.
...
V rámci konzultačného postupu medzi colnými orgánmi pri povolení na centralizované colné konanie podľa osobitného predpisu[85aaa)](#poznamky.poznamka-85aaa) sú konzultované colné orgány povinné požadovať, aby podmienkou použitia centralizovaného colného konania bolo zabezpečenie dane, ak pri dovoze tovaru, ktorého sa povolenie týka, vznikne alebo môže vzniknúť daňová povinnosť.
...
pri ktorom je pravdepodobné, že by náklady na jeho vymáhanie presiahli výťažok z vymáhania,

d)

ktorého vymáhanie je spojené s osobitnými ťažkosťami, alebo

e)

ktorý sa stal nevymáhateľným podľa všeobecného predpisu upravujúceho konkurzné konanie.[86a)](#poznamky.poznamka-86a)
...
Nedoplatok platieb vymeraných alebo uložených podľa colných predpisov okrem nedoplatku na cle a nedoplatok dane z pridanej hodnoty alebo spotrebnej dane pri dovoze zanikne dňom

a)

nadobudnutia právoplatnosti uznesenia súdu o tom, že dedičstvo pripadlo štátu, ak dlžník zomrel,

b)

nadobudnutia právoplatnosti uznesenia súdu, ak dlžník zomrel a súd zastavil dedičské konanie po tom, čo majetok nepatrnej hodnoty zanechaný poručiteľom vydal tomu, kto sa postaral o pohreb alebo ak zastavil konanie z dôvodu, že poručiteľ nezanechal majetok,
...
vyhlásenia konkurzu alebo určenia splátkového kalendára podľa štvrtej časti všeobecného predpisu upravujúceho konkurzné konanie,[86a)](#poznamky.poznamka-86a) a to v rozsahu nevymáhateľných nedoplatkov; rovnako zanikajú aj neprihlásené pohľadávky a pohľadávky nezaradené v splátkovom kalendári určenom súdom,

2.

vyhlásenia konkurzu, ak sa uplatnil postup podľa osobitného predpisu,[88a)](#poznamky.poznamka-88a) a to v rozsahu pohľadávok, ktoré zostali po zrušení konkurzu neuspokojené bez ohľadu na to, či boli do konkurzu prihlásené,
...
Nedoplatok podľa odseku 1 nezaniká, ak je colný úrad oprávnený vymáhať nedoplatok aj od iných osôb ako je dlžník, na ktorého sa vzťahuje dôvod uvedený v odseku 1.
...
Na oznámenie sumy colného dlhu, ktorý vznikol pred 1. augustom 2025, sa použije [§ 53 ods. 4](#paragraf-53.odsek-4) v znení účinnom od 1. augusta 2025, ak pred 1. augustom 2025 neuplynula lehota na oznámenie sumy colného dlhu podľa [§ 53 ods. 4](#paragraf-53.odsek-4) v znení účinnom do 31. júla 2025.

(2)

Nedoplatky uvedené v [§ 89c](#paragraf-89c), ktoré vznikli pred 1. augustom 2025 a pri ktorých aj dôvody uvedené v [§ 89c](#paragraf-89c), s ktorými je spojený zánik takýchto nedoplatkov, nastali pred 1. augustom 2025, zanikajú 1. augusta 2025.
