...
Fyzická osoba, ktorá prepravuje peňažné prostriedky v hotovosti podľa odseku 1 v minimálnej výške ustanovenej v osobitnom predpise,[3e)](#poznamky.poznamka-3e) je povinná písomne ohlásiť túto skutočnosť[3e)](#poznamky.poznamka-3e) príslušnému colnému orgánu na tlačive, ktorého vzor je uvedený v [prílohe č. 1](#prilohy.priloha-priloha_c_1_k_zakonu_c_199_2004_z_z.oznacenie).

(3)

Hodnota peňažných prostriedkov sa na účely odseku 2 určuje kurzom príslušnej meny vyhláseným Národnou bankou Slovenska, platným v deň prepravy peňažných prostriedkov v hotovosti podľa odseku 1.
...
Colný úrad vykonáva kontrolu plnenia ohlasovacej povinnosti podľa odseku 2. Pri kontrole je colný úrad oprávnený vyžadovať potrebnú súčinnosť kontrolovaných osôb. Colný úrad vykonáva kontrolu v súlade s oprávneniami a s použitím prostriedkov podľa osobitného predpisu.[2)](#poznamky.poznamka-2)
...
majú vyhlásenie o zhode a značku zhody podľa osobitného predpisu,[5)](#poznamky.poznamka-5)
...
majú pripojenú sprievodnú dokumentáciu podľa osobitného predpisu.[5a)](#poznamky.poznamka-5a)
...
Ak colný orgán zistí, že výrobky alebo séria výrobkov vykazuje charakteristiky, ktoré odôvodňujú podozrenie z vážneho a bezprostredného ohrozenia zdravia a bezpečnosti pri použití týchto výrobkov alebo série výrobkov za bežných a predvídateľných podmienok alebo k výrobkom nie je pripojená sprievodná dokumentácia podľa osobitného predpisu,[5a)](#poznamky.poznamka-5a) požiada pred prepustením výrobkov do navrhovaného colného režimu príslušný orgán dozoru a kontroly[8a)](#poznamky.poznamka-8a) o záväzné stanovisko.

(6)

Ak orgán dozoru a kontroly[8a)](#poznamky.poznamka-8a) zistí, že výrobok je bezpečný podľa osobitného predpisu,[8b)](#poznamky.poznamka-8b) vydá o tom pre colný orgán záväzné stanovisko. Ak colnému orgánu nie je do troch pracovných dní odo dňa požiadania doručené záväzné stanovisko orgánu dozoru a kontroly,[8a)](#poznamky.poznamka-8a) výrobok sa považuje za bezpečný.

(7)

Ak orgán dozoru a kontroly[8a)](#poznamky.poznamka-8a) zistí, že výrobok nie je bezpečný podľa osobitného predpisu,[8b)](#poznamky.poznamka-8b) vydá o tom pre colný orgán záväzné stanovisko. Colný orgán neprepustí výrobky do navrhovaného colného režimu a k sprievodnej dokumentácii podľa osobitného predpisu[5a)](#poznamky.poznamka-5a) pripojí doložku.[8c)](#poznamky.poznamka-8c)
...
Oslobodenie od dovozného cla na tovar dovážaný členom posádky dopravného prostriedku, ktorý pri výkone činnosti prechádza colnú hranicu najmenej raz za týždeň, dovážaný cestujúcim, ktorý má trvalý pobyt v colnom pohraničnom pásme, alebo dovážaný cestujúcim, ktorý pri výkone povolania prechádza colnú hranicu spravidla každý pracovný deň, sa obmedzuje na tieto množstvá, ak ide o
...
Pohonné látky v hlavných nádržiach súkromných motorových vozidiel[58a)](#poznamky.poznamka-58a) prepravované osobami, ktoré majú trvalý pobyt v colnom pohraničnom pásme, sú oslobodené od dovozného cla v množstve najviac 60 l na súkromné motorové vozidlo a na jednu cestu.
