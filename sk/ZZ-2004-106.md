...
| opis tovaru | kombinovaná sadzba dane | | | --- | --- | --- | | | špecifická časť | percentuálna časť | | cigarety | 0,91 Sk/kus | 20 % z ceny cigariet |
...
Colný úrad uloží pokutu prevádzkovateľovi daňového skladu pre zahraničných zástupcov, ak predal zahraničnému zástupcovi tabakové výrobky oslobodené od dane nad limit podľa [§ 33a ods. 12 až 14](#paragraf-33a.odsek-12) alebo predal tabakové výrobky oslobodené od dane osobe, ktorej nebolo vydané povolenie na nákup tabakových výrobkov oslobodených od dane v daňovom sklade pre zahraničných zástupcov, a to vo výške dane pripadajúcej na množstvo takto predaných tabakových výrobkov, najmenej však 100 000 Sk.
