...
použije tabakové výrobky oslobodené od dane podľa [§ 7 písm. f)](#paragraf-7.odsek-1.pismeno-f) na iný ako určený účel.
...
za priestupok podľa odseku 1 písm. d) vo výške 50 % dane pripadajúcej na množstvo tabakových výrobkov oslobodených od dane podľa [§ 7 písm. f)](#paragraf-7.odsek-1.pismeno-f) použitých na iný ako určený účel, najmenej však 5 000 Sk.
