...
Pamiatkový úrad je právnická osoba so sídlom v Bratislave. Pamiatkový úrad je rozpočtová organizácia štátu^8) zapojená finančnými vzťahmi na rozpočet ministerstva, ktorá v rámci svojej pôsobnosti zabezpečuje mzdové prostriedky a vecné prostriedky krajských pamiatkových úradov a je zamestnávateľom zamestnancov, ktorí pracujú v krajských pamiatkových úradoch.
...
vydáva odborné stanovisko o pamiatkovej hodnote predmetu kultúrnej hodnoty podľa osobitného predpisu.[10aa)](#poznamky.poznamka-10aa)

(3)

Pamiatkový úrad môže na vykonávanie činností podľa odseku 2 písm. j) až l) zriadiť právnickú osobu podľa osobitného predpisu.[8)](#poznamky.poznamka-8)
...
rozhoduje podľa [§ 24](#paragraf-24), [30 až 33](#paragraf-30), [35](#paragraf-35), [36](#paragraf-36), [39](#paragraf-39), [42](#paragraf-42) a [43](#paragraf-43), vydáva záväzné stanoviská podľa [§ 30](#paragraf-30) a [32](#paragraf-32) a stanoviská podľa [§ 29](#paragraf-29), vydáva na žiadosť obce alebo vyššieho územného celku súhlas na prevod pozemkov podľa osobitného predpisu,[10ab)](#poznamky.poznamka-10ab)
...
Osoby, ktoré podľa [§ 5](#paragraf-5), [10 a 11](#paragraf-10) plnia úlohy štátnej správy na úseku ochrany pamiatkového fondu, sú pri výkone štátneho pamiatkového dohľadu oprávnené
...
Ak štát ponuku neprijme do 60 dní odo dňa jej doručenia, predkupné právo zaniká.
...
Miestne príslušný krajský pamiatkový úrad je dotknutým orgánom štátnej správy pri prerokúvaní Koncepcie územného rozvoja regiónu, územného plánu mikroregiónu, územného plánu obce a územného plánu zóny.[28a)](#poznamky.poznamka-28a)
...
člen Komory reštaurátorov[33)](#poznamky.poznamka-33) alebo
...
Príspevok podľa odseku 1 sa neposkytne, ak úhradu nevyhnutných nákladov možno zabezpečiť podľa iných právnych predpisov.
...
Archeologický výskum je oprávnený vykonávať pamiatkový úrad alebo ním zriadená právnická osoba prostredníctvom fyzickej osoby, ktorá je v pracovnoprávnom vzťahu s pamiatkovým úradom alebo ním zriadenou právnickou osobou, spĺňa kvalifikačné predpoklady podľa [§ 35a ods. 3 písm. a)](#paragraf-35a.odsek-3.pismeno-a) a [c)](#paragraf-35a.odsek-3.pismeno-c) a má poverenie od pamiatkového úradu alebo od ním zriadenej právnickej osoby na vykonávanie archeologického výskumu a archeologický ústav prostredníctvom osôb s odbornou spôsobilosťou; iná právnická osoba môže archeologický výskum vykonávať iba na základe oprávnenia vydaného ministerstvom.
...
Osoba podľa [§ 35a ods. 1](#paragraf-35a.odsek-1) a [§ 36 ods. 4](#paragraf-36.odsek-4) je povinná oznámiť krajskému pamiatkovému úradu začatie pamiatkového výskumu najmenej päť dní vopred a ukončenie terénnej časti pamiatkového výskumu bezodkladne.

(6)

Nepovolený pamiatkový výskum alebo výkop na kultúrnej pamiatke, pamiatkovom území, archeologickom náleze alebo archeologickom nálezisku, ako aj nepovolený zber, premiestňovanie hnuteľného nálezu, jeho neoprávnená držba a vyhľadávanie pomocou detekčných zariadení sa zakazujú. Povrchový zber a nedeštruktívna prospekcia oprávnenými právnickými osobami podľa [§ 36 ods. 4](#paragraf-36.odsek-4) sa nepovažujú za nepovolený pamiatkový výskum.
...
Archeologický nález je osoba podľa [§ 36 ods. 4](#paragraf-36.odsek-4) povinná držať a chrániť až do jeho odovzdania, prevodu vlastníckeho práva alebo prevodu správy podľa [§ 40 ods. 9](#paragraf-40.odsek-9). Archeologický nález nesmie osoba podľa [§ 36 ods. 4](#paragraf-36.odsek-4) previesť, ani inak scudziť alebo prenechať do užívania inej osobe.
...
Archeologický nález je vlastníctvom Slovenskej republiky. Správcom archeologického nálezu je od nájdenia archeologického nálezu archeologický ústav alebo múzeum zriadené ústredným orgánom štátnej správy, ak sa archeologický nález našiel nimi vykonávaným archeologickým výskumom. V ostatných prípadoch je správcom archeologického nálezu pamiatkový úrad, a to od prijatia výskumnej dokumentácie podľa [§ 39 ods. 10](#paragraf-39.odsek-10), od prijatia oznámenia o náhodnom archeologickom náleze podľa odseku 2 krajským pamiatkovým úradom, alebo od prevzatia nezákonne nadobudnutého archeologického nálezu zaisteného orgánom činným v trestnom konaní, súdom alebo správnym orgánom.
...
Krajský pamiatkový úrad v spolupráci s príslušným stavebným úradom zabezpečuje podmienky ochrany archeologických nálezísk v konaní o stavebnom zámere.
...
nevypracuje alebo neodovzdá dokumentáciu podľa [§ 31 až 33](#paragraf-31) a [39](#paragraf-39),
...
nezabezpečuje základnú ochranu kultúrnej pamiatky podľa [§ 27](#paragraf-27), neudržiava ju v dobrom stave a využíva ju spôsobom, ktorý ju ohrozuje, poškodzuje, znehodnocuje alebo ničí, alebo ju nechráni pred odcudzením, alebo iným spôsobom poruší povinnosť podľa [§ 28 ods. 2](#paragraf-28.odsek-2),
...
##### Prechodné ustanovenie k úprave účinnej od 1. novembra 2024

Pri ponuke podľa [§ 23 ods. 1](#paragraf-23.odsek-1) doručenej štátu zastúpenému ministerstvom do 31. októbra 2024 sa postupuje podľa [§ 23 ods. 4](#paragraf-23.odsek-4) v znení účinnom do 31. októbra 2024.
