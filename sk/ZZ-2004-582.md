...
Jednotlivou časťou obce sa rozumie časť územia obce vymedzená vo všeobecne záväznom nariadení obce.[11)](#poznamky.poznamka-11) Jednotlivú časť obce možno určiť zoznamom ulíc alebo súborom všetkých pozemkov jedného druhu nachádzajúcich sa v tejto časti obce.
...
Daň z pozemkov, daň zo stavieb a daň z bytov vyrubí správca dane každoročne do 15. mája bežného zdaňovacieho obdobia, ak tento zákon neustanovuje inak.
...
Vyrubená daň z nehnuteľností je splatná do 31. mája bežného zdaňovacieho obdobia, ak tento zákon neustanovuje inak.
...
Obec ustanoví všeobecne záväzným nariadením[11)](#poznamky.poznamka-11) podrobnosti k [§ 30 až 34](#paragraf-30), najmä sadzbu dane, prípadne rôzne sadzby dane podľa určených kritérií, miesta, ktoré sú verejnými priestranstvami, osobitné spôsoby ich užívania, podrobnosti a náležitosti oznamovacej povinnosti, spôsoby vyberania dane, prípadné oslobodenia od tejto dane alebo zníženia dane.

##### § 37

##### Predmet dane

Predmetom dane za ubytovanie je odplatné prechodné ubytovanie fyzickej osoby v ubytovacom zariadení[23)](#poznamky.poznamka-23) (ďalej len „zariadenie“).
...
Daňovník je povinný písomne oznámiť vznik daňovej povinnosti správcovi dane do 30 dní od vzniku daňovej povinnosti a v tejto lehote zaplatiť daň na zdaňovacie obdobie alebo pomernú časť dane na zostávajúce dni zdaňovacieho obdobia, v ktorom vznikla daňová povinnosť.
...
Predmetom dane z motorových vozidiel je motorové vozidlo a prípojné vozidlo (ďalej len „vozidlo"), ktoré možno zaradiť do kategórie vozidiel M, N a O[38)](#poznamky.poznamka-38) a používa sa na podnikanie[40)](#poznamky.poznamka-40) a

a)

má pridelené v Slovenskej republike evidenčné číslo, osobitné evidenčné číslo alebo zvláštne evidenčné číslo,[40a)](#poznamky.poznamka-40a) alebo
...
Vyšší územný celok môže vo všeobecne záväznom nariadení[42)](#poznamky.poznamka-42) podľa miestnych podmienok znížiť daň na vozidlo používané ako
...
Vozidlo používané podľa odseku 2 môže vyšší územný celok vo všeobecne záväznom nariadení[42)](#poznamky.poznamka-42) podľa miestnych podmienok oslobodiť od dane.

(4)

Ak vyšší územný celok oslobodí vozidlo pravidelnej autobusovej dopravy v rozsahu výkonu vo verejnom záujme od dane a ak sa takéto vozidlo použije v priebehu zdaňovacieho obdobia aj na podnikanie,[12)](#poznamky.poznamka-12) daňovník zaplatí pomernú časť dane za dni používania vozidla na podnikanie na základe písomnej evidencie dní, v ktorých používal vozidlo na podnikanie, najneskôr do 31. januára nasledujúceho zdaňovacieho obdobia.
...
Ak v priebehu zdaňovacieho obdobia dôjde k zániku daňovej povinnosti, k vzniku oslobodenia podľa [§ 86](#paragraf-86) alebo k zmene miesta evidencie vozidla, alebo k zmene miesta dočasného pobytu vozidla, ktoré nie je evidované v Slovenskej republike, daňovník je povinný písomne oznámiť túto skutočnosť do 15 dní správcovi dane.
...
Ak v priebehu zdaňovacieho obdobia zanikne daňová povinnosť u vozidla, za ktoré sa platí daň v splátkach podľa [§ 91 ods. 1 alebo § 91 ods. 2](#paragraf-91.odsek-1), správca dane zníži pomerne zostávajúce splátky dane na základe oznámenia o zániku daňovej povinnosti podľa [§ 90 ods. 2](#paragraf-90.odsek-2).
...
Žiadosť o vrátenie zaplatenej dane podáva daňovník po uplynutí zdaňovacieho obdobia, v ktorom používal vozidlo v rámci kombinovanej dopravy, do 31. januára nasledujúceho zdaňovacieho obdobia.

##### § 94

(1)

Správca dane vráti daňovníkovi pomernú časť dane podľa [§ 92 a § 93 ods. 1](#paragraf-92) do 30 dní odo dňa doručenia žiadosti.
...
Vyšší územný celok je povinný zaslať Daňovému riaditeľstvu Slovenskej republiky jeden výtlačok všeobecne záväzného nariadenia,[42)](#poznamky.poznamka-42) ktorým zaviedol daň z motorových vozidiel alebo zmenil sadzby dane alebo podmienky oslobodenia od dane, do piatich kalendárnych dní odo dňa nadobudnutia jeho účinnosti.
...
Daň, splátka dane a pomerná časť dane podľa tohto zákona a poplatok sa zaokrúhľujú na celé koruny nahor.
