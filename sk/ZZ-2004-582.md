...
c) priemerného počtu zamestnancov pripadajúceho na určené obdobie neznížený o počet osôb, ktoré majú v obci aj trvalý pobyt alebo prechodný pobyt, vynásobený koeficientom ustanoveným obcou, ak ide o poplatníka, u ktorého sa do ukazovateľa produkcie komunálnych odpadov v určenom období nezapočítava priemerný počet podľa prvého ani druhého bodu; koeficient nesmie mať vyššiu hodnotu ako 1.
