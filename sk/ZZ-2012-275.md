...
prenos elektriny podľa [prílohy č. 3](#prilohy.priloha-priloha_c_3_k_vyhlaske_c_275_2012_z_z.oznacenie),

b)

distribúciu elektriny podľa [prílohy č. 6](#prilohy.priloha-priloha_c_6_k_vyhlaske_c_275_2012_z_z.oznacenie),

c)

dodávku elektriny podľa [prílohy č. 9](#prilohy.priloha-priloha_c_9_k_vyhlaske_c_275_2012_z_z.oznacenie).
...
Kompenzačná platba sa uhradí regulovaným subjektom účastníkovi trhu s elektrinou, ktorý bol nedodržaním štandardu kvality dotknutý a na ktorého odberné miesto sa nedodržanie štandardu kvality vzťahuje, alebo žiadateľovi podľa [§ 3 písm. m)](#paragraf-3.pismeno-m) alebo [§ 4 písm. d)](#paragraf-4.odsek-1.pismeno-d) (ďalej len „oprávnená osoba“) vo výške určenej podľa [§ 8 až 10](#paragraf-8). Podmienkou na vyplatenie kompenzačnej platby nie je podanie žiadosti oprávnenou osobou o jej vyplatenie.

(2)

Kompenzačná platba za porušenie daného štandardu kvality sa oprávnenej osobe uhradí jednorazovo v lehote do 60 dní po odstránení príčin nedodržania štandardu kvality alebo v lehote do 60 dní po vydaní kolaudačného rozhodnutia, ak bol nedodržaný štandard kvality podľa [§ 3 písm. c) tretieho bodu](#paragraf-3.pismeno-c.bod-3), a to
...
číslo odberného miesta, na ktoré sa kompenzačná platba vzťahuje; ak ide o oprávnenú osobu, ktorou je žiadateľ podľa [§ 3 písm. m)](#paragraf-3.pismeno-m) alebo [§ 4 písm. d)](#paragraf-4.odsek-1.pismeno-d), uvedie sa dátum prijatia podania a podacie číslo, pod ktorým bola žiadosť regulovaným subjektom zaevidovaná,
...
Ak nie je dodržaný štandard kvality podľa [§ 2 písm. b)](#paragraf-2.pismeno-b), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = A + B x (N - 5), ak N < 5, potom KP = A a maximálna výška kompenzačnej platby je 5 000 eur,

(2)

Ak nie je dodržaný štandard kvality podľa [§ 2 písm. c)](#paragraf-2.pismeno-c), výška kompenzačnej platby je 500 eur za každý aj začatý deň nedodržania štandardu kvality.

(3)

Ak nie je dodržaný štandard kvality podľa [§ 2 písm. d) alebo písm. e)](#paragraf-2.pismeno-d), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = A + B x (N – 1),

(4)

Ak nie je dodržaný štandard kvality podľa [§ 2 písm. f)](#paragraf-2.pismeno-f), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = A + B x (N - 4), ak N < 4, potom KP = A a maximálna výška kompenzačnej platby je 3 000 eur,

(5)

Ak nie je dodržaný štandard kvality podľa [§ 2 písm. g)](#paragraf-2.pismeno-g), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = P x [A + B x (N - 6)], ak N < 6, potom KP = P x A,

(6)

Ak nie je dodržaný štandard kvality podľa [§ 2 písm. h) alebo písm. i)](#paragraf-2.pismeno-h), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca
...
Ak nie je dodržaný štandard kvality podľa [§ 3 písm. b)](#paragraf-3.pismeno-b), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = A + B x (N – 5), ak N < 5, potom KP = A a maximálna výška kompenzačnej platby je 100 eur.

(2)

Ak nie je dodržaný štandard kvality podľa [§ 3 písm. c) prvého bodu](#paragraf-3.pismeno-c.bod-1), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = A + B x (N – 10), ak N < 10, potom KP = A a maximálna výška kompenzačnej platby je 100 eur,

(3)

Ak nie je dodržaný štandard kvality podľa [§ 3 písm. c) druhého bodu](#paragraf-3.pismeno-c.bod-2), výška kompenzačnej platby je za každý aj začatý mesiac nedodržania štandardu kvality 40 eur.

(4)

Ak nie je dodržaný štandard kvality podľa [§ 3 písm. c) tretieho bodu](#paragraf-3.pismeno-c.bod-3), výška kompenzačnej platby je za každý aj začatý mesiac nedodržania štandardu kvality 50 eur.

(5)

Ak nie je dodržaný štandard kvality podľa [§ 3 písm. d)](#paragraf-3.pismeno-d), výška kompenzačnej platby je za každý aj začatý deň nedodržania štandardu kvality
...
Ak nie je dodržaný štandard kvality podľa [§ 3 písm. e) alebo písm. f)](#paragraf-3.pismeno-e), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = [A + B x (N – 1)] x C,

(7)

Ak nie je dodržaný štandard kvality podľa [§ 3 písm. g)](#paragraf-3.pismeno-g), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = [A + B x (N – 6)] x C, ak N < 6, potom KP = A x C,

(8)

Ak nie je dodržaný štandard kvality podľa [§ 3 písm. h)](#paragraf-3.pismeno-h), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = P x [A + B x (N – 6)], ak N < 6, potom KP = P x A,

(9)

Ak nie je dodržaný štandard kvality oznámenia termínu začatia a ukončenia plánovaného obmedzenia alebo prerušenia distribúcie elektriny podľa [§ 3 písm. i)](#paragraf-3.pismeno-i), výška kompenzačnej platby je za každý aj začatý deň nedodržania štandardu kvality
...
Ak nie je dodržaný štandard kvality podľa [§ 3 písm. j)](#paragraf-3.pismeno-j), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = [A + B x (N – 6)] x C, ak N < 6, potom KP = A x C,

(11)

Ak nie je dodržaný štandard kvality podľa [§ 3 písm. k) alebo písm. l)](#paragraf-3.pismeno-k), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = A + B x (N – 5), ak N < 5, potom KP = A a maximálna výška kompenzačnej platby je 50 eur,

(12)

Ak nie je dodržaný štandard kvality podľa [§ 3 písm. m)](#paragraf-3.pismeno-m), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca
...
Ak nie je dodržaný štandard kvality podľa [§ 4 písm. a)](#paragraf-4.odsek-1.pismeno-a), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = A + B x (N – 5), ak N < 5, potom KP = A a maximálna výška kompenzačnej platby je 50 eur,

(2)

Ak nie je dodržaný štandard kvality podľa [§ 4 písm. b)](#paragraf-4.odsek-1.pismeno-b), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = A x N x C,

(3)

Ak nie je dodržaný štandard kvality podľa [§ 4 písm. c)](#paragraf-4.odsek-1.pismeno-c), výška kompenzačnej platby v eurách sa vypočíta podľa vzorca

KP = A + B x (N – 2), ak N < 5, potom KP = A a maximálna výška kompenzačnej platby je 100 eur,

(4)

Ak nie je dodržaný štandard kvality podľa [§ 4 písm. d)](#paragraf-4.odsek-1.pismeno-d), výška kompenzačnej platby je 10 eur za každý aj začatý deň nedodržania štandardu kvality. Maximálna výška kompenzačnej platby je 50 eur.

(5)

Ak nie je dodržaný štandard kvality podľa [§ 4 písm. e)](#paragraf-4.odsek-1.pismeno-e), výška kompenzačnej platby je 2 eurá za každý aj začatý deň nedodržania štandardu kvality. Maximálna výška kompenzačnej platby je 100 % kompenzačnej platby prevádzkovateľa sústavy, ktorá nebola odoslaná oprávnenej osobe v ustanovenej lehote.
...
Údaje o štandardoch kvality podľa odsekov 1 až 3 a [§ 6 ods. 3](#paragraf-6) sa archivujú regulovaným subjektom sumárne za celý kalendárny rok v listinnej podobe alebo elektronickej podobe. Údaje o štandardoch kvality sa archivujú tak, aby nedošlo k ich zneužitiu, poškodeniu, zničeniu a neoprávneným zásahom.
