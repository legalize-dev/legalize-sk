...
Prezidentovi po skončení výkonu jeho funkcie patrí doživotne plat vo výške platu poslanca podľa [§ 2 ods. 1 a 2](#paragraf-2.odsek-1).

(3)

Ak prezident po skončení výkonu jeho funkcie začne vykonávať inú funkciu ústavného činiteľa Slovenskej republiky podľa [§ 1](#paragraf-1), po dobu výkonu tejto funkcie sa mu pozastaví vyplácanie platu podľa odseku 2 a neposkytuje sa mu služba ochrany určených osôb náležiaca prezidentovi.[4a)](#poznamky.poznamka-4a)
