...
Ak neexistujú protokoly pre odber vzoriek a testovanie na zistenie výskytu regulovaných nekaranténnych škodcov v Európskej únii (ďalej len „regulovaný nekaranténny škodca“) podľa prílohy č. 1 oddielu 5 piateho bodu a [oddielu 3 tretieho bodu](#prilohy.priloha-priloha_c_1_k_nariadeniu_vlady_c_49_2007_z_z.op-podmienky_tykajuce_sa_pestovatelskeho_porastu.op-odsek_1~2.op-bod_3) vypracované Európskou a stredozemnou organizáciou pre ochranu rastlín alebo zodpovedným orgánom členského štátu iného než Slovenská republika alebo iné medzinárodne uznávané protokoly pre odber vzoriek a testovanie na zistenie výskytu regulovaných nekaranténnych škodcov, vypracuje ich kontrolný ústav.[7)](#poznamky.poznamka-7) Kontrolný ústav na požiadanie sprístupňuje tieto protokoly zodpovednému orgánu iného členského štátu a Európskej komisii.
