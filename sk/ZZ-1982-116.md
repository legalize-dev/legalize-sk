...
na účely hodnotenia plnenia plánu a výsledkov hospodárskej činnosti organizácií

1.

pri výkonoch v plnej výške,

2.

pri odbyte dovedna, jeho štruktúre, upravených vlastných výkonoch, prípadne redukovaných výkonoch a pri zisku vo výške zodpovedajúcej podielu týchto strát k výkonom; rovnako sa postupuje, pokiaľ sa z týchto ukazovateľov vypočítavajú na uvedené účely odvodené ukazovatele (napr. produktivita práce, rentabilita, nákladovosť, výťažnosť základných prostriedkov);
...
Ak sa robí štatistická prebierka a podľa jej výsledku bola dodávka vyhovujúca, zahŕňajú sa náklady na výmenu zistených vadných výrobkov, prípadne cena za tieto výrobky, do vnútorných strát z neakostnej výroby.

7.

Vo vzťahoch vnútri jedného koncernu (medzi koncernom, koncernovými podnikmi, príp. koncernovými účelovými organizáciami) sa všetky straty z neakostnej výroby považujú za vnútorné straty z neakostnej výroby.
