...
dočasné zverenie dieťaťa do starostlivosti osoby, ktorá má záujem stať sa pestúnom,[2)](#poznamky.poznamka-2)
...
ktoré je zverené do náhradnej starostlivosti podľa [§ 1 ods. 2 písm. d) až g)](#paragraf-1.odsek-2.pismeno-d) a pri zverení do náhradnej starostlivosti je mladšie ako šesť mesiacov,
...
Uložením povinnosti poukazovať výživné príslušnému orgánu podľa osobitného predpisu[8)](#poznamky.poznamka-8) prechádza nárok na výživné oprávneného dieťaťa na tento orgán a do sumy poskytovaného opakovaného príspevku dieťaťu podľa odseku 3 je príjmom štátneho rozpočtu. Ak výživné podľa prvej vety je vyššie ako opakovaný príspevok dieťaťu, patrí dieťaťu aj rozdiel medzi výživným a týmto príspevkom. Ak nárok na opakovaný príspevok dieťaťu nevznikol, výživné podľa prvej vety príslušný orgán poukazuje dieťaťu. Príslušný orgán postupuje podľa druhej vety a tretej vety aj vtedy, ak rodič dieťaťa neplní súdom uloženú vyživovaciu povinnosť alebo ju plní čiastočne.
...
Osobitný opakovaný príspevok náhradnému rodičovi je určený na podporu vykonávania osobnej starostlivosti o dieťa zverené do náhradnej starostlivosti podľa [§ 1 ods. 2 písm. a) až e)](#paragraf-1.odsek-2.pismeno-a), ktoré je občan s ťažkým zdravotným postihnutím.[17)](#poznamky.poznamka-17)
...
ktorému bolo na základe rozhodnutia súdu[1)](#poznamky.poznamka-1) alebo rozhodnutia príslušného orgánu[2)](#poznamky.poznamka-2) zverené dieťa do náhradnej starostlivosti podľa [§ 1 ods. 2 písm. a) až e)](#paragraf-1.odsek-2.pismeno-a),
