...
Zamestnávateľ zaradí zamestnanca ([§ 3 ods. 1](#paragraf-3.odsek-1)) do jednej z dvanástich platových tried podľa katalógu na základe náročnosti požadovaného výkonu pracovnej činnosti.
...
Zamestnávateľ zaradí zamestnanca, ktorý ukončil vyššie odborné[7)](#poznamky.poznamka-7) alebo bakalárske štúdium,[8)](#poznamky.poznamka-8) do šiestej až ôsmej platovej triedy podľa katalógu na základe náročnosti požadovaného výkonu pracovnej činnosti.
...
v odbore požadovanej pracovnej činnosti dosiahnutá po ukončení potrebného stupňa vzdelania uvedeného v katalógu alebo po ukončení vzdelania o jeden stupeň nižšieho u zamestnanca zaradeného do platovej triedy podľa [§ 5 ods. 7 písm. c) až e)](#paragraf-5.odsek-7.pismeno-c),
...
Zamestnancovi zaradenému podľa [§ 3 ods. 1](#paragraf-3.odsek-1) patrí tarifný plat vo výške platovej tarify určenej pre platovú triedu a platový stupeň. Platové tarify sú uvedené v [prílohe č. 2 tohto nariadenia](#prilohy.priloha-1.np-1) (ďalej len „[príloha č. 2](#prilohy.priloha-1.np-1)“).
...
Zamestnancovi, ktorý vykonáva pracovné činnosti pri ochrane záujmov štátu, pri ktorých môže dôjsť k ohrozeniu života alebo k iným vážnym rizikám pri vyhlásení brannej pohotovosti štátu, alebo pri vyhlásení mimoriadnych opatrení, patrí príplatok vo výške 200 až 1200 Kčs mesačne.
...
Zamestnancovi, ktorého výkon pracovnej činnosti je spojený s vážnym rizikom a mimoriadnou psychickou záťažou, ktorá je výkonom kontrolnej činnosti podľa osobitného predpisu,[12)](#poznamky.poznamka-12) môže zamestnávateľ po dohode s príslušným nadriadeným ústredným orgánom pre presne definovanú činnosť poskytnúť príplatok vo výške 100 až 500 Kčs mesačne.

(12)

Zamestnancovi, ktorý vykonáva výchovno-vzdelávaciu činnosť v špeciálnych školách[7)](#poznamky.poznamka-7) a školských zariadeniach[13)](#poznamky.poznamka-13) pre deti a mládež telesne, zmyslovo a mentálne postihnutú, patrí príplatok vo výške 300 až 800 Kčs mesačne.
...
Výšku osobitného príplatku v rámci rozpätia ustanoveného v odsekoch 2 až 13 určí zamestnávateľ.
...
pracovné zásluhy pri dosiahnutí 50 rokov veku a prvého ukončenia zamestnania v súvislosti s odchodom do starobného alebo invalidného dôchodku, prípadne v súvislosti s jeho uvoľnením zo zamestnania, ak zamestnanec splní podmienky mimoriadneho poskytovania starobného dôchodku podľa osobitného predpisu,[14)](#poznamky.poznamka-14) až do výšky jeho priemerného mesačného zárobku,
...
Umeleckému zamestnancovi určí zamestnávateľ tarifný plat v rámci rozpätia najnižšej a najvyššej platovej tarify príslušnej platovej triedy, do ktorej zamestnanca zaradil, bez závislosti od dĺžky započítateľnej praxe.
...
Za dobu kratšiu ako 1 mesiac patrí vedúcemu zamestnancovi príplatok za riadenie podľa [§ 8](#paragraf-8) v alikvotnej výške zodpovedajúcej odpracovanému času.
...
Zamestnávateľ môže upraviť niektoré náležitosti podľa tohto nariadenia v kolektívnej zmluve alebo vo vnútornom predpise po prerokovaní s príslušným odborovým orgánom, ak z povahy veci nevyplýva, že rozhodnutie závisí od posúdenia individuálneho prípadu.
