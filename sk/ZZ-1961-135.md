...
Miestnu štátnu správu vo veciach miestnych komunikácií a účelových komunikácií vykonávajú obce ako prenesený výkon štátnej správy. Obce v rámci preneseného výkonu štátnej správy prejednávajú priestupky podľa [§ 22c](#paragraf-22c) na úseku miestnych komunikácií a účelových komunikácií.
...
Na činnosti podľa odseku 3 písm. a), b), c), e), f), h), i), j), k), l), n) a p), odseku 4 písm. e) a odseku 5 písm. d) sa nevzťahujú všeobecné predpisy o správnom konaní.[1)](#poznamky.poznamka-1)
