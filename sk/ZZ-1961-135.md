...
Na činnosti podľa odseku 2 druhej vety, odseku 3 písm. a), b), c), e), f), h), i), j), k), l), n), p) a q), odseku 4 písm. e) a f) a odseku 5 písm. d) a f) sa nevzťahujú všeobecné predpisy o správnom konaní.[1)](#poznamky.poznamka-1)
...
Za priestupok podľa odseku 1 písm. g) možno uložiť vodičovi pokutu do výšky desaťnásobku úhrady na kalendárny rok uvedenej v sadzobníku, ktorý je prílohou č. 1 k tomuto zákonu, a v blokovom konaní do výšky trojnásobku tejto úhrady.
