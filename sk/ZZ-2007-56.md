...
Množiteľský materiál Palmae, ktorý patrí k rodom a druhom uvedeným v [prílohe č. 1](#prilohy.priloha-priloha_c_1_k_nariadeniu_vlady_c_56_2007_z_z) a ktorý má priemer stonky pri zemi viac ako 5 cm, musí spĺňať jednu z týchto požiadaviek:

a)

celý svoj život bol pestovaný v oblasti, ktorú zodpovedný orgán určil v súlade s medzinárodnými normami[4a)](#poznamky.poznamka-4a) pre rastlinolekárske opatrenia ako oblasť bez výskytu *Rhynchophorus ferrugineus* (Olivier),
...
Uplatňovaním požiadaviek podľa odsekov 8 a 9 nie sú dotknuté pravidlá týkajúce sa chránených zón prijaté podľa osobitného predpisu.[4)](#poznamky.poznamka-4)
...
Týmto nariadením vlády sa preberajú právne záväzné akty Európskej únie uvedené v [prílohe č. 2](#prilohy.priloha-priloha_c_2_k_nariadeniu_vlady_c_56_2007_z_z).
