...
Register certifikovaných hnojív je zoznam certifikovaných hnojív, v ktorom sú uvedené údaje o certifikovanom hnojive v rozsahu ustanovenia [§ 5 ods. 2](#paragraf-5.odsek-2) s výnimkou údajov o výrobnom postupe a použitých surovinách. Register certifikovaných hnojív vedie kontrolný ústav.
...
Na zabezpečenie odberov pôdnych vzoriek na agrochemické skúšanie poľnohospodárskych pôd a pri výkone kontrol sú orgány miestnej štátnej správy a obce povinné poskytnúť kontrolnému ústavu údaje o poľnohospodárskej pôde a jej užívateľoch.[6)](#poznamky.poznamka-6)
...
poruší povinnosti podľa [§ 10 ods. 5](#paragraf-10.odsek-5), [7 a 8](#paragraf-10.odsek-7).
...
výrobcovi, producentovi, dovozcovi, predajcovi alebo dodávateľovi za porušenie povinností podľa [§ 8, 9](#paragraf-8) a [§ 18 ods. 3](#paragraf-18.odsek-3),
...
Kontrolný ústav uloží pokutu do 15 000 eur výrobcovi alebo dovozcovi, ktorý uviedol do obehu hnojivo, ktoré nebolo certifikované podľa [§ 5](#paragraf-5) a hnojivo, ktoré je označené slovami „Hnojivo ES", ak nie sú splnené požiadavky osobitného predpisu.[1b)](#poznamky.poznamka-1b)
