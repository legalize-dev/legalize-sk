...
elektrina, uhlie a zemný plyn podliehajúce spotrebnej dani podľa osobitného predpisu,[2a)](#poznamky.poznamka-2a)
...
dňom výmazu z obchodného registra alebo obdobného registra alebo dňom zrušenia živnostenského oprávnenia za podmienok ustanovených osobitnými predpismi.[19a)](#poznamky.poznamka-19a)
...
dňom výmazu obchodného registra alebo obdobného registra alebo dňom zrušenia živnostenského oprávnenia za podmienok ustanovených osobitnými predpismi,[19a)](#poznamky.poznamka-19a) alebo dňom podania oznámenia o skončení podnikania,
...
Daňovým dlžníkom je odosielateľ minerálneho oleja alebo právnická osoba alebo fyzická osoba, ktorá zložila zábezpeku na daň na minerálny olej prepravovaný v pozastavení dane. Daňový dlžník je povinný do piatich pracovných dní po zistení nezrovnalosti podať daňové priznanie, daň vypočítať podľa sadzieb dane platných v deň odoslania minerálneho oleja a zaplatiť daň
...
Dovozom minerálneho oleja sa rozumie vstup minerálneho oleja z územia tretieho štátu na daňové územie. Ak sa pri dovoze nachádza minerálny olej v colnom režime vonkajší tranzit alebo v colnom režime uskladňovanie v colnom sklade, alebo v colnom režime aktívny zušľachťovací styk v podmienečnom systéme, alebo v colnom režime prepracovanie pod colným dohľadom, alebo v colnom režime dočasné použitie, alebo je umiestnený v slobodnom colnom pásme alebo v slobodnom colnom sklade, taký minerálny olej sa považuje za minerálny olej v pozastavení dane. Na daň a na správu dane sa pri dovoze minerálneho oleja vzťahujú colné predpisy, ak tento zákon alebo osobitný predpis[25)](#poznamky.poznamka-25) neustanovuje inak.

(2)

Minerálny olej po prepustení do colného režimu voľný obeh možno uviesť do daňového režimu pozastavenia dane. V takom prípade sa uplatní postup pri preprave minerálneho oleja v pozastavení dane.
...
Právnickej osobe alebo fyzickej osobe, ktorá porušila ustanovenie [§ 8 ods. 3](#paragraf-8.odsek-3), uloží colný úrad pokutu podľa závažnosti, dĺžky trvania a následkov protiprávneho stavu až do 16 596,95 eura, najmenej však 331,93 eura.
...
minerálny olej odberateľovi, ktorý nepredložil odberný poukaz na odber minerálneho oleja oslobodeného od dane, uloží colný úrad pokutu vo výške 50 % dane pripadajúcej na množstvo vydaného minerálneho oleja, najmenej však 3 319,39 eura,

b)

minerálny olej odberateľovi, ktorý nepredložil odberný poukaz na odber minerálneho oleja so zníženou sadzbou dane, uloží colný úrad pokutu vo výške 50 % dane vypočítanej podľa sadzby dane uvedenej v [§ 6](#paragraf-6) pripadajúcej na množstvo vydaného minerálneho oleja, najmenej však 3 319,39 eura,

c)

minerálny olej odberateľovi, ktorý nepredložil odberný poukaz na odber minerálneho oleja uvedeného v [§ 11 ods. 2 písm. c)](#paragraf-11.odsek-2.pismeno-c), uloží colný úrad pokutu do výšky 0,39 eura za každý vydaný liter minerálneho oleja, najmenej však 3 319,39 eura.
...
na účely neuvedené v odbernom poukaze, ak nejde o porušenie [§ 8 ods. 3](#paragraf-8.odsek-3), uloží colný úrad pokutu vo výške 50 % dane pripadajúcej na množstvo takto použitého minerálneho oleja, najmenej však 1 659,69 eura,

b)

bez vydaného odberného poukazu, ak nejde o porušenie [§ 8 ods. 3](#paragraf-8.odsek-3), uloží colný úrad pokutu vo výške 50 % dane pripadajúcej na množstvo takto použitého minerálneho oleja, najmenej však 3 319,39 eura.

(4)

Právnickej osobe alebo fyzickej osobe, ktorá použije minerálny olej uvedený v [§ 6 ods. 1 písm. e)](#paragraf-6.odsek-1) ako pohonnú látku, uloží colný úrad pokutu vo výške 50 % dane pripadajúcej na množstvo takto použitého minerálneho oleja, najmenej však 3 319,39 eura.
...
50 % dane pripadajúcej na množstvo zisteného minerálneho oleja, ak je pre tento minerálny olej ustanovená sadzba dane, najmenej však 1 659,69 eura,

b)

súčinu sadzby dane podľa [§ 6 ods. 1 písm. d)](#paragraf-6.odsek-1.text2) a množstva zisteného minerálneho oleja, ak pre tento minerálny olej nie je ustanovená sadzba dane, najmenej však 1 659,69 eura.
...
Právnickej osobe alebo fyzickej osobe oprávnenej na podnikanie, ktorá použila minerálny olej oslobodený od dane podľa [§ 10 ods. 2 písm. i)](#paragraf-10.odsek-2.pismeno-i) na iný ako určený účel, uloží colný úrad pokutu vo výške 50 % dane pripadajúcej na množstvo takto použitého minerálneho oleja, najmenej však 1 659,69 eura.

(8)

Fyzickej osobe, ktorá použila minerálny olej oslobodený od dane podľa [§ 10a ods. 2](#paragraf-10a.odsek-2) na iný ako určený účel, uloží colný úrad pokutu vo výške 50 % dane pripadajúcej na množstvo takto použitého minerálneho oleja, najmenej však 165,96 eura.
