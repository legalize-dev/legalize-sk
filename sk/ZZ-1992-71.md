...
Orgány uvedené v [§ 3](#paragraf-3) sú povinné na základe zmluvy uzatvorenej medzi prevádzkovateľom systému a orgánmi uvedenými v [§ 3](#paragraf-3) umožniť umiestnenie a prevádzkovanie technického vybavenia na vykonanie a spracovanie platieb poplatkov; v tomto prípade sa všeobecný predpis o správe majetku štátu[5ad)](#poznamky.poznamka-5ad) nepoužije. Podmienky umiestnenia a prevádzkovania technického vybavenia na vykonanie a spracovanie platieb poplatkov upraví zmluva medzi prevádzkovateľom systému a orgánmi uvedenými v [§ 3](#paragraf-3); prevádzkovateľ systému a orgány uvedené v [§ 3](#paragraf-3) sú povinní uzavrieť takúto zmluvu podľa vzoru schváleného Ministerstvom financií Slovenskej republiky. Vzor zmluvy podľa druhej vety sa zverejní na webovom sídle Ministerstva financií Slovenskej republiky.
...
Poplatky sa vyberajú v eurách. Platbu poplatku je poplatník povinný označiť identifikačnými údajmi, ktorými sú najmä číslo účtu, variabilný symbol, ak mu orgány uvedené v [§ 3](#paragraf-3) tieto údaje oznámia.

(10)

Poplatky vyberané v konaniach vo veciach obchodného registra a poplatky za úkony súdov týkajúce sa obchodného registra uvedené v [prílohe č. 1](#prilohy.priloha-priloha_c_1_zakona_snr_c_71_1992_zb), ktoré boli vykonané na základe podania elektronickými prostriedkami, sa platia prostredníctvom elektronického platobného portálu verejnej správy.
...
Súdny poplatok splatný podaním návrhu na vykonanie exekúcie možno platiť len poštovým poukazom, platobnou kartou alebo prevodom z účtu v banke alebo v pobočke zahraničnej banky.
...
Úrad vládneho auditu[7f)](#poznamky.poznamka-7f) vykonáva
...
Orgány uvedené v [§ 3](#paragraf-3), ktoré sú zapojené do centrálneho systému evidencie poplatkov, nearchivujú potvrdenia o úhrade poplatku vydané technickým zariadením prevádzkovateľa systému, ak informačný systém, ktorý orgán uvedený v [§ 3](#paragraf-3) používa, umožní kontrolu poplatkov podľa [§ 15](#paragraf-15).

(3)

Orgány uvedené v [§ 3](#paragraf-3), ktoré nie sú zapojené do centrálneho systému evidencie poplatkov, sú povinné viesť priebežnú evidenciu o vykonaných spoplatňovaných úkonoch a konaniach, ich počte, o príslušných sadzbách poplatkov a sumách vybraných poplatkov za tieto úkony a konania.
...
Jednotné kontaktné miesto, je povinné vybrané poplatky odviesť do 15 pracovných dní odo dňa zaplatenia poplatkov na účet prevádzkovateľa systému.
