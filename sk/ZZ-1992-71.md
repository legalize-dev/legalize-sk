...
Oslobodenie podľa odseku 2 sa nevzťahuje na poplatok podľa [položky 20a](#prilohy.priloha-priloha_zakona_snr_c_71_1992_zb.op-sadzobnik_sudnych_poplatkov.text).
...
Sadzba poplatku je uvedená v sadzobníku percentom zo základu poplatku (ďalej len „percentná sadzba“) alebo pevnou sumou. Ak tento zákon neustanovuje inak, je poplatok za odvolanie päť eur a poplatok za dovolanie 10 eur.
...
Ustanovenie odseku 3 o znížení poplatku sa nepoužije na šieste a každé ďalšie podanie podané tým istým navrhovateľom na jeden súd v jednom kalendárnom roku. Ustanovenie odseku 3 o znížení poplatku sa nepoužije ani pri poplatkoch vyberaných v exekučnom konaní.
...
Ak je poplatok platený prostredníctvom integrovaného obslužného miesta,[5ac)](#poznamky.poznamka-5ac) považuje sa za uhradený dňom doručenia zaručenej informácie o úhrade podľa osobitného predpisu.[7e)](#poznamky.poznamka-7e)

(2)

Pri platbe vykonanej prostredníctvom integrovaného obslužného miesta[5ac)](#poznamky.poznamka-5ac) je lehota na zaplatenie poplatku zachovaná, ak je zaručená informácia o úhrade podľa osobitného predpisu[7e)](#poznamky.poznamka-7e) doručená najneskôr v posledný deň lehoty.
...
Súdny poplatok splatný podaním návrhu na vydanie platobného rozkazu v upomínacom konaní je 50 % z percentnej sadzby ustanovenej v sadzobníku; ustanovenia [§ 6 ods. 3](#paragraf-6.odsek-3) a [5](#paragraf-6.odsek-5) sa nepoužijú.
