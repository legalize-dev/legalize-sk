...
Osoba, ktorá nemá povinnosť platiť poplatok podľa tohto zákona, preukáže túto skutočnosť vyberateľovi poplatkov čestným vyhlásením overeným podľa osobitných predpisov.[1b)](#poznamky.poznamka-1b)
...
Vzťahy medzi vyberateľom poplatkov, Slovenským rozhlasom a Slovenskou televíziou najmä pri vymáhaní nezaplatených poplatkov, nedoplatkov a poplatkov z omeškania ([§ 7 ods. 5](#paragraf-7.odsek-5), [§ 8 ods. 2](#paragraf-8.odsek-2) a [§ 9 ods. 1](#paragraf-9.odsek-1)) vrátane výšky provízie za vyberanie poplatkov sa zabezpečia zmluvne.

(3)

Vyberateľ poplatkov na účely tohto zákona vedie evidenciu platiteľov poplatkov. Právnické osoby, ktoré spravujú údaje z Evidencie mesačných záloh na odber elektrickej energie, sú povinné tieto údaje bezplatne poskytnúť vyberateľovi poplatkov na účely utvárania a pravidelnej aktualizácie evidencie platiteľov poplatkov. Takto získané osobné údaje podliehajú ochrane osobných údajov;[1e)](#poznamky.poznamka-1e) využívať ich môžu iba príjemcovia poplatkov.
...
poberatelia dôchodku,[1a)](#poznamky.poznamka-1c) ak nežijú v spoločnej domácnosti[1c)](#poznamky.poznamka-1d) s inou osobou s pravidelným príjmom zo zárobkovej činnosti.
...
Každá fyzická osoba v Slovenskej republike a každá právnická osoba so sídlom na území Slovenskej republiky, ktoré nie sú platiteľmi poplatkov, sú povinné vyberateľovi poplatkov na jeho výzvu preukázať dôvod oslobodenia od povinnosti platiť poplatok podľa [§ 6](#paragraf-6) alebo čestným vyhlásením s osvedčeným podpisom podľa osobitných predpisov[1b)](#poznamky.poznamka-1b) preukázať skutočnosť, že nie sú vlastníkmi prijímačov alebo že nevykonávajú právo hospodárenia k prijímačom vo vlastníctve štátu.
...
Ak je platiteľ poplatku ([§ 3](#paragraf-3)) v omeškaní s platbou dlhšie ako dva mesiace a dodržal sa postup podľa [§ 8](#paragraf-8), Slovenská televízia alebo Slovenský rozhlas požiada platiteľa o zaplatenie poplatku z omeškania.
