...
vyhodnotenie lokality jadrového zariadenia pre predpokladaný počet a najvyšší výkon zariadenia a určenie možnej interakcie s okolím po zohľadnení požiadaviek ustanovených v osobitnom predpise,[4)](#poznamky.poznamka-4)

c)

požiadavky na schopnosti jadrového zariadenia vykonávať bezpečnostné funkcie pri pôsobení prírodných javov podľa charakteristík ustanovených v písmene a), ktoré sú historicky doložené pre lokalitu a okolitú oblasť s dostatočnou rezervou na ohraničenú presnosť, úplnosť, množstvo a časové obdobie, v ktorom sú historické dáta získané.
...
Návrh hraníc jadrového zariadenia sa určuje pre každé jadrové zariadenie samostatne po zohľadnení prípadných interakcií s inými jadrovými zariadeniami a ďalším okolím tak, aby bolo možné určiť koncepciu rozhrania medzi systémami, konštrukciami a komponentmi jednotlivých jadrových zariadení podľa úrovne rozpracovania zámeru.
...
návrh zásad systému manažérstva kvality pre vyraďovanie, návrh kvalifikácie zariadení pre vyraďovanie, návrh spôsobu využívania skúseností z vyraďovania,[4)](#poznamky.poznamka-4)
...
návrh systému manažérstva kvality pre vyraďovanie, návrh kvalifikácie zariadení pre vyraďovanie a opis systému využívania skúseností z vyraďovania,[4)](#poznamky.poznamka-4)
...
systém manažérstva kvality pre etapu vyraďovania zohľadňujúci zmeny na zariadeniach počas etapy vyraďovania, systém využívania skúseností z vyraďovania,[4)](#poznamky.poznamka-4)
