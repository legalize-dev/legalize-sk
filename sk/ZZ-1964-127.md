...
### Pravidelná preprava osôb na mestských dráhach a na mestských autobusových linkách
...
Pravidelná preprava osôb sa vykonáva na linkách mestských dráh a na mestských autobusových linkách, ktoré sú uvedené v platných cestovných poriadkoch alebo inak zverejnené. Linky sa musia viesť tak, aby sa pri zachovaní hospodárnosti dopravy v najväčšej miere uspokojili prepravné potreby občanov.
...
Dozor na batožinu prislúcha len cestujúcemu, a to aj vtedy, ak je uložená v priestore vyhradenom na batožiny alebo na mieste určenom sprievodcom (vodičom).
...
Cestovné (prepravné) za jednotlivú cestu zaplatí cestujúci bez vyzvania ihneď po nastúpení do vozidla. Ak cestujúci platí sprievodcovi, treba, aby prispieval k plynulému odbaveniu platením cestovného (prepravného) v drobných peniazoch, t.j. v minciach, prípadne v papierových peniazoch do hodnoty 10 Kčs.

(3)

Pri preprave vozidlom s S-prevádzkou je cestujúci povinný platiť cestovné a prepravné len v odpočítaných minciach. Odpočítané mince je cestujúci povinný si pripraviť pred nastúpením do vozidla a po vstupe do vozidla vhodiť bez vyzvania celú sumu naraz do určenej pokladničky; ak naraz platí za viac osôb, je povinný vopred ohlásiť ich počet a osoby musia s ním nastúpiť spoločne.
...
Cestujúci môže nastúpiť do vozidla a z neho vystúpiť len na zastávke, a ak vozidlo nie je v pohybe. Ak ide o zastávku, kde sa vozidlo zastavuje len na znamenie, cestujúci, ktorý chce nastúpiť, musí dať vodičovi vozidla včas znamenie zdvihnutím ruky; cestujúci, ktorý chce na takejto zastávke vystúpiť, musí o tom včas upovedomiť sprievodcu, a ak ide o vozidlo s S-prevádzkou, vodiča (len keď vozidlo stojí).
...
Pokiaľ to miestne dopravné pomery vyžadujú, je dopravca oprávnený vykonať v pravidelnej preprave osôb osobitné miestne úpravy; odchylne od prepravného poriadku môže upraviť len podmienky ustanovené v [§ 6 ods. 3](#paragraf-6.odsek-3), [§ 8 ods. 3 písm. f) a g)](#paragraf-8.odsek-3.pismeno-f), [§ 9](#paragraf-9) a [11](#paragraf-11), [§ 12 ods. 4](#paragraf-12.odsek-4), [§ 15](#paragraf-15) a v [§ 22 ods. 4](#paragraf-22.odsek-4).
