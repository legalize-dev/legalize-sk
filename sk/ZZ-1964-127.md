...
Prepravný poriadok platí aj pre lanové dráhy, ktoré sú súčasťou mestskej dopravy.
...
Dopravca zostavuje a vydáva vývesné cestovné poriadky a predajné knižné cestovné poriadky.

(2)

Dopravca je povinný vyvesiť na každej zastávke alebo stanici (ďalej len „zastávka“), s výnimkou mimoriadne zriadených dočasných zastávok, vývesný cestovný poriadok, ktorý musí obsahovať aspoň tieto údaje:
...
názov zastávky, v ktorej je cestovný poriadok vyvesený,

c)

označenie a smer (cieľovú zastávku) jednotlivej linky prechádzajúcej zastávkou,
...
časy odchodov vozidiel (súprav vozidiel) jednotlivej linky zo zastávky; v čase, v ktorom vozidlá jednotlivej linky prechádzajú zastávkou v kratšom časovom rozpätí ako 15 minút, možno uviesť iba údaj o tomto časovom rozpätí,

f)

údaj o tom, že na linke je zavedená S-prevádzka.

(3)

Trvalé zmeny cestovného poriadku musí dopravca vo vyvesených cestovných poriadkoch urobiť včas a čitateľne. Predvídané dočasné odchýlky od cestovného poriadku vyvolané dopravcom je dopravca povinný vopred oznámiť na zastávkach osobitnými výveskami; nepredvídané dočasné odchýlky oznamuje, ak možno predpokladať, že budú trvať dlhšie ako 12 hodín.

(4)

Dopravca je povinný dbať na správnosť údajov, ktoré sú obsiahnuté vo vyvesených cestovných poriadkoch a vo výveskách. Vyvesené cestovné poriadky a vývesky, ktoré stratili platnosť, sú poškodené alebo nečitateľné, dopravca musí odstrániť, prípadne vymeniť, a to v prípade ich neplatnosti neodkladne.

(5)

Knižný cestovný poriadok musí poskytovať presný prehľad o celkovom usporiadaní liniek i o prevádzke na jednotlivej linke a umožňovať občanom ľahkú orientáciu. Ak to vyžaduje verejný záujem, Ministerstvo dopravy alebo krajský národný výbor môže uložiť dopravcovi, aby vydal knižný cestovný poriadok.
...
Pokiaľ to miestne dopravné pomery vyžadujú, je dopravca oprávnený vykonať v pravidelnej preprave osôb osobitné miestne úpravy; odchylne od prepravného poriadku môže upraviť len podmienky ustanovené v [§ 6 ods. 3](#paragraf-6.odsek-3), [§ 8 ods. 3 písm. f) a g)](#paragraf-8.odsek-3.pismeno-f), [§ 9](#paragraf-9) a [11](#paragraf-11), [§ 12 ods. 4](#paragraf-12.odsek-4), [§ 15](#paragraf-15) a v [§ 22 ods. 4](#paragraf-22.odsek-4) a [ods. 7 písm. d)](#paragraf-22.odsek-7.pismeno-d), pokiaľ sa týka zákazu uvádzať do činnosti návestné zariadenia dopravcu.
...
Pre prepravu osôb a ich batožín na lanových dráhach, ktoré sú súčasťou mestskej dopravy, platia primerane ustanovenia prvého oddielu s týmito odchýlkami:

a)

pre určenie poradia cestujúcich pri nastupovaní do lanovky môže dopravca vydávať osobitné miestenky,

b)

cestovným poriadkom alebo výveskami dopravca môže určiť podmienky, za ktorých prepraví osoby lanovou dráhou mimo pravidelných jázd uvedených v cestovnom poriadku.
...
Pre prepravu osôb a ich batožín v metre platia obdobne ustanovenia [§ 5](#paragraf-5), s výnimkou odseku 2 písm. f), [§ 6 až 8](#paragraf-6), [§ 10, § 11 ods. 1](#paragraf-10), [§ 13](#paragraf-13), [§ 14 ods. 5 a 6](#paragraf-14.odsek-4), [§ 16, § 17](#paragraf-16), [§ 18 ods. 3](#paragraf-18.odsek-3), [§ 19, § 20](#paragraf-19), s výnimkou odsekov 5 až 8, [§ 21](#paragraf-21), s výnimkou odseku 2, a [§ 22](#paragraf-22), s výnimkou prvej vety odseku 4, s týmito odchýlkami:
...
Cestovné a prirážku podľa odseku 1 je povinný zaplatiť aj cestujúci bez platného predplateného cestovného lístka na jednotlivú jazdu alebo bez časového cestovného lístka, ktorý do otvoru turniketu vložil mincu nezodpovedajúcej hodnoty alebo iný predmet alebo vstúpil bez zaplatenia do prepravného priestoru iným spôsobom, než je uvedené v [§ 29](#paragraf-29).
...
Práva objednávateľa osobitnej cesty podľa [§ 28 ods. 2](#paragraf-36.odsek-2) sa musia uplatniť u dopravcu bez zbytočného odkladu. Ak sa práva neuplatnili najneskoršie do šesť mesiacov, zaniknú; šesťmesačná lehota sa začína od udalosti zakladajúcej právo, a ak ide o cestu objednanú socialistickou organizáciou, odo dňa, keď sa cesta vykonala alebo mala vykonať.
