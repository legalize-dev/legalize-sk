...
|  | objemom valcov |  |
|  | 1. do 50 cm3 vrátane | 228 |
|  | 2. nad 50 cm3 do 350 cm3 vrátane | 480 |
|  | 3. nad 350 cm3 | 720 |
...
|  | elektrický pohon | 1 320 |
|  | 2. nad 1 300 cm3 do 1 800 cm3 vrátane | 2 640 |
|  | 3. nad 1 800 cm3 do 2 500 cm3 vrátane | 4 920 |
|  | 4. nad 2 500 cm3 | 6 480 |
| c) | obytný automobil s celkovou hmotnosťou |  |
|  | do 10 000 kg | 2 940 |
| d) | sanitný automobil, ak nie je podľa písme- |  |
|  | na b) ustanovená nižšia sadzba poistného | 2 340 |
| e) | automobily banskej a vodnej záchrannej |  |
|  | služby trvalé vybavené špeciálnymi |  |
|  | prístrojmi na záchranu života a zásahové |  |
|  | vozidlá jednotiek požiarnej ochrany, ak |  |
|  | nie je podľa písmena b) ustanovená |  |
|  | nižšia sadzba poistného | 2 340 |
| f) | ťahač návesov | 7 380 |
| g) | ostatné automobily a pojazdný pracovný stroj so |  |
|  | štátnou poznávacou značkou s celkovou hmotnosťou |  |
|  | 1. od 3 500 kg do 12 000 kg vrátane | 7 380 |
|  | 2. nad 12 000 kg | 10 980 |
| h) | poľnohospodársky alebo lesný traktor, |  |
|  | motorové vozidlo používané výlučne na |  |
|  | prevoz včelstiev so štátnou poznávacou |  |
|  | značkou, pojazdný pracovný stroj bez |  |
|  | štátnej poznávacej značky alebo vyso- |  |
|  | kozdvižný vozík | 432 |
| i) | motorový ručný vozík, jednonápravový |  |
|  | kultivačný traktor alebo traktor, ktorému |  |
|  | sa štátna poznávacia značka neprideľuje | 72 |
| j) | autobus určený na prevádzku iba v mestskej hro- |  |
|  | madnej doprave a trolejbus |  |
|  | 1. autobus | 3 480 |
|  | 2. trolejbus | 1 620 |
| k) | ostatné autobusy s celkovou hmotnosťou |  |
|  | 1. do 5 000 kg vrátane | 7 500 |
|  | 2. nad 5 000 kg | 11 940 |
| l) | prípojné vozidlo |  |
...
|  | vrátane | 72 |
|  | 1.2. s celkovou hmotnosťou nad 750 kg | 144 |
|  | 2. určené na ťahanie motorovým vozidlom |  |
|  | uvedeným v písmene f) - náves | 3 540 |
...
| n) | za motorové vozidlo vyrobené do roku 1945 vrátane |  |
|  | sa platí poistné vo výške polovice príslušnej sadzby |  |
|  | poistného, ktoré je členené podľa skupín motoro- |  |
|  | vých vozidiel uvedených v písmenách a) až k). |  |
