...
Okamžité lotérie podľa [§ 2 písm. d)](#paragraf-2.pismeno-d), stávkové hry podľa [§ 2 písm. g) a h)](#paragraf-2.pismeno-g) a stávkové hry vykonávané v kasínach podľa [§ 2 písm. i)](#paragraf-2.pismeno-i) môžu prevádzkovať len právnické osoby určené ministerstvom.
...
30 % pri lotériách podľa [§ 2 písm. c)](#paragraf-2.pismeno-c),

c)

42 % pri lotériách podľa [§ 2 písm. d)](#paragraf-2.pismeno-d), ak cena za jeden žreb je 10 Sk,

d)

51 % pri lotériách podľa [§ 2 písm. d)](#paragraf-2.pismeno-d), ak cena za jeden žreb je 15 Sk,

e)

54 % pri lotériách podľa [§ 2 písm. d)](#paragraf-2.pismeno-d), ak cena za jeden žreb je 20 Sk,
...
30 % pri stávkových hrách podľa [§ 2 písm. g)](#paragraf-2.pismeno-g),
...
Pri lotériách a iných podobných hrách neuvedených v [§ 2](#paragraf-2) percento odvodu z výťažku určí v povolení orgán, ktorý lotériu alebo inú podobnú hru povolil, vo výške stanovenej v závislosti od charakteristiky hry zodpovedajúcej najbližšej hre uvedenej v § 2 písm. a) až i).

(3)

V odôvodnenom prípade ministerstvo môže v povolení určiť nižšie percento odvodu z výťažku pri štátnych lotériách podľa [§ 4 ods. 1](#paragraf-4.odsek-1).
...
Najnižšia výhra pri lotériách podľa § 2 písm. a) a [d)](#paragraf-2.pismeno-d) a tombolách podľa [§ 2 písm. b)](#paragraf-2.pismeno-b) musí byť vo výške ceny žrebu. Cena žrebu pri lotériách podľa [§ 2 písm. d)](#paragraf-2.pismeno-d) môže byť len 10 Sk, 15 Sk alebo 20 Sk.
...
Výherný prístroj podľa [§ 2 písm. e)](#paragraf-2.pismeno-e) je zariadenie, ktoré spĺňa tieto podmienky:
...
Na povoľovanie a prevádzkovanie stávkových hier podľa [§ 2 písm. c)](#paragraf-2.pismeno-c), [f), g)](#paragraf-2.pismeno-f) a [i)](#paragraf-2.pismeno-i) platia primerane príslušné ustanovenia prvej až piatej časti tohto zákona.
...
päť rokov pri lotériách a stávkových hrách podľa [§ 2 písm. c)](#paragraf-2.pismeno-c), [f), g), h) a i)](#paragraf-2.pismeno-f),
...
50 000 Sk na jednu stávkovú kanceláriu, ak prevádzkuje stávkové hry podľa [§ 2 písm. h)](#paragraf-2.pismeno-h), najviac však 3 000 000 Sk,
...
Peňažné prostriedky v cudzej mene sa prepočítavajú na slovenskú menu kurzom stred vyhláseným Národnou bankou Slovenska v deň otvorenia hracieho dňa.[8)](#poznamky.poznamka-8)
