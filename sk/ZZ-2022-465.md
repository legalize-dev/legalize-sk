...
Rozdiel medzi nákladmi vybraného zraniteľného odberateľa elektriny, ktoré by uhradil za dodávku elektriny, ak by jeho zmluvný dodávateľ uplatnil maximálnu cenu za dodávku elektriny stanovenej alebo určenej úradom pre tohto dodávateľa elektriny na rok 2023 a nákladmi vybraného zraniteľného odberateľa elektriny, ktoré uhradil na základe ceny za dodávku elektriny za maximálnu cenu stanovenú na základe odseku 1 je predmetom priebežnej mesačnej kompenzácie pre tohto dodávateľa elektriny od Ministerstva hospodárstva Slovenskej republiky do 30 dní po konci kalendárneho mesiaca. Výška priebežnej mesačnej kompenzácie sa určí na základe predpokladu spotreby v danom mesiaci, pričom po vyúčtovaní skutočnej dodávky dôjde k doúčtovaniu rozdielov kompenzácií vypočítaných podľa tohto bodu. Prípadné rozdiely medzi predpokladanou spotrebou v roku 2023 a aktualizovanými údajmi o spotrebe na odbernom mieste na základe fyzických odpočtov vykonaných v roku 2023 a 2024 sa zohľadnia v roku 2024.
...
Rozdiel medzi nákladmi vybraného zraniteľného odberateľa plynu, ktoré by uhradil za dodávku plynu, ak by jeho zmluvný dodávateľ plynu uplatnil maximálnu cenu za dodávku plynu stanovenú alebo určenú úradom pre tohto dodávateľa plynu na rok 2023 a nákladmi vybraného zraniteľného odberateľa plynu, ktoré uhradil na základe ceny za dodávku plynu za maximálnu cenu stanovenú na základe odseku 1, je predmetom priebežnej mesačnej kompenzácie pre tohto dodávateľa plynu od Ministerstva hospodárstva Slovenskej republiky do 30 dní po konci kalendárneho mesiaca. Výška priebežnej mesačnej kompenzácie sa určí na základe predpokladu spotreby v danom mesiaci, pričom po vyúčtovaní skutočnej dodávky dôjde k doúčtovaniu rozdielov kompenzácií vypočítaných podľa tohto bodu. Prípadné rozdiely medzi predpokladanou spotrebou v roku 2023 a aktualizovanými údajmi o spotrebe na odbernom mieste na základe fyzických odpočtov vykonaných v roku 2023 a 2024 sa zohľadnia v roku 2024.
