...
podmienky výkonu činnosti audítora bezpečnosti pozemnej komunikácie (ďalej len „bezpečnostný audítor“) a jeho práva a povinnosti,

e)

pôsobnosť Ministerstva dopravy a výstavby Slovenskej republiky (ďalej len „ministerstvo“) v oblasti riadenia bezpečnosti pozemných komunikácií,
...
Tento zákon sa vzťahuje na pozemné komunikácie, ktoré sú súčasťou transeurópskej cestnej siete,^1) diaľnice[1a)](#poznamky.poznamka-1a) a hlavné cestné ťahy[1b)](#poznamky.poznamka-1b) a pozemné komunikácie, ktoré sú budované s využitím prostriedkov Európskej únie v etape ich plánovania, výstavby a užívania, ak ďalej nie je ustanovené inak.

(3)

Tento zákon sa nevzťahuje na cestné tunely podľa osobitného predpisu.[1c)](#poznamky.poznamka-1c)
...
návrhy na odstránenie rozporov s platnými právnymi predpismi, slovenskými technickými normami alebo obdobnými technickými špecifikáciami.
...
Inšpekciou sa hodnotia úseky pozemnej komunikácie vrátane ich súčastí[3a)](#poznamky.poznamka-3a) určené v rámci klasifikácie bezpečnosti cestnej siete. Hodnotenie priľahlých úsekov cestného tunela sa vykoná spolu s inšpekciou podľa osobitného predpisu.[3b)](#poznamky.poznamka-3b) Bezpečnostný audítor pri vykonávaní inšpekcie a pri hodnotení úsekov podľa druhej vety postupuje podľa vykonávacieho predpisu.
...
cielenú prehliadku, ak spĺňa podmienky ustanovené v [§ 6 ods. 2 písm. b) až e)](#paragraf-6.odsek-2.pismeno-b).
...
Bezúhonnosť sa na účely zápisu do zoznamu bezpečnostných audítorov preukazuje výpisom z registra trestov. Na účel preukázania bezúhonnosti poskytne fyzická osoba údaje potrebné na vyžiadanie výpisu z registra trestov.[7a)](#poznamky.poznamka-7a) Údaje podľa druhej vety ministerstvo bezodkladne zašle v elektronickej podobe prostredníctvom elektronickej komunikácie Generálnej prokuratúre Slovenskej republiky na vydanie výpisu z registra trestov.
...
správca pozemnej komunikácie, ktorý nezabezpečí klasifikáciu bezpečnosti úsekov cestnej siete a kontrolu bezpečnosti pozemnej komunikácie a vykonanie inšpekcie podľa [§ 4](#paragraf-4) a cielenú prehliadku podľa [§ 4a](#paragraf-4a),

d)

správca pozemnej komunikácie, ktorý nepredloží správu podľa [§ 4 ods. 5](#paragraf-4.odsek-5) a [8](#paragraf-4.odsek-8) a [§ 4a ods. 6.](#paragraf-4a.odsek-6)
...
určuje zoznam úsekov pozemných komunikácií, na ktoré sa vzťahuje posúdenie podľa [§ 1 ods. 2](#paragraf-1.odsek-2),

c)

je oprávnené z riadne opodstatnených dôvodov spojených s intenzitou cestnej premávky a so štatistikou nehôd doplniť alebo vyňať úseky pozemných komunikácií zo zoznamu pozemných komunikácií, na ktoré sa vzťahuje posúdenie podľa [§ 1 ods. 2](#paragraf-1.odsek-2),
...
zoznam úsekov pozemných komunikácií, ktoré podliehajú posúdeniu podľa [§ 4](#paragraf-4) a následne každú zmenu tohto zoznamu,

2.

zoznam úsekov pozemných komunikácií vyňatých z posúdenia podľa [§ 4](#paragraf-4) a následne každú zmenu tohto zoznamu,
...
Na konanie podľa tohto zákona sa vzťahuje [správny poriadok](../../../../SK/ZZ/1967/71/), ak tento zákon neustanovuje inak.
...
Prvá inšpekcia podľa [§ 4](#paragraf-4) sa vykoná do 31. decembra 2023.

(2)

Prvá správa o vykonanej inšpekcii podľa [§ 4 ods. 5](#paragraf-4.odsek-5) sa predloží do 31. decembra 2023.

(3)

Prvá správa o nápravných opatreniach podľa [§ 4 ods. 8](#paragraf-4.odsek-8) sa predloží do 31. januára 2024.
...
Povinnosť podľa [§ 4a ods. 1](#paragraf-4a.odsek-1) sa prvýkrát vykoná v kalendárnom roku 2024.
