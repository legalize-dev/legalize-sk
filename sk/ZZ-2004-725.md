...
Žiadosť o schválenie jednotlivo dovezeného vozidla z tretej krajiny musí obsahovať údaje podľa [§ 16a ods. 1 písm. a) a b)](#paragraf-16a.odsek-1).
...
platný protokol o technickej kontrole vozidla podľa [§ 49 ods. 2 písm. b)](#paragraf-49.odsek-2.pismeno-b), ak vozidlo takej kontrole podlieha, s výsledkom hodnotenia spôsobilé na premávku na pozemných komunikáciách,

e)

platný protokol o emisnej kontrole motorového vozidla podľa [§ 67 ods. 2 písm. a)](#paragraf-67.odsek-2), ak vozidlo takej kontrole podlieha, s výsledkom hodnotenia spôsobilé na premávku na pozemných komunikáciách,
...
Jednotlivo dovezenému vozidlu podľa odseku 6, ktoré podlieha prihláseniu do evidencie vozidiel,[5)](#poznamky.poznamka-5) obvodný úrad dopravy vystaví a vydá osvedčenie o evidencii, v ktorom uvedie údaje zo základného technického opisu vozidla; jednotlivo dovezenému vozidlu, ktoré nepodlieha prihláseniu do evidencie vozidiel,[5)](#poznamky.poznamka-5) vydá technické osvedčenie vozidla, v ktorom uvedie údaje zo základného technického opisu vozidla.
...
na vlastné náklady podrobiť vozidlo technickej kontrole administratívnej a motorové vozidlo emisnej kontrole administratívnej, ak táto povinnosť bola uložená obvodným úradom dopravy[8)](#poznamky.poznamka-8) v konaní o jednotlivo dovezenom vozidle podľa [§ 16a ods. 16](#paragraf-16a.odsek-16) a [§ 16b ods. 8](#paragraf-16b.odsek-8), a to v lehote do siedmich dní od prihlásenia vozidla do evidencie vozidiel.[5)](#poznamky.poznamka-5)
...
obvodný úrad dopravy,[8)](#poznamky.poznamka-8) ktorý vydal technické osvedčenie vozidla, ak ide o vozidlo jednotlivo vyrobené podľa [§ 14](#paragraf-14), alebo vozidlo jednotlivo dovezené podľa [§ 16a a 16b](#paragraf-16a), alebo vozidlo prestavané podľa [§ 20](#paragraf-20).
...
V lehote od jedného roka do štyroch rokov podlieha emisnej kontrole pravidelnej motorové vozidlo, ktoré je evidované v Slovenskej republike[5)](#poznamky.poznamka-5) a nie je vyradené z premávky na pozemných komunikáciách dočasne podľa [§ 24 ods. 2](#paragraf-24.odsek-2) alebo natrvalo podľa [§ 24 ods. 3](#paragraf-24.odsek-3), jednotlivo dovezené motorové vozidlo z členského štátu alebo iného zmluvného štátu podľa [§ 16a](#paragraf-16a), ktoré nemá platný doklad o vykonaní emisnej kontroly, pred jeho prihlásením do evidencie vozidiel v Slovenskej republike[5)](#poznamky.poznamka-5) a jednotlivo dovezené motorové vozidlo z tretej krajiny podľa [§ 16b](#paragraf-16b) pred jeho prihlásením do evidencie vozidiel v Slovenskej republike[5)](#poznamky.poznamka-5). Lehoty emisných kontrol pravidelných pre jednotlivé kategórie vozidiel ustanoví všeobecne záväzný právny predpis vydaný na vykonanie tohto zákona.
...
prevádzkovateľovi vozidla za každé vozidlo, ktoré nepodrobil v ustanovenej lehote technickej kontrole administratívnej alebo emisnej kontrole administratívnej podľa [§ 21 ods. 1 písm. e)](#paragraf-21.odsek-1.pismeno-e).
