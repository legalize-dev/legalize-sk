...
s devízovými hodnotami, ktoré podliehajú ponukovej povinnosti ([§ 11 ods. 1](#paragraf-11.odsek-1), [§ 17 ods. 1](#paragraf-17.odsek-1)) a ktoré devízová banka odmietla kúpiť ([§ 12 ods. 3](#paragraf-12.odsek-3), [§ 17 ods. 7](#paragraf-17.odsek-7)) a vydala im o tom potvrdenie,
...
Devízový orgán príslušný podľa [§ 6 ods. 2](#paragraf-6.odsek-2) môže v odôvodnených prípadoch udeliť devízovému tuzemcovi - právnickej osobe devízové povolenie na výnimočný nákup devízových prostriedkov nad rámec prípadov uvedených v [§ 13 ods. 1](#paragraf-13.odsek-1) alebo [§ 13a ods. 1 až 3](#paragraf-13a.odsek-1).
...
Povinnosti podľa odseku 1 nepodliehajú devízové prostriedky predané alebo vydané devízovým peňažným ústavom do šiestich mesiacov odo dňa ich kúpy alebo vydania uvedenom v potvrdení devízového peňažného ústavu. V uvedenej lehote môže devízový tuzemec – fyzická osoba s týmito devízovými prostriedkami nakladať, s výnimkou prípadov uvedených v [§ 7 ods. 3](#paragraf-7.odsek-3) a [§ 23](#paragraf-23).
...
zmluvne prevezme záväzok voči devízovému cudzozemcovi, nakupuje nehnuteľnosti v zahraničí, zahraničné cenné papiere, prijíma peňažný úver od devízového cudzozemca ([§ 14](#predpis.cast-tretia.oddiel-4), [23](#predpis.cast-stvrta.oddiel-5)),

g)

bezodplatne prevádza alebo sa vzdá v prospech devízového cudzozemca pohľadávky voči devízovému cudzozemcovi alebo nehnuteľnosti v zahraničí ([§ 24](#predpis.cast-stvrta.oddiel-6)),
...
Devízový priestupok, ktorý bol spoľahlivo zistený, a ak nestačí dohovorenie osobe, ktorá sa priestupku dopustila, môžu orgány uvedené v [§ 44](#paragraf-44) so súhlasom tejto osoby prejednať v blokovom konaní a uložiť blokovú pokutu až do výšky 5 000 Kčs.
...
Devízové účty devízových tuzemcov - právnických osôb ([§ 5 ods. 1 a 2](#paragraf-5.odsek-1)) zriadené podľa doterajších predpisov zostávajú zachované, a to s výnimkou devízových účtov zriadených podľa [§ 11 ods. 3](#paragraf-11.odsek-3), do ich vyčerpania. Pre použitie zostatkov na devízových účtoch platí ustanovenie [§ 11 ods. 6](#paragraf-11.odsek-6). Devízové účty devízových tuzemcov - právnických osôb zriadené na základe devízového povolenia sa riadia podmienkami ustanovenými v tomto povolení.
