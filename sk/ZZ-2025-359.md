...
v bytových budovách s nájomnými bytmi v rámci štátom podporovaného nájomného bývania,[6b)](#poznamky.poznamka-6b)

e)

v bytových budovách, ktoré sa nečlenia na byty, ak sa na nich vzťahujú ustanovenia osobitného predpisu,[6c)](#poznamky.poznamka-6c)

f)

v bytových budovách vo výlučnom vlastníctve Slovenskej republiky alebo vo výlučnom vlastníctve právnickej osoby so 100 % majetkovou účasťou štátu, ak sa na nich vzťahujú ustanovenia osobitného predpisu.[6c)](#poznamky.poznamka-6c)
...
Ustanovenie [§ 5 ods. 1](#paragraf-5.odsek-1) druhej vety v znení účinnom dňom vyhlásenia sa uplatňuje na kalendárny rok 2026.
