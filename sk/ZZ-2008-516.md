...
Príspevok podľa odseku 1 písm. a) nesmie byť menší ako celková suma príspevkov osôb podľa [§ 24 až 28a](#paragraf-24) za posledný kalendárny rok.
...
Osoby, ktoré platia príspevok do fondu podľa [§ 24 až 28a](#paragraf-24), sú povinné tento príspevok odviesť bezhotovostne každoročne najneskôr do 31. júla nasledujúceho kalendárneho roka na účet fondu a predložiť fondu vyúčtovanie odvedeného príspevku, ktoré obsahuje najmä výšku základu pre výpočet príspevku za dané obdobie a výšku odvedeného príspevku.
...
Do základu pre výpočet príspevku podľa [§ 24](#paragraf-24), [25](#paragraf-25), [27](#paragraf-27) až [28a](#paragraf-28a) sa nezaratúva daň z pridanej hodnoty. Základ pre výpočet príspevku sa zaokrúhľuje na celé eurá nahor. Príspevok podľa [§ 24](#paragraf-24), [25](#paragraf-25), [27 až 28a](#paragraf-27) sa zaokrúhľuje na celé eurá nahor.

(4)

Príspevok do fondu podľa [§ 24 až 28a](#paragraf-24) sa neplatí, ak je suma príspevku v príslušnom kalendárnom roku nižšia ako 50 eur. Tým nie je dotknutá povinnosť predložiť vyúčtovanie príspevku podľa odseku 1.

##### § 31

(1)

Ak osoba, ktorá je povinná platiť príspevok do fondu podľa [§ 24 až 28a](#paragraf-24), neodvedie príspevok v lehote podľa [§ 30 ods. 1](#paragraf-30.odsek-1), fond má právo domáhať sa určenia sumy príspevku alebo zaplatenia dlžnej sumy neodvedeného príspevku na súde.
