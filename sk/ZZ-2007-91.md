...
Na postavenie a právne vzťahy týkajúce sa európskeho družstva, ktoré nie sú upravené osobitným predpisom[1)](#poznamky.poznamka-1) ani týmto zákonom, sa primerane použijú ustanovenia o družstve podľa osobitných predpisov.[2)](#poznamky.poznamka-2)

(3)

Na postavenie a právne vzťahy týkajúce sa európskeho družstva sa v prípadoch ustanovených osobitným predpisom[1)](#poznamky.poznamka-1) primerane použijú ustanovenia o akciovej spoločnosti podľa osobitného predpisu.[3)](#poznamky.poznamka-3)

(4)

Týmto zákonom nie sú dotknuté požiadavky na európske družstvá, ktoré podnikajú podľa osobitného predpisu.[4)](#poznamky.poznamka-4)
...
sídlom európskeho družstva sídlo podľa osobitného predpisu,[5)](#poznamky.poznamka-5)
...
Ak tento zákon alebo osobitný predpis[3)](#poznamky.poznamka-3) ustanovuje pôsobnosť predstavenstva, rozumie sa tým, v prípade európskeho družstva, ktoré má podľa stanov monistický systém, pôsobnosť generálneho riaditeľa, ak z ustanovenia tohto zákona alebo z osobitného predpisu[1)](#poznamky.poznamka-1) nevyplýva, že ide o pôsobnosť správnej rady.

(2)

Ak tento zákon alebo osobitný predpis[3)](#poznamky.poznamka-3) ustanovuje pôsobnosť kontrolnej komisie, rozumie sa tým, v prípade európskeho družstva, ktoré má podľa stanov monistický systém, pôsobnosť správnej rady, ak z ustanovenia tohto zákona nevyplýva, že ide o pôsobnosť generálneho riaditeľa.

(3)

Ak tento zákon neustanovuje inak, na pôsobnosť správnej rady sa vzťahujú ustanovenia osobitného predpisu[3)](#poznamky.poznamka-3) upravujúce pôsobnosť predstavenstva alebo kontrolnej komisie.

##### § 4

Európske družstvo je právnickou osobou, ktorá sa zapisuje do obchodného registra podľa osobitného predpisu.[7)](#poznamky.poznamka-7)
...
Na členov správnej rady európskeho družstva sa primerane vzťahujú ustanovenia osobitného predpisu o ich povinnostiach a zodpovednosti.[30)](#poznamky.poznamka-30)
...
Na generálneho riaditeľa európskeho družstva sa primerane vzťahujú ustanovenia osobitného predpisu.[30)](#poznamky.poznamka-30)
...
Na výkonných riaditeľov európskeho družstva sa primerane vzťahujú ustanovenia osobitného predpisu.[30)](#poznamky.poznamka-30)
...
Povinnosťou zachovávať mlčanlivosť podľa odsekov 1 a 2 nie sú dotknuté ustanovenia osobitného predpisu.[36)](#poznamky.poznamka-36)
