...
spory uvedené v [§ 2a](#paragraf-2a) medzi organizáciami a federálnymi ministerstvami alebo inými federálnymi ústrednými orgánmi, alebo ak ide spory súvisiace so zaistením obrany a bezpečnosti štátu alebo s dodávkami v odbore štátnych hmotných rezerv.
...
Hospodárska arbitráž môže uložiť odvod až do výšky sumy, ktorá mala byť ako penále zaplatená (ďalej len „odvod penále") do príslušného štátneho rozpočtu, ak pri prejednávaní sporu alebo v konaní o odvode penále do štátneho rozpočtu zistí, že boli splnené podmienky ustanovené pre uloženie tohto odvodu osobitným predpisom.[5)](#poznamky.poznamka-5)
...
V rozhodnutí o uložení odvodu do štátneho rozpočtu a o uložení hospodárskej pokuty sa uvedie, ktorá organizácia sú povinné odviesť sumu a akú. V rozhodnutí sa uvedie aj finančná správa, na účet ktorej sa má určená suma odviesť; rovnopis rozhodnutia zašle hospodárska arbitráž aj tomuto orgánu.
