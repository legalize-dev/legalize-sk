...
Poštový regulačný úrad v konaní podľa odseku 2 vo veci posúdenia návrhu určenia relevantných trhov, na ktorých je poštová služba poskytovaná, alebo zameniteľnosti poštovej služby, spolupracuje s Protimonopolným úradom Slovenskej republiky.[4)](#poznamky.poznamka-4)
...
Na účely určenia, či je poštová služba zameniteľnou poštovou službou, je rozhodujúci zápis v registri poštových podnikov podľa [§ 23 ods. 1 písm. b)](#paragraf-23.odsek-1.pismeno-b), pokiaľ Poštový regulačný úrad nerozhodne v konaní podľa odseku 2 inak.
...
Na čele Poštového regulačného úradu je predseda Poštového regulačného úradu (ďalej len „predseda“), ktorého volí a odvoláva Národná rada Slovenskej republiky na návrh vlády. Plat a platové náležitosti predsedu určuje vláda podľa osobitného predpisu.[12)](#poznamky.poznamka-12)
...
Ak sú po zmene skutočností podľa odseku 1 splnené podmienky podľa [§ 19 ods. 2](#paragraf-19.odsek-2), Poštový regulačný úrad písomne oznámi poštovému podniku, že vzal ohlásenú zmenu na vedomie a vykoná zmenu v registrovaných údajoch.

(5)

Ak Poštový regulačný úrad zistí, že po zmene skutočností podľa odseku 1 nie sú splnené podmienky podľa [§ 19 ods. 2](#paragraf-19.odsek-2), a ak je odôvodnený predpoklad, že poštový podnik by tieto podmienky mohol splniť v primeranej lehote, Poštový regulačný úrad preruší konanie o zmene registrácie a poskytne poštovému podniku primeranú lehotu na splnenie podmienok podľa [§ 19 ods. 2](#paragraf-19.odsek-2), najviac však 60 dní. Ak poštový podnik v tejto lehote podmienky podľa [§ 19 ods. 2](#paragraf-19.odsek-2) nesplní, alebo ak Poštový regulačný úrad zistí, že poštový podnik nespĺňa podmienky podľa [§ 19 ods. 2](#paragraf-19.odsek-2) a nie sú ani predpoklady, že tieto podmienky dodatočne splní, Poštový regulačný úrad uznesením zastaví konanie o zmene registrácie a začne konanie o zrušení registrácie.
...
Poštový regulačný úrad je cenovým orgánom pre reguláciu poštových sadzieb za poskytovanie univerzálnej služby v rozsahu udelenej poštovej licencie a za poskytovanie poštového platobného styku. Poštový regulačný úrad vykonáva reguláciu poštových sadzieb podľa osobitného predpisu.[15)](#poznamky.poznamka-15)
...
Poštový regulačný úrad začne konanie o zrušenie poštovej licencie, okrem prípadu podľa [§ 48 ods. 5](#paragraf-48.odsek-5), aj vtedy, ak
...
Financovanie univerzálnej služby sa vykonáva spôsobom a v rozsahu podľa tohto zákona prostredníctvom osobitného účtu v Štátnej pokladnici[23)](#poznamky.poznamka-23) (ďalej len „kompenzačný fond“), ktorý na tento účel zriadi a spravuje Poštový regulačný úrad.
...
Ak rozdiel medzi sumou náhrady čistých nákladov univerzálnej služby určenou rozhodnutím podľa [§ 57 ods. 6](#paragraf-57.odsek-6) a sumou predbežných čistých nákladov univerzálnej služby určenou podľa [§ 57 ods. 3](#paragraf-57.odsek-3) je kladný, Poštový regulačný úrad súčasne s vydaním rozhodnutia o náhrade čistých nákladov univerzálnej služby vydá v rozsahu tohto rozdielu rozhodnutie o zvýšení príspevku do kompenzačného fondu; ustanovenia odsekov 1, 2, 4 a 5 sa použijú rovnako.

(7)

Ak rozdiel medzi sumou predbežných čistých nákladov univerzálnej služby určenou podľa [§ 57 ods. 3](#paragraf-57.odsek-3) a sumou náhrady čistých nákladov univerzálnej služby určenou rozhodnutím podľa [§ 57 ods. 6](#paragraf-57.odsek-6) je kladný, Poštový regulačný úrad vráti v rozsahu tohto rozdielu zaplatené príspevky do kompenzačného fondu poštovým podnikom, a to pomerne s použitím spôsobu určenia sumy týchto príspevkov.
...
Príslušným správnym orgánom na prejednanie priestupku podľa odseku 1 je Poštový regulačný úrad; na priestupky a ich prejednávanie sa vzťahuje všeobecný predpis o priestupkoch.[26)](#poznamky.poznamka-26)
...
neposkytne Poštovému regulačnému úradu na jeho požiadanie informácie a údaje o nákladoch a výnosoch z poskytovania univerzálnej služby alebo nepredloží ani na výzvu Poštovému regulačnému úradu ročnú účtovnú závierku podľa [§ 54 ods. 6](#paragraf-54.odsek-6).
...
ako poštový podnik, ktorý je povinný viesť účtovníctvo spôsobom podľa [§ 36](#paragraf-36), túto povinnosť poruší alebo nepredloží ani na výzvu Poštovému regulačnému úradu ročnú účtovnú závierku alebo iné údaje podľa [§ 36](#paragraf-36),
...
Poštový regulačný úrad zverejní návrh všeobecného povolenia podľa [§ 18 ods. 1](#paragraf-18.odsek-1) najneskôr do 10 pracovných dní od nadobudnutia účinnosti tohto zákona.
