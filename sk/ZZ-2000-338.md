...
O zadržaní lodných osvedčení podľa odseku 5 písm. b) a c), ktoré boli vydané iným členským štátom, alebo o zákaze pokračovať v plavbe vydanom podľa odseku 5 písm. d) plavidlu, ktorého lodné osvedčenie vydal iný členský štát, informuje Dopravný úrad príslušný orgán tohto členského štátu do siedmich dní od zistenia tejto skutočnosti alebo uloženia zákazu. O zadržaní dokladov uvedených v [§ 30 ods. 3](#paragraf-30.odsek-3) a [5](#paragraf-30.odsek-5), ktoré boli zadržané podľa odseku 5 písm. a) Dopravný úrad bezodkladne vykoná záznam v Databáze odborných spôsobilostí členov posádky plavidla Európskej únie.
...
Doklady podľa [§ 30 ods. 3 až 6](#paragraf-30.odsek-3) alebo [§ 31](#paragraf-31) vydané Dopravným úradom a zadržané podľa odseku 5 písm. a) a lodné osvedčenie alebo lodné osvedčenie malého plavidla vydané Dopravným úradom a zadržané podľa odseku 5 písm. b) postúpi plavebný inšpektor Dopravnému úradu na ďalšie konanie. Doklady podľa [§ 30 ods. 3 až 6](#paragraf-30.odsek-3) alebo [§ 31](#paragraf-31) vydané príslušným orgánom cudzieho štátu a zadržané podľa odseku 5 písm. a) a lodné osvedčenie alebo lodné osvedčenie malého plavidla vydané príslušným orgánom cudzieho štátu a zadržané podľa odseku 5 písm. b) zasiela Dopravný úrad príslušnému orgánu cudzieho štátu, ktorý doklady podľa [§ 30 ods. 3 až 6](#paragraf-30.odsek-3) alebo [§ 31](#paragraf-31) alebo lodné osvedčenie alebo lodné osvedčenie malého plavidla vydal. Ak plavebný inšpektor zistí pri výkone štátneho odborného dozoru podľa [§ 39 písm. a) šiesteho bodu](#paragraf-39.pismeno-a.bod-6) porušenie tohto zákona alebo súvisiacich všeobecne záväzných právnych predpisov, postúpi vec Dopravnému úradu na ďalšie konanie.
...
prevádzkovateľovi plavidla, ak porušil povinnosti ustanovené v tomto zákone ([§ 22 až 23](#paragraf-22), [§ 24 ods. 9](#paragraf-24.odsek-9), [§ 26](#paragraf-26) a [27](#paragraf-27), [§ 28 ods. 2](#paragraf-28.odsek-2), [3](#paragraf-28.odsek-3) a [6](#paragraf-28.odsek-6), [§ 29 ods. 8](#paragraf-29.odsek-8) a [§ 39c ods. 4](#paragraf-39c.odsek-4)),
...
členovi posádky plavidla alebo vodcovi malého plavidla ním vydaný doklad podľa [§ 30 ods. 3 až 6](#paragraf-30.odsek-3) alebo [§ 31](#paragraf-31) zadržaný podľa [§ 39d ods. 5 písm. a)](#paragraf-39d.odsek-5.pismeno-a) na určitý čas, najviac tri roky, a v prípade straty zdravotnej spôsobilosti natrvalo; vrátenie odňatého dokladu podľa [§ 30 ods. 3 až 6](#paragraf-30.odsek-3) alebo [§ 31](#paragraf-31) je podmienené preskúšaním jeho držiteľa,

b)

lodné osvedčenie alebo lodné osvedčenie malého plavidla zadržané podľa [§ 39d ods. 5 písm. b)](#paragraf-39d.odsek-5.pismeno-b) na čas potrebný na odstránenie zistených závad alebo nedostatkov; v prípade úplnej straty spôsobilosti plavidla na plavbu natrvalo.
