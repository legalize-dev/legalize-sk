...
vo výške preukázanej znaleckým posudkom podľa osobitného predpisu[1)](#poznamky.poznamka-1) alebo posudkom štatutárneho audítora alebo audítorskej spoločnosti podľa osobitného predpisu,[2)](#poznamky.poznamka-2) ak dodávateľ plynu znaleckým posudkom alebo posudkom audítora alebo audítorskej spoločnosti preukáže, že oprávnené náklady spojené so zabezpečením dodávky plynu pre malého odberateľa plynu podľa osobitného predpisu[4)](#poznamky.poznamka-4) vrátane primeraného zisku vo výške 3 eurá na MWh sú vyššie ako maximálna kompenzovaná výška ceny plynu v 2023 podľa písmena a) alebo písmena b), nie však vyššej ako zmluvná cena za plyn v 2023.
...
Celková výška kompenzácie pre dodávateľa plynu malým odberateľom plynu podľa [§ 6](#paragraf-6) za rok 2023 úhradou zo štátneho rozpočtu nesmie presiahnuť sumu kompenzácie vypočítanú ako suma kompenzácie za celkové množstvo plynu dodaného pre malých odberateľov plynu príslušným dodávateľom plynu podľa [§ 6](#paragraf-6) a [§ 7 ods. 2](#paragraf-7.odsek-2) v znení účinnom od 1. októbra 2023. Dodávateľ plynu predloží ministerstvu do 31. decembra 2023 prepočet kompenzácií vyplatených za obdobie do 1. októbra 2023 podľa [§ 6](#paragraf-6) v znení účinnom od 1. októbra 2023. Prípadné rozdiely medzi výškou kompenzácie vyplatenej pred 1. októbrom 2023 a výškou kompenzácie za toto obdobie podľa [§ 6](#paragraf-6) v znení účinnom od 1. októbra 2023 vysporiada ministerstvo v roku 2024 spolu s rozdielmi medzi kompenzáciou poukázanou dodávateľovi plynu v roku 2023 a výškou kompenzácie na základe skutočne nameraných údajov podľa [§ 6 ods. 3](#paragraf-6.odsek-3) tak, aby celková výška kompenzácie pre dodávateľa plynu podľa [§ 6](#paragraf-6) za rok 2023 úhradou zo štátneho rozpočtu bola v súlade s prvou vetou.
