...
Ak to vyžaduje rozsah správy, môže súd ustanoviť na pomoc správcovi osobitného správcu pre určitý odbor správy. Osobitný správca je v rozsahu jeho odboru správy povinný podľa požiadaviek a pokynov správcu poskytovať pomoc správcovi pri výkone správy podstaty. Osobitný správca má práva, povinnosti a zodpovednosť správcu v medziach svojej pôsobnosti.
