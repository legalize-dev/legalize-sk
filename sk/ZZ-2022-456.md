...
V § 3 ods. 1 sa vypúšťajú písmená b), c) a h).

Doterajšie písmená d) až g) sa označujú ako písmená b) až e) a doterajšie písmená i) až o) sa označujú ako písmená f) až l).
