...
Parametre pre zaradenie pyrotechnických výrobkov do tried a podtried podľa odsekov 3 až 5 sú uvedené v [prílohe č. 1 tejto vyhlášky](#prilohy.priloha-priloha_c_1vyhlasky_sbu_c_536_1991_zb.oznacenie). V tejto prílohe sa uvádzajú aj najčastejšie používané pyrotechnické výrobky.
...
Pyrotechnické zlože používané v pyrotechnických predmetoch nesmú byť mechanicky alebo chemicky znečistené a samozápalné. Nesmú vytvárať chemické reakcie a zmeny nepriaznivo ovplyvňujúce bezpečnosť pri manipulácii, skladovaní a použití, a to ani v prípade ich uloženia v najmenšom pôvodnom balení pri teplote 50 stupňov C počas 4 týždňov.
...
Žiadosť o zaradenie a schválenie pyrotechnických predmetov[2)](#poznamky.poznamka-2) pred ich uvedením do obehu podáva výrobca alebo dovozca.
...
Na konštrukciu, skúšanie, typové schvaľovanie a označenie obalov sa vzťahujú osobitné predpisy upravujúce podmienky prepravy nebezpečných vecí a nebezpečného tovaru jednotlivými druhmi dopravy.[3)](#poznamky.poznamka-3)
...
Nadobúdať sa smú len pyrotechnické predmety uvedené do obehu podľa [§ 4 ods. 1](#paragraf-4.odsek-1) a používať sa smú len v súlade s návodom na ich používanie.
