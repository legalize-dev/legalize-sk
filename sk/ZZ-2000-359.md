...
zaplatí určené zápisné [[§ 9 ods. 3 písm. h)](#paragraf-9.odsek-3.pismeno-h)].
...
organizuje a zabezpečuje vykonávanie výcviku žiadateľov o udelenie inštruktorského oprávnenia (ďalej len „inštruktorský kurz“),[2)](#poznamky.poznamka-2)

b)

organizuje a zabezpečuje vykonávanie doškoľovacích kurzov inštruktorov,[2a)](#poznamky.poznamka-2a)

c)

organizuje a zabezpečuje kurzy na vydanie preukazu skúšobného komisára komory a doškoľovacie kurzy skúšobného komisára komory,[2b)](#poznamky.poznamka-2b)

d)

zaznamenáva údaje o začatých a ukončených inštruktorských kurzoch a doškoľovacích kurzoch inštruktorov autoškôl, o účastníkoch kurzov a o udelených vodičských oprávneniach a inštruktorských oprávneniach do informačného systému podľa osobitného predpisu,[2c)](#poznamky.poznamka-2c)

e)

zaznamenáva údaje o začatých a ukončených kurzoch podľa písmen a) až d) do informačného systému podľa osobitného predpisu,[2c)](#poznamky.poznamka-2c)

f)

zasiela prostredníctvom informačného systému podľa osobitného predpisu[2c)](#poznamky.poznamka-2c) Ministerstvu dopravy a výstavby Slovenskej republiky (ďalej len „ministerstvo dopravy“) bezodkladne po ukončení kurzu hlásenie o ukončení kurzov podľa písmen a) až d),

g)

spolupôsobí s okresným úradom v sídle kraja pri vykonávaní inštruktorských skúškok[2d)](#poznamky.poznamka-2d) tým, že zástupcovia komory sú členmi skúšobnej komisie,

h)

spolupôsobí s ministerstvom dopravy pri vykonávaní skúšok na vydanie preukazu skúšobného komisára komory[3)](#poznamky.poznamka-3) a skúšok na predĺženie platnosti preukazu skúšobného komisára tým, že zástupcovia komory sú členmi skúšobnej komisie,

i)

spolupracuje s Ministerstvom vnútra Slovenskej republiky pri tvorbe otázok do skúšobných testov na teoretickú skúšku z odbornej spôsobilosti.[3a)](#poznamky.poznamka-3a)
...
schvaľovať stanovy komory, rokovací poriadok, volebný poriadok a disciplinárny poriadok,
...
voliť a odvolávať členov predstavenstva, dozornej rady a disciplinárnej komisie a ich náhradníkov,
...
preskúmavať a schvaľovať správy o činnosti predstavenstva, dozornej rady a disciplinárnej komisie,
...
Valné zhromaždenie je uznášaniaschopné, ak je prítomná najmenej jedna tretina všetkých členov komory. Na platnosť uznesenia je potrebný súhlas nadpolovičnej väčšiny prítomných členov komory. Pri voľbe členov a náhradníkov orgánov komory rozhoduje počet hlasov, ktoré jednotlivým kandidátom odovzdali prítomní členovia komory.
...
Funkčné obdobie volených orgánov komory je štvorročné. Ak počas funkčného obdobia voleného orgánu komory dôjde k zániku funkcie jeho člena, na zostávajúce funkčné obdobie nastupuje do jeho funkcie zvolený náhradník. Ak predčasne zanikla funkcia člena voleného orgánu aj u posledného zvoleného náhradníka a do uplynutia funkčného obdobia voleného orgánu komory zostáva viac ako šesť mesiacov, na najbližšom zasadnutí valného zhromaždenia sa uskutočnia doplňujúce voľby na uvoľnenú funkciu člena voleného orgánu a náhradníkov voleného orgánu na zostávajúce funkčné obdobie; [§ 9 ods. 3 písm. c)](#paragraf-9.odsek-3.pismeno-c) a [d)](#paragraf-9.odsek-3.pismeno-d) tým nie sú dotknuté.

(2)

Funkcia člena voleného orgánu komory zaniká
...
vzdaním sa funkcie; výkon funkcie člena voleného orgánu komory zaniká dňom doručenia písomného oznámenia o vzdaní sa funkcie orgánu komory, ktorý ho zvolil,

c)

dočasným prerušením členstva v komore,

d)

zánikom členstva v komore,

e)

zánikom funkcie štatutárneho orgánu zástupcu právnickej osoby, ktorá je členom komory,
...
vedie evidenciu členov komory, inštruktorov, skúšobných komisárov, prevádzkovateľov autoškoly, zodpovedných zástupcov autoškoly a kurzov podľa [§ 5 ods. 1 písm. a) až d)](#paragraf-5.odsek-1.pismeno-a),
...
zabezpečuje organizovanie kurzov podľa [§ 5 ods. 1 písm. a) až c)](#paragraf-5.odsek-1.pismeno-a).

(2)

Činnosť úradu komory riadi a za jeho hospodárenie zodpovedá riaditeľ, ktorého vymenúva a odvoláva predstavenstvo. Riaditeľ úradu komory sa zúčastňuje na zasadaniach predstavenstva a valného zhromaždenia.
...
Funkčné obdobie orgánov komory, ktoré začalo plynúť pred 1. januárom 2025, sa skončí uplynutím štyroch rokov odo dňa ich zvolenia.

(2)

Valné zhromaždenie na najbližšom zasadnutí zvolí dvoch náhradníkov pre každý volený orgán komory.
