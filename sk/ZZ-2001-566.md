...
Obchodník s cennými papiermi, ktorý je kontrolovaný materskou finančnou holdingovou spoločnosťou v Európskej únií alebo v ktorom má materská finančná holdingová spoločnosť v Európskej únii majetkovú účasť, má povinnosť poskytnúť súčinnosť pri uverejňovaní informácií podľa odsekov 1 a 2 za konsolidovaný celok tejto finančnej holdingovej spoločnosti.
...
obchodník s cennými papiermi, ktorý je oprávnený poskytovať investičné služby podľa [§ 6 ods. 2 písm. a), b)](#paragraf-6.odsek-2) alebo [d)](#paragraf-6.odsek-2.pismeno-d) a pri ich poskytovaní je oprávnený nakladať s peňažnými prostriedkami alebo finančnými nástrojmi klienta,
...
Kvalifikovaným investorom sa na účely tohto zákona rozumie profesionálny klient alebo oprávnená protistrana; kvalifikovaným investorom nie je osoba, ktorá požiadala, aby sa s ňou na účely tohto zákona zaobchádzalo ako s neprofesionálnym klientom. Obchodník s cennými papiermi a úverová inštitúcia informujú emitenta na základe jeho žiadosti o zaradení klientov podľa [§ 8a](#paragraf-8a); tým nie sú dotknuté ustanovenia osobitného zákona.[108a)](#poznamky.poznamka-108a)
...
Príslušným orgánom na vykonávanie oprávnení vo vzťahu k ratingovým agentúram podľa osobitného predpisu[107ca)](#poznamky.poznamka-107ca) je Národná banka Slovenska.
...
Ratingové agentúry a osoby žiadajúce o registráciu podľa osobitného predpisu[107ca)](#poznamky.poznamka-107ca) sú povinné predkladať Národnej banke Slovenska ňou požadované údaje potrebné na riadne plnenie povinností príslušného orgánu podľa osobitného predpisu.[107ca)](#poznamky.poznamka-107ca)

(4)

Na konanie a rozhodovanie o registrácii ratingovej agentúry sa vzťahujú ustanovenia osobitného zákona,[20)](#poznamky.poznamka-20) ak osobitný predpis neustanovuje inak.[107ca)](#poznamky.poznamka-107ca)
