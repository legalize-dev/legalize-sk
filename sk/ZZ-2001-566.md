...
Obchodník s cennými papiermi je povinný bezodkladne potom, čo zverejní informácie podľa osobitného predpisu,[56ab)](#poznamky.poznamka-56ab) zaslať zverejnené informácie Národnej banke Slovenska.
...
Na účely odseku 2 si obchodník s cennými papiermi môže zriadiť výbor pre riadenie rizík; ak obchodník s cennými papiermi nezriadi výbor pre riadenie rizík, je povinný riadenie rizík vykonávať výborom pre audit podľa osobitného predpisu,[56ac)](#poznamky.poznamka-56ac) ktorý vykonáva činnosti podľa odseku 2.
...
ďalších zamestnancov, ktorí nie sú uvedení v písmenách a) až d), ktorí sú zodpovední za podstupovanie rizika a ktorých profesionálne činnosti majú významný vplyv na rizikový profil banky podľa osobitného predpisu.[56aca)](#poznamky.poznamka-56aca)
...
iné finančné nástroje, ktoré primerane odrážajú kreditnú kvalitu obchodníka s cennými papiermi pri pokračovaní jeho činnosti vrátane nástrojov podľa osobitného predpisu,[56ad)](#poznamky.poznamka-56ad) alebo
...
Informácie podľa odseku 1 a informácie zverejňované podľa § 74b ods. 1 písm. l) Národná banka Slovenska oznámi Európskemu orgánu dohľadu (Európskemu orgánu pre bankovníctvo).[56b)](#poznamky.poznamka-56b)
...
Fyzická osoba alebo právnická osoba, ktorá nie je centrálnym depozitárom podľa tohto zákona, nesmie vykonávať činnosti uvedené v odseku 3, ak tento zákon alebo právne záväzný akt Európskej únie upravujúci činnosť centrálnych depozitárov neustanovuje inak, s výnimkou činností podľa odseku 3 písm. h), ktoré centrálny depozitár môže vykonávať v súčinnosti s burzou cenných papierov.
...
Centrálny depozitár nesmie splynúť s inou osobou ani sa rozdeliť. Zakazuje sa predaj centrálneho depozitára alebo jeho časti.[33)](#poznamky.poznamka-33) Centrálny depozitár sa nesmie zlúčiť s inou osobou, ako je centrálny depozitár alebo právnická osoba so sídlom v zahraničí, s obdobným predmetom činnosti inej osobe ako osobe uvedenej v [§ 99 ods. 11](#paragraf-99.odsek-11). Na takéto zlúčenie sa vyžaduje predchádzajúci súhlas Národnej banky Slovenska podľa [§ 102](#paragraf-102).
...
pravidlá založenia, vedenia a zrušenia účtov majiteľov vedených centrálnym depozitárom a klientskych účtov členov vrátane určenia právnických osôb, ktorým môže centrálny depozitár zriadiť účet majiteľa a pravidlá pre poskytovanie s tým súvisiacich služieb vrátane spôsobu poskytovania výpisu z účtu podľa [§ 105 ods. 7](#paragraf-105.odsek-7),
...
spôsob a postup na podávanie príkazov na prevod podľa [§ 18b](#paragraf-18b), a to aj ak právoplatné rozhodnutie o dedičstve neobsahuje údaje o cenných papieroch, ktoré sú predmetom prevodu.

(3)

Predstavenstvo centrálneho depozitára je povinné predložiť Národnej banke Slovenska na schválenie návrh prevádzkového poriadku a jeho zmien po prerokovaní vo Výbore pre služby alebo v inom poradnom orgáne určenom v prevádzkovom poriadku.
...
Centrálny depozitár zriadi na žiadosť účet majiteľa aj centrálnemu depozitáru, štátnemu orgánu konajúcemu v mene Slovenskej republiky a právnickej osobe podľa osobitného predpisu.[90ab)](#poznamky.poznamka-90ab) Centrálny depozitár môže zriadiť účet majiteľa aj inej právnickej osobe, ak je to uvedené v prevádzkovom poriadku.
...
nepredstavujú podriadené dlhy alebo nie sú vymeniteľné za nimi vydané akcie alebo vymeniteľné za akcie iných obchodných spoločností,
...
uložiť pokutu obchodníkovi s cennými papiermi alebo zahraničnému obchodníkovi s cennými papiermi od 330 do 664 000 eur,
...
Pokutu podľa odseku 1 písm. e) môže Národná banka Slovenska uložiť aj osobám, ktoré porušili ustanovenia [§ 99 ods. 10](#paragraf-99.odsek-10), [§ 102](#paragraf-102), [§ 118d](#paragraf-118d), [§ 132c](#paragraf-132c) alebo [§ 133](#paragraf-133). Uloží im aj opatrenie na odstránenie a nápravu protiprávneho stavu. Ak Národná banka Slovenska zistí, že fyzická osoba alebo právnická osoba vykonáva bez povolenia činnosti, na ktoré je potrebné povolenie podľa tohto zákona, je oprávnená uložiť fyzickej osobe alebo právnickej osobe podľa závažnosti a miery zavinenia sankcie podľa odseku 1 písm. d) a odseku 25 a oznámi túto skutočnosť orgánu činnému v trestnom konaní. Ak Národná banka Slovenska zistí manipuláciu s trhom podľa [§ 131a](#paragraf-131a) alebo zneužitie dôverných informácií podľa [§ 132](#paragraf-132) fyzickou osobou alebo právnickou osobou, ktorá nie je obchodníkom s cennými papiermi alebo finančnou inštitúciou, je oprávnená uložiť fyzickej osobe alebo právnickej osobe podľa závažnosti a miery zavinenia pokutu až do výšky 5 000 000 eur, alebo nariadiť povinnosť uhradiť náhradu rovnajúcu sa hodnote dvojnásobku majetkového prospechu osobe, na ktorej úkor bol majetkový prospech získaný, a oznámi túto skutočnosť orgánu činnému v trestnom konaní.
...
Za porušenie ustanovení [§ 54 ods. 8](#paragraf-54.odsek-8) a [§ 70](#paragraf-70.odsek-8) môže Národná banka Slovenska uložiť pokutu
...
Informácie o opatreniach na nápravu a pokutách podľa odsekov 1, 7, 25, [§ 145 ods.1](#paragraf-145.odsek-1), [§ 145a ods. 1](#paragraf-145a.odsek-1) a [2](#paragraf-145a.odsek-2) a [§ 46 ods. 1](#paragraf-46.odsek-1), proti ktorým už nie je prípustný opravný prostriedok Národná banka Slovenska zverejňuje na svojom webovom sídle najmenej po dobu piatich rokov,[114e)](#poznamky.poznamka-114e) a to bezodkladne potom ako bol obchodník s cennými papiermi, pobočka zahraničného obchodníka s cennými papiermi, zmiešaná finančná holdingová spoločnosť alebo osoba o uložení opatrenia na nápravu alebo pokute informovaná.
...
Národná banka Slovenska je povinná zachovať anonymitu zamestnanca, vedúceho zamestnanca, člena štatutárneho orgánu alebo člena dozornej rady obchodníka s cennými papiermi, ako aj zamestnanca alebo vedúceho zamestnanca pobočky zahraničného obchodníka s cennými papiermi, ktorý poskytol Národnej banke Slovenska akúkoľvek informáciu o nedostatkoch v činnosti obchodníka s cennými papiermi a pobočky zahraničného obchodníka s cennými papiermi podľa [§ 144 ods. 1](#paragraf-144.odsek-1).
...
Ak obchodník s cennými papiermi postupuje podľa odseku 9, pred 1. januárom 2008 sa neuplatňujú ustanovenia týkajúce sa systému hodnotenia primeranosti vnútorného kapitálu a [§ 74c ods. 3](#paragraf-74c.odsek-4) a na povinnosť obchodníka s cennými papiermi uverejňovať informácie sa vzťahujú predpisy účinné pred 1. januárom 2007.
