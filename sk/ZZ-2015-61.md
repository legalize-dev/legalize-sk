...
príslušná stavovská organizácia alebo príslušná profesijná organizácia po prerokovaní v Krajskej rade pre odborné vzdelávanie a prípravu (ďalej len „krajská rada“) udelí oprávnenie pre príslušný študijný odbor, príslušný učebný odbor alebo pre príslušnú profesijnú kvalifikáciu,
