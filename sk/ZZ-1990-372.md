...
V blokovom konaní ([§ 84](#paragraf-84)) možno uložiť pokutu do 33 eur, ak tento zákon alebo iný zákon neustanovuje inak, a v rozkaznom konaní ([§ 87](#paragraf-87)) do 132 eur.
...
Horná hranica pokuty sa u mladistvých znižuje na polovicu; nesmie byť pritom vyššia ako 132 eur a v blokovom konaní nesmie byť vyššia ako 16 eur. V blokovom konaní možno uložiť mladistvému pokutu do 33 eur, ak podľa tohto zákona alebo iného zákona možno uložiť v blokovom konaní pokutu vyššiu ako 33 eur.
...
V blokovom konaní možno uložiť za priestupok podľa odseku 1 pokutu do 66 eur.
...
Za priestupok podľa odseku 1 písm. a) až f) možno uložiť pokutu do 99 eur a za priestupok podľa odseku 1 písm. g) až j) pokutu do 165 eur; zákaz činnosti do jedného roku možno uložiť za priestupok podľa odseku 1 písm. d), g) a j).
...
Za priestupok podľa odseku 1 písm. a) až e) možno uložiť pokutu do 99 eur, za priestupok podľa odseku 1 písm. f) až ch) pokutu do 165 eur; zákaz činnosti do jedného roku možno uložiť za priestupok podľa odseku 1 písm. f), g) a ch).
...
Za priestupok podľa odseku 1 písm. a) až d) možno uložiť pokutu do 99 eur.
...
Za priestupok podľa odseku 1 písm. a) až d) možno uložiť pokutu do 33 eur, za priestupok podľa odseku 1 písm. e) až g) pokutu do 99 eur a za priestupok podľa odseku 1 písm. h) až i) pokutu do 165 eur.
...
orgány Železničnej polície, ak ide o priestupky, ktoré sú oprávnené prejednať podľa § 52 písm. b) a v blokovom konaní,
