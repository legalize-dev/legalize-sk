...
účasť podľa [§ 49 ods. 5 písm. f)](#paragraf-49.odsek-5.pismeno-f) poisťovne alebo zaisťovne v inej poisťovni, poisťovni z iného členského štátu, zahraničnej poisťovni, zaisťovni, zaisťovni z iného členského štátu, zahraničnej zaisťovni, finančnej holdingovej inštitúcii alebo v inej finančnej inštitúcii,
...
poisťovňa, poisťovňa z iného členského štátu, zahraničná poisťovňa vrátane ich pobočiek, zaisťovňa, zaisťovňa z iného členského štátu alebo zahraničná zaisťovňa vrátane ich pobočiek alebo poisťovacia holdingová spoločnosť; tie tvoria sektor poisťovníctva,
...
Sankcie a opatrenia podľa odsekov 1 až 9 možno ukladať samostatne alebo súbežne a opakovane. Sankcie a opatrenia podľa odsekov 1 až 8 možno uložiť do dvoch rokov od zistenia nedostatkov, najneskôr však do desiatich rokov od ich vzniku. Nedostatky uvedené v protokole o vykonanom dohľade na mieste sa považujú za zistené odo dňa skončenia príslušného dohľadu na mieste podľa osobitného zákona.[59a)](#poznamky.poznamka-59a) Pokutu podľa odseku 6 možno uložiť do jedného roka od zistenia nedostatkov, najneskôr však do troch rokov od ich vzniku.
