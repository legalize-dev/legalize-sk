...
Technické rezervy podľa odseku 1 sa vytvárajú vo výške dostatočnej na to, aby bola v každom okamihu zabezpečená schopnosť poisťovne a pobočky zahraničnej poisťovne uhradiť záväzky poisťovne z poistných zmlúv a záväzky poisťovne vznikajúce z činností podľa osobitného predpisu^14a) a používajú sa na ich úhradu, ak nie sú uspokojené zo zaistenia.
