...
Ustanovenia tohto zákona o používaní v uzavretých priestoroch sa nevzťahujú na geneticky modifikované mikroorganizmy, o ktorých príslušné orgány Európskej únie na podklade návrhov príslušných orgánov členských štátov Európskej únie alebo štátov, ktoré sú zmluvnou stranou Dohody o Európskom hospodárskom priestore (ďalej len „členský štát“) rozhodnú, že spĺňajú kritériá bezpečnosti ustanovené vo vykonávacom predpise ([§ 39](#paragraf-39)). Vykonávací predpis tiež ustanoví zoznam geneticky modifikovaných mikroorganizmov, na ktoré sa nevzťahujú ustanovenia tohto zákona o používaní v uzavretých priestoroch.
...
Úroveň ochrany je súbor ochranných opatrení ([§ 7 ods. 2](#paragraf-7.odsek-2)) a systém práce v zariadení, ktoré zodpovedajú konkrétnej rizikovej triede podľa odseku 2 alebo odseku 3.
...
údaje o geneticky modifikovaných organizmoch a geneticky modifikovaných mikroorganizmoch, s ktorými vykonával činnosti zatriedené do rizikovej triedy 1, na účely vedenia evidencie podľa [§ 24 ods. 1 písm. c)](#paragraf-24.odsek-1.pismeno-c) raz za šesť mesiacov,
...
Žiadateľom o súhlas je osoba, ktorá má podľa tohto zákona povinnosť podať žiadosť o súhlas s použitím v uzavretých priestoroch podľa [§ 13](#paragraf-13), o súhlas na zavedenie do životného prostredia podľa [§ 17](#paragraf-17) alebo o súhlas na uvedenie výrobku na trh podľa [§ 21](#paragraf-21).
...
Ustanovenia [§ 15 až 22](#paragraf-15) sa vzťahujú aj na zámerné uvoľňovanie geneticky modifikovaných mikroorganizmov.
...
preveriť informácie, ktoré uviedol v žiadosti na uvedenie výrobku na trh a upovedomiť ministerstvo; na obsah upovedomenia sa primerane vzťahuje [§ 19 ods. 3.](#paragraf-19.odsek-3)
...
vedie evidenciu geneticky modifikovaných organizmov a geneticky modifikovaných mikroorganizmov a evidenciu zavádzania do životného prostredia podľa [§ 17 ods. 1 písm. a)](#paragraf-17.odsek-1),
...
podávať správy z monitorovania výrobku na trhu podľa [§ 22 ods. 2 písm. d)](#paragraf-22.odsek-2.pismeno-d) a raz za tri roky aj správu o skúsenostiach s uvádzaním výrobku na trh,
...
Ministerstvo je povinné bezodkladne informovať členské štáty o každom zistenom nepovolenom zavedení do životného prostredia alebo uvedení výrobku na trh a o prijatých bezpečnostných opatreniach podľa [§ 21a](#paragraf-21a) spolu s odôvodnením, s prehodnotením pôvodného posudzovania rizika a s uvedením, či a ako sa majú zmeniť podmienky súhlasu alebo či sa má súhlas odňať, a poskytnúť nové informácie, na ktorých základe boli prijaté bezpečnostné opatrenia.
...
použil genetické technológie alebo geneticky modifikované organizmy a geneticky modifikované mikroorganizmy alebo uskutočnil ich cezhraničný pohyb bez súhlasu alebo bez ohlásenia ([§ 12, 13](#paragraf-12), [17](#paragraf-17) a [21](#paragraf-21)),
...
použil genetické technológie podľa tohto zákona alebo geneticky modifikované organizmy a geneticky modifikované mikroorganizmy v uzavretých priestoroch bez ohlásenia podľa [§ 12](#paragraf-12) alebo bez súhlasu podľa [§ 13](#paragraf-13),

b)

geneticky modifikované organizmy a geneticky modifikované mikroorganizmy uvoľňoval bez súhlasu podľa [§ 17](#paragraf-17) alebo podľa [§ 21](#paragraf-21).
...
Ak ide o ohlásenie podľa [§ 12 ods. 2 písm. c)](#paragraf-12.odsek-2.pismeno-c), ministerstvo ďalej
...
O predĺženie platnosti rozhodnutia o súhlase vydaného v konaní podľa [§ 35](#paragraf-35) možno žiadať najneskôr deväť mesiacov pred dňom uplynutia doby platnosti vydaného súhlasu.
...
Žiadateľ o predĺženie platnosti rozhodnutia o súhlase s uvedením výrobku na trh, ktoré bolo vydané v konaní podľa [§ 35](#paragraf-35), môže pokračovať v uvádzaní výrobku na trhu za podmienok určených vo vydanom rozhodnutí až do dňa vydania nového rozhodnutia v konaní o súhlase s uvedením výrobku na trh podľa [§ 35](#paragraf-35).
...
podrobnosti o posudzovaní environmentálneho rizika ([§ 5](#paragraf-5)) a o postupe a kritériách na zatriedenie do rizikovej triedy a o obsahu úrovní ochrany ([§ 10](#paragraf-10)),

b)

podrobnosti o požiadavkách na uzavreté priestory ([§ 8](#paragraf-8)),

c)

podrobnosti o postupe pri vyhodnocovaní priamych a nepriamych, bezprostredných a následných účinkoch a pri vykonávaní analýzy kumulatívnych dlhodobých účinkov ([§ 16](#paragraf-16)),

d)

podrobnosti o obsahu dokumentácie a o spôsobe jej vedenia a ukladania ([§ 5](#paragraf-5), [9](#paragraf-9) a [19](#paragraf-19)),

e)

podrobnosti o obsahu havarijného plánu ([§ 6](#paragraf-6)),

f)

podrobnosti o obsahu správy o výsledku zavedenia do životného prostredia ([§ 20](#paragraf-20)),

g)

podrobnosti o náležitostiach jednotlivých ohlásení a o posudzovaní ich obsahu ([§ 32](#paragraf-32)),

h)

podrobnosti o ďalších náležitostiach žiadostí o vydanie súhlasov ([§ 33 až 37](#paragraf-33)),

i)

podrobnosti o obsahu hodnotiacej správy ([§ 35 ods. 4](#paragraf-35.odsek-4)),

j)

zoznam geneticky modifikovaných mikroorganizmov, na ktoré sa nebudú vzťahovať ustanovenia tohto zákona o používaní v uzavretých priestoroch a podrobnosti o kritériách bezpečnosti geneticky modifikovaných mikroorganizmov, na ktoré sa nebudú vzťahovať ustanovenia tohto zákona o používaní v uzavretých priestoroch ([§ 8](#paragraf-8)).
...
Konanie o súhlase s používaním v uzavretých priestoroch podľa [§ 33](#paragraf-33), konanie o súhlase so zavedením do životného prostredia podľa [§ 34](#paragraf-34), konanie o súhlase s uvedením výrobku na trh podľa [§ 35](#paragraf-35) alebo konanie o predĺženie platnosti rozhodnutia o súhlase s uvedením na trh podľa [§ 37](#paragraf-37), ktoré sa začalo a právoplatne sa neskončilo do dňa účinnosti tohto zákona, sa dokončí podľa doterajších predpisov.
