...
odmena športového reprezentanta Slovenskej republiky[28a)](#poznamky.poznamka-28a) za dosiahnuté výsledky na paralympijských hrách a deaflympijských hrách,

s)

jednorazový príspevok za výkon mimoriadnej služby, motivačný príspevok, naturálne náležitosti, náhrada cestovného a jednorazové odškodnenie pozostalých poskytované v súvislosti so zaradením do aktívnych záloh podľa osobitného predpisu.[28b)](#poznamky.poznamka-28b)
