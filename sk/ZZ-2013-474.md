...
Na účely tohto zákona a osobitného predpisu[19)](#poznamky.poznamka-19) správca výberu mýta a osoba poverená podľa odseku 2 má oprávnenie získavať, zaznamenávať, zhromažďovať, spracúvať, využívať a uchovávať tieto údaje:
...
Správca výberu mýta vydáva stanovisko podľa [§ 22 ods. 5](#paragraf-22.odsek-2) pre notifikovanú osobu pri posudzovaní vhodnosti zložiek interoperability na použitie[25)](#poznamky.poznamka-25) podľa osobitného predpisu.[26)](#poznamky.poznamka-26)
...
Za bezúhonnú sa považuje fyzická osoba, ktorá nebola právoplatne odsúdená za úmyselný trestný čin. Bezúhonnosť sa preukazuje výpisom z registra trestov.[31)](#poznamky.poznamka-31) Na účel preukázania bezúhonnosti podľa odseku 5 poskytne fyzická osoba údaje potrebné na vyžiadanie výpisu z registra trestov.[30)](#poznamky.poznamka-30) Údaje podľa tretej vety ministerstvo bezodkladne zašle v elektronickej podobe prostredníctvom elektronickej komunikácie Generálnej prokuratúre Slovenskej republiky na vydanie výpisu z registra trestov.
