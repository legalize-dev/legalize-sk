...
spôsob určenia výšky úhrady za poskytnutú ústavnú zdravotnú starostlivosť[24aaa)](#poznamky.poznamka-24aaa) podľa klasifikačného systému diagnosticko-terapeutických skupín (ďalej len „klasifikačný systém“) ([§ 8c](#paragraf-8c)) na základe metodického usmernenia úradu o podrobnostiach klasifikačného systému podľa [§ 20 ods. 2 písm. q)](#paragraf-20.odsek-2.pismeno-q), ak sa zdravotná poisťovňa dohodla s poskytovateľom ústavnej zdravotnej starostlivosti[24aab)](#poznamky.poznamka-24aab) na úhrade ústavnej zdravotnej starostlivosti podľa klasifikačného systému ([§ 8c](#paragraf-8c)),
...
počítačový program zdravotnej poisťovne má osvedčenú zhodu podľa [§ 20ca ods. 11](#paragraf-20ca.odsek-11).
...
je centrom pre klasifikačný systém ([§ 20b](#paragraf-20b)),
...
vykonáva odbornú prípravu na získanie odbornej spôsobilosti a ďalšie vzdelávanie pre klasifikačný systém podľa [§ 20c](#paragraf-20c),

n)

vedie zoznam odborne spôsobilých osôb pre klasifikačný systém, ktoré získali odbornú spôsobilosť podľa [§ 20c](#paragraf-20c) (ďalej len „zoznam odborne spôsobilých osôb“), s náležitosťami podľa [§ 20c ods. 10](#paragraf-20c.odsek-10),

o)

vydáva osvedčenia o zhode počítačového programu (ďalej len „osvedčenie o zhode“) podľa [§ 20ca](#paragraf-20ca),

p)

dočasne pozastavuje platnosť osvedčenia o zhode [§ 20ca ods. 9](#paragraf-20ca.odsek-9),

q)

zrušuje platnosť osvedčenia o zhode podľa [§ 20ca ods. 10](#paragraf-20ca.odsek-10),

r)

aktualizuje zoznam odborne spôsobilých osôb, ktoré sú na základe získanej odbornej spôsobilosti poverené činnosťami podľa [§ 20c ods. 11 písm. a) až f)](#paragraf-20c.odsek-11.pismeno-a) a ktoré poskytovateľ ústavnej zdravotnej starostlivosti nahlasuje centru pre klasifikačný systém ako osoby zodpovedné za výkon činnosti súvisiaci s odbornou spôsobilosťou v klasifikačnom systéme,
...
Žiadosť o odbornú prípravu podáva centru pre klasifikačný systém užívateľ klasifikačného systému ([§ 20b ods. 2](#paragraf-20b.odsek-2)), s ktorým je osoba v pracovnoprávnom vzťahu, zamestnanec ministerstva zdravotníctva alebo zamestnanec úradu.
...
je povinná zúčastňovať sa na školeniach podľa [§ 20b ods. 1 písm. m)](#paragraf-20b.odsek-1.pismeno-m),
...
Výstup z testovania vo výstupných parametroch musí byť najmenej v 97-percentnej zhode s definičnou príručkou podľa [§ 20b ods. 3 písm. a)](#paragraf-20b.odsek-3.pismeno-a), inak sa žiadosť zamietne.
...
poskytnutie dokumentácie potrebnej na vytvorenie zaraďovacieho algoritmu a vydanie osvedčenia o zhode ([§ 20ca](#paragraf-20ca)),
...
harmonogram prevodu poistného kmeňa s náležitosťami určenými úradom podľa [§ 20 ods. 2 písm. o)](#paragraf-20.odsek-2.pismeno-o).
