...
zaraďuje poistencov na dispenzarizáciu na základe návrhu poskytovateľa zdravotnej starostlivosti, s ktorým má uzatvorenú zmluvu podľa [§ 7](#paragraf-7), a vedie zoznam takýchto poistencov; návrh na dispenzarizáciu, ktorý vyhotovuje všeobecný lekár alebo lekár špecialista, obsahuje aj dĺžku dispenzarizácie,
...
vykonáva odbornú prípravu na získanie odbornej spôsobilosti pre klasifikačný systém podľa [§ 20c](#paragraf-20c),

m)

vedie zoznam odborne spôsobilých osôb pre klasifikačný systém (ďalej len „zoznam odborne spôsobilých osôb“) s náležitosťami podľa [§ 20c ods. 10](#paragraf-20c.odsek-10),
...
je povinná zúčastňovať sa na školeniach podľa [§ 20b ods. 1 písm. n)](#paragraf-20b.odsek-1.pismeno-n),
...
Výstup z testovania vo výstupných parametroch podľa odseku 8 musí byť najmenej v 97-percentnej zhode s definičnou príručkou zverejnenou centrom pre klasifikačný systém podľa [§ 20 ods. 2 písm. q) prvého bodu](#paragraf-20.odsek-2.pismeno-q.bod-1).
...
Ak centrum pre klasifikačný systém vydá definičnú príručku podľa [§ 20 ods. 2 písm. q) prvého bodu](#paragraf-20.odsek-2.pismeno-q.bod-1), ktorá obsahuje zmenu oproti predchádzajúcej definičnej príručke, ktorá môže mať vplyv na zaradenie hospitalizačného prípadu do správnej diagnosticko-terapeutickej skupiny, držiteľ osvedčenia do 30. novembra kalendárneho roka požiada centrum pre klasifikačný systém o nové osvedčenie zhody.
...
výpis z registra trestov osôb uvedených v [§ 33 ods. 1 písm. h) a i)](#paragraf-33.odsek-1.pismeno-h) nie starší ako tri mesiace,
...
Ak úrad zistí porušenie povinností podľa § 47c ods. 1 druhej vety alebo [§ 47da ods. 5](#paragraf-47da.odsek-5), podľa závažnosti zistených nedostatkov a ich následkov môže uložiť organizátorovi prehliadok mŕtvych tiel pokutu ([§ 64 ods. 6](#paragraf-64.odsek-6)).
...
Úrad môže uložiť organizátorovi prehliadok mŕtvych tiel za porušenie povinností podľa § 47c ods. 1 druhej vety alebo [§ 47da ods. 5](#paragraf-47da.odsek-5) a za podmienok ustanovených v [§ 50 ods. 8](#paragraf-50.odsek-8) pokutu až do výšky 33 193 eur.
