...
príspevok na správu národného zdravotníckeho informačného systému ([§ 8b](#paragraf-8b)).
...
Žiadosť o odbornú prípravu podáva centru pre klasifikačný systém užívateľ klasifikačného systému ([§ 20b ods. 2](#paragraf-20b.odsek-2)), s ktorým je osoba v pracovnoprávnom vzťahu.
