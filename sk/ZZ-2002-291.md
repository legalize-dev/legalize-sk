...
vedenie účtov centrálneho systému evidencie poplatkov Štátnej pokladnice podľa osobitných predpisov.[5a)](#poznamky.poznamka-5a)
...
spravuje centrálny systém evidencie poplatkov Štátnej pokladnice,

ag)

zabezpečuje technické vybavenie a podmienky na vykonanie a spracovanie platieb správnych poplatkov a súdnych poplatkov podľa osobitných predpisov,[5a)](#poznamky.poznamka-5a)

ah)

zabezpečuje evidenciu platieb správnych poplatkov a súdnych poplatkov a na účel identifikácie úkonu alebo konania sprístupňuje hodnoty z číselníka poplatkov orgánom verejnej moci podľa osobitných predpisov,[5a)](#poznamky.poznamka-5a)

ai)

zabezpečuje zúčtovanie a prevod finančných prostriedkov evidovaných v centrálnom systéme evidencie poplatkov Štátnej pokladnice do štátneho rozpočtu, do rozpočtu vyššieho územného celku alebo do rozpočtu obce,

aj)

umožňuje používateľovi centrálneho systému evidencie poplatkov Štátnej pokladnice kontrolu vykonanej platby správneho poplatku alebo platby súdneho poplatku a použitie tejto platby na požadovaný úkon alebo konanie,

ak)

zabezpečuje sprístupnenie technického vybavenia a podmienok na vykonanie platby poplatku podľa osobitného predpisu,[14aa)](#poznamky.poznamka-14aa)

al)

zabezpečuje vrátenie poplatku alebo preplatku podľa osobitných predpisov,[5a)](#poznamky.poznamka-5a)

am)

spravuje účty a zabezpečuje analytické výstupy pre potreby centrálneho systému evidencie poplatkov Štátnej pokladnice.
...
súvisiace s činnosťou Štátnej pokladnice podľa odseku 1 písm. e), j), k), q), aa) alebo písm. af) a súvisiace s finančným zabezpečením hospodárskej mobilizácie,[14ba)](#poznamky.poznamka-14ba)
...
Štátna pokladnica realizuje platobné operácie výlučne bezhotovostne. Na účely zabezpečenia hotovostných platobných operácií pre centrálny systém evidencie poplatkov Štátnej pokladnice môže Štátna pokladnica využiť služby tretej strany na zmluvnom základe.
