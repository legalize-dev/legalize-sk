...
štátna rozpočtová organizácia,[2)](#poznamky.poznamka-2)

b)

štátna príspevková organizácia,[2)](#poznamky.poznamka-2)

c)

štátny fond,[3)](#poznamky.poznamka-3)
...
zdravotné poisťovne,[4)](#poznamky.poznamka-4)
...
Úrad pre dohľad nad zdravotnou starostlivosťou.[4)](#poznamky.poznamka-4)
...
Vstupom do záväzku sa rozumie právny úkon, na ktorého základe sa uskutoční výdavok z rozpočtu klienta, napríklad uzavretie zmluvy o dielo na dodávku tovarov alebo služieb, objednávka alebo rozhodnutie o transfere z rozpočtu klienta.
...
zriaďuje účty v slovenskej mene a účty v cudzích menách Štátnej pokladnice v Národnej banke Slovenska; na účely vykonávania finančných operácií na finančnom trhu s dočasne voľnými prostriedkami na účtoch Štátnej pokladnice vedených v Národnej banke Slovenska a evidovaných na jedinom účte Štátnej pokladnice (ďalej len „jediný účet") môže Štátna pokladnica zriadiť účet v slovenskej mene a účet v cudzej mene v banke a v pobočke zahraničnej banky,[13)](#poznamky.poznamka-13)
...
úročí na zmluvnom základe a na základe žiadosti dočasne voľné finančné prostriedky vedené na účte klienta podľa písmena j). Správy štátnych hmotných rezerv Slovenskej republiky a Štátneho fondu likvidácie jadrovoenergetických zariadení a nakladania s vyhoretým jadrovým palivom a rádioaktívnymi odpadmi; Štátna pokladnica môže dočasne voľnými finančnými prostriedkami kryť nesúlad medzi príjmami štátneho rozpočtu a výdavkami štátneho rozpočtu a zabezpečovať likviditu na jedinom účte,
...
zabezpečuje pre svojich klientov cezhraničné prevody peňažných prostriedkov[13b)](#poznamky.poznamka-13b) (ďalej len „cezhraničné prevody") prostredníctvom Národnej banky Slovenska, banky a pobočky zahraničnej banky (ďalej len „banka"),
...
vydáva metodické usmernenia pre klientov v oblasti tuzemských prevodov a cezhraničných prevodov a v oblasti realizácie rozpočtu klienta v podmienkach systému Štátnej pokladnice,
...
vydáva po dohode s ministerstvom metodické usmernenia pre správcov majetku štátu v oblasti vedenia centrálneho registra majetku štátu.
...
zostavuje súbory údajov z vlastnej evidencie o klientoch a z účtovných výkazov[14c)](#poznamky.poznamka-14c) štátnych rozpočtových organizácií, štátnych príspevkových organizácií, verejných vysokých škôl, vyšších územných celkov, rozpočtových organizácií vyššieho územného celku, príspevkových organizácií vyššieho územného celku, obcí, rozpočtových organizácií obcí, príspevkových organizácií obcí, štátnych fondov, Sociálnej poisťovne, zdravotných poisťovní, Národného úradu práce, Fondu národného majetku Slovenskej republiky a Slovenského pozemkového fondu; súbory údajov zostavené Štátnou pokladnicou sa zahŕňajú do osobitnej časti Programu štátnych štatistických zisťovaní na príslušné roky,[14d)](#poznamky.poznamka-14d)
...
Pri realizácii rozpočtu klienta postupuje Štátna pokladnica v súlade so schváleným zákonom o štátnom rozpočte na príslušný rozpočtový rok a rozpočtami Sociálnej poisťovne, zdravotných poisťovní, rozpočtami štátnych fondov, rozpočtami verejných vysokých škôl, štátnych rozpočtových organizácií, štátnych príspevkových organizácií, vyšších územných celkov, Národného úradu práce, Fondu národného majetku Slovenskej republiky, Slovenského pozemkového fondu a klienta uvedeného v [§ 2 ods. 2 písm. l)](#paragraf-2.odsek-2.pismeno-l).
...
vyšší územný celok, je transfer zo štátneho rozpočtu alebo rozpočet podľa platnej rozpočtovej klasifikácie, ak sa tak vyšší územný celok dohodne so Štátnou pokladnicou po predchádzajúcom písomnom súhlase ministerstva.
...
Podľa odsekov 2 až 10 postupuje klient, ktorým je Sociálna poisťovňa, zdravotné poisťovne, Národný úrad práce a jeho vnútorné organizačné jednotky, Fond národného majetku Slovenskej republiky, vyšší územný celok a Slovenský pozemkový fond. Podľa odsekov 2 až 10 postupuje aj klient uvedený v [§ 2 ods. 2 písm. l)](#paragraf-2.odsek-2.pismeno-l), ak sa tak určilo v dohode so Štátnou pokladnicou.[1)](#poznamky.poznamka-1)

(2)

Klient predloží Štátnej pokladnici rozpočet klienta najneskôr do 60 dní odo dňa schválenia vládou alebo Národnou radou Slovenskej republiky s výnimkou vyššieho územného celku, ktorý predloží rozpočet klienta do konca januára príslušného rozpočtového roka.
...
Štátna pokladnica je oprávnená vyplatiť z osobitného účtu podľa odseku 5 úroky podľa [§ 6 ods. 1 písm. j), k) a l)](#paragraf-6.odsek-1.pismeno-j) maximálne do výšky výnosov získaných z úročenia podľa odseku 3 a z finančných operácií na finančnom trhu.
...
Vnútorná organizačná jednotka[9)](#poznamky.poznamka-9) klienta realizuje výdavky z rozpočtu klienta, ktorého je súčasťou. Klient, ktorého súčasťou je vnútorná organizačná jednotka, pri realizácii rozpočtu postupuje podľa [§ 8 a 9](#paragraf-8). Na realizáciu ustanovení [§ 8 ods. 8](#paragraf-8.odsek-8) a [11](#paragraf-8.odsek-11) a [§ 9 ods. 7](#paragraf-9.odsek-7) môže klient splnomocniť aj svoju vnútornú organizačnú jednotku. Rozsah splnomocnenia je klient povinný písomne oznámiť Štátnej pokladnici; ak klient nepredloží Štátnej pokladnici splnomocnenie, považuje sa za oprávneného realizovať výdavky z rozpočtu pre vnútorné organizačné jednotky výhradne klient.
...
vykonáva na finančnom trhu finančné operácie s investičnými nástrojmi[28a)](#poznamky.poznamka-28a) vrátane operácií s finančnými derivátmi[28b)](#poznamky.poznamka-28b) na preklenutie nesúladu medzi príjmami a výdavkami štátneho rozpočtu a na zabezpečenie likvidity na jedinom účte.
...
údaje na hodnotenie plnenia rozpočtu klienta,
...
Klient podľa [§ 2 ods. 2 písm. a) a b)](#paragraf-2.odsek-2), ktorým je zdravotnícke zariadenie,[33)](#poznamky.poznamka-33) môže v rokoch 2005 a 2006 postupovať podľa [§ 2 ods. 2 písm. l)](#paragraf-2.odsek-2.pismeno-l).
