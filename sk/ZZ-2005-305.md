...
pobytového opatrenia súdu v centre, ktoré vykonáva opatrenia na základe udelenej akreditácie, v ustanovenom druhu špecializovanej samostatnej skupiny zriadenej pre

1.

deti s duševnou poruchou na základe lekárskeho posudku podľa osobitného predpisu[22a)](#poznamky.poznamka-22a)^ a pre deti s duševnou poruchou na základe lekárskeho posudku podľa osobitného predpisu[22a)](#poznamky.poznamka-22a)^ v kombinácii so zdravotným stavom podľa druhého bodu,

2.

deti, ktorých zdravotný stav vyžaduje osobitnú starostlivosť výlučne pobytovou formou na základe lekárskeho posudku podľa osobitného predpisu,[22a)](#poznamky.poznamka-22a)
