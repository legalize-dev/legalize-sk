...
Pre jazdu dreziny cez úrovňové križovanie dráhy s cestnou komunikáciou prevádzkovateľ dreziny vykoná opatrenia, ktoré umožnia bezpečnú jazdu dreziny cez úrovňové križovanie dráhy s cestnou komunikáciou.
...
Železničný systém je súhrn subsystémov uvedených v [prílohe č. 1](#prilohy.priloha-priloha_c_1_k_zakonu_c_513_2009_z_z). Železničný systém tvoria železničné dráhy na území Slovenskej republiky a ich súčasti a registrované železničné vozidlá všetkých radov a typov, ktoré na nich jazdia.
...
Systém transeurópskych železníc tvorí systém transeurópskych konvenčných železníc a systém transeurópskych vysokorýchlostných železníc v rozsahu uvedenom v osobitnom predpise.[16)](#poznamky.poznamka-16)
...
Na siete dráh, železničné infraštruktúry a koľajové vozidlá uvedené v odseku 5 sa vzťahuje [prvá časť](#predpis.clanok-1.cast-prva).
...
Európskou špecifikáciou je spoločná technická špecifikácia, európske technické osvedčenie[20a)](#poznamky.poznamka-20a) alebo slovenská technická norma,[21)](#poznamky.poznamka-21) ktorou sa preberá právne záväzný akt Európskej únie.
...
Uplatnenie výnimky podľa odseku 5 je predmetom notifikácie Európskej komisii vrátane súboru dokumentácie podľa [prílohy č. 5](#prilohy.priloha-priloha_c_5_k_zakonu_c_513_2009_z_z) a ak ide o výnimku podľa odseku 5 písm. a), vrátane zoznamu projektov v pokročilom štádiu vývoja do jedného roka od nadobudnutia účinnosti každej technickej špecifikácie interoperability, z ktorej sa uplatňuje výnimka. Súbor dokumentácie a zoznam projektov vypracuje a poskytne navrhovateľ uplatnenia výnimky.
...
doklad o bezpečnej integrácii subsystémov určenej na základe príslušných technických špecifikácií interoperability, vnútroštátnych predpisov, národných registrov a spoločných bezpečnostných metód podľa [§ 82](#paragraf-82),
...
doklad o uvedení subsystému vozidlové zariadenie riadenia-zabezpečenia a návestenia na trh, ak je súčasťou železničného vozidla podľa [§ 75](#paragraf-75) na základe ES vyhlásenia o overení,
...
povolenie na uvedenie železničného vozidla na trh podľa [§ 76](#paragraf-76) a registrácia v národnom registri železničných vozidiel podľa [§ 80](#paragraf-80),
...
Zrušenie povolenia na uvedenie železničného vozidla na trh sa registruje v národnom registri železničných vozidiel. Zrušenie povolenia typu železničného vozidla sa registruje v Európskom registri povolených typov železničných vozidiel a oznamuje sa železničnému podniku, ktorý ak zistí, že železničné vozidlá nespĺňajú základné požiadavky, uplatní postup podľa [§ 78a](#paragraf-78a).
...
Národný register železničných vozidiel musí spĺňať spoločné špecifikácie podľa osobitného predpisu[27)](#poznamky.poznamka-27) a byť verejne prístupný na webovom sídle bezpečnostného orgánu.
...
Železničný podnik po vážnej nehode poskytne obetiam pomoc pri podávaní sťažností podľa osobitného predpisu,[30d)](#poznamky.poznamka-30d) pričom využije prostriedky komunikácie s rodinami obetí, ako aj psychologickú podporu obetí a ich rodinných príslušníkov.
...
nevykoná opatrenia, ktoré umožnia bezpečnú jazdu dreziny cez úrovňové križovanie dráhy s cestnou komunikáciou,
...
Konanie o uloženie pokuty podľa odsekov 1 až 15 možno začať do šiestich mesiacov odo dňa, keď sa správny orgán o správnom delikte dozvedel, najneskôr do troch rokov odo dňa, keď k správnemu deliktu došlo. Ak ide o trvajúcu činnosť alebo opomenutie, lehota začne plynúť posledným dňom skončenia trvajúcej činnosti alebo opomenutia, ktorá je správnym deliktom.
