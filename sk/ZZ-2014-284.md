...
O poskytnutí finančných prostriedkov rozhodne riaditeľ do 60 dní od posledného dňa obdobia určeného fondom na predkladanie žiadostí, ktorá je úplná, a to na základe hodnotenia odbornej komisie. Riaditeľ rozhodne o
...
bol právoplatne odsúdený za úmyselný trestný čin proti majetku,
...
ktorý je majetkovo prepojený[16)](#poznamky.poznamka-16) alebo personálne prepojený[16a)](#poznamky.poznamka-16a) s fyzickou osobou alebo právnickou osobou, ktorá nemá vysporiadané finančné vzťahy s fondom,
...
oznámenie obsahujúce údaje žiadateľa potrebné na vyžiadanie výpisu z registra trestov;[2a)](#poznamky.poznamka-2a) ak ide o cudzinca, obdobné potvrdenie, ako je výpis z registra trestov, vydané príslušným orgánom štátu, ktorého je občanom, ktoré nesmie byť staršie ako tri mesiace,
...
Prílohou žiadosti o poskytnutie finančných prostriedkov vo forme štipendia sú prílohy podľa odseku 2 písm. a), e), f), h), j) až l) a n).
...
Fond do 30 pracovných dní odo dňa doručenia všetkých náležitostí podľa odseku 3 písm. j) od žiadateľa potrebných pre vyhotovenie návrhu zmluvy podľa odseku 1 doručí žiadateľovi návrh zmluvy. Ak žiadateľ najneskôr do 30 dní od doručenia návrhu zmluvy tento návrh neprijme, návrh zmluvy zaniká.
...
Bezúhonnosť sa preukazuje výpisom z registra trestov. Na účel preukázania bezúhonnosti poskytne fyzická osoba údaje potrebné na vyžiadanie výpisu z registra trestov.[2a)](#poznamky.poznamka-2a) Údaje podľa druhej vety fond bezodkladne zašle v elektronickej podobe prostredníctvom elektronickej komunikácie Generálnej prokuratúre Slovenskej republiky na vydanie výpisu z registra trestov.
