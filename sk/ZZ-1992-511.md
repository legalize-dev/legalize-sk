...
informácie získané v daňovom konaní poskytnúť inému pracovníkovi toho istého alebo iného správcu dane, nadriadeným orgánom, odvolacím orgánom alebo súdu, ak tieto orgány prerokovávajú opravný prostriedok v daňovej veci alebo výkon exekúcie, daňovej pohľadávky,

b)

poskytovať informácie nadriadeným alebo kontrolným orgánom[7a)](#poznamky.poznamka-7a) v rámci ich pôsobnosti,
...
poskytovať informácie získané v daňovom konaní súdom v konaní o výživnom podľa osobitného predpisu[8)](#poznamky.poznamka-8) alebo v konkurznom a vyrovnacom konaní podľa osobitného predpisu[8aa)](#poznamky.poznamka-8aa).

g)

informácie získané v daňovom konaní poskytnúť na účely spracovania pomocou výpočtovej techniky sprostredkovateľovi,[8e)](#poznamky.poznamka-8e) ktorého určí ministerstvo,

h)

poskytnúť vláde Slovenskej republiky a Ministerstvu pre správu a privatizáciu národného majetku Slovenskej republiky informácie získané v daňovom konaní o daňovom subjekte, ktorý nadobudol vlastníctvo podľa osobitného predpisu.[8b)](#poznamky.poznamka-8b)
...
Informácie podľa odseku 4 písm. d) môžu uvedené orgány poskytovať inému orgánu, ak tak ustanovuje osobitný predpis, alebo zahraničnému orgánu, ktorý vykonáva správu daní v rozsahu ustanovenom medzinárodnou zmluvou.
...
Za porušenie povinnosti zachovávať mlčanlivosť ([§ 23](#paragraf-23)), ak nejde o trestný čin, možno pracovníkovi správcu dane alebo tretej osobe, ktorá sa zúčastnila na daňovom konaní, uložiť pokutu až do výšky 50 000 Sk, a to podľa závažnosti porušenia tejto povinnosti, doby trvania a následkov protiprávneho konania.
...
Na postup pri ukladaní pokuty podľa odseku 1 sa vzťahujú ustanovenia [§ 35 ods. 3](#paragraf-35.odsek-3), [5 a 6](#paragraf-35.odsek-5).
...
Odvolacím orgánom proti rozhodnutiu ministerstva o uložení pokuty podľa [§ 23a](#paragraf-23a) je minister financií Slovenskej republiky, ktorý na základe návrhu ním ustanovenej osobitnej komisie vydáva rozhodnutie o odvolaní.
...
Ak výťažok z predaja vecí je vyšší ako súčet daňového nedoplatku, pre ktorý sa exekúcia vykonáva, a náhrady exekučných nákladov, môže správca dane s týmto rozdielom naložiť ako s daňovým preplatkom podľa [§ 63 ods. 2 a 3](#paragraf-63.odsek-2).
...
Ministerstvo všeobecne záväzným právnym predpisom upraví podrobnosti k ustanoveniam [§ 40 ods. 13](#paragraf-40.odsek-13), § 58 ods. 5 a 6, [§ 61 ods. 10](#paragraf-61.odsek-10), § 74, 75, § 80 ods. 1 a [§ 97](#paragraf-97).
