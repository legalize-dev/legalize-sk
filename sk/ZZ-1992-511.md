...
daňová kontrola na základe žiadosti súdu ([§ 15 ods. 14](#paragraf-15.odsek-14)),
...
Ustanovenia [§ 15 až 15b](#paragraf-15) sa rovnako vzťahujú aj na daňovú kontrolu paušálnej dane s výnimkou [§ 15 ods. 7](#paragraf-15.odsek-7) a [15](#paragraf-15.odsek-15).
...
Dodatočné daňové priznanie alebo hlásenie nemožno podať po doručení oznámenia o výkone daňovej kontroly za obdobie, ktorého by sa dodatočné daňové priznanie alebo hlásenie týkalo, a to až do jej ukončenia. Ak sa začala daňová kontrola podľa [§ 15 ods. 3](#paragraf-15.odsek-3), dodatočné daňové priznanie alebo hlásenie nemožno podať po dobu výkonu daňovej kontroly.
...
Správca dane z prostriedkov získaných podľa [§ 92 ods. 2 písm. g)](#paragraf-92.odsek-2.pismeno-g) vráti dražobné zábezpeky neúspešných dražiteľov ([§ 87f ods. 5](#paragraf-87f.odsek-5)) a uhradí daň z pridanej hodnoty za platiteľa dane z pridanej hodnoty. O úhrade dane z pridanej hodnoty správca dane upovedomí daňového dlžníka. Daňový dlžník o sumu uhradenej dane z pridanej hodnoty upraví vlastnú daňovú povinnosť alebo nadmerný odpočet.

(2)

Správca dane získaný výťažok poukázaný na daňový exekučný účet podľa [§ 92 ods. 2 písm. a) až f)](#paragraf-92.odsek-2) a úhrad podľa písmena h) použije na úhradu exekučných nákladov, hotových výdavkov a na pokrytie daňového nedoplatku nasledujúci deň po dni, keď peňažné prostriedky boli pripísané na účet správcu dane alebo po dni, keď správca dane prijal prostriedky v hotovosti.
