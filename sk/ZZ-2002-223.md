...
Patentová prihláška (ďalej len „prihláška“) obsahuje žiadosť o udelenie patentu, opis, anotáciu, prípadne výkresy a aspoň jeden uplatnený patentový nárok.

(2)

Ak prihláška podľa odseku 1 obsahuje skutočnosť utajovanú podľa osobitného predpisu[1)](#poznamky.poznamka-1) ([§ 59 ods. 1 zákona](../../../../SK/ZZ/2001/435/#paragraf-59.odsek-1)), opis, anotácia, prípadne výkresy a aspoň jeden uplatnený patentový nárok sa predkladajú v dvoch vyhotoveniach.
...
Patentové nároky vymedzujú rozsah ochrany podľa [§ 13 ods. 1](../../../../SK/ZZ/2001/435/#paragraf-13.odsek-1) zákona uvedením technických znakov vynálezu; patentové nároky musia byť jasné, stručné a podložené opisom. Každý patentový nárok sa vyjadrí jednou vetou.
...
Bez toho, aby tým bol dotknutý [§ 37 ods. 3](../../../../SK/ZZ/2001/435/#paragraf-37.odsek-3) zákona, prihláška môže obsahovať viac ako jeden nezávislý patentový nárok v rovnakej kategórii vynálezov (kategóriou vynálezu sa rozumie výrobok, spôsob, zariadenie alebo použitie), ak predmet prihlášky zahŕňa
...
alternatívne riešenia určitého problému, ak tieto alternatívy nie je vhodné pokryť jedným patentovým nárokom.

(6)

Patentové nároky neobsahujú odkazy na opis alebo výkresy; to neplatí, ak je uvedenie odkazov na opis alebo výkresy nevyhnutné na zabezpečenie jasnosti patentového nároku. Patentové nároky neobsahujú tabuľky; to neplatí, ak si to predmet patentového nároku vyžaduje.

(7)

V patentových nárokoch sa technické znaky zobrazené a označené na výkresoch vzťahovými značkami uvádzajú s týmito vzťahovými značkami, ak to uľahčí zrozumiteľnosť patentových nárokov.
...
Vzťahové značky použité na výkresoch sú vysvetlené v opise. Na výkresoch možno použiť len tie vzťahové značky, ktoré sú uvedené v opise, a naopak; [§ 5 ods. 7](#paragraf-5.odsek-7) tým nie je dotknutý.
...
Ak nie je možné podstatu vynálezu znázorniť prostredníctvom obrázkov podľa odseku 1, podstata vynálezu sa znázorní prostredníctvom fotografie; pre fotografie platia rovnaké požiadavky ako pre obrázky.
...
Za prioritný doklad ([§ 36 ods. 6](../../../../SK/ZZ/2001/435/#paragraf-36.odsek-6) zákona) sa pokladá kópia prvej prihlášky [[§ 36 ods. 1 písm. b)](../../../../SK/ZZ/2001/435/#paragraf-36.odsek-1.pismeno-b) zákona] potvrdená orgánom, ktorému sa prihláška podľa medzinárodného dohovoru[3)](#poznamky.poznamka-3) podala, alebo doklad o práve prednosti registrovaný v elektronickom systéme výmeny prioritných dokladov zriadenom medzinárodnou organizáciou.[3a)](#poznamky.poznamka-3a)
...
Na medzinárodnú prihlášku ([§ 58 ods. 1](../../../../SK/ZZ/2001/435/#paragraf-58.odsek-1) a [2](../../../../SK/ZZ/2001/435/#paragraf-58.odsek-2) zákona) sa vzťahujú ustanovenia Zmluvy o patentovej spolupráci.[5)](#poznamky.poznamka-5) Žiadosť o udelenie ochrany sa podáva v anglickom jazyku, francúzskom jazyku alebo nemeckom jazyku.

##### § 11

(1)

Preklad medzinárodnej prihlášky, podanej podľa Zmluvy o patentovej spolupráci[5)](#poznamky.poznamka-5) ([§ 58 ods. 3 zákona](../../../../SK/ZZ/2001/435/#paragraf-58.odsek-3)), predkladá prihlasovateľ v jednom vyhotovení.
...
Ustanovenie odseku 1 sa použije primerane aj na žiadosť o zápis ukončenia súdneho sporu o právo na riešenie. K žiadosti o ukončenie súdneho sporu o právo na riešenie žiadateľ priloží rozhodnutie súdu opatrené doložkou právoplatnosti alebo úradne overenú kópiu rozhodnutia súdu opatreného doložkou právoplatnosti.
...
Úrad zverejní vo vestníku ([§ 57 ods. 6 zákona](../../../../SK/ZZ/2001/435/#paragraf-57.odsek-6)) údaje uvedené v odseku 1 písm. a), c) až k), m) až p), q), s) až v) a anotáciu ([§ 7](#paragraf-7)).
...
Ak dôkazy predložené účastníkom konania nie sú v štátnom jazyku,[2)](#poznamky.poznamka-2) úrad vyzve účastníka konania, aby predložil ich preklad alebo preklad príslušných častí týchto dôkazov do štátneho jazyka s ich vyznačením v pôvodnom texte; to neplatí, ak sú predložené v českom jazyku.
