...
Kurz dlhopisu je cena, za ktorú sa dlhopis predáva a kupuje na verejnom trhu s cennými papiermi.[1)](#poznamky.poznamka-1)
...
údaj o rozhodnutí Úradu pre finančný trh (ďalej len „úrad“)[1c)](#poznamky.poznamka-1c) o povolení na vydanie dlhopisov, ak sa povolenie vyžaduje,
...
Na vydanie komunálnych obligácií bez ohľadu na dobu ich splatnosti a na vydanie dlhopisov s dobou splatnosti kratšou ako jeden rok a na vydanie dlhopisov, pri ktorých si emitent vyhradil možnosť predčasného splatenia do jedného roka od vydania dlhopisov alebo sa zaviazal, že majiteľovi dlhopisu na požiadanie splatí menovitú hodnotu dlhopisu do jedného roka, je na ich vydanie na území Slovenskej republiky potrebné povolenie podľa tohto zákona s výnimkou dlhopisov podľa [§ 18](#paragraf-18).

(3)

Emitent môže vydať dlhopisy sám alebo prostredníctvom osôb, ktoré majú povolenie na vykonávanie tejto činnosti udelené úradom podľa osobitného zákona.[2f)](#poznamky.poznamka-2f)

##### § 7

(1)

Povolenie na vydanie dlhopisov podľa [§ 6 ods. 2](#paragraf-6.odsek-2) udeľuje úrad na základe písomnej žiadosti emitenta.

(2)

Pokiaľ žiadosť neobsahuje náležitosti uvedené v [§ 8](#paragraf-8), úrad ju vráti na doplnenie.

(3)

O žiadosti rozhodne úrad do dvoch mesiacov od doručenia žiadosti, prípadne od jej doplnenia.
...
Udelením povolenia nevzniká právo na obchodovanie s dlhopismi na verejnom trhu s cennými papiermi.[1)](#poznamky.poznamka-1)
...
Prílohou žiadosti o povolenie musí byť návrh emisných podmienok podľa [§ 3 ods. 3](#paragraf-3.odsek-3), vzor dlhopisu, ak sa dlhopis vydáva v listinnej podobe, posledná ročná účtovná závierka s komentárom overená audítorom, výpis z obchodného registra nie starší ako tri mesiace a rozhodnutie príslušného orgánu emitenta o vydaní dlhopisov.[3a)](#poznamky.poznamka-3a)

(3)

Overenie ročnej účtovnej závierky sa nevyžaduje, ak ide o vydanie zamestnaneckých obligácií ([§ 21](#paragraf-21)).

(4)

Emisné podmienky dlhopisov, na ktorých vydanie sa nevyžaduje povolenie, je emitent povinný predložiť úradu a Národnej banke Slovenska do 15 dní od dátumu začiatku ich vydávania, a to v rozsahu uvedenom v [§ 3 ods. 3](#paragraf-3.odsek-3).
...
S výnimkou dlhopisov podľa [§ 18](#paragraf-18) splácanie menovitej hodnoty dlhopisov a vyplácanie výnosu z dlhopisov môžu emitenti vykonávať sami alebo prostredníctvom osôb, ktoré majú povolenie na vykonávanie týchto činností udelené úradom podľa osobitného zákona.[2f)](#poznamky.poznamka-2f)
...
Ak je emitent v omeškaní s vyplácaním výnosov dlhopisov, je povinný bezodkladne túto skutočnosť oznámiť úradu. Pri verejne obchodovateľných dlhopisoch je emitent povinný bezodkladne zverejniť v periodickej tlači s celoštátnou pôsobnosťou uverejňujúcej burzové správy oznámenie o omeškaní s vyplácaním výnosov dlhopisov.
...
Ak je emitent v omeškaní so splácaním menovitej hodnoty dlhopisov, je povinný bezodkladne oznámiť túto skutočnosť úradu. Pri verejne obchodovateľných dlhopisoch je emitent povinný bezodkladne zverejniť v periodickej tlači s celoštátnou pôsobnosťou uverejňujúcej burzové správy oznámenie o omeškaní so splácaním menovitej hodnoty dlhopisu.
...
Emitentom štátnych dlhopisov je Ministerstvo financií Slovenskej republiky (ďalej len „ministerstvo“), ktoré môže rozhodnúť o ich podobe,[3ea)](#poznamky.poznamka-3ea) pričom sa nepoužijú ustanovenia osobitného predpisu.[3eb)](#poznamky.poznamka-3eb)
...
emitentmi dlhopisov s výnimkou štátnych dlhopisov ([§ 18 a 19](#paragraf-18)),

b)

právnickými osobami a fyzickými osobami, ktoré neoprávnene bez povolenia vykonávajú činnosť, na ktorú sa vyžaduje povolenie podľa tohto zákona alebo podľa osobitného predpisu.[3f)](#poznamky.poznamka-3f)

(2)

Štátny dozor podľa tohto zákona vykonáva úrad.[1c)](#poznamky.poznamka-1c)
...
Ak emitent pri vydávaní dlhopisov, splácaní menovitej hodnoty dlhopisov a vyplácaní výnosov z dlhopisov v prípade, že ide o dlhopisy, na ktorých vydanie sa vyžaduje povolenie, poruší ustanovenia tohto zákona, uloží mu úrad
...
podľa [§ 3 ods. 5](#paragraf-3.odsek-5) alebo [§ 10 ods. 3](#paragraf-10.odsek-3), alebo [§ 12 ods. 6](#paragraf-12.odsek-6) uloží úrad emitentovi pokutu 500 000 Sk,

b)

podľa [§ 8 ods. 4](#paragraf-8.odsek-4) uloží úrad emitentovi pokutu 100 000 Sk.

(3)

Ak hypotekárny správca alebo jeho zástupca[4)](#poznamky.poznamka-4) poruší povinnosti pri výkone dozoru nad vydávaním hypotekárnych záložných listov alebo komunálnych obligácií, môže mu úrad uložiť v závislosti od závažnosti porušenia pokutu až do 1 000 000 Sk.
...
Pri výkone štátneho dozoru je úrad oprávnený vyžadovať od osôb podliehajúcich tomuto dozoru, aby úradu poskytli v ním určenej lehote údaje, doklady a informácie potrebné na riadny výkon tohto dozoru, a to v rozsahu nevyhnutne potrebnom na výkon štátneho dozoru. Doklady potvrdzujúce splnenie povinností podľa [§ 3 ods. 5](#paragraf-3.odsek-5), [§ 10 ods. 3](#paragraf-10.odsek-3) a [§ 12 ods. 6](#paragraf-12.odsek-6) sú tieto osoby povinné predložiť úradu do 15 dní od doručenia žiadosti.

(8)

Ak sa pri výkone štátneho dozoru zistí, že neoprávnená osoba vykonáva činnosť podľa tohto zákona, na ktorú sa vyžaduje povolenie podľa tohto zákona alebo podľa osobitného predpisu,[3f)](#poznamky.poznamka-3f) úrad jej zakáže vykonávať túto činnosť a uloží jej pokutu do 25 000 000 Sk.
...
Na konanie podľa tohto zákona sa vzťahuje všeobecný predpis o správnom konaní,[4b)](#poznamky.poznamka-4b) ak tento zákon alebo osobitný zákon[1c)](#poznamky.poznamka-1c) neustanovujú inak.
...
Konania začaté pred 1. januárom 2000 úrad dokončí podľa doterajších právnych predpisov.
