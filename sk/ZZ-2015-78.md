...
Ak sa rozhodnutím ukladá kontrolovanej osobe povinnosť zdržiavať sa v určený čas na určenom mieste, kontrola technickými prostriedkami sa vykonáva za súčasného použitia technických prostriedkov podľa [§ 3 písm. a)](#paragraf-3.odsek-1.pismeno-a) a [b)](#paragraf-3.odsek-1.pismeno-b); ustanovenie [§ 10](#paragraf-10) tým nie je dotknuté. Ak sa rozhodnutím ukladá povinnosť zdržiavať sa v určený čas na určenom mieste popri zákaze podľa odseku 2 alebo odseku 3, ktorého dodržiavanie sa má zisťovať kontrolou technickými prostriedkami, kontrolu technickými prostriedkami možno vykonať za súčasného použitia technických prostriedkov podľa [§ 3 písm. a)](#paragraf-3.odsek-1.pismeno-a) a [c)](#paragraf-3.odsek-1.pismeno-c).

(2)

Ak sa rozhodnutím ukladá kontrolovanej osobe zákaz priblížiť sa k chránenej osobe na určenú vzdialenosť, kontrola technickými prostriedkami sa vykonáva za súčasného použitia technických prostriedkov podľa [§ 3 písm. a)](#paragraf-3.odsek-1.pismeno-a), [c)](#paragraf-3.odsek-1.pismeno-c) a [d)](#paragraf-3.odsek-1.pismeno-d); ustanovenie [§ 10](#paragraf-10) tým nie je dotknuté.

(3)

Ak sa rozhodnutím ukladá kontrolovanej osobe zákaz zdržiavať sa na určenom mieste alebo v určenom obvode vrátane zákazu účasti na verejnom podujatí, kontrola technickými prostriedkami sa vykonáva za súčasného použitia technických prostriedkov podľa [§ 3 písm. a)](#paragraf-3.odsek-1.pismeno-a) a [c)](#paragraf-3.odsek-1.pismeno-c), v prípade zákazu účasti na verejnom podujatí aj podľa [§ 3 písm. f)](#paragraf-3.odsek-1.pismeno-f); ustanovenie [§ 10](#paragraf-10) tým nie je dotknuté.

(4)

Ak sa rozhodnutím ukladá kontrolovanej osobe zákaz požívať alkoholické nápoje, kontrola technickými prostriedkami sa vykonáva za súčasného použitia technických prostriedkov podľa [§ 3 písm. a)](#paragraf-3.odsek-1.pismeno-a) a [e)](#paragraf-3.odsek-1.pismeno-e).

(5)

Ak sa rozhodnutím ukladá kontrolovanej osobe povinnosť podľa odseku 1 a súčasne zákaz podľa odseku 4, funkciu zariadenia na kontrolu prítomnosti plní technický prostriedok podľa [§ 3 písm. e)](#paragraf-3.odsek-1.pismeno-e).
...
Kontrolu technickými prostriedkami možno vykonať, ak sú technické prostriedky k dispozícii a ak sú splnené materiálno-technické podmienky ich použitia. Materiálno-technické podmienky použitia technických prostriedkov ustanoví všeobecne záväzný právny predpis, ktorý vydá Ministerstvo spravodlivosti Slovenskej republiky (ďalej len „ministerstvo“).
...
Inštaláciu a deinštaláciu technických prostriedkov môže vykonať príslušník Zboru väzenskej a justičnej stráže.
...
umožniť inštaláciu, deinštaláciu a údržbu technických prostriedkov a v prípade technických prostriedkov podľa [§ 3 písm. b)](#paragraf-3.odsek-1.pismeno-b) a [e)](#paragraf-3.odsek-1.pismeno-e) na tento účel aj vstup do obydlia,
