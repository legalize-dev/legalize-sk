...
koncovým zariadením elektronické zariadenie, ktoré umožňuje prístup do prostredia virtuálnej registračnej pokladnice a tlač pokladničných dokladov, dokladov podľa [§ 4a ods. 3 písm. b)](#paragraf-4a.odsek-3.pismeno-b), intervalovej uzávierky a prehľadovej uzávierky.
...
Ak Colný úrad Bratislava zruší rozhodnutie o certifikácii, je povinný o tejto skutočnosti bez zbytočného odkladu písomne informovať podnikateľa.
...
Podnikateľ je povinný oznámiť daňovému úradu zmenu predajného miesta, ak je odlišné od miesta podnikania, v lehote podľa osobitného predpisu[14)](#poznamky.poznamka-14) za účelom vykonania zmeny tohto údaja v evidencii daňového úradu.
...
Pokladničný doklad, ak ide o úhradu faktúry alebo jej časti, nesmie obsahovať údaje podľa odseku 1 písm. g), h) a j) až l). Doklad podľa [§ 4 ods. 2 písm. a) ôsmeho bodu](#paragraf-4.odsek-2.pismeno-a.bod-8) a [§ 4a ods. 3 písm. b)](#paragraf-4a.odsek-3.pismeno-b) označený slovami „NEPLATNÝ DOKLAD“ obsahuje najmenej údaje podľa odseku 1 písm. a) až c) a e) až o) a doklad podľa [§ 4 ods. 2 písm. a) ôsmeho bodu](#paragraf-4.odsek-2.pismeno-a.bod-8) a [§ 4a ods. 3 písm. b)](#paragraf-4a.odsek-3.pismeno-b) označený slovom „VKLAD“ obsahuje najmenej údaje podľa odseku 1 písm. a) až c), e), f) a i) a sumu vkladu podľa [§ 3 ods. 3](#paragraf-3.odsek-3).
...
Daňový úrad zruší prístup do virtuálnej registračnej pokladnice aj, ak podnikateľ oznámi stratu prihlasovacích údajov alebo ak stratu zistí daňový úrad alebo colný úrad; rovnako sa postupuje aj, ak daňový úrad alebo colný úrad zistí zneužitie alebo odcudzenie prihlasovacích údajov.
...
nezaznamená do knihy elektronickej registračnej pokladnice skutočnosti podľa [§ 10 ods. 1](#paragraf-10.odsek-1) alebo [ods. 3](#paragraf-10.odsek-3),
...
poruší zákaz predávať tovar alebo poskytovať službu na predajnom mieste podľa [§ 16b ods. 7](#paragraf-16b.odsek-8),
...
V konaní o uložení pokút a pri ich vymáhaní sa postupuje podľa osobitného predpisu,[19)](#poznamky.poznamka-19) ak [§ 16b](#paragraf-16b) neustanovuje inak.
