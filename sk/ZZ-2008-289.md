...
daňovým kódom elektronickej registračnej pokladnice kód pridelený pre elektronickú registračnú pokladnicu daňovým úradom,
...
pokladničným dokladom doklad o prijatí tržby, doklad o vrátení platby za vrátený tovar, doklad o vrátení platby za tovar alebo poskytnutú službu pri ich reklamácii, doklad o vrátení platby za neposkytnutú službu alebo doklad za vrátené zálohované obaly vyhotovený elektronickou registračnou pokladnicou;
...
Ak akreditovaná osoba[10)](#poznamky.poznamka-10) zruší certifikát vydaný na elektronickú registračnú pokladnicu alebo fiskálnu tlačiareň podľa odseku 1 písm. a), je povinná o tejto skutočnosti bezodkladne informovať finančné riaditeľstvo. Finančné riaditeľstvo je povinné o zrušení certifikátu podľa prvej vety bez zbytočného odkladu písomne informovať podnikateľa.
...
Podnikateľ je povinný po zaevidovaní tržby v elektronickej registračnej pokladnici odovzdať kupujúcemu pokladničný doklad okrem kópie pokladničného dokladu ihneď po jeho vytlačení v elektronickej registračnej pokladnici; iný doklad vyhotovený elektronickou registračnou pokladnicou o prijatí tržby podnikateľ nesmie kupujúcemu odovzdať. Pokladničný doklad obsahuje najmenej tieto povinné údaje:
...
Podnikateľ je povinný po zrušení certifikátu podľa [§ 4 ods. 10](#paragraf-4.odsek-10) ukončiť prevádzku elektronickej registračnej pokladnice v lehote do 30 dní od doručenia informácie o zrušení certifikátu[19)](#poznamky.poznamka-19) finančným riaditeľstvom. Ak informácia podľa prvej vety podnikateľovi nebola zaslaná, je podnikateľ povinný ukončiť prevádzku elektronickej registračnej pokladnice v lehote do 30 dní odvtedy, keď mu daňový úrad alebo colný úrad túto skutočnosť oznámil pri kontrole dodržiavania ustanovení tohto zákona.
...
nepoužil elektronickú registračnú pokladnicu na evidenciu tržby podľa [§ 3 ods. 1](#paragraf-3.odsek-1) alebo prijme tržbu na základe dokladu vyhotoveného elektronickou registračnou pokladnicou, ktorý nie je pokladničným dokladom,
...
na evidenciu prijatej tržby používa elektronickú registračnú pokladnicu, ktorá nespĺňa požiadavky podľa [§ 4 ods. 1 až 3](#paragraf-4.odsek-1),
...
zaeviduje tržbu v elektronickej registračnej pokladnici, ale neodovzdá pokladničný doklad podľa [§ 8 ods. 1](#paragraf-8.odsek-1) a [2](#paragraf-8.odsek-2),

f)

odovzdá pokladničný doklad, doklad alebo paragón, ktoré nespĺňajú náležitosti podľa [§ 8 ods. 1](#paragraf-8.odsek-1) a [2](#paragraf-8.odsek-2) alebo [§ 10 ods. 4](#paragraf-10.odsek-4),

g)

nemá knihu elektronickej registračnej pokladnice umiestnenú na predajnom mieste podľa [§ 2 písm. zc)](#paragraf-2.pismeno-zb),

h)

nezaeviduje v elektronickej registračnej pokladnici vklad hotovosti podľa [§ 3 ods. 3](#paragraf-3.odsek-3),
...
nepoužíva elektronickú registračnú pokladnicu v súlade s [§ 3 ods. 6](#paragraf-3.odsek-6),
...
nesplní povinnosť podľa [§ 8 ods. 5](#paragraf-8.odsek-5),

p)

nesplní povinnosť podľa [§ 9](#paragraf-9),
...
neoznámi ukončenie prevádzky elektronickej registračnej pokladnice podľa [§ 15 ods. 2](#paragraf-15.odsek-2),
...
neoznámi daňovému úradu zistenie poškodenia plomby alebo chýbanie plomby, zmeny údajov uložených v elektronickej registračnej pokladnici alebo odchýlky od elektronickej registračnej pokladnice certifikovanej akreditovanou osobou podľa [§ 5 ods. 2 písm. c)](#paragraf-5.odsek-2.pismeno-c),
...
[§ 16a písm. g) až i)](#paragraf-16a.pismeno-g), [k) až n)](#paragraf-16a.pismeno-k), [p) až r)](#paragraf-16a.pismeno-p) a [u) až x)](#paragraf-16a.pismeno-u) od 200 eur do 6 600 eur; pokutu za správny delikt podľa [§ 16a písm. h)](#paragraf-16a.pismeno-h) daňový úrad alebo colný úrad neuloží, ak daňovým úradom alebo colným úradom zistená celková suma vloženej hotovosti v elektronickej registračnej pokladnici okrem prijatej tržby podľa [§ 3 ods. 3](#paragraf-3.odsek-3) nepresiahne sumu 20 eur,
