...
kópiu certifikátu elektronickej registračnej pokladnice alebo fiskálnej tlačiarne, ak fiskálna tlačiareň je certifikovaná ako samostatné elektronické registračné zariadenie podľa [§ 4 ods. 1 písm. a)](#paragraf-4.odsek-1.pismeno-a); tento doklad je predajca elektronickej registračnej pokladnice alebo fiskálnej tlačiarne povinný odovzdať podnikateľovi pri kúpe elektronickej registračnej pokladnice alebo fiskálnej tlačiarne.
...
Podnikateľ je povinný po zaevidovaní tržby v elektronickej registračnej pokladnici bez zbytočného odkladu vydať kupujúcemu pokladničný doklad; iný doklad vyhotovený elektronickou registračnou pokladnicou o prijatí tržby podnikateľ nesmie kupujúcemu vydať. Pokladničný doklad obsahuje najmenej tieto údaje:
...
Kópie paragónov podľa [§ 10 ods. 4](#paragraf-10.odsek-4), pokladničné doklady vyhotovené pri uplatnení postupu podľa [§ 10 ods. 5](#paragraf-10.odsek-5) a tlačové výstupy z dennej uzávierky je podnikateľ povinný uchovávať po dobu piatich rokov od konca kalendárneho roka, v ktorom boli vyhotovené.
...
Podnikateľ z údajov v prevádzkovej pamäti vyhotovuje dennú uzávierku; dennú uzávierku podnikateľ vyhotovuje len za dni, v ktorých mal tržbu. Podnikateľ je povinný vyhotoviť dennú uzávierku kedykoľvek raz za deň. Na požiadanie daňového úradu alebo colného úradu je podnikateľ povinný v lehote určenej daňovým úradom alebo colným úradom vytlačiť intervalovú uzávierku alebo prehľadovú uzávierku; povinnosť vytlačiť intervalovú uzávierku má podnikateľ do uplynutia lehoty na zánik práva vyrubiť daň alebo rozdiel dane.[12)](#poznamky.poznamka-12)
...
nepoužil elektronickú registračnú pokladnicu na evidenciu tržby alebo prijme tržbu na základe dokladu vyhotoveného elektronickou registračnou pokladnicou, ktorý nie je pokladničným dokladom,
...
nenahlási servisnej organizácii poruchu elektronickej registračnej pokladnice podľa [§ 10 ods. 1](#paragraf-10.odsek-1) alebo poškodenie alebo chýbanie plomby podľa [§ 4 ods. 8](#paragraf-4.odsek-8),
...
nevyhotoví dennú uzávierku alebo intervalovú uzávierku alebo prehľadovú uzávierku podľa [§ 12 ods. 1](#paragraf-12.odsek-1),
...
[§ 16a písm. g) až u)](#paragraf-16a.pismeno-g) od 30 do 3 300 eur; pokutu za správny delikt podľa [§ 16a písm. h)](#paragraf-16a.pismeno-h) daňový úrad alebo colný úrad neuloží, ak daňovým úradom alebo colným úradom zistená celková suma vloženej hotovosti v elektronickej registračnej pokladnici okrem prijatej tržby ([§ 3 ods. 3](#paragraf-3.odsek-3)) nepresiahne sumu 20 eur,

d)

[§ 16a písm. af)](#paragraf-16a.pismeno-af) 2 000 eur.
...
[§ 16a písm. g) až u)](#paragraf-16a.pismeno-g) od 60 eur do 6 600 eur; pokutu za správny delikt podľa [§ 16a písm. h)](#paragraf-16a.pismeno-h) pri každom ďalšom zistení porušenia daňový úrad alebo colný úrad neuloží, ak daňovým úradom alebo colným úradom zistená celková suma vloženej hotovosti v elektronickej registračnej pokladnici okrem prijatej tržby ([§ 3 ods. 3](#paragraf-3.odsek-3)) nepresiahne sumu 20 eur,

d)

[§ 16a písm. af)](#paragraf-16a.pismeno-af) 4 000 eur.
...
[§ 16a písm. ae)](#paragraf-16a) od 330 eur do 3 300 eur,
...
Daňový úrad a colný úrad sa o zistení porušenia podľa [§ 16a písm. a) až u)](#paragraf-16a.pismeno-a) a [af)](#paragraf-16a.pismeno-af) vzájomne informujú.

(6)

Spáchanie správnych deliktov podľa [§ 16a písm. a) až d)](#paragraf-16a.pismeno-a), [ae) a af)](#paragraf-16a.pismeno-ae) sa považuje za osobitne závažné porušenie tohto zákona. Daňový úrad, colný úrad alebo daňový úrad servisnej organizácie

a)

po prvom opakovanom zistení spáchania správnych deliktov podľa [§ 16a písm. a) až d)](#paragraf-16a.pismeno-a) a [ae)](#paragraf-16a.pismeno-ae) môže namiesto uloženia pokuty podľa odseku 3 písm. a) alebo odseku 4 písm. b) podať podnet na zrušenie živnostenského oprávnenia,[18a)](#poznamky.poznamka-18a)

b)

pri prvom zistení spáchania správneho deliktu podľa [§ 16a písm. af)](#paragraf-16a.pismeno-af) uloží pokutu podľa odseku 1 písm. d) alebo odseku 2 písm. c) a môže podať podnet na zrušenie živnostenského oprávnenia,[18a)](#poznamky.poznamka-18a)

c)

pri opakovanom zistení spáchania správneho deliktu podľa [§ 16a písm. af)](#paragraf-16a.pismeno-af) uloží pokutu podľa odseku 3 písm. d) alebo odseku 4 písm. c) a podá podnet na zrušenie živnostenského oprávnenia.[18a)](#poznamky.poznamka-18a)

(7)

Pri ukladaní pokuty podľa odsekov 1 až 4 sa prihliada na závažnosť, trvanie a následky protiprávneho stavu.
