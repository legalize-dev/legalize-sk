...
cenín okrem poukazu podľa osobitného predpisu,[4a)](#poznamky.poznamka-4a) cestovných lístkov mestskej hromadnej dopravy, telefónnych kariet, dennej tlače a periodickej tlače,
...
Podnikatelia, ktorí vykonávajú činnosť na základe zmluvy o združení[9)](#poznamky.poznamka-9) a predávajú tovar alebo poskytujú službu na tom istom predajnom mieste, môžu používať jednu spoločnú elektronickú registračnú pokladnicu alebo pokladnicu e-kasa klient.
...
Na účely plnenia povinnosti podľa [§ 3 ods. 1](#paragraf-3.odsek-1), [3](#paragraf-3.odsek-3) a [7](#paragraf-3.odsek-7) a podľa [§ 3a ods. 3](#paragraf-3a.odsek-3) možno používať len
...
ktorej daňový úrad pridelil kód podľa [§ 7a](#paragraf-7a),
...
ktorá používa pokladničný program a chránené dátové úložisko, na ktoré bolo vydané rozhodnutie o certifikácii pokladničného programu a chráneného dátového úložiska podľa [§ 4c](#paragraf-4c).
...
zhodu údajov podľa [§ 8 ods. 2](#paragraf-8.odsek-2), [6](#paragraf-8.odsek-6) a [9](#paragraf-8.odsek-9) s údajmi zasielanými do systému e-kasa podľa [§ 8a](#paragraf-8a),

r)

zasielanie údajov podľa [§ 8a](#paragraf-8a) do systému e-kasa,
...
obchodné meno a sídlo, predajné miesto, ak je odlišné od sídla, identifikačné číslo organizácie, daňové identifikačné číslo, identifikačné číslo pre daň z pridanej hodnoty, ak mu bolo pridelené a ak je platiteľom dane z pridanej hodnoty, ak ide o právnickú osobu.
...
Ak podnikatelia vykonávajú činnosť na základe zmluvy o združení podľa [§ 3 ods. 5](#paragraf-3.odsek-5) a používajú jednu spoločnú pokladnicu e-kasa klient, žiadosť podľa odseku 1 a kópiu zmluvy o združení predloží jeden z účastníkov združenia podľa ich dohody.

(11)

Podnikateľ, ktorý sa stal platiteľom dane z pridanej hodnoty podľa osobitného predpisu,[14a)](#poznamky.poznamka-14a) je povinný pred prvým vyhotovením pokladničného dokladu ako platiteľ dane z pridanej hodnoty oznámiť finančnému riaditeľstvu prostredníctvom portálu finančnej správy v e-kasa zóne podnikateľa skutočnosť, že sa stal platiteľom dane z pridanej hodnoty; to neplatí pre podnikateľa, ktorý sa stal platiteľom dane z pridanej hodnoty na základe žiadosti o registráciu podľa osobitného predpisu[14aa)](#poznamky.poznamka-14aa) alebo k 1. januáru roka nasledujúceho po roku, v ktorom prekročil obrat podľa osobitného predpisu.[14ab)](#poznamky.poznamka-14ab)
...
daňové identifikačné číslo, ak sa podnikateľ nestal platiteľom dane z pridanej hodnoty alebo sa stal platiteľom dane z pridanej hodnoty a nebolo mu pridelené identifikačné číslo pre daň z pridanej hodnoty,

c)

identifikačné číslo pre daň z pridanej hodnoty, ak sa podnikateľ stal platiteľom dane z pridanej hodnoty a bolo mu pridelené identifikačné číslo pre daň z pridanej hodnoty,
...
Pokladničné doklady vyhotovené elektronickou registračnou pokladnicou pri uplatnení postupu podľa [§ 10 ods. 5](#paragraf-10.odsek-5), doklady označené slovami „NEPLATNÝ DOKLAD“ vyhotovené elektronickou registračnou pokladnicou, tlačové výstupy z dennej uzávierky vyhotovené elektronickou registračnou pokladnicou a kópie paragónov je podnikateľ povinný uchovávať chronologicky usporiadané po dobu piatich rokov od konca kalendárneho roka, v ktorom boli vyhotovené.
...
vtedy, ak podnikateľ v žiadosti o pridelenie kódu pokladnice e-kasa klient podľa [§ 7a](#paragraf-7a) oznámi ukončenie používania elektronickej registračnej pokladnice podľa odseku 2.
...
nepoužil elektronickú registračnú pokladnicu alebo pokladnicu e-kasa klient na evidenciu tržby podľa [§ 3 ods. 1](#paragraf-3.odsek-1) prvej vety alebo prijme tržbu na základe dokladu vyhotoveného elektronickou registračnou pokladnicou alebo pokladnicou e-kasa klient, ktorý nie je pokladničným dokladom, uvedie v žiadosti nepravdivú informáciu o dostupnosti internetového signálu na predajnom mieste podľa [§ 3a ods. 1](#paragraf-3a.odsek-1) alebo nesplní povinnosť podľa [§ 3a ods. 3](#paragraf-3a.odsek-3) alebo [§ 8 ods. 5](#paragraf-8.odsek-5),
...
na evidenciu prijatej tržby používa elektronickú registračnú pokladnicu, ktorá nespĺňa požiadavky podľa [§ 4 ods. 1 až 4](#paragraf-4.odsek-1) alebo pokladnicu e-kasa klient, ktorá nespĺňa požiadavky podľa [§ 4a](#paragraf-4a), alebo nesplní povinnosti uvedené v [§ 8a ods. 1 až 5](#paragraf-8a.odsek-1) a [7](#paragraf-8a.odsek-7),
...
zaeviduje tržbu v elektronickej registračnej pokladnici alebo v pokladnici e-kasa klient, ale neodovzdá pokladničný doklad podľa [§ 8 ods. 1](#paragraf-8.odsek-1), [2](#paragraf-8.odsek-2), [6](#paragraf-8.odsek-6), [8](#paragraf-8.odsek-8) a [9](#paragraf-8.odsek-9),

f)

odovzdá pokladničný doklad, doklad alebo paragón, ktoré nespĺňajú náležitosti podľa [§ 8 ods. 1](#paragraf-8.odsek-1), [2](#paragraf-8.odsek-2), [6](#paragraf-8.odsek-6), [8](#paragraf-8.odsek-8) a [9](#paragraf-8.odsek-9) alebo [§ 10 ods. 4](#paragraf-10.odsek-4) a [6](#paragraf-10.odsek-6),

g)

nemá knihu elektronickej registračnej pokladnice umiestnenú na predajnom mieste podľa [§ 2 písm. aw)](#paragraf-2.pismeno-aw),

h)

nezaeviduje v elektronickej registračnej pokladnici vklad hotovosti podľa [§ 3 ods. 3](#paragraf-3.odsek-3) prvej vety alebo v pokladnici e-kasa klient vklad alebo výber hotovosti podľa [§ 3 ods. 3](#paragraf-3.odsek-3) druhej vety alebo nesplní povinnosť podľa [§ 3 ods. 3](#paragraf-3.odsek-3) tretej vety alebo štvrtej vety,
...
nepoužíva elektronickú registračnú pokladnicu alebo pokladnicu e-kasa klient v súlade s [§ 3 ods. 6](#paragraf-3.odsek-6) alebo nesplní povinnosť podľa [§ 3 ods. 7](#paragraf-3.odsek-8) prvej vety,
...
nesplní povinnosť podľa [§ 3 ods. 1](#paragraf-3.odsek-1) druhej vety a tretej vety, [§ 3 ods. 7](#paragraf-3.odsek-7) druhej vety a tretej vety, [§ 4 ods. 9](#paragraf-4.odsek-9) a [10](#paragraf-4.odsek-10) alebo [§ 7a ods. 5](#paragraf-7a.odsek-5), [7 až 9](#paragraf-7a.odsek-7),
...
nesplní povinnosť podľa [§ 3 ods. 8](#paragraf-3.odsek-8) alebo [§ 3a ods. 4](#paragraf-3a.odsek-4),

p)

nesplní povinnosť podľa [§ 9](#paragraf-9) alebo [§ 10 ods. 7](#paragraf-10.odsek-7),
...
nevedie knihu elektronickej registračnej pokladnice alebo nesplní povinnosť podľa [§ 13](#paragraf-13),
...
nesplní povinnosť podľa [§ 4 ods. 6](#paragraf-4.odsek-6), [§ 4c ods. 4](#paragraf-4c.odsek-4) a [10](#paragraf-4c.odsek-10), [§ 17a ods. 4](#paragraf-17a.odsek-4), [§ 17c ods. 4](#paragraf-17c.odsek-4) alebo [§ 18c ods. 4](#paragraf-18c.odsek-4),
...
v rozpore s týmto zákonom umožní zmeniť alebo zmení údaje v elektronickej registračnej pokladnici, v pokladnici e-kasa klient, v kontrolnom zázname alebo umožní zmeniť alebo zmení obsah alebo usporiadanie údajov výsledných výstupov vytvorených pokladnicou e-kasa klient alebo zmení údaje z dátovej správy uloženej v on-line registračnej pokladnici podľa [§ 3 ods. 1](#paragraf-3.odsek-1), [3](#paragraf-3.odsek-3) a [7](#paragraf-3.odsek-7) alebo [§ 3a ods. 3](#paragraf-3a.odsek-3) alebo umožní zmeniť alebo zmení rozsah údajov zasielaných do systému e-kasa podľa [§ 8a](#paragraf-8a),
...
nesplní oznamovaciu povinnosť podľa [§ 7a ods. 11.](#paragraf-7a.odsek-11)
...
[§ 16a písm. a) až f)](#paragraf-16a.pismeno-a), [j)](#paragraf-16a.pismeno-j), [s)](#paragraf-16a.pismeno-s) a [t)](#paragraf-16a.pismeno-t) od 500 eur do 15 000 eur,

b)

[§ 16a písm. g) až i)](#paragraf-16a.pismeno-g), [k)](#paragraf-16a.pismeno-k), [l)](#paragraf-16a.pismeno-l), [n)](#paragraf-16a.pismeno-n), [p) až r)](#paragraf-16a.pismeno-p) a [u) až x)](#paragraf-16a.pismeno-x) od 150 eur do 6 500 eur; pokutu za správny delikt podľa [§ 16a písm. h)](#paragraf-16a.pismeno-h) daňový úrad alebo colný úrad neuloží, ak daňovým úradom alebo colným úradom zistená celková suma vloženej hotovosti v elektronickej registračnej pokladnici alebo v pokladnici e-kasa klient okrem prijatej tržby podľa [§ 3 ods. 3](#paragraf-3.odsek-3) nepresiahne sumu 20 eur,

c)

[§ 16a písm. m)](#paragraf-16a.pismeno-m) od 30 eur do 200 eur pri druhom zistení porušenia; pri prvom zistení porušenia daňový úrad alebo colný úrad pokutu neuloží, ale podnikateľa vyzve na odstránenie nedostatkov pri označení tovaru alebo služby,

d)

[§ 16a písm. o)](#paragraf-16a.pismeno-o) od 80 eur do 650 eur; pri prvom zistení porušenia podľa [§ 3 ods. 8](#paragraf-3.odsek-8) daňový úrad alebo colný úrad pokutu neuloží, ale podnikateľa vyzve na odstránenie nedostatkov,

e)

[§ 16a písm. am)](#paragraf-16a.pismeno-am), [ap)](#paragraf-16a.pismeno-ap) a [ar)](#paragraf-16a.pismeno-ar) od 3 000 eur do 15 000 eur,

f)

[§ 16a písm. ao)](#paragraf-16a.pismeno-ao) od 3 000 eur do 60 000 eur,

g)

[§ 16a písm. at)](#paragraf-16a.pismeno-at) od 20 eur do 100 eur.
...
[§ 16a písm. a) až f)](#paragraf-16a.pismeno-a), [j)](#paragraf-16a.pismeno-j), [s)](#paragraf-16a.pismeno-s) a [t)](#paragraf-16a.pismeno-t) od 1 000 eur do 30 000 eur,

b)

[§ 16a písm. g) až i)](#paragraf-16a.pismeno-g), [k)](#paragraf-16a.pismeno-k), [l)](#paragraf-16a.pismeno-l), [n)](#paragraf-16a.pismeno-n), [p) až r)](#paragraf-16a.pismeno-p) a [u) až x)](#paragraf-16a.pismeno-x) od 300 eur do 13 000 eur; pokutu za správny delikt podľa [§ 16a písm. h)](#paragraf-16a.pismeno-h) daňový úrad alebo colný úrad neuloží, ak daňovým úradom alebo colným úradom zistená celková suma vloženej hotovosti v elektronickej registračnej pokladnici alebo v pokladnici e-kasa klient okrem prijatej tržby podľa [§ 3 ods. 3](#paragraf-3.odsek-3) nepresiahne sumu 20 eur,

c)

[§ 16a písm. m)](#paragraf-16a.pismeno-m) od 60 eur do 400 eur,

d)

[§ 16a písm. o)](#paragraf-16a.pismeno-o) od 150 eur do 1 300 eur,

e)

[§ 16a písm. am)](#paragraf-16a.pismeno-am), [ap)](#paragraf-16a.pismeno-ap) a [ar)](#paragraf-16a.pismeno-ar) od 6 000 eur do 30 000 eur.
...
[§ 16a písm. z)](#paragraf-16a.pismeno-z) a [ag)](#paragraf-16a.pismeno-ag) od 500 eur do 6 500 eur,
...
[§ 16a písm. as)](#paragraf-16a.pismeno-as) od 3 000 eur do 15 000 eur.
...
[§ 16a písm. z)](#paragraf-16a.pismeno-z) a [ag)](#paragraf-16a.pismeno-ag) od 1 000 eur do 13 000 eur,
...
[§ 16a písm. as)](#paragraf-16a.pismeno-as) od 6 000 eur do 30 000 eur.
...
Colný úrad alebo daňový úrad postupuje pri zabezpečení a prepadnutí on-line registračnej pokladnice primerane podľa daňového poriadku,[20a)](#poznamky.poznamka-20a) ak odseky 1 až 6 neustanovujú inak.
...
Počas zabezpečenia on-line registračnej pokladnice je podnikateľ povinný pri predaji tovaru alebo poskytovaní služby postupovať podľa [§ 10 ods. 4](#paragraf-10.odsek-4) a [5](#paragraf-10.odsek-5) alebo používať inú on-line registračnú pokladnicu, ktorá bola uvedená do prevádzky podľa [§ 7a](#paragraf-7a), alebo používať virtuálnu registračnú pokladnicu.

(2)

Podnikateľ, ktorý počas zabezpečenia on-line registračnej pokladnice postupoval podľa [§ 10 ods. 4](#paragraf-10.odsek-4) a [5](#paragraf-10.odsek-5), je povinný po zrušení rozhodnutia o zabezpečení on-line registračnej pokladnice zaevidovať údaje z vyhotovených paragónov do on-line registračnej pokladnice v lehote podľa [§ 10 ods. 5](#paragraf-10.odsek-5), pričom kópie paragónov je povinný uchovávať podľa [§ 9 ods. 4](#paragraf-9.odsek-4).

(3)

Podnikateľ, ktorému bola zabezpečená on-line registračná pokladnica, je povinný po nadobudnutí právoplatnosti rozhodnutia o prepadnutí on-line registračnej pokladnice kópie paragónov archivovať podľa osobitného predpisu;[20b)](#poznamky.poznamka-20b) ak bude podnikateľ naďalej predávať tovar alebo poskytovať službu uvedenú v [prílohe č. 1](#prilohy.priloha-priloha_c_1_k_zakonu_c_289_2008_z_z), je povinný používať on-line registračnú pokladnicu alebo virtuálnu registračnú pokladnicu.
...
Technická expertíza, ktorej vykonávanie začal Colný úrad Bratislava pred 1. januárom 2019, dokončí finančné riaditeľstvo podľa [§ 17c](#paragraf-17c) v znení účinnom od 1. januára 2019.
...
Daňový úrad alebo colný úrad neuloží do 31. decembra 2019 pokutu za nepoužívanie on-line registračnej pokladnice podnikateľovi, ktorému vznikla povinnosť evidovať tržby podľa tohto zákona prvýkrát od 1. apríla 2019, ak požiadal o pridelenie kódu pokladnice e-kasa klient a pri evidencii tržieb postupuje primerane podľa [§ 10 ods. 6](#paragraf-10.odsek-6); podmienka primeraného postupu podľa [§ 10 ods. 6](#paragraf-10.odsek-6) sa pre takýchto podnikateľov na obdobie do dňa účinnosti tohto zákona neuplatní. Ak daňový úrad alebo colný úrad takémuto podnikateľovi pokutu už uložil, rozhodnutie o uložení takejto pokuty sa zrušuje dňom účinnosti tohto zákona v časti týkajúcej sa nepoužívania on-line registračnej pokladnice, alebo ak sa začalo konanie o uložení takejto pokuty, toto konanie sa zastavuje dňom účinnosti tohto zákona.
...
Činnosť servisných organizácií podľa [§ 5](#paragraf-5) a register podľa [§ 6](#paragraf-6) sa ukončí k 1. júnu 2020.

(3)

Servisná organizácia, podnikateľ alebo iná osoba poverená podnikateľom sú povinní ukončiť používanie elektronickej registračnej pokladnice podľa [§ 15 ods. 1](#paragraf-15.odsek-1) a [3](#paragraf-15.odsek-3) alebo [ods. 9](#paragraf-15.odsek-9) najneskôr do 31. augusta 2020.
