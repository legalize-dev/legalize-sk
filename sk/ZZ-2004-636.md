...
odporúčanou hodnotou hodnota ukazovateľa, ku ktorej smeruje asanačná činnosť a ochranná činnosť v povodí a v ochranných pásmach vodárenských zdrojov,[1)](#poznamky.poznamka-1)
...
z podzemného vodárenského zdroja alebo z povrchového vodárenského zdroja, ktorá nespĺňa požiadavky na kvalitu pitnej vody podľa osobitného predpisu[2)](#poznamky.poznamka-2) a ktorú je potrebné upravovať,

2.

z podzemného vodárenského zdroja, ktorú je potrebné zdravotne zabezpečiť spravidla dezinfekciou na plnenie požiadavky na kvalitu pitnej vody podľa osobitného predpisu,[2)](#poznamky.poznamka-2)

d)

vodou z podzemného vodárenského zdroja, ktorá spĺňa požiadavky na kvalitu pitnej vody podľa osobitného predpisu,[2)](#poznamky.poznamka-2) voda bez nutnosti použitia dezinfekcie, ktorá sa odoberá v prirodzenom stave a sledovanie jej kvality sa vykonáva podľa osobitného predpisu,[2)](#poznamky.poznamka-2)
...
upravenou vodou voda po výstupe z posledného technologického stupňa úpravy vody alebo na odtoku z úpravne vody, ak spĺňa požiadavky na ukazovatele pre kvalitu pitnej vody,[2)](#poznamky.poznamka-2) je zároveň pitnou vodou,
...
úpravou vody proces, ktorý je zameraný na zlepšenie kvality surovej vody na dosiahnutie kvality vody podľa osobitného predpisu[2)](#poznamky.poznamka-2) alebo na zachovanie kvality pitnej vody vrátane dezinfekcie,

j)

technologickým procesom súbor technologických stupňov na úpravni vody určených na zlepšenie kvality surovej vody na dosiahnutie kvality vody podľa osobitného predpisu.[2)](#poznamky.poznamka-2)
...
Kvalita surovej vody sa na základe hodnôt fyzikálnych, chemických, mikrobiologických, biologických a rádiologických ukazovateľov zaraďuje do kategórií A0, A1, A2 a A3, ktoré zodpovedajú štandardným metódam úpravy povrchovej vody alebo podzemnej vody na pitnú vodu uvedené v [prílohe č. 1](#prilohy.priloha-priloha_c_1_k_vyhlaske_c_636_2004_z_z) tabuľke č. 1. Kategória A0 predstavuje takú kvalitu surovej vody, ktorá spĺňa požiadavky podľa osobitného predpisu.[2)](#poznamky.poznamka-2)

(2)

Pre surovú vodu z povrchových vodárenských zdrojov a z podzemných vodárenských zdrojov sú ustanovené odporúčané hodnoty a medzné hodnoty ukazovateľov kvality surovej vody pre kategórie A1, A2 a A3, ktoré sú uvedené v [prílohe č. 1](#prilohy.priloha-priloha_c_1_k_vyhlaske_c_636_2004_z_z) tabuľkách č. 2a a 2b.

(3)

Pri výbere vodárenského zdroja sa okrem kvality surovej vody hodnotí najmä využiteľná výdatnosť vodárenského zdroja, možnosť ochrany kvality surovej vody vo vodárenskom zdroji, potenciálne nebezpečenstvo znečistenia vody a ďalšie miestne podmienky. Ak je viac vodárenských zdrojov, posudzuje sa aj zložitosť technológie úpravy, náročnosť na dopravu vody a ekonomické požiadavky. Zaradenie nového vodárenského zdroja surovej vody do kategórie kvality surovej vody sa vykonáva vyhodnotením ukazovateľov kvality vody uvedených v [prílohe č. 1](#prilohy.priloha-priloha_c_1_k_vyhlaske_c_636_2004_z_z) tabuľkách č. 2a a 2b, a najmenej 12 odbermi.

(4)

Ak surovú vodu nemožno jednoznačne zaradiť do jednej kategórie z dôvodu kolísania kvality počas roka, určí sa priemerný index upraviteľnosti vybraných ukazovateľov kvality surovej vody a zaradenie do príslušnej kategórie podľa [prílohy č. 2](#prilohy.priloha-priloha_c_2_k_vyhlaske_c_636_2004_z_z).
...
Počet odberov vzoriek a druhy rozborov pri kontrole kvality podzemnej vody, ktorá spĺňa požiadavky na kvalitu pitnej vody podľa osobitného predpisu[2)](#poznamky.poznamka-2) a nevyžaduje úpravu, nad rámec tejto vyhlášky určí individuálne prevádzkovateľ verejného vodovodu.

(3)

Minimálnym rozborom sa overuje stálosť kvality vody vo vodárenskom zdroji a účinnosť úpravy vody; minimálnym rozborom je rozsah ukazovateľov, ktoré sú uvedené v [prílohe č. 3](#prilohy.priloha-priloha_c_3_k_vyhlaske_c_636_2004_z_z) tabuľke č. 1.

(4)

Minimálny ročný počet odberov vzoriek a druhy rozborov pri kontrole kvality surovej vody je uvedený v [prílohe č. 3](#prilohy.priloha-priloha_c_3_k_vyhlaske_c_636_2004_z_z) tabuľke č. 3 pre
...
Minimálny ročný počet odberov vzoriek a druhy rozborov pri kontrole kvality pitnej vody na odtoku z úpravne vody je uvedený v [prílohe č. 3](#prilohy.priloha-priloha_c_3_k_vyhlaske_c_636_2004_z_z) tabuľkách č. 5 a 6. Rozsah ukazovateľov minimálneho rozboru a úplného rozboru na kontrolu kvality pitnej vody na odtoku z úpravne vody je uvedený v osobitnom predpise.[3)](#poznamky.poznamka-3)

(10)

Ak z [prílohy č. 3](#prilohy.priloha-priloha_c_3_k_vyhlaske_c_636_2004_z_z) tabuliek č. 3 až 6 nie je jednoznačný minimálny počet odberov, a ak objem dodávanej pitnej vody a počet zásobovaných obyvateľov sa nedá priradiť k jednému riadku tabuľky, rozhoduje objem dodávanej vody.
...
Program monitorovania zahŕňa sledovanie kvality surovej vody pred úpravou, počas úpravy na kontrolu technologického procesu a po jej úprave na pitnú vodu, pri doprave, akumulácii a dodávke pitnej vody k odberateľovi. Na základe programu monitorovania systému zásobovania pitnou vodou[4)](#poznamky.poznamka-4) sa sleduje kvalita vody v objektoch a zariadeniach verejného vodovodu v primeranom rozsahu k technickému riešeniu verejného vodovodu.
...
Na miestach kontroly kvality vody musí byť nainštalované zariadenie na odber vzoriek vody. Zásady pre osadenie zariadenia na odber vzoriek sú uvedené [prílohe č. 4](#prilohy.priloha-priloha_c_4_k_vyhlaske_c_636_2004_z_z).
...
Na stanovenie ukazovateľov kvality vody pri kontrole kvality surovej vody, kvality vody v technologickom procese a kvality upravenej vody na odtoku z úpravne vody sa používajú metódy, ktoré vyhovujú kritériám podľa osobitného predpisu[5)](#poznamky.poznamka-5) a ktoré zodpovedajú technickým normám alebo iným obdobným technickým špecifikáciám.
...
prekročenia limitných hodnôt jednotlivých ukazovateľov podľa osobitného predpisu,[2)](#poznamky.poznamka-2)
...
Zistené hodnoty výsledkov kvality surovej vody, kvality vody v technologickom procese a kvality upravenej vody na odtoku z úpravne vody sa odovzdávajú podľa osobitného predpisu.[6)](#poznamky.poznamka-6)
...
Rozsah evidencie záznamov kontroly kvality vody je uvedený v [prílohe č. 5](#prilohy.priloha-priloha_c_5_k_vyhlaske_c_636_2004_z_z).

##### § 11a

##### Transpozičné ustanovenie

Touto vyhláškou sa preberajú právne záväzné akty Európskej únie uvedené v [prílohe č. 6](#prilohy.priloha-priloha_c_6_k_vyhlaske_c_636_2004_z_z).
