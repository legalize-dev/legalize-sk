...
výške minimálnej požiadavky na vlastné zdroje a oprávnené záväzky vybranej inštitúcie podľa [§ 31 ods. 4](#paragraf-31.odsek-4),

c)

povinnosti vypočítavať a sústavne dodržiavať minimálnu požiadavku na vlastné zdroje a oprávnené záväzky osobou podľa [§ 1 ods. 3 písm. b) až d)](#paragraf-1.odsek-3.pismeno-b),

d)

tom, že dcérska spoločnosť nemusí dodržiavať minimálnu požiadavku na vlastné zdroje a oprávnené záväzky na individuálnej úrovni podľa [§ 31 ods. 13](#paragraf-31.odsek-13),

e)

rozsahu, v akom môže vybraná inštitúcia splniť minimálnu požiadavku na konsolidovanej úrovni alebo individuálnej úrovni prostredníctvom opatrení zmluvnej kapitalizácie podľa [§ 31 ods. 14](#paragraf-31.odsek-14),
...
Obmedzenie alebo pozastavenie práv podľa [§ 14 až 17](#paragraf-14) sa nepovažuje za neplnenie zmluvných povinností na účely odsekov 1 a 2.
...
vklady podľa osobitného predpisu,[1)](#poznamky.poznamka-1)

c)

platby a iné plnenia voči prevádzkovateľom platobných systémov a systémov zúčtovania a vyrovnania obchodov s finančnými nástrojmi podľa osobitných predpisov,[60)](#poznamky.poznamka-60) centrálnym protistranám a centrálnym bankám,
...
Obmedzenie podľa odseku 1 sa nevzťahuje na prevádzkovateľov platobných systémov a systémov zúčtovania a vyrovnania obchodov s finančnými nástrojmi podľa osobitných predpisov,[60)](#poznamky.poznamka-60) centrálne protistrany a centrálne banky, vo vzťahu k akejkoľvek zábezpeke poskytnutej vybranou inštitúciou.
...
Obmedzenia podľa odsekov 1 a 2 sa nevzťahujú na prevádzkovateľov platobných systémov a systémov zúčtovania a vyrovnania obchodov s finančnými nástrojmi podľa osobitných predpisov,[60)](#poznamky.poznamka-60) centrálne protistrany a centrálne banky.
...
Ak rada vykonáva právomoc odpísania alebo konverzie, a to aj vo vzťahu k príslušným kapitálovým nástrojom v súlade s [§ 70](#paragraf-70), medzi oprávnené záväzky alebo príslušné kapitálové nástroje vybranej inštitúcie patria aj
...
Rada môže na území Slovenskej republiky vykonávať pôsobnosť v oblasti riešenia krízových situácií vo vzťahu k pobočke vybranej inštitúcie tretej krajiny, ak rada dospela k záveru, že je splnená niektorá z podmienok podľa [§ 85 ods. 7](#paragraf-85.odsek-7) alebo k vybranej inštitúcii tretej krajiny, o ktorej pobočku ide, nezačal rezolučné konanie rezolučný orgán tretej krajiny.
...
dcérskej spoločnosti osoby podľa písmena a) so sídlom mimo Európskej únie okrem postupu uvedeného v [§ 20 ods. 2 až 5](#paragraf-20.odsek-2), [§ 20a](#paragraf-20a) a [85 ods. 2 až 7](#paragraf-85.odsek-2).
...
Ak je rada rezolučným orgánom na úrovni skupiny, rada spolu s príslušnými rezolučnými orgánmi dcérskych spoločností a po prerokovaní s kolégiom orgánov dohľadu a príslušnými rezolučnými orgánmi v štáte sídla významnej pobočky v rozsahu, v akom sa plán riešenia krízových situácií na úrovni skupiny vzťahuje na významnú pobočku, vykoná v rámci kolégia pre riešenie krízových situácií posúdenie podľa [§ 28](#paragraf-28) a vyvinie maximálne úsilie na dosiahnutie spoločného rozhodnutia o uložení povinnosti osobe v skupine prijať náhradné opatrenia podľa [§ 25 ods. 4](#paragraf-25.odsek-4).
...
záväzok nevyplýva z vkladu, ktorý má prednostné poradie v rámci konkurzného konania podľa osobitného predpisu.[59a)](#poznamky.poznamka-59a)
...
Národná banka Slovenska ako orgán dohľadu na úrovni skupiny v plnom rozsahu udelila materskej spoločnosti výnimku podľa osobitného predpisu.[71a)](#poznamky.poznamka-71a)
...
Rada prijme opatrenia na riešenie krízovej situácie vo vzťahu k osobám podľa [§ 1 ods. 3 písm. c)](#paragraf-1.odsek-3.pismeno-c) a [d)](#paragraf-1.odsek-3.pismeno-d), ak sú vzhľadom na tieto osoby a zároveň vzhľadom na jednu dcérsku spoločnosť alebo na viaceré dcérske spoločnosti, ktoré sú vybranými inštitúciami, splnené podmienky podľa [§ 34 ods. 1](#paragraf-34.odsek-1) alebo ak rezolučný orgán tretej krajiny alebo orgán vykonávajúci dohľad nad dcérskou spoločnosťou so sídlom v tretej krajine vydá vyhlásenie, že táto dcérska spoločnosť splnila podmienky na riešenie krízovej situácie v súlade s právnymi predpismi príslušnej tretej krajiny.
...
Rada môže, po zohľadnení ustanovenia odseku 3, prijať opatrenia na riešenie krízovej situácie voči osobe podľa [§ 1 ods. 3 písm. c)](#paragraf-1.odsek-3.pismeno-c) alebo [písm. d)](#paragraf-1.odsek-3.pismeno-d), aj ak nespĺňa podmienky ustanovené v [§ 34 ods. 1](#paragraf-34.odsek-1) a ak platí, že

a)

jedna dcérska spoločnosť alebo viaceré dcérske spoločnosti, ktoré sú vybranými inštitúciami, spĺňajú podmienky podľa [§ 32 ods. 2](#paragraf-32.odsek-2) a [§ 34 ods. 1](#paragraf-34.odsek-1) a [2](#paragraf-34.odsek-2) a ich aktíva a záväzky sú také, že ich zlyhanie ohrozuje vybranú inštitúciu alebo skupinu ako celok alebo

b)

konkurzné právo členského štátu vyžaduje, aby sa ku skupine pristupovalo ako k celku a opatrenie na riešenie krízovej situácie vzhľadom na osobu podľa [§ 1 ods. 3 písm. c)](#paragraf-1.odsek-3.pismeno-c) alebo [písm. d)](#paragraf-1.odsek-3.pismeno-d) je potrebné na riešenie krízovej situácie jednej dcérskej spoločnosti alebo viacerých dcérskych spoločností, ktoré sú vybranými inštitúciami, alebo na riešenie krízovej situácie skupiny ako celku.
...
obsahovať plán financovania v súlade s plánom riešenia krízových situácií na úrovni skupiny, ktorý zohľadní zásady rozdelenia zodpovednosti ustanovené v súlade s [§ 26 ods. 4 písm. f)](#paragraf-26.odsek-4.pismeno-f) a všeobecné zásady spoločného využívania prostriedkov podľa [§ 96](#paragraf-96).
...
plány riešenia krízových situácií podľa [§ 21](#paragraf-21); to neplatí, ak príslušné rezolučné orgány usúdia podľa okolností prípadu, že ciele riešenia krízových situácií sa účinnejšie dosiahnu prijatím opatrení, ktoré nie sú určené v plánoch riešenia krízových situácií,
...
Ak sa rada rozhodne uplatniť na vybranú inštitúciu alebo osobu podľa [§ 1 ods. 3 písm. b) až d)](#paragraf-1.odsek-3.pismeno-b) opatrenie na riešenie krízových situácií, ktoré by viedlo k stratám pre veriteľov alebo ku konverzii ich pohľadávok, pristúpi rada k výkonu právomoci odpísať a konvertovať kapitálové nástroje podľa ôsmej časti tohto zákona bezprostredne pred uplatnením opatrenia na riešenie krízových situácií alebo spolu s jeho uplatnením.
...
Pri vylúčení niektorých záväzkov podľa odseku 2 môže rada zvýšiť rozsah odpísania alebo konverzie uplatnený na iné oprávnené záväzky v súlade s pravidlom podľa [§ 33 ods. 1 písm. f)](#paragraf-33.odsek-1.pismeno-f).
...
pokrytia všetkých strát, ktoré neboli absorbované oprávnenými záväzkami a obnovu čistej hodnoty aktívna na nulu podľa [§ 60 ods. 1 písm. a)](#paragraf-60.odsek-1.pismeno-a),
...
Rada rozhoduje o odpísaní príslušných kapitálových nástrojov alebo ich konverzii do akcií alebo iných nástrojov vlastníctva vybranej inštitúcie alebo osoby podľa [§ 1 ods. 3 písm. b) až d)](#paragraf-1.odsek-3.pismeno-b) postupom podľa [§ 71](#paragraf-71)
...
Rada pred vydaním rozhodnutia o odpísaní alebo konverzii kapitálových nástrojov vybranej inštitúcie alebo osoby podľa [§ 1 ods. 3 písm. b) až d)](#paragraf-1.odsek-3.pismeno-b) zistí hodnotu aktív a záväzkov vybranej inštitúcie alebo osoby podľa [§ 1 ods. 3 písm. b) až d)](#paragraf-1.odsek-3.pismeno-b) postupom podľa [§ 51](#paragraf-51). Výsledok ocenenia sa použije ako východisko na rozhodnutie o odpísaní a konverzii príslušných kapitálových nástrojov s cieľom absorbovať straty a na účely doplnenia kapitálu vybranej inštitúcie alebo osoby podľa [§ 1 ods. 3 písm. b) až d)](#paragraf-1.odsek-3.pismeno-b).

(3)

Rada je povinná bezodkladne vydať rozhodnutie o odpísaní alebo konverzii príslušných kapitálových nástrojov vybranej inštitúcie alebo osoby podľa [§ 1 ods. 3 písm. b) až d)](#paragraf-1.odsek-3.pismeno-b), ak je splnená niektorá z týchto podmienok:

a)

sú splnené podmienky podľa [§ 34](#paragraf-34) alebo [§ 48](#paragraf-48) a zároveň [§ 52 ods. 8](#paragraf-52.odsek-8) pred vykonaním úkonu alebo vydaním iného rozhodnutia v rezolučnom konaní,

b)

Národná banka Slovenska doručila rade stanovisko, že odpísanie alebo konverzia sú nevyhnutné na zachovanie stability vybranej inštitúcie alebo osoby podľa [§ 1 ods. 3 písm. b) až d)](#paragraf-1.odsek-3.pismeno-b), alebo k takému záveru dospela rada na základe svojej vlastnej činnosti,
...
Ak rada ako rezolučný orgán na úrovni skupiny dospela k záveru, že je splnená podmienka podľa [§ 70a ods. 1 písm. b)](#paragraf-70a.odsek-1.pismeno-b) vo vzťahu k zahraničnej vybranej inštitúcii, ktorá je dcérskou spoločnosťou a ňou vydané príslušné kapitálové nástroje sú vykazované ako nástroje na splnenie požiadaviek na vlastné zdroje tejto zahraničnej dcérskej spoločnosti na individuálnom základe a skupiny na konsolidovanom základe, bezodkladne oznámi túto skutočnosť
...
Na účely konverzie príslušných kapitálových nástrojov podľa odseku 1 písm. b) alebo písm. c) môže rada uložiť vybranej inštitúcii alebo osobe podľa [§ 1 ods. 3 písm. b) až d)](#paragraf-1.odsek-3.pismeno-b), aby vydala nástroje tvoriace položky vlastného kapitálu Tier 1 v prospech majiteľov príslušných kapitálových nástrojov, ktoré sú predmetom konverzie. Na konverziu príslušných kapitálových nástrojov platia tieto podmienky:

a)

nástroje vlastného kapitálu Tier 1 vybranej inštitúcie alebo osoby podľa [§ 1 ods. 3 písm. b) až d)](#paragraf-1.odsek-3.pismeno-b) alebo jej materskej spoločnosti sa vydajú iba so súhlasom príslušného rezolučného orgánu,
...
konverzný pomer na určenie počtu nástrojov tvoriacich položky vlastného kapitálu Tier 1, ktoré sa vydajú oproti príslušným kapitálovým nástrojom, sa určí podľa [§ 64](#paragraf-64).
...
Ak je rada rezolučným orgánom na úrovni skupiny, zriadi kolégium pre riešenie krízových situácií na vykonávanie úloh podľa [§ 26 až 29](#paragraf-26), [48](#paragraf-48), [49](#paragraf-49) a [59](#paragraf-59) a na zabezpečenie spolupráce a koordinácie s rezolučnými orgánmi z tretích krajín.
...
rozhodnutie a dosiahnutie dohody o potrebe zaviesť program riešenia krízových situácií na úrovni skupiny podľa [§ 48](#paragraf-48) a [49](#paragraf-49),
...
vykonávať právomoci podľa [§ 14](#paragraf-14), [15](#paragraf-15) a [17](#paragraf-17) v súvislosti s právami ktorejkoľvek zmluvnej strany spoločného rozhodnutia podľa odseku 2, ak je to nevyhnutné na zabezpečenie výkonu rozhodnutí tretej krajiny zameraných na riešenie krízových situácií,
...
Na konanie rady podľa tohto zákona a osobitného predpisu[26)](#poznamky.poznamka-26) sa nevzťahuje všeobecný predpis o správnom konaní.[110)](#poznamky.poznamka-110)
