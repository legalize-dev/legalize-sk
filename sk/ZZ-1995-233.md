...
získal právnické vzdelanie v Slovenskej republike alebo má uznaný (nostrifikovaný) diplom o vysokoškolskom právnickom vzdelaní vydaný zahraničnou vysokou školou,[3)](#poznamky.poznamka-3)
...
Exekútora vymenuje do exekútorského úradu minister na návrh komory, a to do sídla v obvode súdu prvého stupňa ([§ 15](#paragraf-15)). Návrh na vymenovanie exekútora podáva na základe výberového konania komora.

(2)

Komora uskutoční výberové konanie najneskôr do jedného mesiaca od uvoľnenia miesta exekútora alebo ak ide o zvýšenie počtu exekútorských úradov [[§ 9 písm. b)](#paragraf-9.pismeno-b)]. Ak komora nepodá ministrovi návrh na vymenovanie exekútora do jedného mesiaca od ukončenia výberového konania alebo neuskutoční výberové konanie v ustanovenej lehote, minister môže vymenovať exekútora aj bez tohto návrhu.

(3)

Do výberového konania sa môže prihlásiť v lehote určenej komorou každý, kto spĺňa podmienky podľa [§ 10](#paragraf-10).
...
Zástupcu môže komora ustanoviť z jeho exekútorských kandidátov alebo z exekútorov alebo z ich exekútorských kandidátov v rámci obvodu toho istého súdu prvého stupňa. Za zástupcu exekútora možno ustanoviť exekútorského kandidáta, len ak spĺňa podmienky podľa [§ 12 ods. 1 písm. b)](#paragraf-12.odsek-1.pismeno-b).
...
ak ustanoveným zástupcom je exekútor a výkon jeho exekútorského úradu zanikol ([§ 16](#paragraf-16)),

b)

ak ustanoveným zástupcom je exekútorský kandidát a komora ho vyčiarkne zo zoznamu kandidátov ([§ 27](#paragraf-27)) alebo ak zanikne jeho poistenie zodpovednosti za škodu a ani po upozornení komory ho v určenej lehote neobnoví alebo ak disciplinárna komisia mu odňala právo zastupovať exekútora ([§ 221](#paragraf-221)),
...
je ku dňu zápisu zapísaný v zozname koncipientov a u koho nenastal dôvod na jeho vyčiarknutie podľa [§ 23 ods. 1 písm. a) až f)](#paragraf-23.odsek-1.pismeno-a),
...
Exekútor môže kandidáta písomne splnomocniť na vykonanie jednotlivých úkonov, ktoré sú predmetom exekučnej činnosti. Exekútor však nemôže splnomocniť kandidáta, ktorý nespĺňa podmienky podľa [§ 12 ods. 1 písm. b)](#paragraf-12.odsek-1.pismeno-b), na vydanie upovedomenia o začatí exekúcie, príkazu na začatie exekúcie a exekučného príkazu. Kandidát, ktorý nespĺňa podmienky podľa [§ 12 ods. 1 písm. b)](#paragraf-12.odsek-1.pismeno-b), nemôže vykonať ani dražbu a ani vymáhať nepeňažné plnenia.

##### § 27

(1)

Komora vyčiarkne kandidáta zo zoznamu kandidátov z dôvodov uvedených v [§ 23 ods. 1 písm. a) až f)](#paragraf-23.odsek-1.pismeno-a).
...
Exekútor môže odmietnuť vykonať požadovaný právny úkon aj vtedy, ak žiadateľ nezloží primeraný preddavok na odmenu exekútora a na náhradu jeho hotových výdavkov ([§ 197](#paragraf-197)). Ak oprávnený nezloží preddavok v lehote určenej exekútorom, na návrh exekútora môže súd exekúciu zastaviť ([§ 57 ods. 2](#paragraf-57.odsek-2)). Súd exekúciu nezastaví, ak sú splnené podmienky na oslobodenie podľa osobitného predpisu.[4)](#poznamky.poznamka-4)
...
Začatie exekučného konania bráni tomu, aby v tej istej veci prebiehalo iné exekučné konanie. Ak oprávnený podá návrh na vykonanie exekúcie v tej istej veci niekoľkým exekútorom, exekúciu vykoná ten exekútor, ktorého jej vykonaním poverí súd; v ostatných prípadoch sa exekúcia zastaví [[§ 57 ods. 1 písm. h)](#paragraf-57.odsek-1.pismeno-h)].
...
Ak sa napriek výzve exekútora v určenej lehote návrh neopraví alebo nedoplní a v konaní nemožno pre tento nedostatok pokračovať alebo ak sa nepriloží exekučný titul, na návrh exekútora môže súd exekúciu zastaviť ([§ 57 ods. 2](#paragraf-57.odsek-2)). O týchto následkoch musí byť oprávnený poučený.
...
Od vykonania exekúcie môže exekútor upustiť len vtedy, ak povinný dobrovoľne splní, čo mu ukladá rozhodnutie [[§ 60 písm. b)](#paragraf-60.text.pismeno-b)].
...
Ak súd námietkam vyhovie, exekúciu zastaví ([§ 57 ods. 1](#paragraf-57.odsek-1)).

##### § 51

Pred rozhodnutím o námietkach proti exekúcii vykonávanej na podklade exekučného titulu podľa [§ 41 ods. 2](#paragraf-41.odsek-2) si môže súd vyžiadať vyjadrenie orgánu, ktorý vydal rozhodnutie, prípadne platobný výmer alebo výkaz nedoplatkov, spísal notársku zápisnicu alebo ktorý schválil zmier alebo dohodu.
...
exekúcia postihuje veci, ktoré sú z exekúcie podľa [§ 114 a 115](#paragraf-114) vylúčené,
...
Pred zastavením exekúcie vykonávanej na podklade exekučného titulu podľa [§ 41 ods. 2](#paragraf-41.odsek-2) súd si môže vyžiadať vyjadrenie orgánu, ktorý vydal rozhodnutie, prípadne platobný výmer, výkaz nedoplatkov alebo spísal notársku zápisnicu alebo schválil zmier alebo dohodu.

##### § 60

Poverenie na vykonanie exekúcie vydané exekútorovi podľa [§ 44](#paragraf-44) exekútor bezodkladne vráti súdu, ak a) súd rozhodol o vylúčení exekútora ([§ 30](#paragraf-30)), b) exekútor upustil od vykonania exekúcie ([§ 46 ods. 3](#paragraf-46.odsek-3)), c) súd zastavil exekúciu ([§ 57](#paragraf-57)), d) sa exekučné konanie skončilo vymožením pohľadávky, jej príslušenstva a trov exekúcie.
...
Ak súd povolí odklad exekúcie podľa [§ 56 ods. 1](#paragraf-56.odsek-1), platiteľ mzdy nevykonáva zrážky zo mzdy povinného odo dňa, keď mu exekútor oznámi rozhodnutie súdu o odklade exekúcie, kým mu exekútor nedoručí príkaz, aby sa v zrážkach pokračovalo.

(2)

Ak súd povolí odklad exekúcie podľa [§ 56 ods. 2](#paragraf-56.odsek-3), platiteľ mzdy vykonáva zrážky ďalej, ale nevypláca ich oprávnenému, kým sa odklad exekúcie nezruší. Ak súd zastaví exekúciu, platiteľ mzdy vyplatí zrazené sumy povinnému.

##### § 80

Na návrh povinného môže súd zastaviť exekúciu zrážkami zo mzdy ([§ 57 ods. 2](#paragraf-57.odsek-2)), ak sa zrážky vykonávajú už len na bežné výživné a možno predpokladať, že povinný bude výživné plniť ďalej dobrovoľne.
...
Za nesplnenie povinností uvedených v [§ 84 a 85](#paragraf-84) môže súd na návrh exekútora uložiť povinnému i platiteľovi mzdy poriadkovú pokutu.[5)](#poznamky.poznamka-5)
...
Exekútor vydá exekučný príkaz (príkaz na vykonanie exekúcie prikázaním pohľadávky z účtu v banke) po uplynutí lehoty na vznesenie námietok proti exekúcii alebo po tom, keď mu bolo doručené rozhodnutie súdu o námietkach, ktorým sa námietky zamietli ([§ 50](#paragraf-50)).
...
Ak súd povolí odklad exekúcie podľa [§ 56 ods. 2](#paragraf-56.odsek-3) a ide o rozhodnutie podľa [§ 99](#paragraf-99), banka vykonáva odpisovanie pohľadávky z účtu povinného ďalej, ale odpísané sumy nevypláca oprávnenému, kým sa odklad exekúcie nezruší. Ak súd exekúciu zastaví, vyplatí banka odpísané sumy povinnému.
...
Ak banka nepostupuje tak, ako jej to ukladajú ustanovenia [§ 95](#paragraf-95), [97, 98 a § 99](#paragraf-97), môže sa oprávnený na súde domáhať, aby mu banka zaplatila sumu, na ktorú by mal právo, keby banka postupovala správne, a to aj vtedy, keď už na účte povinného nie je dostatok prostriedkov.
...
Z exekúcie sú vylúčené aj veci podnikateľa hospodáriaceho na pôde,[11a)](#poznamky.poznamka-11a) ak by ich zexekvovaním bolo ohrozené riadne obhospodarovanie poľnohospodárskej pôdy alebo zachovanie plynulej prevádzky rastlinnej a živočíšnej výroby podľa osobitných predpisov.[11b)](#poznamky.poznamka-11b)
...
Cenné papiere na meno, cenné papiere na doručiteľa a cenné papiere na rad (ktoré možno previesť rubopisom)[13)](#poznamky.poznamka-13) možno zexekvovať tak, že exekútor spíše tieto cenné papiere podľa ustanovení o predaji hnuteľných vecí a odníme ich.
...
Znaleckým posudkom sa zistí cena nehnuteľnosti; pritom sa jednotlivo odhadnú závady, ktoré musí vydražiteľ prevziať bez započítania na najvyššie podanie ([§ 153 ods. 1](#paragraf-153.odsek-1)), ako aj závady, ktoré vydražiteľ prevezme so započítaním na najvyššie podanie ([§ 153 ods. 2](#paragraf-153.odsek-2)).
...
Pre opätovnú dražbu platia ustanovenia o prvej dražbe s tým, že najnižšie podanie tvoria dve tretiny ceny určenej znaleckým posudkom. O dražbe upovedomí exekútor aj vydražiteľa uvedeného v odseku 1. Tento vydražiteľ je povinný zaplatiť rozdiel na najvyššom podaní, náklady opätovnej dražby a škodu, ktorá vznikla tým, že nezaplatil najvyššie podanie včas ([§ 152](#paragraf-152)). Táto náhrada pripadne do rozdeľovanej podstaty.
...
Dražiť nemôže exekútor poverený vykonaním exekúcie ([§ 44](#paragraf-44)) ani jeho zamestnanci, zapisovateľ, povinný, vydražiteľ uvedený v [§ 143 ods. 1](#paragraf-143.odsek-1) a ani ten, komu nadobudnúť vec bráni osobitný predpis.
...
Ak sa pri dražbe neurobilo ani najnižšie podanie, exekútor nepokračuje v konaní. V konaní možno pokračovať najskôr po uplynutí troch mesiacov od bezúspešnej dražby. Ak sa nepodarí predať nehnuteľnosť na dražbe do jedného roka od vydania exekučného príkazu, môže súd na návrh exekútora exekúciu predajom tejto nehnuteľnosti zastaviť ([§ 57 ods. 2](#paragraf-57.odsek-2)).
...
Udelenie príklepu podlieha schváleniu súdom ([§ 45](#paragraf-45)). Proti rozhodnutiu súdu o príklepe nie je prípustné odvolanie.

(2)

Rozhodnutie súdu o príklepe doručí exekútor oprávnenému, povinnému, vydražiteľovi, tým, ktorí vzniesli proti udeleniu príklepu námietky ([§ 147](#paragraf-147)), a katastrálnemu úradu na zápis do katastra nehnuteľností.
...
Po skončení rozvrhového pojednávania nemožno žiadať z najvyššieho podania sumu vyššiu, než bola prihlásená [[§ 140 ods. 2 písm. i)](#paragraf-140.odsek-2.pismeno-i)].
...
Rozvrh výťažku podlieha schváleniu súdom ([§ 45](#paragraf-45)). Proti rozhodnutiu súdu o rozvrhu výťažku nie je prípustné odvolanie.
...
po uplynutí lehoty na vznesenie námietok alebo po tom, keď sa mu doručí rozhodnutie súdu o námietkach, ktorým sa námietky zamietli ([§ 50](#paragraf-50)), vydá exekučný príkaz (príkaz na vykonanie exekúcie odobratím veci) a odobratú vec so všetkým, čo k nej patrí, odovzdá oprávnenému.
...
Ak exekútor vykonáva činnosť podľa [§ 193](#paragraf-193), náklady hradí žiadateľ.

(2)

Ak exekútor vykonáva činnosť podľa [§ 194 a 195](#paragraf-194), o tom, ktorá zo sporových strán uhradí náklady za činnosť exekútora a v akej výške, rozhodne súd.
