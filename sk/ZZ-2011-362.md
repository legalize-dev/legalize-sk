...
Štátny ústav uloží pokutu za iné správne delikty podľa odseku 1 písm. a) až u), x) až ao), aq a ar), odseku 3 písm. a) až s), v) až af) a am) až ap), odsekov 4, 5 písm. bb), 6 až 23, 25, 26 a 29 a [§ 138a](#paragraf-138a) od 300 eur do 35 000 eur.
