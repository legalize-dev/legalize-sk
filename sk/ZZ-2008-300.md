...
úlohy v oblasti štátnej podpory vrcholového a výkonnostného športu[1)](#poznamky.poznamka-1) (ďalej len „šport“), starostlivosti o športové talenty a športovania detí, žiakov a študentov,
...
Vláda utvára podmienky pre športovú reprezentáciu, na prípravu športových talentov, na športovanie detí, žiakov a študentov a pre výstavbu športovej infraštruktúry osobitného významu.
...
iné zdroje.[4a)](#poznamky.poznamka-4a)
...
úhradu výdavkov podľa osobitného predpisu.[4b)](#poznamky.poznamka-4b)

##### § 11a

##### Žiadateľom o poskytnutie dotácie podľa [§ 11 ods. 1](#paragraf-11.odsek-1)(ďalej len „žiadateľ“) môže byť
...
vymedzenie a odôvodnenie konkrétnych aktivít, na ktoré sa dotácia požaduje, vrátane označenia oblasti podľa [§ 11 ods. 1](#paragraf-11.odsek-1),
...
ďalšie náležitosti podľa osobitného predpisu.[4c)](#poznamky.poznamka-4c)
...
Komisia má najmenej troch členov. Člen komisie alebo jemu blízka osoba[4d)](#poznamky.poznamka-4d) nesmie byť
...
Komisia je pri vyhodnocovaní žiadostí nezávislá a vyhodnocuje ich podľa kritérií uvedených vo výzve podľa [§ 11b ods. 2 písm. f).](#paragraf-11b.odsek-2.pismeno-f)
...
znenia predložených žiadostí okrem náležitostí podľa [§ 11b ods. 5 písm. e) až g),](#paragraf-11b.odsek-5.pismeno-e)
...
podmienky poskytnutia dotácie, ktorých nesplnenie je spojené s povinnosťou jej vrátenia,[4e)](#poznamky.poznamka-4e)
...
Ministerstvo vykonáva kontrolu použitia poskytnutej dotácie podľa osobitného predpisu.[4f)](#poznamky.poznamka-4f)
...
Ak žiadateľ poruší finančnú disciplínu, postupuje sa podľa osobitného predpisu.[4g)](#poznamky.poznamka-4g)

(4)

Týmto zákonom nie sú dotknuté osobitné predpisy o štátnej pomoci.[4h)](#poznamky.poznamka-4h)

(5)

Týmto zákonom nie sú dotknuté ustanovenia o obmedzení prístupu k informáciám podľa osobitného predpisu.[4i)](#poznamky.poznamka-4i)
...
Ministerstvo podporuje športovanie detí, žiakov a študentov v rámci uskutočňovania rozvojových projektov a programov a organizovaním a financovaním školských športových súťaží na celoštátnej a regionálnej úrovni.
...
Ministerstvo uloží pokutu do 1 659,50 eura národnému športovému zväzu, športovému klubu a vzdelávacej inštitúcii za porušenie oznamovacej povinnosti podľa [§ 30](#paragraf-30).
