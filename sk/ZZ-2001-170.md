...
Pri kontrole plnenia povinností podľa tohto ustanovenia zákona postupuje colný úrad podľa osobitného predpisu.[9h)](#poznamky.poznamka-9h)

(5)

Ak má podnikateľ nárok na vrátenie spotrebnej dane podľa osobitného predpisu,[9i)](#poznamky.poznamka-9i) vzniká mu nárok na vrátenie poplatku. Pri vrátení poplatku alebo jeho časti postupuje podnikateľ a colný úrad primerane podľa osobitného predpisu.[9i)](#poznamky.poznamka-9i) Poplatok je možné vrátiť podnikateľovi,

a)

ktorý vybrané ropné výrobky dodal na územie iného členského štátu osobe na podnikateľské účely a ak uskutočnenie dodania vybraných ropných výrobkov na územie iného členského štátu preukázal podľa osobitného predpisu,[9i)](#poznamky.poznamka-9i)

b)

ktorý vybrané ropné výrobky vyviezol na územie tretieho štátu a uskutočnenie vývozu doložil podľa osobitného predpisu,[9i)](#poznamky.poznamka-9i)
...
údaj o výške príjmu za úhradu poplatku podľa vybraných ropných výrobkov uvedených v [prílohe č. 4 štvrtom bode](#prilohy.priloha-4.op-zaklad_poplatku_vypocet_a_sadzba_poplatku.op-bod_4) s uvedením ich množstva,

b)

údaj o výške uplatneného nároku na vrátenie poplatku, a to v členení podľa vybraných ropných výrobkov uvedených v [prílohe č. 4 štvrtom bode](#prilohy.priloha-4.op-zaklad_poplatku_vypocet_a_sadzba_poplatku.op-bod_4),
