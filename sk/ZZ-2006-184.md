...
Ten, kto chce pestovať modifikované rastliny, ktorých pestovanie nebolo obmedzené alebo zakázané podľa [§ 8a ods. 1](#paragraf-8a.odsek-1), je povinný tento zámer oznámiť Ústrednému kontrolnému a skúšobnému ústavu poľnohospodárskemu (ďalej len „kontrolný ústav“) na tlačive vydanom kontrolným ústavom.
...
Kontrolný ústav do piatich pracovných dní odo dňa uplynutia hospodárskeho roka,[4a)](#poznamky.poznamka-4a) v ktorom nadobudne účinnosť nariadenie vlády vydané podľa [§ 8a ods. 1](#paragraf-8a.odsek-1),
...
vyradí pestovateľa z evidencie pestovateľov, ak sa zákaz podľa [§ 8a ods. 3](#paragraf-8a.odsek-3) týka všetkých modifikovaných rastlín pestovaných pestovateľom a bezodkladne o tejto skutočnosti informuje pestovateľa.
...
dodržať minimálne izolačné vzdialenosti medzi modifikovanými rastlinami a geneticky nemodifikovanými rastlinami rovnakého alebo príbuzného botanického druhu stanovené pre jednotlivé plodiny podľa [§ 13 písm. a)](#paragraf-13.pismeno-a), ktoré sú pestované na okolitých pozemkoch,
...
môže do 45 dní odo dňa doručenia hodnotiacej správy[10a)](#poznamky.poznamka-10a) alebo stanoviska orgánu Európskej únie[10b)](#poznamky.poznamka-10b) v konaní o súhlase s uvedením výrobku na trh alebo v konaní o obnovení súhlasu na uvedenie výrobku na trh zaslať Európskej komisii žiadosť o vyňatie územia Slovenskej republiky z pestovania modifikovanej rastliny, ktorej sa týka hodnotiaca správa alebo stanovisko orgánu Európskej únie, a o úpravu geografického rozsahu tohto povolenia,
...
oznamuje Európskej komisii návrh obmedzenia alebo zákazu podľa [§ 8a ods. 1](#paragraf-8a.odsek-1); túto skutočnosť zároveň oznámi kontrolnému ústavu,

h)

oznamuje Európskej komisii a členským štátom Európskej únie zrušenie obmedzenia alebo zákazu podľa [§ 8a ods. 1](#paragraf-8a.odsek-1),

i)

zverejňuje na svojom webovom sídle zoznam modifikovaných rastlín, ktorých pestovanie je obmedzené alebo zakázané podľa [§ 8a ods. 1.](#paragraf-8a.odsek-1)
...
predchádzaním prítomnosti geneticky modifikovaných organizmov v iných produktoch bez toho, aby bol dotknutý [§ 5](#paragraf-5) a technické opatrenia podľa [§ 13 písm. a)](#paragraf-13.pismeno-a),
...
Postup podľa odseku 1 možno uplatniť z dôvodov podľa odseku 1 písm. a) až f) samostatne alebo v kombinácií okrem dôvodu uvedeného v odseku 1 písm. g), ktorý nemožno uplatniť samostatne; uplatnené dôvody nesmú byť v rozpore s posudzovaním environmentálneho rizika.[11a)](#poznamky.poznamka-11a)

(3)

Pestovanie modifikovaných rastlín určených nariadením vlády vydaným podľa odseku 1 je obmedzené alebo zakázané po uplynutí hospodárskeho roka,[4a)](#poznamky.poznamka-4a) v ktorom nariadenie vlády nadobúda účinnosť; tým nie je dotknuté uvádzanie osiva modifikovaných rastlín a výrobkov z nich na trh.[11b)](#poznamky.poznamka-11b) Nariadenie vlády podľa odseku 1 môže nadobudnúť účinnosť najneskôr tri mesiace pred uplynutím hospodárskeho roka[4a)](#poznamky.poznamka-4a) podľa prvej vety.
...
Na priestupky a ich prejednávanie sa vzťahuje všeobecný predpis o priestupkoch.[12)](#poznamky.poznamka-12)
...
Na konanie o vyradení z evidencie pestovateľov podľa [§ 3 ods. 7](#paragraf-3.odsek-7) sa vzťahuje správny poriadok.

##### § 14a

##### Transpozičné ustanovenie

Týmto zákonom sa preberajú právne záväzné akty Európskej únie uvedené v [prílohe](#prilohy.priloha-priloha_k_zakonu_c_184_2006_z_z.oznacenie).
