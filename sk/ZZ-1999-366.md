...
Príjmom podľa odseku 1 sa rozumie peňažný príjem i nepeňažný príjem dosiahnutý aj zámenou vrátane zisteného majetkového prírastku podľa osobitného predpisu[1a)](#poznamky.poznamka-1a) nadobudnutého z príjmov daňovníka, ktoré neboli podľa tohto zákona zdanené.[1a)](#poznamky.poznamka-1a)
...
z odpisu záväzkov pri konkurze a vyrovnaní vykonaných podľa osobitného predpisu;[9)](#poznamky.poznamka-9)
...
Ak ide o predaj nehnuteľností uvedených v odseku 1 písm. a) alebo b) po zániku a vyporiadaní bezpodielového spoluvlastníctva manželov,[32a)](#poznamky.poznamka-32a) do lehoty uvedenej v odseku 1 písm. a) alebo b) sa započítava doba, počas ktorej bola takáto nehnuteľnosť v bezpodielovom spoluvlastníctve manželov.
...
Do základu dane sa nezahŕňajú príjmy oslobodené od dane, príjmy, pre ktoré je ustanovené, že sa z nich daň vyrubí sadzbou dane podľa [§ 13 ods. 9](#paragraf-13.odsek-9) a príjmy, pre ktoré je ďalej ustanovené, že sa z nich daň vyberá osobitnou sadzbou podľa [§ 36](#paragraf-36) zo samostatného základu dane.
...
Ak daňovník nepoužije príjmy oslobodené od dane podľa [4 ods. 1 písm. m)](#paragraf-4.odsek-1.pismeno-m) v súlade s [§ 4 ods. 1 písm. m)](#paragraf-4.odsek-1.pismeno-m), tieto príjmy sú základom dane v tom zdaňovacom období, do ktorého konca ich mal použiť v súlade s [§ 4 ods. 1 písm. m)](#paragraf-4.odsek-1.pismeno-m). Ak daňovník použije alebo používal rodinný dom alebo bytový dom (byt), alebo jeho časť, na ktorých obstaranie použil príjmy oslobodené od dane podľa [§ 4 ods. 1 písm. m)](#paragraf-4.odsek-1.pismeno-m), na podnikanie alebo inú samostatnú zárobkovú činnosť, alebo na prenájom do piatich rokov po uplynutí zdaňovacieho obdobia, v ktorom mal daňovník príjem oslobodený od dane podľa [§ 4 ods. 1 písm. m)](#paragraf-4.odsek-1.pismeno-m), musí zahrnúť do základu dane tú časť príjmov, ktorá zodpovedá pomeru, v akom tento rodinný dom alebo bytový dom (byt), alebo jeho časť používa na podnikanie alebo inú samostatnú zárobkovú činnosť, alebo na prenájom. V takomto prípade sa pomerná časť príjmov oslobodených od dane podľa [§ 4 ods. 1 písm. m)](#paragraf-4.odsek-1.pismeno-m) zahrnie do základu dane v tom zdaňovacom období, v ktorom sa používal rodinný dom alebo bytový dom (byt), alebo jeho časť na podnikanie alebo inú samostatnú zárobkovú činnosť alebo na prenájom.
...
plnenie zo sociálneho fondu podľa osobitného predpisu[35)](#poznamky.poznamka-35) poskytnuté zamestnancovi najviac do výšky 2000 Sk ročne od jedného zamestnávateľa; do tejto sumy sa nezapočítava hodnota ostatných plnení poskytnutých zo sociálneho fondu uvedených v tomto odseku,
...
Základom dane (čiastkovým základom dane) sú príjmy uvedené v odsekoch 1 až 3 s výnimkou uvedenou v odseku 8, znížené o daňové výdavky vynaložené na ich dosiahnutie, zabezpečenie a udržanie ([§ 24](#paragraf-24)). Ak daňovníkovi okrem príjmov podľa odseku 1 písm. a) plynú aj iné druhy príjmov podľa [§ 6 až 10](#paragraf-6), a úhrn príjmov podľa odseku 1 písm. a) tvorí viac ako 50 % z celkových príjmov podľa [§ 6 až 10](#paragraf-6), do základu dane (čiastkového základu dane) z príjmov podľa [§ 7](#paragraf-7) sa nezahŕňajú príjmy podľa odseku 1 písm. a); z príjmov podľa odseku 1 písm. a) sa základ dane vyčísľuje osobitne a zdaňuje sa podľa [§ 13 ods. 8](#paragraf-13.odsek-8). Na zistenie základu dane (čiastkového základu dane) sa použijú ustanovenia [§ 23 až 34](#paragraf-23). Príjmy uvedené v odseku 1 písm. d) sa môžu znížiť len za podmienok uvedených v odseku 7. Príjmy uvedené v [§ 22 ods. 1 písm. d) bodoch 1 až 3](#paragraf-22.odsek-1.pismeno-d) plynúce daňovníkom uvedeným v [§ 2 ods. 3](#paragraf-2.odsek-3) sú samostatným základom dane na zdanenie osobitnou sadzbou dane ([§ 36](#paragraf-36)). Výška odpusteného dlhu alebo jeho časti sa zahrnie u dlžníka do základu dane v tom zdaňovacom období, v ktorom bol dlh odpustený.
...
pri príjmoch z predaja tuzemských cenných papierov prijatých na trh burzy cenných papierov[6)](#poznamky.poznamka-6) vrátane spätného predaja (vyplatenia) tuzemských podielových listov znížených o výdavky podľa odseku 5 je suma prevyšujúca 50 000 Sk,
...
Zistené majetkové prírastky, ktoré sú predmetom dane, sú samostatným základom dane na vyrubenie dane sadzbou podľa [§ 13 ods. 9](#paragraf-13.odsek-9).
...
Daň je zo základu dane zníženého podľa [§ 12](#paragraf-12), zaokrúhleného na celé stovky Sk nadol
...
Daňovník, ktorý má príjmy len podľa [§ 7 ods. 1 písm. a), b) alebo c)](#paragraf-7), ktorého daň zo základu dane zníženého podľa [§ 12](#paragraf-12) vypočítaná podľa odseku 1 je vyššia ako daň vypočítaná sadzbou podľa [§ 21 ods. 1](#paragraf-21.odsek-1), môže znížiť daň o tento rozdiel, ak sumu, o ktorú znížil daň, vynaloží najneskôr do skončenia tretieho zdaňovacieho obdobia od zdaňovacieho obdobia, v ktorom uplatnil zníženie dane, na obstaranie hmotného investičného majetku, o ktorom bude účtovať ako o majetku využívanom na podnikanie [[§ 7 ods. 1 písm. a), b) a c)](#paragraf-7)] najmenej tri zdaňovacie obdobia. To platí aj vtedy, ak dedič daňovníka pokračuje v podnikaní daňovníka a vynaloží sumu, o ktorú si daňovník znížil daň do konca tretieho zdaňovacieho obdobia od zdaňovacieho obdobia, v ktorom uplatnil zníženie dane pôvodný daňovník.

(4)

Daňovník, ktorého základ dane tvorí súčet čiastkových základov dane, a jedným z nich je aj čiastkový základ dane z príjmov podľa [§ 7 ods. 1 písm. a), b), alebo c)](#paragraf-7), si môže uplatniť zníženie dane podľa odseku 3 v pomere zodpovedajúcom pomeru čiastkového základu dane z príjmov podľa [§ 7 ods. 1 písm. a), b) alebo c)](#paragraf-7) k základu dane.
...
Možnosť zníženia dane podľa odseku 3 sa nevzťahuje na daňovníka, ktorý uplatní postup podľa [§ 7 ods. 14](#paragraf-7.odsek-14) alebo uplatní zníženie dane podľa odseku 8.
...
Daň vyrubená zo zistených majetkových prírastkov, ktoré sú predmetom dane ([§ 3 ods. 2](#paragraf-3.odsek-2)), je 38 %.
...
ktorého úhrn príjmov z činností podľa odseku 1 v predchádzajúcom zdaňovacom období s výnimkou príjmov zdaňovaných osobitnou sadzbou dane ([§ 36](#paragraf-36)) nepresiahol 2 000 000 Sk a
...
úhrn jeho príjmov z činností podľa odseku 1 s výnimkou príjmov zdaňovaných osobitnou sadzbou dane ([§ 36](#paragraf-36)) v bežnom zdaňovacom období presiahne sumu 2 000 000 Sk, alebo
...
V zdaňovacom období, v ktorom sa daňovník rozhodne platiť paušálnu daň, je príjmom podľa odseku 1 aj suma vytvorenej rezervy uznaná za daňový výdavok podľa [§ 24 ods. 2 písm. h)](#paragraf-24.odsek-2.pismeno-h), ak v tomto zdaňovacom období pominuli dôvody, pre ktoré bola táto rezerva vytvorená.
...
príjmy štátnych fondov, príjmy Úradu pre finančný trh[78a)](#poznamky.poznamka-78a) a príjmy Fondu ochrany vkladov,[78)](#poznamky.poznamka-78) ktoré sú ustanovené ako zdroj príjmov osobitnými predpismi[79)](#poznamky.poznamka-79) okrem príjmov, z ktorých sa daň vyberá osobitnou sadzbou ([§ 36](#paragraf-36)),

f)

príjmy plynúce z odpisu záväzkov pri konkurze a vyrovnaní vykonaných podľa osobitného predpisu,[9)](#poznamky.poznamka-9)
...
príjmy vysokých škôl a fakúlt[80)](#poznamky.poznamka-80) a príjmy základných škôl a stredných škôl a školských zariadení[80a)](#poznamky.poznamka-80a) získané z podnikateľskej činnosti vykonávanej v súvislosti s plnením ich hlavných úloh s výnimkou príjmov, z ktorých sa daň vyberá osobitnou sadzbou ([§ 36](#paragraf-36)).
...
Od základu dane možno odpočítať aj príspevok do výšky 0,35 % z objemu zúčtovaných miezd zaplatený najviac jednému združeniu právnických osôb, vyplývajúci z členstva v tomto združení založenému na účel ochrany záujmov platiteľa okrem príspevku, ktorého povinnosť úhrad vyplýva priamo zo zákona a príspevok je súčasťou výdavkov podľa [§ 24 ods. 3 písm. a)](#paragraf-24.odsek-3).
...
zvýši o sumy podľa [§ 24 ods. 3](#paragraf-24.odsek-3), ak neboli zaplatené do konca mesiaca nasledujúceho po zdaňovacom období, v ktorom sa o platbe účtovalo, ak ide o daňovníka, ktorý účtuje v sústave podvojného účtovníctva,
...
zníži o sumy podľa [§ 24 ods. 3](#paragraf-24.odsek-3), ktoré neboli zaplatené do konca mesiaca nasledujúceho po zdaňovacom období, v ktorom sa o platbe účtovalo, v tom zdaňovacom období, v ktorom k takémuto zaplateniu došlo,
...
výnos z dlhopisov[30)](#poznamky.poznamka-30) alebo jeho pomerná časť zahŕňaná do nákladov alebo príjmov pri predaji dlhopisov a pri ich splatení s výnimkou predaja dlhopisov osobám, ktoré nemajú bydlisko alebo sídlo na území Slovenskej republiky,
...
Pri trvalom upustení od vymáhania nepremlčanej pohľadávky alebo jej časti na základe písomnej dohody veriteľa a dlžníka alebo na základe písomného oznámenia veriteľa o trvalom upustení od vymáhania takejto pohľadávky alebo jej časti, pri uplatnení odpisu takejto pohľadávky veriteľom do daňových výdavkov podľa [§ 24 ods. 2 písm. s) siedmeho bodu](#paragraf-24.odsek-2.pismeno-s.bod-7) zahrnie dlžník odpustenú sumu záväzku do základu dane v tom zdaňovacom období, v ktorom má veriteľ podľa písomnej dohody zahrnúť odpis takejto pohľadávky do daňových výdavkov alebo v ktorom mu bolo doručené oznámenie o trvalom upustení od vymáhania pohľadávky.

(28)

Základ dane sa pri rozpustení opravných položiek, rozpustení rezerv a účtovaní zostatkov ostatných účtov nákladov na účet nerozdeleného hospodárskeho výsledku[68a)](#poznamky.poznamka-68a) zvyšuje o zaúčtovanú výšku zostatkov týchto účtov, ak ich tvorba je považovaná za daňový výdavok podľa tohto zákona.
...
osobné dopravné prostriedky (kód Klasifikácie produkcie 35.12 a 35.3) odpisované podľa [§ 24 ods. 2 písm. a) druhého a tretieho bodu](#paragraf-24.odsek-2.pismeno-a.bod-2) vrátane tých, ktoré boli nadobudnuté pred rokom 2000 a nevzťahuje sa na tieto osobné dopravné prostriedky limit odpisovania,

zostatková cena likvidovaného stavebného objektu alebo jeho časti v súvislosti s výstavbou nového stavebného objektu alebo jeho technickým zhodnotením sa v súlade s osobitným predpisom zahrnie do obstarávacej (vstupnej, zvýšenej vstupnej alebo zostatkovej) ceny;[5)](#poznamky.poznamka-5)
...
príspevok maximálne vo výške 1 000 Sk ročne na ubytovanie v zariadeniach cestovného ruchu na území Slovenskej republiky počas dovolenky zamestnanca alebo osoby samostatne zárobkovo činnej, ktoré sú podľa tohto zákona daňovníkmi dane z príjmov fyzických osôb podľa [§ 2 ods. 1](#paragraf-2) a majú príjmy podľa [§ 6 ods. 1 písm. a) a b)](#paragraf-6) alebo príjmy podľa [§ 7 ods. 1 písm. a), b) a c)](#paragraf-7);
...
na tvorbu opravnej položky podľa [§ 25 ods. 1 písm. v) tretieho bodu](#paragraf-25.odsek-1.pismeno-v.bod-3),

3.

na tvorbu opravnej položky k pochybným a stratovým pohľadávkam v bankovníctve podľa osobitného predpisu[90)](#poznamky.poznamka-90) alebo

4.

na odpis menovitej hodnoty pohľadávky podľa [§ 24 ods. 2 písm. s) siedmeho bodu](#paragraf-24.odsek-2.pismeno-s.bod-7), ktoré sa zahŕňajú do výdavkov (nákladov) do výšky účtovanej[68a)](#poznamky.poznamka-68a) v nákladoch,
...
o trvalom upustení od vymáhania nepremlčanej pohľadávky bolo účtované[68a)](#poznamky.poznamka-68a) v nákladoch, počnúc 1. januárom 2003.
...
tvorba opravných položiek[5)](#poznamky.poznamka-5) s výnimkou

1.

opravných položiek, o ktorých osobitný zákon ustanoví, že sú daňovým výdavkom podľa [§ 24 ods. 1](#paragraf-24.odsek-1),

2.

opravnej položky k nadobudnutému majetku zahrnovanej do výdavkov alebo príjmov v súlade s účtovnými predpismi,[5)](#poznamky.poznamka-5) pričom u daňovníka účtujúceho v sústave jednoduchého účtovníctva je doba zahrnovania rovnaká ako u daňovníka účtujúceho v sústave podvojného účtovníctva,
...
odplaty (provízie) za sprostredkovanie, a to aj za sprostredkovanie na základe mandátnych zmlúv alebo podobných zmlúv[97)](#poznamky.poznamka-97) s výnimkou uvedenou v [§ 24 ods. 3 písm. h)](#paragraf-24.odsek-3.pismeno-h) a [m)](#paragraf-24.odsek-3.pismeno-m),
...
prevedie hmotný majetok štátu v dôsledku delimitácie na inú rozpočtovú organizáciu alebo príspevkovú organizáciu[77)](#poznamky.poznamka-77) alebo rozpočtovú organizáciu alebo príspevkovú organizáciu zriadenú obcou;[77)](#poznamky.poznamka-77)
...
daňovník, ktorý nadobudol hmotný majetok a nehmotný majetok v dôsledku delimitácie štátnych organizácií[113)](#poznamky.poznamka-113) alebo rozpočtových organizácií alebo príspevkových organizácií zriadených obcou[77)](#poznamky.poznamka-77),
...
bezodplatne prevedený hmotný majetok po ukončení nájomnej zmluvy s dojednaným právom kúpy prenajatej veci a hmotný majetok, pri ktorom náklady s obstaraním neprevýšia sumu 30 000 Sk pri zaradení do majetku podľa osobitného predpisu,[5)](#poznamky.poznamka-5)
...
Technickým zhodnotením sa na účely tohto zákona rozumejú výdavky na dokončené nadstavby, prístavby a stavebné úpravy,[107)](#poznamky.poznamka-107) rekonštrukcie a modernizácie prevyšujúce pri jednotlivom hmotnom majetku a nehmotnom majetku 30 000 Sk v úhrne za zdaňovacie obdobie.
...
je jeho poskytnutie v súlade s osobitným predpisom.[123a)](#poznamky.poznamka-123a)
...
Pri uplatňovaní daňového úveru podľa odsekov 1 až 9 musia byť splnené aj ustanovenia osobitného predpisu.[123a)](#poznamky.poznamka-123a)

##### § 35b

(1)

Daňovník uvedený v [§ 17 ods. 2](#paragraf-17.odsek-2), ktorému bolo vydané rozhodnutie o poskytnutí investičných stimulov obsahujúce úľavu na dani podľa osobitného predpisu,[128a)](#poznamky.poznamka-128a) ktorý bol založený po 1. decembri 2001 v súvislosti s vydaním rozhodnutia o poskytnutí investičných stimulov[128b)](#poznamky.poznamka-128b) a ktorý si neuplatňuje nárok na úľavu na dani podľa [§ 35](#paragraf-35) alebo [§ 35a](#paragraf-35a), môže si uplatniť nárok na zníženie dane vykázanej v daňovom priznaní (ďalej len „daňový úver“), ak splní podmienky ustanovené osobitným predpisom[128a)](#poznamky.poznamka-128a) a podmienku uvedenú v odseku 5.
...
Nárok na daňový úver si daňovník môže uplatniť najviac do výšky, ktorá v priebehu zdaňovacích období, za ktoré sa uplatňuje úľava na dani, v úhrne nepresiahne hodnotu uvedenú pre tento druh investičného stimulu v rozhodnutí o poskytnutí investičných stimulov.[128c)](#poznamky.poznamka-128c)
...
V zdaňovacom období, za ktoré daňovník uplatňuje nárok na daňový úver podľa odseku 2, daňovník je povinný uplatniť odpisy podľa [§ 26 až 33](#paragraf-26), pričom počas uplatňovania úľavy na dani nemožno odpisovanie prerušiť ([§ 26 ods. 9](#paragraf-26.odsek-9)).

(7)

Daňovník, ktorý si uplatňuje nárok na úľavu na dani, môže daňové straty vykázané za zdaňovacie obdobia bezprostredne predchádzajúce zdaňovaciemu obdobiu, za ktoré si prvýkrát uplatňuje nárok na daňový úver, odpočítať od základu dane rovnomerne počas piatich zdaňovacích období bezprostredne nasledujúcich po zdaňovacom období, v ktorom si poslednýkrát uplatnil nárok na daňový úver. V tom prípade sa na daňovníka nepoužije [§ 34](#paragraf-34).

(8)

Ak daňovník nesplní podmienku uvedenú v odseku 5 alebo niektorú zo všeobecných podmienok ustanovených osobitným predpisom,[128a)](#poznamky.poznamka-128a) nárok na daňový úver zaniká a daňovník je povinný podať dodatočné daňové priznania za všetky zdaňovacie obdobia, za ktoré si nárok na daňový úver uplatnil.

(9)

Na daňovníka, ktorý čerpá daňový úver, sa vzťahujú ustanovenia o daňovej kontrole a ustanovenia o štátnej pomoci podľa osobitných predpisov.[128c)](#poznamky.poznamka-128c)

##### § 35c

(1)

Daňovník uvedený v [§ 17 ods. 2](#paragraf-17.odsek-2), ktorému bolo vydané rozhodnutie o poskytnutí investičných stimulov obsahujúce úľavu na dani podľa osobitného predpisu,[128a)](#poznamky.poznamka-128a) môže si uplatniť nárok na daňový úver do výšky podľa odseku 2, ak splní podmienky podľa osobitného predpisu[128a)](#poznamky.poznamka-128a) a neuplatňuje si nárok na daňový úver podľa [§ 35](#paragraf-35), [35a a 35b](#paragraf-35a).
...
hodnoty investície, pre ktorú boli poskytnuté investičné stimuly podľa osobitného predpisu,[128a)](#poznamky.poznamka-128a) najviac však do úhrnnej výšky obstarávacej ceny hmotného majetku a nehmotného majetku tejto investície obstaraného po vydaní rozhodnutia o poskytnutí investičných stimulov do konca zdaňovacieho obdobia, za ktoré sa uplatňuje nárok na daňový úver, a

b)

súčtu hodnoty vlastného imania daňovníka vykázaného v účtovnej závierke za kalendárny rok, v ktorom bolo vydané rozhodnutie o poskytnutí investičných stimulov podľa osobitného predpisu,[128a)](#poznamky.poznamka-128a) a hodnoty investície uvedenej v písmene a).
...
Na daňovníka, ktorý si uplatňuje nárok na daňový úver podľa odsekov 1 až 3, vzťahuje sa obdobne [§ 35b ods. 3 až 6](#paragraf-35b.odsek-3), [8 a 9](#paragraf-35b.odsek-8).
...
ak nejde o príjmy od dane oslobodené, príjmy vylúčené zo zdanenia podľa [§ 54](#paragraf-54) a o príjmy, z ktorých sa daň vyberá osobitnou sadzbou ([§ 36](#paragraf-36)). Priznanie je povinný podať daňovník aj vtedy, ak nemožno zraziť preddavok na daň alebo daň ([§ 41](#paragraf-41)) alebo ak nepožiadal platiteľa dane o vykonanie ročného zúčtovania preddavkov na daň ([§ 44](#paragraf-44)), alebo nepredložil v ustanovenom termíne platiteľovi dane potrebné doklady ([§ 44 ods. 6](#paragraf-44.odsek-6)), alebo ak ide o platiteľa dane podľa [§ 44 ods. 9](#paragraf-44.odsek-9).

(4)

Priznanie nie je povinný podať daňovník, ktorý má v zdaňovacom období príjmy len podľa [§ 6](#paragraf-6) a len od jedného platiteľa dane a nie je povinný podať priznanie podľa odseku 3.
...
Platenie preddavkov na daň podľa predchádzajúcich odsekov sa nevzťahuje na daňovníka, ktorý platí paušálnu daň ([§ 15](#paragraf-15)), na príjmy zdaňované osobitnou sadzbou dane ([§ 36](#paragraf-36)) a na príjmy zo závislej činnosti a funkčné požitky, ktoré sú zdaňované podľa [§ 41](#paragraf-41), ak nemá daňovník súčasne iné príjmy podliehajúce dani s výnimkou príjmov zdaňovaných paušálnou daňou.
...
príspevky na doplnkové dôchodkové poistenie, ktoré platí zamestnanec podľa osobitného predpisu,[41)](#poznamky.poznamka-41) najviac do výšky 10 % úhrnu príjmov zo závislej činnosti a z funkčných požitkov; ak 10 % úhrnu týchto príjmov presahuje v kalendárnom mesiaci 1/12 sumy uvedenej v [§ 6 ods. 12 písm. b)](#paragraf-6.odsek-12.pismeno-b), najviac do výšky tejto jednej dvanástiny,
...
Nárok na uplatnenie zníženia úhrnu príjmov zo závislej činnosti alebo z funkčných požitkov podľa [§ 41 ods. 1 písm. c)](#paragraf-41.odsek-1.pismeno-c) preukazuje daňovník platnou zamestnaneckou zmluvou.[41)](#poznamky.poznamka-41)
...
Daňovník, ktorý v zdaňovacom období poberal zdaniteľnú mzdu len od jedného platiteľa dane, môže tohto platiteľa dane písomne požiadať najneskôr do 15. februára po uplynutí zdaňovacieho obdobia o vykonanie ročného zúčtovania preddavkov z úhrnnej sumy zdaniteľnej mzdy, ktorú mu za zdaňovacie obdobie vyplatil. Ak uvedený daňovník nepožiada o ročné zúčtovanie preddavkov, je povinný podať priznanie ([§ 38](#paragraf-38)).

(2)

Daňovník, ktorý poberal v zdaňovacom období zdaniteľnú mzdu od viacerých platiteľov dane, je povinný podať priznanie ([§ 38](#paragraf-38)).

(3)

Ročné zúčtovanie preddavkov vykoná platiteľ dane na žiadosť daňovníka uvedeného v odseku 1. Ak daňovník v zdaňovacom období neuplatňoval nárok na nezdaniteľné časti základu dane alebo sumu podľa [§ 6 ods. 12 písm. b)](#paragraf-6.odsek-12.pismeno-b), platiteľ dane na ne prihliadne dodatočne pri ročnom zúčtovaní preddavkov.
...
že nepoberal v uplynulom zdaňovacom období od ďalších platiteľov dane príjmy zo závislej činnosti a funkčné požitky okrem príjmov, z ktorých sa daň vyberá osobitnou sadzbou ([§ 36](#paragraf-36)), a okrem príjmov, ktoré nie sú predmetom dane alebo sú od dane oslobodené,
...
Ak daňovník nemôže požiadať platiteľa dane o vykonanie ročného zúčtovania preddavkov z dôvodu zániku platiteľa dane bez právneho nástupcu, podá priznanie podľa [§ 38](#paragraf-38).
...
Daň a penále sa zaokrúhľujú na celé koruny nahor. To platí aj na zaokrúhľovanie sumy zodpovedajúcej 1 % zaplatenej dane podľa [§ 48](#paragraf-48).
...
občianske združenie,[131a)](#poznamky.poznamka-131a)

b)

nadácia,[131b)](#poznamky.poznamka-131b)

c)

neinvestičný fond,[131c)](#poznamky.poznamka-131c)

d)

nezisková organizácia poskytujúca všeobecne prospešné služby,[131d)](#poznamky.poznamka-131d)

e)

účelové zariadenie cirkvi a náboženskej spoločnosti,[131e)](#poznamky.poznamka-131e)

f)

organizácia s medzinárodným prvkom,[131f)](#poznamky.poznamka-131f)
...
daňovník predloží vyhlásenie správcovi dane podľa odseku 1 do 15 dní po uplynutí lehoty na zaplatenie dane podľa osobitného predpisu;[125)](#poznamky.poznamka-125) ak ide o daňovníka, ktorému platiteľ dane vykonal ročné zúčtovanie preddavkov, daňovník predloží takéto vyhlásenie do konca apríla roku, v ktorom sa vykonáva ročné zúčtovanie preddavkov za predchádzajúce zdaňovacie obdobie,

b)

daňovník nemá do lehoty na podanie vyhlásenia podľa písmena a) nedoplatok na dani [[§ 1 písm. a)](#paragraf-1)],
...
prijímateľ je uvedený k 31. decembru predchádzajúceho kalendárneho roka v centrálnom registri prijímateľov vedenom Notárskou komorou Slovenskej republiky (ďalej len „komora“) podľa osobitného predpisu,[131g)](#poznamky.poznamka-131g)
...
prijímateľ vznikol najneskôr v priebehu kalendárneho roka, ktorý predchádza roku, v ktorom preukazuje splnenie podmienok podľa písmena k), h) prijímateľ nemá nedoplatok na dani [[§ 1 písm. b)](#paragraf-1.pismeno-b)],

i)

prijímateľ preukáže, že nemá nedoplatok na poistnom na zdravotné poistenie, na poistnom na nemocenské poistenie, na poistnom na dôchodkové zabezpečenie a na príspevku na poistení v nezamestnanosti podľa osobitného predpisu[40)](#poznamky.poznamka-40) potvrdením príslušného orgánu, nie starším ako 30 dní,
...
Ak prijímateľ nepoužije poskytnutý podiel zaplatenej dane na činnosti podľa odseku 4 najneskôr do konca nasledujúceho roka po roku, v ktorom mu bol podiel zaplatenej dane poukázaný, vzťahujú sa na prijímateľa ustanovenia o porušení rozpočtovej disciplíny podľa osobitného predpisu.[131i)](#poznamky.poznamka-131i)
...
Za daňovníka, ktorý zanikol bez likvidácie, podáva priznanie jeho právny nástupca. Za daňovníka, na ktorého bol vyhlásený konkurz, podáva priznanie správca konkurznej podstaty.
...
Preddavky na daň neplatí daňovník, ktorého daň za predchádzajúce zdaňovacie obdobie nepresiahla 50 000 Sk a daňovník v likvidácii, v konkurze alebo vyrovnaní v zdaňovacom období podľa [§ 49 ods. 5, 6](#paragraf-49.odsek-5), [8 a 9](#paragraf-49.odsek-8), ak správca dane neurčí platenie preddavkov podľa odseku 11. Daň sa vyrovná v lehote na podanie priznania.
...
daňovník predloží vyhlásenie správcovi dane podľa odseku 1 do 15 dní po uplynutí lehoty na zaplatenie dane podľa osobitného predpisu,[125)](#poznamky.poznamka-125)
...
prijímateľ je uvedený k 31. decembru predchádzajúceho kalendárneho roka v centrálnom registri prijímateľov vedenom komorou podľa osobitného predpisu,[131g)](#poznamky.poznamka-131g)
...
prijímateľ nemá nedoplatok na dani [[§ 1 písm. b)](#paragraf-1.pismeno-b)],
...
Preddavok na daň vo výške podľa sadzby dane uvedenej v [§ 21 ods. 1](#paragraf-21.odsek-1) zrazí platiteľ dane zo zdaniteľných príjmov okrem príjmov, z ktorých sa daň vyberá, osobitnou sadzbou dane a z platieb uhrádzaných na účely ustanovené všeobecne záväzným právnym predpisom vydaným Ministerstvom financií Slovenskej republiky uhrádzaných osobe s bydliskom alebo so sídlom na území so zvýhodneným daňovým režimom.
...
Ak je daň zabezpečená platením preddavkov na daň podľa [§ 40](#paragraf-40) alebo [50](#paragraf-50), preddavok na daň podľa odseku 2 sa nebude zrážať, ak správca dane nerozhodne inak.
...
Prijímateľ, ktorého súhrn podielov zaplatenej dane z príjmov fyzických osôb a právnických osôb v ročnom prehľade prijímateľov podľa [§ 48 ods. 11](#paragraf-48.odsek-11) a [§ 51a ods. 11](#paragraf-51a.odsek-11) je vyšší ako 100 000 Sk, je povinný do 12 mesiacov odo dňa zverejnenia zoznamu podľa [§ 48 ods. 11](#paragraf-48.odsek-11) a [§ 51a ods. 11](#paragraf-51a.odsek-11) zaslať presnú špecifikáciu použitia prijatého podielu na zverejnenie v Obchodnom vestníku, ktorá obsahuje najmä výšku a účel použitia finančných prostriedkov, spôsob použitia finančných prostriedkov, prípadne výrok audítora, ak to určuje osobitný predpis.[5)](#poznamky.poznamka-5)
...
Ak prijímateľ nepoužije poskytnutý podiel zaplatenej dane na činnosti podľa [§ 46 ods. 4](#paragraf-46.odsek-4) a [§ 51a ods. 4](#paragraf-51a.odsek-4) najneskôr do konca nasledujúceho roka po roku, v ktorom mu bol podiel zaplatenej dane poukázaný, alebo ich použije v rozpore s týmto účelom, je povinný podiel zaplatenej dane vrátiť do štátneho rozpočtu do 90 dní odo dňa vzniku stanovenej skutočnosti.
...
Ustanovenie [§ 23 ods. 3 písm. c)](#paragraf-23.odsek-3.pismeno-c) sa vzťahuje na daňovú povinnosť vypočítanú v daňovom priznaní, ktorého termín podania je po 1. januári 2002.
...
Hmotný majetok odpisovaný k 31. decembru 2002, ktorého nadobúdacia (vstupná) cena bola 30 000 Sk a menej, odpisuje daňovník ďalej spôsobom zvoleným pri zaradení do užívania podľa [§ 31 alebo 32](#paragraf-31) alebo jeho zostatkovú cenu môže jednorazovo zahrnúť do výdavkov (základu dane) v roku 2003.
...
Ustanovenie [§ 52 ods. 1](#paragraf-52.odsek-1) o najneskoršom termíne zdanenia dividend, keď sa za termín vyplatenia, poukázania alebo pripísania považuje deň splatnosti podľa osobitného predpisu,[132a)](#poznamky.poznamka-132a) sa použije na dividendy, ktoré mali byť podľa tohto osobitného predpisu splatné po nadobudnutí účinnosti tohto zákona.

(9)

Notár môže na zdaňovacie obdobie 2001 osvedčiť splnenie podmienok podľa [§ 48 ods. 5](#paragraf-48.odsek-5) do 31. januára 2002. Komora zverejní zoznam prijímateľov podľa [§ 48 ods. 6](#paragraf-48.odsek-6) v zdaňovacom období 2001 do 15. februára 2002. Podmienka podľa [§ 48 ods. 5 písm. e)](#paragraf-48.odsek-5.pismeno-e) sa pre zdaňovaie oddobie 2001 považuje za splnenú, ak prijímateľ je uvedený v centrálnom registri prijímateľov vedenom komorou podľa osobitného predpisu[131g)](#poznamky.poznamka-131g) k 15. januáru 2002.

##### § 58d

Ustanovenia [§ 35 ods. 4 písm. c)](#paragraf-35.odsek-4.pismeno-c) a [§ 35a ods. 11](#paragraf-35a.odsek-11) sa vzťahujú na daňovníka, ktorý si po prvýkrát uplatní daňový úver najskôr za zdaňovacie obdobie roku 2002.

##### § 58e

V roku 2002 sa lehota na podanie priznania k paušálnej dani ustanovená v [§ 15 ods. 7](#paragraf-15.odsek-7) predlžuje do 30. septembra 2002 daňovníkovi s príjmami podľa [§ 7 ods. 2 písm. a)](#paragraf-7.odsek-2), ktorý v roku 2001 nemal takéto príjmy a nemohol podať priznanie k paušálnej dani podľa znenia [§ 15 ods. 7](#paragraf-15.odsek-7) platného do nadobudnutia účinnosti tohto zákona.
...
Tento zákon nadobúda účinnosť 1. januára 2000 okrem [§ 48](#paragraf-48), ktorý nadobúda účinnosť 1. januára 2002.
