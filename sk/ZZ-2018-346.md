...
neziskové organizácie poskytujúce všeobecne prospešné služby, ak osobitný predpis neustanovuje inak,[1)](#poznamky.poznamka-1)
...
rodné číslo alebo iný identifikátor fyzickej osoby, ak tak ustanoví osobitný predpis[1a)](#poznamky.poznamka-1a) (ďalej len „rodné číslo“),
...
Verejná časť registra obsahuje údaje podľa [§ 3 ods. 1 písm. a) až c)](#paragraf-3.odsek-1.pismeno-a), [písm. d) prvého bodu až tretieho bodu](#paragraf-3.odsek-1.pismeno-d.bod-1), [písm. e)](#paragraf-3.odsek-1.pismeno-e), [písm. f) prvého bodu až tretieho bodu](#paragraf-3.odsek-1.pismeno-f.bod-1), [písm. g) až j)](#paragraf-3.odsek-1.pismeno-g), [písm. k) prvého bodu až tretieho bodu](#paragraf-3.odsek-1.pismeno-k.bod-1) a [šiesteho bodu až ôsmeho bodu](#paragraf-3.odsek-1.pismeno-k.bod-6), [písm. l) prvého bodu až ôsmeho bodu](#paragraf-3.odsek-1.pismeno-l.bod-1) a [jedenásteho bodu až trinásteho bodu](#paragraf-3.odsek-1.pismeno-l.bod-11), [písm. m)](#paragraf-3.odsek-1.pismeno-m), [písm. p)](#paragraf-3.odsek-1.pismeno-p), [§ 3 ods. 2 písm. a)](#paragraf-3.odsek-2.pismeno-a), [b)](#paragraf-3.odsek-2.pismeno-b), [c) prvého bodu](#paragraf-3.odsek-2.pismeno-c.bod-1) a [druhého bodu](#paragraf-3.odsek-2.pismeno-c.bod-2), [písm. d) prvého bodu až tretieho bodu](#paragraf-3.odsek-2.pismeno-d.bod-1) a [piateho bodu](#paragraf-3.odsek-2.pismeno-d.bod-5), [písm. e)](#paragraf-3.odsek-2.pismeno-e), [§ 3 ods. 3 písm. a) až d)](#paragraf-3.odsek-3.pismeno-a), [písm. e) prvého bodu až tretieho bodu](#paragraf-3.odsek-3.pismeno-e.bod-1), [písm. f) až j)](#paragraf-3.odsek-3.pismeno-f), [§ 3 ods. 5](#paragraf-3.odsek-5) a elektronickú podobu listín podľa [§ 3 ods. 6.](#paragraf-3.odsek-6) Pred zverejnením elektronickej podoby listín sa v nich anonymizujú údaje, ktorých anonymizovaním sa pri ich zverejňovaní zabezpečí ochrana práv a právom chránených záujmov.
...
Registrový úrad vydá na základe písomnej žiadosti, ktorá obsahuje meno, priezvisko, dátum narodenia a adresu trvalého pobytu žiadateľa a ktorej prílohou je doklad o zaplatení správneho poplatku, výpis z registra. Výpis z registra obsahuje zapísané údaje platné v deň jeho vydania. Výpis s údajmi z neverejnej časti registra registrový úrad vydá len právnickej osobe, ktorej sa týka, a orgánu verejnej moci v rámci výkonu svojej právomoci. O vydanie výpisu z registra možno žiadať aj v elektronickej podobe prostredníctvom elektronického formulára.

(5)

Registrový úrad vydá na základe písomnej žiadosti, ktorá obsahuje meno, priezvisko, dátum narodenia a adresu trvalého pobytu žiadateľa a ktorej prílohou je doklad o zaplatení správneho poplatku, informáciu o tom, že v registri zápis nie je.
...
Elektronická podoba listín podľa [§ 3 ods. 6](#paragraf-3.odsek-6) sa stane súčasťou registra najneskôr do dvoch rokov odo dňa uvedenia registra do prevádzky podľa odseku 1.
