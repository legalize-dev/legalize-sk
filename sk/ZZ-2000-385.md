...
Súdna rada podá prezidentovi návrh na vymenovanie sudcu, len ak ide o osobu, ktorá spĺňa predpoklady podľa [§ 5 ods. 1](#paragraf-5) a [3](#paragraf-5.odsek-3) a ktorá súhlasí so svojím vymenovaním za sudcu a s pridelením na vopred určený súd.
...
Na Špeciálny súd možno prideliť len sudcu, ktorý dovŕšil vek 35 rokov a podľa vyjadrenia Národného bezpečnostného úradu podľa osobitného zákona[5a)](#poznamky.poznamka-5a) je oprávnený oboznamovať sa s utajovanými skutočnosťami stupňa utajenia Prísne tajné. Tieto podmienky platia rovnako na sudcu dočasne prideleného alebo sudcu preloženého na Špeciálny súd, ako aj na sudcu, ktorý rozhoduje o opravnom prostriedku proti rozhodnutiu Špeciálneho súdu.
...
Pridelenie sudcu na výkon funkcie na určitý súd sa uskutoční dňom vymenovania.
...
Dočasné pridelenie sudcu nesmie presahovať jeden rok v období troch rokov, a ak ide o člena trestnoprávneho grémia[5aa)](#poznamky.poznamka-5aa) alebo trestnoprávneho kolégia[5ab)](#poznamky.poznamka-5ab) alebo ak sa také grémium alebo kolégium nezriadilo, sudcu, ktorý by bol jeho členom, dva roky v období troch rokov, ak tento zákon neustanovuje inak. To neplatí, ak ide o sudcu, ktorý je dočasne pridelený na Špeciálny súd; v takom prípade nesmie dočasné pridelenie presahovať obdobie piatich rokov.
...
Súdna rada môže preložiť sudcu na iný súd len s jeho súhlasom alebo na základe rozhodnutia disciplinárneho senátu. Preložiť sudcu možno iba na voľné miesto sudcu určené ministrom podľa osobitného zákona.[7)](#poznamky.poznamka-7)

(2)

Na najvyšší súd a Špeciálny súd možno preložiť len sudcu, ktorý dovŕšil vek 35 rokov.
...
odvolaním súhlasu s pridelením na určitý súd ([§ 11 ods. 4](#paragraf-11.odsek-4)),
...
Osobný úrad sudcu je súd, na ktorý bol sudca pridelený alebo preložený. Osobný úrad sudcu je ministerstvo, ak sudca prerušil výkon funkcie sudcu alebo ak je sudca poberateľom príplatku za výkon funkcie sudcu alebo pozostalý po sudcovi poberateľom príplatku k dôchodku pozostalých.
...
Predseda súdu, na ktorom je zriadená sudcovská rada, vyhlasuje výberové konanie na obsadenie voľného miesta sudcu určeného ministrom podľa osobitného zákona.[7)](#poznamky.poznamka-7)
...
Výberové konanie uskutočňuje výberová komisia zriadená podľa odseku 1 na súde vyššieho stupňa. Pri rozhodovaní prihliada na vyjadrenie kolégia predsedov sudcovských rád toho súdu, v ktorého obvode vykonáva uchádzač o postup na súd vyššieho stupňa svoju funkciu.
...
právnom dôvode a o dátume nadobudnutia nehnuteľného majetku, a ak o to požiada predseda príslušnej sudcovskej rady alebo predseda súdnej rady, aj cenu jeho obstarania, pri bezodplatnom nadobudnutí cenu podľa osobitného predpisu,[11a)](#poznamky.poznamka-11a)
...
Vyhlásenie podľa [§ 31 ods. 1](#paragraf-31.odsek-1), oznámenie podľa [§ 31 ods. 3](#paragraf-31.odsek-3) a majetkové priznanie zverejňuje ministerstvo na voľne prístupnej internetovej stránke v súlade s ochranou osobných údajov podľa osobitného zákona.[14a)](#poznamky.poznamka-14a)
...
Ak sudca nepodá včas písomné vyhlásenie podľa [§ 31](#paragraf-31) alebo majetkové priznanie podľa [§ 32](#paragraf-32), vyzve ho predseda príslušnej sudcovskej rady, alebo ak ide o predsedu sudcovskej rady, predseda súdnej rady, aby dodatočne splnil takú povinnosť, najviac však v lehote 30 dní.

(2)

Minister, príslušná sudcovská rada, alebo ak ide o jej predsedu, súdna rada preskúmajú úplnosť písomného vyhlásenia a majetkového priznania a v prípade potreby vyzvú sudcu, aby ich v lehote najviac 30 dní v potrebnom rozsahu spresnil alebo doplnil.

(3)

Ak sa na základe vyhodnotenia majetkového priznania podľa [§ 32 ods. 5](#paragraf-32.odsek-5) zistia u sudcu majetkové prírastky, ktoré zjavne presahujú súhrn jeho platových pomerov a iných vyčíslených príjmov [[§ 31 ods. 2 písm. c](#paragraf-31.odsek-2.pismeno-c))], sudca je povinný na základe výzvy ministra, príslušnej sudcovskej rady, alebo ak ide o predsedu sudcovskej rady, predseda súdnej rady vysvetliť alebo preukázať ich pôvod. Na splnenie tejto povinnosti určí sudcovi primeranú lehotu, ktorá nesmie byť dlhšia ako 60 dní.
...
Sudca má nárok na dovolenku na zotavenie za obdobie dočasného pozastavenia výkonu funkcie sudcu iba v prípade, ak sa toto obdobie bude posudzovať ako výkon funkcie sudcu [[§ 62 písm. j)](#paragraf-62.pismeno-j)].
...
Počas rodičovskej dovolenky patrí sudkyni alebo sudcovi peňažná pomoc v materstve[18)](#poznamky.poznamka-18) a príplatok k peňažnej pomoci v materstve podľa [§ 94](#paragraf-94) a počas ďalšej rodičovskej dovolenky patrí sudcovi rodičovský príspevok podľa osobitného predpisu.
...
dočasného pozastavenia výkonu funkcie ([§ 22](#paragraf-22)), ak je sudcovi doplatený plat podľa [§ 22 ods. 5](#paragraf-22.odsek-6).
...
predsedovi krajského súdu a predsedovi Špeciálneho súdu v sume 6 200 Sk mesačne,

d)

podpredsedovi krajského súdu a podpredsedovi Špeciálneho súdu v sume 3 600 Sk mesačne.
...
predsedovi senátu krajského súdu a predsedovi senátu Špeciálneho súdu v sume 2 000 Sk mesačne,

b)

sudcovi krajského súdu a sudcovi Špeciálneho súdu, ktorý rozhoduje ako samosudca, v sume 1 000 Sk mesačne,
...
Sudcovi, ktorý bol poverený výkonom činnosti podľa [§ 27 ods. 3](#paragraf-27.odsek-3), možno priznať osobitný príplatok, ktorého výška nepresiahne 5 000 Sk. O jeho priznaní a výške rozhodne predseda príslušného súdu po predchádzajúcom súhlase sudcovskej rady.
...
za vykonanie úloh nad rozsah povinností vyplývajúcich mu z ustanovenia [§ 30](#paragraf-30),
...
V čase, keď sudca nevykonáva svoju funkciu pre chorobu alebo pre úraz, patrí mu, ak tento zákon neustanovuje inak, k náhrade príjmu pri dočasnej pracovnej neschopnosti poskytovanej podľa osobitného predpisu[20)](#poznamky.poznamka-20) (ďalej len „náhrada príjmu") príplatok k náhrade príjmu a k nemocenskému poskytovanému podľa osobitného predpisu[20a)](#poznamky.poznamka-20a) príplatok k nemocenskému.
...
Sudcovi okresného súdu, krajského súdu a Špeciálneho súdu patrí základný plat podľa tohto zákona odo dňa zloženia sľubu.
...
Príplatky podľa [§ 72 a 73](#paragraf-72) patria sudcovi od prvého dňa mesiaca nasledujúceho po dni, v ktorom nastala rozhodujúca skutočnosť na priznanie týchto príplatkov.
...
Za škodu spôsobenú rozhodnutím alebo nesprávnym úradným postupom súdu zodpovedá štát. Kedy a v akej miere môže štát vymáhať náhradu škody spôsobenej nezákonným rozhodnutím alebo nesprávnym úradným postupom od sudcu, ustanovuje osobitný predpis;[26)](#poznamky.poznamka-26) ustanovenie [§ 105 ods. 2](#paragraf-105.odsek-2) sa nepoužije.
...
Zodpovednosť sudcu za disciplinárne previnenie zaniká uplynutím premlčacej lehoty, ktorá je dvojročná a plynie odo dňa spáchania disciplinárneho previnenia, to neplatí, ak ide o disciplinárne previnenie, ktorého sa sudca dopustil tým, že neviedol súdne konanie bez zbytočných prieťahov.
...
Disciplinárny sudca nemôže byť zaradený do disciplinárneho senátu počas dočasného pridelenia podľa § 12 ods. 2 písm. a) a c) a [§ 12 ods. 3](#paragraf-12.odsek-3), ak nejde o dočasné pridelenie na súd vyššieho stupňa, počas dočasného pozastavenia výkonu funkcie sudcu podľa [§ 22](#paragraf-22) alebo ak sa proti nemu vedie disciplinárne konanie.
...
Návrh na začatie disciplinárneho konania možno podať na disciplinárnom súde do šiestich mesiacov odo dňa, keď sa orgán oprávnený podať návrh dozvedel o disciplinárnom previnení, najneskôr však do šiestich rokov odo dňa spáchania disciplinárneho previnenia. Ak ide o priestupok, môže oprávnený orgán oznámiť jeho spáchanie najneskôr do jedného roka odo dňa jeho spáchania.
...
O námietkach sudcu proti hodnoteniu podľa [§ 27 ods. 7](#paragraf-27.odsek-6) rozhodne disciplinárny súd v konaní, v ktorom sa primerane použijú ustanovenia osobitného predpisu.[30)](#poznamky.poznamka-30)
...
Ak o opravnom prostriedku proti rozhodnutiu Špeciálneho súdu nemôže rozhodnúť príslušný senát vyčlenený na takéto rozhodovanie ([§ 11 ods. 3](#paragraf-11.odsek-3)), rozhodne o opravnom prostriedku ktorýkoľvek senát najvyššieho súdu určený rozvrhom práce; funkčný príplatok podľa [§ 69 ods. 2](#paragraf-69.odsek-2) týmto sudcom nepatrí.

##### § 150a

(1)

Ak je sudca pridelený na Špeciálny súd dňom vymenovania ([§ 11 ods. 4](#paragraf-11.odsek-4)), zároveň na návrh ministra s predchádzajúcim súhlasom sudcu určí súdna rada súd, na ktorý bude preložený, ak nastanú okolnosti uvedené v odseku 2 alebo 4.
...
Sudcu Špeciálneho súdu uvedeného v odseku 2 preloží s jeho súhlasom súdna rada na súd, na ktorom vykonával funkciu sudcu pred jeho preložením na Špeciálny súd. Ak bol sudca pridelený na Špeciálny súd dňom vymenovania ([§ 11 ods. 4](#paragraf-11.odsek-4)), súdna rada ho s jeho súhlasom preloží na súd určený podľa odseku 1. Ak sudca nedá súhlas na preloženie, výkon funkcie sudcu sa prerušuje. Po prerušení sa sudca ujme výkonu funkcie sudcu na súde, na ktorom vykonával funkciu sudcu pred svojím preložením na Špeciálny súd; ak bol sudca pridelený na Špeciálny súd dňom vymenovania ([§ 11 ods. 4](#paragraf-11.odsek-4)), ujme sa výkonu funkcie sudcu na súde určenom podľa odseku 1.
...
O opravných prostriedkoch proti rozhodnutiam Špeciálneho súdu rozhoduje senát najvyššieho súdu určený rozvrhom práce; jeho členom môže byť iba sudca, ktorý spĺňa podmienky podľa [§ 11 ods. 3](#paragraf-11.odsek-3). Do ustanovenia senátu, ktorý bude rozhodovať o opravných prostriedkoch proti rozhodnutiam Špeciálneho súdu, rozhodne o opravnom prostriedku ktorýkoľvek senát najvyššieho súdu určený rozvrhom práce; funkčný príplatok podľa [§ 69 ods. 2](#paragraf-69.odsek-2) týmto sudcom nepatrí.
