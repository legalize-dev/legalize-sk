...
účelne vynaložených nákladov spojených s právnym zastúpením pri uplatňovaní nárokov podľa písmen a), b) a d), ak poisťovateľ nesplnil povinnosti uvedené v [§ 11 ods. 5 písm. a) alebo písm. b)](#paragraf-11.odsek-5) alebo poisťovateľ neoprávnene odmietol poskytnúť poistné plnenie, alebo neoprávnene krátil poskytnuté poistné plnenie,
...
Ak poistenie zodpovednosti zanikne počas poistného obdobia pre neplatenie poistného, osoba, ktorá má povinnosť uzavrieť poistnú zmluvu podľa [§ 3 tohto zákona](#paragraf-3), je povinná uzavrieť poistnú zmluvu na zostávajúcu časť poistného obdobia s doterajším poisťovateľom. Poistná zmluva uzavretá počas tohto poistného obdobia s iným poisťovateľom je neplatná.
...
Poisťovateľ je povinný do 15 dní po zániku poistenia zodpovednosti vydať poistníkovi doklad o škodovom priebehu poistenia zodpovednosti. Ak poistník nesplnil povinnosť podľa [§ 9 ods. 6](#paragraf-9.odsek-6), nie je poisťovateľ povinný do splnenia tejto povinnosti vrátiť poistné podľa odseku 10.
...
Ak je poistným obdobím kalendárny rok, poisťovateľ je povinný zverejniť výšku poistného a všeobecné poistné podmienky podľa [§ 8](#paragraf-8) na nasledujúce poistné obdobie najneskôr do 31. októbra.
...
Týmto zákonom sa preberajú právne akty Európskych spoločenstiev a Európskej únie uvedené v [prílohe](#prilohy.priloha-priloha_k_zakonu_c_381_2001_z_z.oznacenie).
