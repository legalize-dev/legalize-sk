...
Za bezúhonného sa nepovažuje ten, kto bol právoplatne odsúdený za trestný čin hospodársky, trestný čin proti majetku alebo za úmyselný trestný čin, ktorého skutková podstata súvisí s predmetom podnikania, ak sa naňho nehľadí, akoby nebol odsúdený.[22f)](#poznamky.poznamka-22f) Bezúhonnosť sa preukazuje výpisom z registra trestov; ak ide o cudzinca,[22d)](#poznamky.poznamka-22d) bezúhonnosť sa preukazuje dokladom o bezúhonnosti obdobným výpisu z registra trestov vydaným príslušným orgánom štátu, ktorého je štátnym príslušníkom, alebo príslušným orgánom štátu jeho trvalého pobytu, alebo štátu, v ktorom sa obvykle zdržiava, a to dokladom nie starším ako tri mesiace a predloženým spolu s jeho úradne overeným prekladom do slovenského jazyka. Na účely preukázania bezúhonnosti fyzickej osoby musia byť aj bez jej súhlasu písomne poskytnuté Národnej banke Slovenska údaje,[22fa)](#poznamky.poznamka-22fa) ktoré sú potrebné na vyžiadanie výpisu z registra trestov o dotknutej osobe, ako aj kópia dokladu totožnosti a kópia rodného listu dotknutej osoby na účely preverovania totožnosti dotknutej osoby a správnosti poskytnutých údajov; pritom na poskytovanie a preverovanie týchto údajov, na preverovanie totožnosti dotknutej osoby a na vyžiadanie, vydanie a zaslanie výpisov sa vzťahujú ustanovenia osobitných predpisov[22fb)](#poznamky.poznamka-22fb) s tým, že Národná banka Slovenska je príslušná podávať žiadosti o výpis z registra trestov.[22fb)](#poznamky.poznamka-22fb)
