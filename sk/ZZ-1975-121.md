...
pracovníci v pracovnom pomere, a členovia výrobných družstiev,
...
pracujúci, ktorí podľa tohto zákona, predpisov vydaných na jeho vykonanie alebo podľa iných predpisov majú v dôchodkovom zabezpečení práva a povinnosti ako pracovníci v pracovnom pomere, najmä poslanci národných výborov, členovia orgánov ľudovej kontroly, sudcovia z povolania, advokáti, žiaci a študenti, vedeckí a umeleckí ašpiranti, občania vykonávajúci práce na základe dohody o pracovnej činnosti uzavretej s organizáciou a občania poskytujúci vecné plnenia a výkony (ďalej len „služby“) na základe povolenia národného výboru,
...
Jednotlivo hospodáriaci roľníci a iné samostatne hospodáriace osoby a pozostalí po nich sú zúčastnení na dôchodkovom poistení za podmienok a v rozsahu ustanovených vykonávacími predpismi ([§ 172 ods. 3](#paragraf-172.odsek-4)).
...
doba odbojovej činnosti, včítane väznenia (internácie) z politických, národnostných alebo rasových dôvodov v čase neslobody;[2)](#poznamky.poznamka-2) tieto doby sa započítavajú v rozsahu ustanovenom vykonávacími predpismi;
...
Ak bol pracujúci po vzniku nároku na starobný dôchodok ďalej nepretržite zamestnaný a nepoberal starobný dôchodok ani jeho časť, zisťuje sa priemerný mesačný zárobok na vymeranie starobného dôchodku z úhrnu hrubých zárobkov za posledných 10 (5) kalendárnych rokov pred rokom, v ktorom pracujúci skončil zamestnanie alebo pred rokom, do ktorého spadá deň, od ktorého sa priznáva starobný dôchodok, pokiaľ je tento výpočet pre neho výhodnejší než výpočet podľa ustanovení predchádzajúceho odseku. Do doby nepretržitého zamestnania sa nezapočítava náhradná doba uvedená v [§ 11 ods. 1 písm. ch)](#paragraf-11.odsek-1.pismeno-ch).

(4)

Ak bol pracujúci zamestnaný aspoň 5 rokov v zamestnaní uvedenom v [§ 12 ods. 1 písm. a) č. 1](#paragraf-12.odsek-1), zisťuje sa priemerný mesačný zárobok z hrubých zárobkov za posledných 10 (5) kalendárnych rokov pred rokom, v ktorom také zamestnanie pracujúci naposledy skončil, pokiaľ je tento výpočet pre neho výhodnejší, ako výpočet podľa predchádzajúcich odsekov.
...
55 rokov, ak bol zamestnaný najmenej 15 rokov v zamestnaní uvedenom v [§ 12 ods. 1 písm. a) č. 1](#paragraf-12.odsek-1) alebo najmenej 10 rokov v takom zamestnaní v uránových baniach a uvedený vek dosiahol v čase trvania zamestnania,
...
58 rokov, ak bol zamestnaný najmenej 20 rokov v zamestnaní uvedenom v [§ 12 ods. 1 písm. a) č. 9 a 10](#paragraf-12.odsek-1.pismeno-a.bod-9) a zamestnanie I. pracovnej kategórie trvalo pri dosiahnutí uvedeného veku.
...
3000 Kčs mesačne, ak pracujúci bol zamestnaný dovedna najmenej 15 rokov v zamestnaní uvedenom v [§ 12 ods. 1 písm. a) č. 1](#paragraf-12.odsek-1) alebo najmenej 10 rokov v takom zamestnaní v uránových baniach;
...
ak ide o zárobky z pracovnej činnosti člena jednotného roľníckeho družstva, 90 % priemerného mesačného zárobku neobmedzeného podľa [§ 14 ods. 5](#paragraf-14.odsek-5),

c)

ak ide o zárobky, z ktorých časť podlieha dani zo mzdy [písmeno a)] a časť tejto dani nepodlieha [písmeno b)], 90 % priemerného mesačného zárobku zisteného zo súčtu zdanených i nezdaniteľných zárobkov a neobmedzeného podľa [§ 14 ods. 5](#paragraf-14.odsek-5).
...
Invalidný (čiastočný invalidný) dôchodok patrí pracujúcemu, ktorý bol zamestnaný po dobu potrebnú na nárok na dôchodok ([§ 26](#paragraf-26)) a v čase trvania zamestnania sa stal úplne (čiastočne) invalidným. Ak ide o úplnú (čiastočnú) invaliditu vzniknutú chorobou z povolania, nie je rozhodujúce, kedy úplná (čiastočná) invalidita vznikla.
...
do 20 rokov ................................. menej ako 1 rok, nad 20 rokov do 22 rokov ........ 1 rok, nad 22 rokov do 24 rokov ........ 2 roky, nad 24 rokov do 26 rokov ........ 3 roky, nad 26 rokov do 28 rokov ........ 4 roky, nad 28 rokov .............................. 5 rokov.
...
60 % priemerného mesačného zárobku, ak bol pracujúci zamestnaný najmenej 20 rokov v I. pracovnej kategórii a ak zamestnanie tejto kategórie trvalo ku dňu vzniku nároku na dôchodok alebo ak bol pracujúci zamestnaný najmenej 15 rokov v zamestnaní uvedenom v [§ 12 ods. 1 písm. a) č. 1](#paragraf-12.odsek-1) alebo najmenej 10 rokov v takom zamestnaní v uránových baniach, alebo ak sa stal úplne (čiastočne) invalidným následkom pracovného úrazu, ktorý utrpel pri plnení pracovných úloh v zamestnaní I. pracovnej kategórie alebo v priamej súvislosti s ním;
...
Čiastočný invalidný dôchodok je polovica invalidného dôchodku; pritom však neplatia ustanovenia o výške invalidného dôchodku, ktorý je jediným zdrojom príjmu ([§ 42](#paragraf-42)).
...
Invalidný dôchodok pracujúceho, ktorého úplná invalidita je následkom pracovného úrazu, je o 10 % priemerného mesačného zárobku vyšší ako invalidný dôchodok vypočítaný podľa [§ 28 a 29](#paragraf-28).

(2)

Čiastočný invalidný dôchodok pracujúceho, ktorého čiastočná invalidita je následkom pracovného úrazu, je polovica invalidného dôchodku, ktorý by mu patril pri pracovnom úraze. Ustanovenie [§ 30 vety za bodkočiarkou](#paragraf-30)platí aj tu.
...
Invalidný dôchodok patrí aj občanovi, ktorý sa stal úplne invalidným pred dovŕšením veku, v ktorom sa končí návšteva základnej školy, nemohol byť preto zamestnaný vôbec alebo po dobu potrebnú na nárok na tento dôchodok a dosiahol vek 18 rokov.
...
3000 Kčs mesačne, ak pracujúci bol zamestnaný dovedna najmenej 15 rokov v zamestnaní uvedenom v [§ 12 ods. 1 písm. a) č. 1](#paragraf-12.odsek-1) alebo najmenej 10 rokov v takom zamestnaní v uránových baniach, alebo sa stal úplne invalidným následkom pracovného úrazu, ktorý utrpel pri plnení pracovných úloh v zamestnaní uvedenom v [§ 12 ods. 1 písm. a) č. 1](#paragraf-12.odsek-1) alebo v priamej súvislosti s ním;
...
stará sa aspoň o jedno dieťa, ktoré má nárok na sirotský dôchodok ([§ 40](#paragraf-40)),

c)

vychovala aspoň tri deti ([§ 40](#paragraf-40)),

d)

dosiahla vek 45 rokov a vychovala dve deti ([§ 40](#paragraf-40)),
...
dosiahla vek aspoň 40 rokov ku dňu smrti manžela, ktorý zomrel následkom pracovného úrazu ([§ 27 ods. 1 prvá veta](#paragraf-27.odsek-1)), ktorý utrpel pri plnení pracovných úloh v zamestnaní I. pracovnej kategórie.

Ustanovenia písmen b) až d) sa nevzťahujú na deti, ktoré žena alebo jej manžel prevzali do pestúnskej starostlivosti podľa osobitných predpisov.[7)](#poznamky.poznamka-7)
...
Ak je starobný, invalidný alebo vdovský dôchodok alebo sirotský dôchodok obojstranne osirelého dieťaťa jediným zdrojom príjmu dôchodcu a nedosahuje sumu 1 000 Kčs mesačne, zvyšuje sa na túto sumu; ak má dôchodca aj iný príjem (dôchodok) a úhrn dôchodku a tohto príjmu nedosahuje sumu 1 000 Kčs mesačne, zvyšuje sa dôchodok tak, aby úhrn dôchodku a príjmu (dôchodku) bol 1 000 Kčs mesačne. Ak je iným príjmom požívateľky vdovského dôchodku starobný alebo invalidný dôchodok, zvyšuje sa len starobný alebo invalidný dôchodok. Pri súbehu sirotského dôchodku s invalidným alebo vdovským dôchodkom sa zvyšuje len invalidný alebo vdovský dôchodok.

(2)

Ak je na starobný alebo invalidný dôchodok, ktorý nedosahuje sumu 1 700 Kčs mesačne odkázaný aj rodinný príslušník dôchodcu, o ktorom to ustanovia vykonávacie predpisy, dôchodok sa zvyšuje na túto sumu; ak má dôchodca alebo taký rodinný príslušník aj iný príjem (dôchodok), zvyšuje sa dôchodok tak, aby úhrn tohto dôchodku a iného príjmu (dôchodku) bol 1 700 Kčs mesačne. Ak podmienky zvýšenia dôchodku spĺňajú obaja manželia, zvýši sa len dôchodok patriaci manželovi o rozdiel medzi sumou 1 700 Kčs a úhrnom dôchodkov a iných príjmov manželov.
...
Dôchodok sa zvyšuje podľa predchádzajúcich odsekov, len ak si dôchodca alebo rodinný príslušník nemôže pre starobu, zdravotný stav alebo iné vážne dôvody zvýšiť životnú úroveň vlastnou prácou. Pri zvýšení dôchodku sa nehľadí na výchovné, na zvýšenie dôchodku (výchovného) pre bezvládnosť, na príspevky sociálnej starostlivosti, na odmenu za výkon pestúnskej starostlivosti,[9)](#poznamky.poznamka-9) na pracovný príjem dôchodcu alebo jeho rodinného príslušníka z činnosti, ktorá netrvá dlhšie ako 60 pracovných dní v kalendárnom roku, ani na pracovný príjem dôchodcu alebo jeho rodinného príslušníka staršieho ako 70 rokov ani na príjem zo záhumienka. Zvýšenie dôchodku sa nezapočítava do výšky dôchodku rozhodujúcej pre výpočet dôchodkov pozostalých.

(5)

Invalidný dôchodok podľa odseku 1 môže byť dôchodcovi, na ktorého nie je odkázaný žiaden rodinný príslušník dôchodcu, zvýšený v prípadoch hodných mimoriadneho zreteľa o ďalších 100 Kčs mesačne; dôchodok s týmto zvýšením nesmie byť však vyšší, ako je najvyššia percentná výmera ([§ 23 ods. 6](#paragraf-23.odsek-6) a [§ 34 ods. 4](#paragraf-34.odsek-4)).
...
Ak je sociálny dôchodok jediným zdrojom príjmu dôchodcu, môže sa mu priznať až do výšky 1 000 Kčs mesačne; ak má dôchodca aj iný príjem (dôchodok), môže sa sociálny dôchodok priznať až do takej výšky, aby úhrn tohto dôchodku a iného príjmu (dôchodku) bol 1 000 Kčs mesačne. Ak je na dôchodok odkázaný aj rodinný príslušník dôchodcu ([§ 42 ods. 2](#paragraf-42.odsek-2)), môže sa tento dôchodok priznať až do výšky 1 700 Kčs mesačne; ak má dôchodca alebo taký rodinný príslušník aj iný príjem (dôchodok), môže sa sociálny dôchodok priznať až do takej výšky, aby úhrn tohto dôchodku a iného príjmu (dôchodku) bol 1 700 Kčs mesačne. Ak podmienky priznania sociálneho dôchodku spĺňajú obaja manželia (druh a družka), môže sa im priznať spoločný sociálny dôchodok až do výšky rozdielu medzi sumou 1 700 Kčs a úhrnom príjmov oboch manželov (druha a družky).
...
Výchovné patrí požívateľovi starobného, invalidného, čiastočného invalidného dôchodku, dôchodku za výsluhu rokov, čiastočného dôchodku za výsluhu rokov, osobného a sociálneho dôchodku na každé dieťa ([§ 40](#paragraf-40)). Požívateľke vdovského dôchodku patrí výchovné na každé dieťa ([§ 40](#paragraf-40)), ak nie je účastná nemocenského zabezpečenia[46)](#poznamky.poznamka-46) a má v priamom zaopatrení aspoň jedno dieťa vo veku do troch rokov. Výchovné patrí aj na dieťa zverené požívateľovi niektorého z uvedených dôchodkov do pestúnskej starostlivosti. Výchovné nepatrí na dieťa, ktorému sa poskytuje invalidný dôchodok.

(2)

Výchovné je mesačne

| | na jedno dieťa Kčs | na dve deti Kčs | na tri deti Kčs | na štyri detiKčs | | --- | --- | --- | --- | --- | | k dôchodku invalidnému | 250 | 650 | 1210 | 1720 | | inému | 200 | 650 | 1210 | 1720 |

a zvyšuje sa na každé ďalšie dieťa o 350 Kčs mesačne.

(3)

Ak ide o nezaopatrené dieťa, ktoré je podľa posudku orgánov sociálneho zabezpečenia invalidné a vyžaduje stálu starostlivosť, poskytuje sa k výchovnému naň príplatok vo výške 300 Kčs mesačne; podmienkou pritom je, že dieťa nie je umiestnené v ústave pre také deti.
...
Výchovné patrí až do skončenia povinnej školskej dochádzky; potom patrí a vypláca sa za rovnakých podmienok ako sirotský dôchodok ([§ 40 ods. 3](#paragraf-40.odsek-3)).

(6)

Ak je dieťa v priamom zaopatrení iného občana než dôchodcu, vypláca sa výchovné tomuto občanovi; výchovné na dieťa, ktoré je v plnom priamom zaopatrení ústavu (zariadenia) pre starostlivosť o deti alebo o mládež z iných dôvodov než z dôvodu liečenia, sa vypláca tomuto ústavu. Osobitné predpisy[10)](#poznamky.poznamka-10) upravujú výplatu výchovného miestnemu národnému výboru, ak sa o dieťa nik riadne nestará.
...
Invalidný (čiastočný invalidný) dôchodok podľa [§ 48 ods. 1](#paragraf-48) a [§ 49 ods. 1](#paragraf-49.odsek-1) sa vymeriava vo výške určenej pre prípad úplnej (čiastočnej) invalidity následkom pracovného úrazu v zamestnaní I. pracovnej kategórie [[§ 28 ods. 2 písm. a)](#paragraf-28.odsek-2) a [§ 31](#paragraf-31)].

(2)

Pozostalým po občanoch, ktorí zomreli následkom poškodenia zdravia spôsobom uvedeným v [§ 48 a 49](#paragraf-48) alebo boli požívateľmi dôchodku podľa týchto ustanovení, patria dôchodky pozostalých; ak ide o vdovy po občanoch, ktorí zomreli následkom poškodenia zdravia za okolností uvedených v [§ 48 ods. 1](#paragraf-48.odsek-1) a [§ 49 ods. 1](#paragraf-49.odsek-1), obdobne platia ustanovenia [§ 37 ods. 2 písm. f)](#paragraf-37.odsek-2.pismeno-f) a [ods. 3](#paragraf-37.odsek-3), pokiaľ ide o lehotu piatich rokov.
...
ktorí boli príslušníkmi ozbrojených útvarov[13)](#poznamky.poznamka-13) alebo boli väznení z dôvodov fašistickej perzekúcie[14)](#poznamky.poznamka-14) alebo
...
ktorí boli účastníkmi povstania v máji 1945,[15)](#poznamky.poznamka-15)
...
Ustanovenia [§ 18 ods. 2](#paragraf-18.odsek-2) a [§ 28 ods. 3](#paragraf-28.odsek-3) platia s tým, že
...
Invalidný (čiastočný invalidný) dôchodok účastníka odboja, ktorého úplná (čiastočná) invalidita vznikla v súvislosti s odbojovou činnosťou, sa posudzuje podľa ustanovenia o invalidnom (čiastočnom invalidnom) dôchodku pri pracovnom úraze ([§ 31](#paragraf-31)); ustanovenie [§ 25 ods. 1 prvej vety](#paragraf-25.odsek-1)tu neplatí. Ak je to pre účastníka odboja výhodnejšie, vymeriava sa invalidný (čiastočne invalidný) dôchodok z priemerného mesačného zárobku ustanoveného vykonávacími predpismi pre výpočet týchto dôchodkov občanov vykonávajúcich službu v ozbrojených silách.
...
Vdove po účastníkovi odboja patrí vdovský dôchodok, ak sa splní niektorá z podmienok ustanovených v [§ 37 ods. 2 písm. a) až e)](#paragraf-37.odsek-2) pre nárok na vdovský dôchodok aj po uplynutí dvoch rokov po zániku skoršieho nároku na vdovský dôchodok.
...
vymeria sa vdovský dôchodok najmenej sumou uvedenou v [§ 56 ods. 2](#paragraf-56.odsek-2) podľa toho, do ktorej skupiny účastníkov odboja je zaradená, prípadne úhrn dôchodkov uvedených pod písmenom b) sa upraví najmenej na túto sumu.
...
Ak sa rodičom účastníka odboja, ktorý v súvislosti s odbojovou činnosťou padol, bol popravený alebo zomrel vo väzení, poskytuje dôchodok rodičov, starobný, invalidný, vdovský alebo sociálny dôchodok, patrí tento dôchodok, ak ide o jednotlivca, najmenej vo výške 950 Kčs mesačne, a ak ide o manželskú dvojicu, najmenej vo výške 1600 Kčs mesačne, včítane osobitného prídavku; pri úhrne dôchodkov patriacich rodičovi (rodičom) sa zvýšenie prizná k vyššiemu (najvyššiemu) dôchodku tak, aby úhrn dôchodkov dosiahol sumu 950 Kčs mesačne, prípadne 1600 Kčs mesačne.
...
Ak vdovský dôchodok vdovy po účastníkovi odboja je jediným zdrojom príjmu vdovy a nedosahuje sumu 1 100 Kčs mesačne, zvyšuje sa na túto sumu. Ustanovenia [§ 42 ods. 1 časti prvej vety za bodkočiarkou](#paragraf-42.odsek-1) a [odseku 4](#paragraf-42.odsek-4) platia obdobne.

(2)

Ak dôchodok (úhrn dôchodkov) nedosahuje sumu 1 800 Kčs mesačne a je jediným zdrojom príjmu dôchodcu a jeho rodinného príslušníka, z ktorých jeden je účastníkom odboja, zvyšuje sa dôchodok (úhrn dôchodkov) na túto sumu. Ustanovenia [§ 42 ods. 2 až 4](#paragraf-42.odsek-2) platia obdobne.

(3)

Zvýšenie dôchodku pre bezmocnosť sa prizná aj nad hranicu uvedenú v [§ 47 ods. 1](#paragraf-47.odsek-1), ak bol dôchodok (úhrn dôchodkov) upravený podľa predchádzajúceho odseku.
...
na dôchodcov, ktorí sú zabezpečení v chorobe a v materstve podľa predpisov platných pre príslušníkov ozbrojených síl;[19)](#poznamky.poznamka-19) z tohto zabezpečenia sa môže poskytnúť aj príspevok na detskú rekreáciu,

b)

na dôchodcov, ktorí sú zamestnaní a sú zabezpečení v chorobe a v materstve ako pracujúci,[20)](#poznamky.poznamka-20)

c)

na manželku a deti dôchodcu uvedeného pod písmenami a) a b), ako ani na ďalších občanov odkázaných prevažne na neho, pokiaľ ide o výživu, alebo ak sú sami zabezpečení v chorobe alebo v materstve podľa osobitných predpisov,[20)](#poznamky.poznamka-20)
...
Nezaopatrenými deťmi sa rozumejú deti vo veku až do skončenia povinnej školskej dochádzky; potom za obdobných podmienok, aké sú ustanovené v [§ 40 ods. 3](#paragraf-40.odsek-3). Ustanovenia [§ 11 ods. 2](#paragraf-11.odsek-2) a [§ 16 ods. 4](#paragraf-16.odsek-4) platia obdobne.
...
550 Kčs, ak ide o ostatných oprávnených uvedených v [§ 73 ods. 2 písm. b) až f)](#paragraf-73.odsek-2.pismeno-b); ak však v týchto prípadoch súd priznal príspevok na výživu voči vojakovi, patrí zaopatrovací príspevok vo výške príspevku na výživu, najviac však v sume 550 Kčs.
...
Zabezpečenie pracovníkov v pracovnom pomere a občanov posudzovaných ako pracovníci v pracovnom pomere pri vojenskom cvičení a ďalších druhoch služby v ozbrojených silách, s výnimkou základnej (náhradnej) služby, upravuje Zákonník práce a predpisy vydané podľa neho.[21)](#poznamky.poznamka-21)

(2)

Zabezpečenie pracujúcich uvedených v [§ 3 písm. f)](#paragraf-3.pismeno-f) a občanov poskytujúcich služby na základe povolenia národného výboru pri vojenskom cvičení a ďalších druhoch služby v ozbrojených silách, s výnimkou základnej (náhradnej) služby, upravujú vykonávacie predpisy ([§ 172 ods. 1 písm. d) a e)](#paragraf-172.odsek-1.pismeno-d)).
...
Sumy príjmov občanov uvedených v predchádzajúcom odseku sú však 880 Kčs mesačne, ak ide o pozostalých po účastníkovi odboja, ktorým bol dôchodok priznaný podľa [§ 57 ods. 2](#paragraf-57.odsek-2) a [5](#paragraf-57.odsek-5), [§ 59 ods. 2](#paragraf-59.odsek-2) a [§ 60](#paragraf-60).
...
Ak vojak nemá nárok na zabezpečenie pri vojenskom cvičení a pri ďalších druhoch služby v ozbrojených silách, patrí občanom uvedeným v [§ 73 ods. 2](#paragraf-73.odsek-2) zaopatrovací príspevok podľa prvého dielu tejto časti zákona; ustanovenia [§ 75 ods. 3 druhej vety](#paragraf-75.odsek-3) tu neplatí.
...
plniť úlohy vyplývajúce im z plánu úloh potrebných na uskutočňovanie pracovnej rehabilitácie ([§ 5 ods. 2](#paragraf-5));
...
Federálne ministerstvo práce a sociálnych vecí vykonáva vo veciach sociálneho zabezpečenia pôsobnosť v rozsahu ustanovenom týmto zákonom a osobitnými predpismi.[23)](#poznamky.poznamka-23)
...
Opravný prostriedok je podaný včas[25)](#poznamky.poznamka-25) aj vtedy, ak bol podaný v lehote na národnom výbore príslušnom podľa miesta bydliska.
...
Ako vojak z povolania má nárok na plný starobný dôchodok aj občan, ktorý bol vojakom z povolania, získal najmenej 25 rokov doby zamestnania a v čase trvania zamestnania ([§ 13](#paragraf-13)) dosiahol vek aspoň
...
Ustanovenia [§ 16 ods. 2 písm. a)](#paragraf-16.odsek-2), [ods. 3 a 4](#paragraf-16.odsek-3) platia obdobne.
...
Ustanovenia [§ 18 ods. 1 písm. a)](#paragraf-18.odsek-1), ak ide o výšku dôchodku zo zamestnania uvedeného v [§ 12 ods. 1 písm. a) č. 1](#paragraf-12.odsek-1) a [§ 18 ods. 2 a 3](#paragraf-18.odsek-2) platia obdobne.
...
2500 Kčs mesačne, ak ide o vojaka z povolania, ktorý bol zamestnaný najmenej 25 rokov a v dobe služby v ozbrojených silách ([§ 13](#paragraf-13)) dosiahol vek aspoň 55 rokov, ak vykonával najmenej 20 rokov službu v ozbrojených silách zaradenú do I. kategórie funkcií [[§ 122 ods. 1 písm. a)](#paragraf-122.odsek-1)], alebo o občana, ktorý bol vojakom z povolania, získal najmenej 25 rokov doby zamestnania a v čase trvania zamestnania ([§ 13](#paragraf-13)) dosiahol vek aspoň 55 rokov, ak vykonával najmenej 20 rokov službu výkonného letca v ozbrojených silách [[§ 122 ods. 2 písm. a)](#paragraf-122.odsek-2)],
...
Ustanovenia [§ 23 ods. 1 písm. a)](#paragraf-23.odsek-1), [ods. 2](#paragraf-23.odsek-2) a [6](#paragraf-23.odsek-6) platia aj tu.
...
Ustanovenia [§ 28](#paragraf-28) platia obdobne.
...
2500 Kčs mesačne, ak ide o dôchodok vojaka z povolania alebo občana, ktorý bol vojakom z povolania, ak vykonával najmenej 20 rokov službu zaradenú do I. kategórie funkcií alebo sa stal úplne (čiastočne) invalidným následkom úrazu alebo ochorení vzniknutých pri výkone služby zaradenej do I. kategórie funkcií alebo v priamej súvislosti s ním [[§ 126 ods. 1 písm. a)](#paragraf-126.odsek-1)],
...
Ustanovenia [§ 34 ods. 1 písm. a)](#paragraf-34.odsek-1) a [ods. 2](#paragraf-34.odsek-2) platia aj tu. Ustanovenie [§ 23 ods. 6](#paragraf-23.odsek-6) o najvyššej percentnej výmere dôchodku platí obdobne, ak ide o invalidný dôchodok vojaka z povolania (občana) staršieho ako 20 rokov.
...
Peňažné príspevky podľa [§ 93](#paragraf-93), [95 a 96](#paragraf-95) poskytujú požívateľom dôchodkov podľa tejto časti zákona a ich rodinným príslušníkom orgány federálnych ministerstiev národnej obrany a vnútra a orgány ministerstiev vnútra republík vo svojej pôsobnosti.
...
Starobné a invalidné dôchodky priznané podľa predpisov platných pred 1. januárom 1957 pre dôchodkové poistenie pracovníkov v pracovnom pomere a pre dôchodkové zaopatrenie príslušníkov ozbrojených síl a podľa predpisov platných pred 1. aprílom 1962 pre dôchodkové poistenie družstevných roľníkov,[26)](#poznamky.poznamka-26) aj pokiaľ boli novovymerané podľa predpisov platných po 31. decembri 1956[27)](#poznamky.poznamka-27) alebo boli upravené podľa predpisov o dôchodkovom zabezpečení účastníkov odboja,[28)](#poznamky.poznamka-28) sa zvyšujú takto:
...
Zvýšenie sa prizná k mesačnej sume dôchodku, ktorá s prípadným zvýšením dôchodku podľa doterajších predpisov patrí k 31. decembru 1975, po znížení o osobitnú daň z dôchodku, pokiaľ jej bol dôchodok podrobený, a po pripočítaní osobitného prídavku[30)](#poznamky.poznamka-30) k tomuto dôchodku; ak sa osobitný prídavok priznal k úhrnu dôchodkov toho istého požívateľa, pripočíta sa celý osobitný prídavok k starobnému, invalidnému alebo čiastočnému invalidnému dôchodku, ku ktorému sa priznáva zvýšenie ([§ 145](#paragraf-145)), a ak ide o úhrn vdovského a sirotského dôchodku, k vdovskému dôchodku. Pripočítaním k dôchodku nárok na osobitný prídavok zaniká. Zvýšenie pre bezvládnosť, výchovné ani dôchodok z dôchodkového pripoistenia[31)](#poznamky.poznamka-31) sa do mesačnej sumy dôchodku nezapočítava.
...
Zvýšenie patrí za splnenia ostatných podmienok aj k dôchodku upravenému už prv podľa predpisov o najnižšej výmere dôchodkov,[32)](#poznamky.poznamka-32) ktoré sú jediným zdrojom príjmu (jediným alebo hlavným zdrojom výživy) dôchodcu; osobitné podmienky ustanovené na úpravu dôchodku na uvedenú najnižšiu výmeru sa inak nemenia.

(5)

Ak dôchodok ani po zvýšení spolu s iným príjmom dôchodcu a rodinných príslušníkov odkázaných na jeho dôchodok nedosahuje novourčenú najnižšiu výmeru dôchodku, ktorý je jediným zdrojom príjmu, zvýši sa na žiadosť dôchodok tak, aby spolu s príjmom dôchodcu a takých rodinných príslušníkov dosiahol túto najnižšiu výmeru ([§ 42](#paragraf-42)).
...
Starobný dôchodok (odsek 1) i jeho zvýšenie za dobu ďalšieho zamestnania sa vypočíta z priemerného mesačného zárobku zisteného pred rokom, v ktorom pracujúci skončil zamestnanie ([§ 14 ods. 3](#paragraf-14.odsek-3)), pokiaľ je tento výpočet pre neho výhodnejší.
...
vykonávaného po 31. decembri 1975 podľa tohto zákona ([§ 22](#paragraf-22)).
...
Dôchodky rodičov a súrodencov priznané podľa predpisov o dôchodkovom poistení (zaopatrení) platných pred 1. januárom 1957, ktoré sú jediným zdrojom príjmu dôchodcu, sa zvýšia na sumu 1 000 Kčs mesačne; ak má dôchodca aj iný príjem (dôchodok), zvýši sa dôchodok rodičov a súrodencov tak, aby úhrn tohto dôchodku a iného príjmu (dôchodku) bol 1 000 Kčs mesačne. Ak je na dôchodok odkázaný aj rodinný príslušník ([§ 42 ods. 2](#paragraf-42.odsek-2)) dôchodcu, zvýši sa tento dôchodok na sumu 1 700 Kčs mesačne; ak má dôchodca alebo taký rodinný príslušník aj iný príjem (dôchodok), zvýši sa dôchodok rodičov a súrodencov tak, aby úhrn tohto dôchodku a iného príjmu (dôchodku) bol 1 700 Kčs mesačne. Ustanovenie [§ 42 ods. 4](#paragraf-42.odsek-4) platí obdobne. Dôchodok sa zvýši na žiadosť.
...
Ak dôchodca požíva alebo požíval starobný (výsluhový), invalidný alebo čiastočný invalidný dôchodok vymeraný z dôchodkového základu podľa predpisov platných pred 1. októbrom 1964, nesmie sa starobný, invalidný alebo čiastočný invalidný dôchodok a dôchodok za výsluhu rokov vymerať z nižšieho priemerného mesačného zárobku, než by bol dôchodkový základ upravený podľa doterajších predpisov.[34)](#poznamky.poznamka-34)
...
Starobný dôchodok podľa predchádzajúceho odseku nesmie byť však menší, než by bol skorší výsluhový dôchodok s prípadnými úpravami podľa predpisov platných pred 1. januárom 1976[35)](#poznamky.poznamka-35) a jeho zvýšenie podľa ôsmej časti.
...
sadzby výchovného, prípadne príplatok k nemu ([§ 46 ods. 2 a 3](#paragraf-46.odsek-2)) a priznávať k nemu jednorazovú výpomoc,
...
sumy najvyššej prípustnej hranice príjmu na priznanie náhrady ušlej pracovnej odmeny členom jednotných roľníckych družstiev pri vojenskom cvičení a ďalších druhoch služby v ozbrojených silách ([§ 78 ods. 5 a 6](#paragraf-78.odsek-5)).

##### § 168a

Vláda Československej socialistickej republiky môže vzhľadom na zmeny, ktoré nastali vo vývoji mzdovej úrovne, nariadením upraviť výšku priemerného mesačného zárobku, z ktorého bol vymeraný predošlý dôchodok ([§ 14 ods. 6](#paragraf-14.odsek-6)).
...
dávky zo zabezpečenia v chorobe, zo zabezpečenia matky a dieťaťa pracujúcich uvedených v [§ 3 písm. f)](#paragraf-3.pismeno-f) a občanov poskytujúcich služby na základe povolenia národného výboru,
...
zabezpečenie dôchodcov niektorými ďalšími dávkami ([§ 72](#paragraf-72)).
...
spôsob zúčtovania invalidného dôchodku pri jeho spätnom priznaní, ak dôjde k jeho súbehu s nemocenským, sirotským dôchodkom, výchovným alebo prídavkami na deti, prípadne príplatkom na invalidné dieťa a spôsob zúčtovania starobného, invalidného, čiastočného invalidného a osobného dôchodku pri jeho súbehu s osobitným príspevkom baníkov.[45)](#poznamky.poznamka-45)
...
zákon [č. 101/1964 Zb.](../../../../SK/ZZ/1964/101/) o sociálnom zabezpečení v znení zákonov č. 89/1968 Zb., č. 161/1968 Zb., č. 71/1970 Zb., č. 106/1971 Zb. a č. 99/1972 Zb.;
...
čl. I zákona [č. 161/1968 Zb.](../../../../SK/ZZ/1968/161/) o osobitnom prídavku k dávkam, o zmenách v dôchodkovom zabezpečení účastníkov odboja a o niektorých ďalších zmenách v sociálnom zabezpečení;

4.

zákon [č. 161/1969 Zb.](../../../../SK/ZZ/1969/161/) o niektorých dôsledkoch neoprávneného pobytu pracovníkov v cudzine, pokiaľ upravuje dôchodkové zabezpečenie (poistenie), a to v § 1 ods. 1 písm. b) slová „a pre nárok na dávky dôchodkového zabezpečenia (poistenia) a ich výšku,“;

5.

vládne nariadenie [č. 113/1950 Zb.](../../../../SK/ZZ/1950/113/), ktorým sa určujú podrobnosti o prestupe štátnych zamestnancov a niektorých neštátnych verejných zamestnancov, ako aj príjemcov odpočivných (zaopatrovacích) platov do národného dôchodkového poistenia a zrážky na poistné;
...
vládne nariadenie [č. 115/1950 Zb.](../../../../SK/ZZ/1950/115/) o pracovných a platových pomeroch a o penzijnom zabezpečení bývalých pragmatikálnych zamestnancov prevzatých do služieb národných alebo komunálnych podnikov, pokiaľ nebolo zrušené ustanovením § 279 ods. 1 č. 48 Zákonníka práce č. 65/1965 Zb.;
...
§ 19 vládneho nariadenia [č. 59/1964 Zb.](../../../../SK/ZZ/1964/59/) o úlohách národných výborov pri starostlivosti o deti v znení nariadenia vlády Československej socialistickej republiky č. 99/1971 Zb.
...
K dôchodkom vyplácaným ku dňu účinnosti tohto zákonného opatrenia sa poskytuje zvýšenie podľa [Čl. I](../../../../SK/ZZ/1982/7/#predpis.clanok-1) od splátky dôchodku splatnej po účinnosti tohto zákonného opatrenia. Rozhodnutie o tomto zvýšení sa vydáva len na žiadosť dôchodcu.

(2)

Invalidné (čiastočné invalidné) dôchodky pracujúcich (občanov), ktorým vznikol nárok na invalidný (čiastočne invalidný) dôchodok pred dovŕšením 28 rokov, a občanov vykonávajúcich službu v ozbrojených silách ([§ 48 až 50 zákona č. 121/1975 Zb.](#paragraf-48) o sociálnom zabezpečení) priznané predo dňom účinnosti tohto zákonného opatrenia sa upravia podľa [čl. II č. 1 a 2](../../../../SK/ZZ/1982/7/#predpis.clanok-2.bod-1) na žiadosť najskôr od splátky dôchodku splatnej po dni účinnosti tohto zákonného opatrenia. Dôchodky uvedené v predchádzajúcej vete, na ktoré vznikol nárok pred účinnosťou zákona č. 121/1975 Zb. o sociálnom zabezpečení, sa pritom prepočítajú podľa tohto zákona.

(3)

Dôchodky vyplácané ku dňu účinnosti tohto zákonného opatrenia, ktoré boli upravené ako jediný zdroj príjmu, sa zvýšia podľa [čl. II č. 3](../../../../SK/ZZ/1982/7/#predpis.clanok-2.bod-3) a [14](../../../../SK/ZZ/1982/7/#predpis.clanok-2.bod-14) bez žiadosti od splátky dôchodku splatnej po dni účinnosti tohto zákonného opatrenia.

(4)

Starobné, invalidné, vdovské, sirotské obojstranne osirelých detí, sociálne dôchodky, dôchodky rodičov a súrodencov, ktoré neboli dosiaľ upravené ako jediný zdroj príjmu a nedosahujú výšku ustanovenú v [čl. II č. 3](../../../../SK/ZZ/1982/7/#predpis.clanok-2.bod-3) a [14](../../../../SK/ZZ/1982/7/#predpis.clanok-2.bod-14), a dôchodky účastníkov odboja, ktoré nedosahujú výšku ustanovenú v [čl. II č. 6 až 10](../../../../SK/ZZ/1982/7/#predpis.clanok-2.bod-6), sa upravia na žiadosť najskôr od splátky dôchodku splatnej po dni účinnosti zákonného opatrenia.

(5)

Čiastočné invalidné dôchodky účastníkov odboja priznané pred účinnosťou tohto zákonného opatrenia sa prepočítajú vzhľadom na novoustanovenú najnižšiu výmeru invalidného dôchodku účastníka odboja ([čl. II č. 6](../../../../SK/ZZ/1982/7/#predpis.clanok-2.bod-6)), ak je to pre nich výhodnejšie. Úprava dôchodku sa urobí na žiadosť najskôr od splátky dôchodku splatnej po dni účinnosti tohto zákonného opatrenia.

(6)

Zvýšenia podľa [čl. I](../../../../SK/ZZ/1982/7/#predpis.clanok-1)a podľa zákonného opatrenia Predsedníctva Federálneho zhromaždenia [č. 76/1979 Zb.](../../../../SK/ZZ/1979/76/) o zvýšení dôchodkov sa poskytujú k sirotskému dôchodku upravenému podľa [§ 41 ods. 5 zákona č. 121/1975 Zb.](#paragraf-41.odsek-5) o sociálnom zabezpečení.
...
Výška plného starobného dôchodku pracujúcich v baníctve, ktorí vykonávali zamestnanie uvedené v [§ 12 ods. 1 písm. a) č. 1 zákona č. 121/1975 Zb](#paragraf-12.odsek-1). o sociálnom zabezpečení v znení [čl. I tohto zákona](../../../../SK/ZZ/1982/73/#predpis.clanok-1), splnili podmienky pre nárok na tento dôchodok před 1. júlom 1982, sú po vzniku nároku na plný starobný dôchodok ďalej nepretržite zamestnaní k 30. júnu 1982 a nepoberali starobný dôchodok ani jeho časť, sa určí podľa [čl. I tohto zákona](../../../../SK/ZZ/1982/73/#predpis.clanok-1).

(2)

Zvýšenie dôchodku pre bezvládnosť, ktoré po 31. januári 1982 nebolo priznané, pretože by dôchodok spolu so zvýšením presiahol sumu 1800 Kčs mesačne alebo ktoré bolo z tohto dôvodu priznané v nižšej sume, sa upraví podľa [čl. I č. 13](../../../../SK/ZZ/1982/73/#predpis.clanok-1.bod-13) na žiadosť najskôr od splátky dôchodku splatnej vo februári 1982.

(3)

Invalidné (čiastočne invalidné) dôchodky účastníkov odboja, ktorých plná (čiastočná) invalidita vznikla v súvislosti odbojovou činnosťou,[1)](#poznamky.poznamka-1~1) priznané pred 1. júlom 1982 sa upravia podľa [čl. I č. 14](../../../../SK/ZZ/1982/73/#predpis.clanok-1.bod-14) na žiadosť najskôr od splátky dôchodku splatnej vo februári 1982.
...
Ak zvýšenie dôchodku pre bezvládnosť priznané pred 1. januárom 1976 nedosahuje výšku súm ustanovených v [§ 47 ods. 1 zákona o sociálnom zabezpečení](#paragraf-47.odsek-1), upravia sa na tieto sumy na žiadosť najskôr od splátky za mesiac september 1984.

(3)

Zvýšenie dôchodku pre bezvládnosť, ktoré nebolo pred 1. februárom 1982 priznané, pretože by dôchodok spolu so zvýšením presiahol sumu 1800 Kčs mesačne, alebo ktoré bolo z tohto dôvodu priznané v nižšej sume, sa prizná alebo upraví podľa [§ 47 ods. 1 zákona o sociálnom zabezpečení](#paragraf-47.odsek-1) na žiadosť najskôr od splátky za mesiac september 1984.
...
Zvýšenie dôchodku podľa [čl. I](../../../../SK/ZZ/1984/108/#predpis.clanok-1) sa poskytuje k dôchodkom ktoré sa priznali pred 1. januárom 1971 ([čl. I ods. 1](../../../../SK/ZZ/1984/108/#predpis.clanok-1.odsek-1)), bez žiadosti; zvýšenie k dôchodkom, ktoré sa priznali po 31. decembri 1970 ([čl. I ods. 2](../../../../SK/ZZ/1984/108/#predpis.clanok-1.odsek-2)), sa poskytuje na žiadosť.

(2)

Zvýšenie dôchodku podľa [čl. I](../../../../SK/ZZ/1984/108/#predpis.clanok-1) sa poskytuje k dôchodkom vyplácaným ku dňu účinnosti tohto zákona od splátky dôchodku splatnej po dni účinnosti tohto zákona.

(3)

Starobné, invalidné, vdovské dôchodky, sirotské dôchodky obojstranne osirelých detí, sociálne dôchodky a dôchodky rodičov a súrodencov vyplácané ku dňu účinnosti tohto zákona, ktoré sú upravené ako jediný zdroj príjmu dôchodcu ([§ 42 ods. 1](#paragraf-42.odsek-1), [§ 45 ods. 2 prvá veta](#paragraf-45.odsek-2) a [§ 159 prvá veta zákona č. 121/1975 Zb.](#paragraf-159.odsek-1) v znení neskorších predpisov), sa zvýšia na sumu 950,- Kčs ([čl. II č. 1](../../../../SK/ZZ/1984/108/#predpis.clanok-2.bod-1) a [9](../../../../SK/ZZ/1984/108/#predpis.clanok-2.bod-9)) bez žiadosti od splátky dôchodku splatnej po dni účinnosti tohto zákona. Pokiaľ dôchodky uvedené v predchádzajúcej vete neboli dosiaľ upravené ako jediný zdroj príjmu a nedosahujú sumu 950,- Kčs ([čl. II č. 1](../../../../SK/ZZ/1984/108/#predpis.clanok-2.bod-1) a [9](../../../../SK/ZZ/1984/108/#predpis.clanok-2.bod-9)), prípadne sumu 1050,- Kčs ([čl. II č. 8](../../../../SK/ZZ/1984/108/#predpis.clanok-2.bod-8) - [§ 60a ods. 1](#paragraf-60a.odsek-1)), upravia sa na žiadosť najskoršie od splátky dôchodku splatnej po dni účinnosti tohto zákona.

(4)

Úprava starobného, invalidného, sociálneho dôchodku a dôchodku rodičov a súrodencov, na ktorý je odkázaný aj rodinný príslušník dôchodcu ([§ 42 ods. 2](#paragraf-42.odsek-2), [§ 45 ods. 2 druhá veta](#paragraf-45.odsek-2) a [§ 159 druhá veta zákona č. 121/1975 Zb.](#paragraf-159) v znení neskorších predpisov), z dôvodu jediného zdroja príjmu na sumu 1600,- Kčs ([čl. II č. 1](../../../../SK/ZZ/1984/108/#predpis.clanok-2.bod-1) a [9](../../../../SK/ZZ/1984/108/#predpis.clanok-2.bod-9)) sa vykoná na žiadosť najskoršie od splátky dôchodku splatnej po dni účinnosti tohto zákona. To tiež platí, ak ide o úpravu dôchodku (úhrnu dôchodkov), ktorý je jediným zdrojom príjmu, na sumu 1700,- Kčs podľa [čl. II č. 8](../../../../SK/ZZ/1984/108/#predpis.clanok-2.bod-8) ([§ 60a ods. 2](#paragraf-60a.odsek-2)).

(5)

Dôchodky účastníkov odboja, ktoré nedosahujú výšku ustanovenú v [čl. II č. 3 až 7](../../../../SK/ZZ/1984/108/#predpis.clanok-2.bod-2.text2.citat.bod-3), sa upravia na žiadosť najskoršie od splátky dôchodku splatnej po dni účinnosti tohto zákona.

(6)

Čiastočné invalidné dôchodky účastníkov odboja priznané pred účinnosťou tohto zákona sa na žiadosť prepočítajú vzhľadom na novo ustanovenú najnižšiu výmeru invalidného dôchodku účastníka odboja ([čl. II č. 3](../../../../SK/ZZ/1984/108/#predpis.clanok-2.bod-2.text2.citat.bod-3)), ak je to pre nich výhodnejšie. Úprava dôchodkov sa vykoná najskoršie od splátky dôchodku splatnej po dni účinnosti tohto zákona.
...
Dôchodky vyplácané ku dňu účinnosti tohto zákona, ktoré boli upravené ako jediný zdroj príjmu, sa zvýšia podľa [čl. I](../../../../SK/ZZ/1987/53/#predpis.clanok-1) bez žiadosti od splátky dôchodku splatnej po dni účinnosti tohto zákona.

(2)

Starobné, invalidné, vdovské dôchodky, sirotské dôchodky obojstranne osirelých detí, sociálne dôchodky a dôchodky rodičov a súrodencov, ktoré neboli dosiaľ upravené ako jediný zdroj príjmu a nedosahujú výšku ustanovenú v [čl. I](../../../../SK/ZZ/1987/53/#predpis.clanok-1), sa upravia na žiadosť najskôr od splátky dôchodku splatnej po dni účinnosti tohto zákona.
