...
potvrdenie príslušného orgánu ku skutočnostiam uvedeným v ustanovení [§ 6 ods. 7](#paragraf-6.odsek-7), ak je alebo ak bol sudcom, advokátom, komerčným právnikom, notárom, notárskym kandidátom, súdnym exekútorom alebo exekútorským kandidátom,
...
Uchádzača, ktorý spĺňa podmienky na vymenovanie do funkcie prokurátora ustanovené v [§ 6](#paragraf-6) a v odsekoch 5 a 6, generálny prokurátor pozve na výberové konanie najmenej 14 dní pred jeho začatím. Uchádzača, ktorý podmienky nespĺňa, generálny prokurátor o tejto skutočnosti vyrozumie.
...
Výberovým konaním na funkciu vedúceho prokurátora na prokuratúre toho istého stupňa, na funkciu prokurátora pri funkčnom postupe na prokuratúru vyššieho stupňa a na funkciu vedúceho prokurátora pri funkčnom postupe na prokuratúru vyššieho stupňa (ďalej len "výberové konanie pri funkčnom postupe prokurátora") sa overujú riadiace, organizačné a kontrolné schopnosti, odborné vedomosti, jazykové znalosti a ďalšie skutočnosti, ktoré je potrebné alebo vhodné overiť vzhľadom na povahu funkcie, pre ktorú sa vyhlasuje výberové konanie. Výberové konanie sa uskutočňuje v súlade so zásadou rovnakého zaobchádzania ustanovenou osobitným predpisom.[8)](#poznamky.poznamka-8)
...
navrhuje členov výberovej komisie ([§ 7a](#paragraf-7a), [21a](#paragraf-21a) a [238](#paragraf-238)),

d)

vyjadruje sa k vymenovaniu prokurátora do funkcie vedúceho prokurátora ([§ 19 ods. 1](#paragraf-19.odsek-1) a [§ 21a ods. 4 a 5](#paragraf-21a.odsek-4)) a k jeho odvolaniu z tejto funkcie ([§ 23 ods. 1](#paragraf-23.odsek-1)) a udeľuje alebo odmieta súhlas na vymenovanie prokurátora do funkcie v Úrade špeciálnej prokuratúry ([§ 24a](#paragraf-24a)) a k jeho odvolaniu z tejto funkcie [[§ 24d ods. 1 písm. c)](#paragraf-24d.odsek-1.pismeno-c)],
...
odmietnuť pokyn, ktorý je v rozpore so všeobecne záväznými právnymi predpismi, a úlohu, ktorú podľa úpravy generálneho prokurátora ([§ 248 ods. 4](#paragraf-248.odsek-4)) nemožno právnemu čakateľovi prokuratúry zveriť,
