...
Základom pre určenie výšky dovoznej prirážky je hodnota tovaru slúžiaca pre výpočet cla (colná hodnota). Dovozná prirážka sa určí vo výške 18 % z tohto základu.
