...
Organizácie uvoľňujú pre praktické vyučovanie osvedčených a odborne vyspelých pracovníkov (ďalej len „inštruktori“). Inštruktori sú ustanovovaní a odmeňovaní podľa osobitných predpisov.[12)](#poznamky.poznamka-12)
...
Pri praktickom vyučovaní organizácia poskytuje, prípadne zabezpečuje žiakom závodné stravovanie za rovnakých podmienok ako svojim pracovníkom.[13)](#poznamky.poznamka-13)
...
Žiakom, ktorí nebývajú v mieste konania praktického vyučovania, a nemožno od nich vyžadovať, aby dochádzali denne, je organizácia povinná zabezpečiť bezplatné ubytovanie, ktoré vyhovuje hygienickým požiadavkám na hromadné ubytovanie.[14)](#poznamky.poznamka-14)
