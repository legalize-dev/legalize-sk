...
používa informačné systémy finančnej správy[12a)](#poznamky.poznamka-12a) uvedené v § 8 ods. 3 písm. c),
...
Kto sa na výzvu podľa odseku 1 dostaví, má nárok na náhradu nutných výdavkov a na náhradu mzdy, ktorá mu preukázateľne ušla[36)](#poznamky.poznamka-36) (ďalej len „náhrada“). Náhradu poskytuje finančná správa. Nárok na náhradu nemá ten, kto sa dostavil iba vo vlastnom záujme alebo v dôsledku svojho protiprávneho konania.
...
Colník Kriminálneho úradu finančnej správy je oprávnený osobe zaistenej podľa § 21 ods. 1, osobe zadržanej, osobe zatknutej, osobe podozrivej alebo obvinenej zo spáchania trestného činu v súvislosti s porušením colných predpisov alebo daňových predpisov v oblasti dane z pridanej hodnoty pri dovoze alebo spotrebných daní odobrať daktyloskopické odtlačky.
...
odhaľovaní obzvlášť závažných trestných činov spáchaných v súvislosti s porušením colných predpisov alebo daňových predpisov v oblasti dane z pridanej hodnoty pri dovoze alebo spotrebných daní na úseku
...
Finančná správa je oprávnená použiť prostriedky operatívno-pátracej činnosti v prípadoch uvedených v [§ 29](#paragraf-29) a na odhaľovanie úmyselnej trestnej činnosti.
...
Odoberanie pachovej stopy z osoby možno vykonať, len ak ide o osobu, ktorá je podozrivá zo spáchania trestného činu v súvislosti s porušením colných predpisov alebo daňových predpisov v oblasti dane z pridanej hodnoty pri dovoze alebo spotrebných daní.
...
Colník v jednotke služobných zákrokov vykonáva služobné zákroky proti nebezpečným páchateľom trestnej činnosti páchanej v súvislosti s porušovaním colných predpisov alebo daňových predpisov v oblasti dane z pridanej hodnoty pri dovoze alebo spotrebných daní.
...
Prevádzkovateľom informačných systémov finančnej správy, v ktorých sa spracúvajú osobné údaje, je Kompetenčné centrum finančných operácií, okrem spoločného automatizovaného informačného systému na colné účely, ktorého prevádzkovateľom je Kriminálny úrad finančnej správy.
...
Pri predchádzaní a odhaľovaní trestnej činnosti, zisťovaní páchateľov trestných činov a vyšetrovaní trestných činov v súvislosti s porušením colných predpisov alebo daňových predpisov v oblasti dane z pridanej hodnoty pri dovoze alebo spotrebných daní (ďalej len „plnenie úloh finančnej správy na účely trestného konania“) je finančná správa pri získavaní a spracúvaní osobných údajov povinná
