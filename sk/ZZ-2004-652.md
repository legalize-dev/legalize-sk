...
Prevádzkovateľ informačného systému alebo sprostredkovateľ informačného systému užívateľov verejnej telefónnej služby[52)](#poznamky.poznamka-52) je povinný finančnej správe na plnenie jej úloh umožniť diaľkový, nepretržitý a priamy prístup k informáciám a k osobným údajom z príslušného informačného systému.
