...
Colná správa spolupracuje s medzinárodnými organizáciami a s colnými správami iných štátov v rozsahu a za podmienok ustanovených právne záväznými aktmi Európskej únie, medzinárodnou zmluvou alebo dohodou zúčastnených strán.
...
Príslušník colnej správy iného štátu môže podľa podmienok, v rozsahu a spôsobom ustanoveným medzinárodnou zmluvou[10aa)](#poznamky.poznamka-10aa) a týmto zákonom vykonávať na území Slovenskej republiky oprávnenia a povinnosti colníka.
...
používať informačno-technické prostriedky a nástrahovú a zabezpečovaciu techniku; tým nie sú dotknuté ustanovenia osobitného predpisu.[10ab)](#poznamky.poznamka-10ab)
...
Pri náhrade škody vzniknutej v súvislosti s vykonávaním úloh podľa odseku 2 sa postupuje podľa [§ 50 a 51](#paragraf-50) alebo podľa osobitného predpisu.[10ac)](#poznamky.poznamka-10ac)
...
informuje Európsku komisiu v prípadoch a za podmienok ustanovených osobitným predpisom[10a)](#poznamky.poznamka-10a) vo veciach patriacich do jeho pôsobnosti,[11a)](#poznamky.poznamka-11a)
...
vytvára, spravuje, rozvíja a prevádzkuje informačné systémy colnej správy[12a)](#poznamky.poznamka-12a) a vedie centrálny register hospodárskych subjektov a iných osôb, ktoré sa zaoberajú činnosťami, na ktoré sa vzťahujú colné predpisy, a zabezpečuje jeho zosúladenie s príslušnými registrami Európskej komisie;[12b)](#poznamky.poznamka-12b) zámer vykonať činnosti týkajúce sa vytvárania, správy a rozvoja informačných systémov colnej správy predkladá ministerstvu,
...
plní a zabezpečuje úlohy v oblasti odhaľovania trestných činov spáchaných v súvislosti s porušením colných predpisov alebo daňových predpisov v oblasti nepriamych daní[6)](#poznamky.poznamka-6) (ďalej len „daňový predpis“) a zisťovania ich páchateľov,[14)](#poznamky.poznamka-14)
...
prideľuje hospodárskemu subjektu alebo inej osobe číslo EORI (číslo registrácie a identifikácie hospodárskych subjektov) podľa osobitného predpisu,[15a)](#poznamky.poznamka-15a)
...
rozhoduje o žiadostiach o prijatie opatrenia proti porušovaniu práv duševného vlastníctva podľa osobitného predpisu[17)](#poznamky.poznamka-17) (ďalej len „žiadosť o prijatie opatrenia"),

v)

rozhoduje o upustení od zabezpečenia colného dlhu v colnom režime tranzit podľa osobitného predpisu,[17aa)](#poznamky.poznamka-17aa)

w)

informuje Európsku komisiu o svojej príslušnosti na prijímanie žiadostí o prijatie opatrenia a na konanie o týchto žiadostiach podľa osobitného predpisu,[17)](#poznamky.poznamka-17)

x)

poskytuje Európskej komisii v lehotách a štruktúre podľa osobitného predpisu[17a)](#poznamky.poznamka-17a)
...
v prípadoch a za podmienok ustanovených osobitným predpisom[17)](#poznamky.poznamka-17) informuje príslušné colné orgány členských štátov Európskej únie o rozhodnutí, ktorým sa schvaľuje žiadosť o prijatie opatrenia proti porušovaniu práv duševného vlastníctva,

z)

poskytuje Európskej komisii zoznam colných úradov príslušných na prijímanie žiadostí o vydanie osvedčenia schváleného hospodárskeho subjektu podľa osobitného predpisu,[17b)](#poznamky.poznamka-17b)
...
informuje Európsku komisiu v ďalších prípadoch a za podmienok ustanovených osobitným predpisom[18a)](#poznamky.poznamka-18a) vo veciach patriacich do jeho pôsobnosti,

zc)

zabezpečuje doručovanie písomností, ak tak ustanovuje osobitný predpis alebo medzinárodná zmluva,[18b)](#poznamky.poznamka-18b)
...
objasňuje a prejednáva colné priestupky podľa osobitných predpisov,[22)](#poznamky.poznamka-22) odhaľuje a prerokúva colné delikty podľa osobitného predpisu,[23)](#poznamky.poznamka-23) odhaľuje a prerokúva porušenie daňových predpisov, odhaľuje trestné činy spáchané v súvislosti s porušením colných predpisov alebo daňových predpisov a zisťuje ich páchateľov,[14)](#poznamky.poznamka-14)

g)

rozhoduje a vykonáva úkony v oblasti ochrany práv duševného vlastníctva podľa osobitného predpisu,[17)](#poznamky.poznamka-17)

h)

objasňuje a prejednáva priestupky podľa osobitného predpisu[23a)](#poznamky.poznamka-23a) a odhaľuje a prejednáva iné správne delikty podľa osobitného predpisu,[23b)](#poznamky.poznamka-23b)
...
používa informačné systémy colnej správy[12a)](#poznamky.poznamka-12a) uvedené v [§ 8 ods. 3 písm. c)](#paragraf-8.odsek-3.pismeno-c),
...
Colný úrad Žilina rozhoduje v konaní o udelení statusu schváleného hospodárskeho subjektu a zabezpečuje výmenu informácií s príslušnými colnými orgánmi ostatných členských štátov Európskej únie a Európskou komisiou v tomto konaní;[21a)](#poznamky.poznamka-21a) túto pôsobnosť vykonáva na celom území Slovenskej republiky.
...
používa informačné systémy, v ktorých zhromažďuje, spracúva, uchováva, odovzdáva, využíva, ochraňuje a vyraďuje informácie o skutočnostiach a osobách, ktoré spáchali trestné činy alebo je dôvodné podozrenie, že páchajú trestné činy v súvislosti s porušením colných predpisov alebo daňových predpisov, alebo ktoré v oblasti pôsobnosti colnej správy narušili alebo je dôvodné podozrenie, že narúšajú verejný poriadok; na tieto informačné systémy sa vzťahuje osobitný predpis,[12)](#poznamky.poznamka-12)

c)

prevádzkuje spoločný automatizovaný informačný systém na colné účely,[30a)](#poznamky.poznamka-30a) zodpovedá zaň, určuje údaje, ktoré sa doň vložia,[30b)](#poznamky.poznamka-30b) prijíma opatrenia na zabezpečenie jeho bezpečnosti a bezpečnosti údajov, ktoré sa poskytujú podľa osobitného predpisu,[30c)](#poznamky.poznamka-30c) na žiadosť príslušného orgánu členského štátu udeľuje súhlas na poskytnutie údajov, ktoré sám do tohto systému vložil,[30d)](#poznamky.poznamka-30d) a umožňuje priamy prístup do tohto informačného systému príslušnému útvaru Policajného zboru,

d)

poskytuje informácie v súvislosti s prevádzkovaním spoločného automatizovaného informačného systému na colné účely[30e)](#poznamky.poznamka-30e) a zoznam závažných porušení vnútroštátnych právnych predpisov[30f)](#poznamky.poznamka-30f) podľa osobitného predpisu,[30g)](#poznamky.poznamka-30g)
...
vykonáva cezhraničné sledovanie a cezhraničné prenasledovanie v rozsahu a za podmienok ustanovených medzinárodnou zmluvou,[32aa)](#poznamky.poznamka-32aa)
...
poskytuje súčinnosť Colnému úradu Žilina pri preverovaní splnenia podmienok na udelenie statusu schváleného hospodárskeho subjektu podľa osobitného predpisu,[32a)](#poznamky.poznamka-32a)

n)

informuje Európsku komisiu v prípadoch a za podmienok ustanovených osobitným predpisom[32b)](#poznamky.poznamka-32b) vo veciach patriacich do jeho pôsobnosti,
...
Ak colník nezistí totožnosť osoby do 12 hodín od jej predvedenia ani na základe údajov v evidenciách obyvateľov a ak je podozrenie, že fyzická osoba uvádza o sebe nepravdivé údaje, je povinný túto osobu odovzdať najbližšiemu útvaru Policajného zboru na účely zistenia totožnosti podľa osobitného predpisu[37a)](#poznamky.poznamka-37a).
...
Colník je oprávnený vykonávať cezhraničné prenasledovanie v rozsahu a za podmienok ustanovených medzinárodnou zmluvou.[42a)](#poznamky.poznamka-42a)
...
Prostriedky operatívno-pátracej činnosti na účely tohto zákona sú sledovanie osôb a vecí, cezhraničné sledovanie osôb podľa medzinárodnej zmluvy,[10aa)](#poznamky.poznamka-10aa) kontrolovaná dodávka,[43)](#poznamky.poznamka-43) krycie doklady, nástrahová a zabezpečovacia technika a využívanie osôb konajúcich v prospech colnej správy.
...
Povolenie na cezhraničné sledovanie podľa medzinárodnej zmluvy[10aa)](#poznamky.poznamka-10aa) udeľuje generálny riaditeľ colného riaditeľstva alebo ním poverená osoba; generálny riaditeľ colného riaditeľstva alebo ním poverená osoba tiež žiada príslušný orgán iného štátu o povolenie na cezhraničné sledovanie podľa medzinárodnej zmluvy[10aa)](#poznamky.poznamka-10aa) na území tohto iného štátu.

(5)

Ak majú informácie získané použitím prostriedkov operatívno-pátracej činnosti slúžiť ako dôkaz v trestnom konaní, postupuje sa podľa osobitného predpisu.[43a)](#poznamky.poznamka-43a)
...
O použití krycích dokladov pri plnení úloh podľa tohto zákona rozhoduje generálny riaditeľ colného riaditeľstva.

(4)

Krycie doklady vydáva Policajný zbor podľa osobitného predpisu.[43a)](#poznamky.poznamka-43a) O ich vydanie žiada generálny riaditeľ colného riaditeľstva.
...
Informácie a osobné údaje z informačných systémov, ktoré vedie colná správa podľa odseku 1, zvukové, obrazové alebo iné záznamy z miest verejne prístupných, ktoré vedie colná správa podľa odseku 2 písm. a), sa poskytujú alebo sprístupňujú
...
iným štátnym orgánom alebo osobám, ak tak ustanovuje osobitný predpis,[46)](#poznamky.poznamka-46)

k)

do zahraničia, ak tak ustanovuje tento zákon, osobitný predpis[46a)](#poznamky.poznamka-46a) alebo medzinárodná zmluva.[30)](#poznamky.poznamka-30)
...
Informácie a osobné údaje z informačných systémov podľa odseku 4 nie sú verejne prístupné a osoby uvedené v odseku 4 ich môžu poskytnúť alebo sprístupniť tretím osobám len s predchádzajúcim súhlasom colnej správy.
...
Prevádzkovateľom informačných systémov colnej správy, v ktorých sa spracúvajú osobné údaje, je colné riaditeľstvo, ak [§ 11 ods. 3 písm. c)](#paragraf-11.odsek-3.pismeno-c) neustanovuje inak.
...
Pri plnení úloh colnej správy na účely trestného konania je colná správa oprávnená spracúvať aj osobné údaje, ktoré nie sú uvedené v zozname osobných údajov podľa [§ 57 ods. 1](#paragraf-57.odsek-1).
...
Colná správa poskytuje alebo sprístupňuje osobné údaje iným štátnym orgánom alebo osobám, ak
...
je poskytnutie alebo sprístupnenie osobných údajov nevyhnutné na splnenie dôležitej úlohy realizovanej vo verejnom záujme[46aa)](#poznamky.poznamka-46aa) alebo
...
Colná správa poskytne alebo sprístupní podľa odseku 1 písm. a), b) a d) osobné údaje na základe písomnej žiadosti, ktorá musí obsahovať účel, na aký sa majú osobné údaje poskytnúť alebo sprístupniť. Osobné údaje podľa odseku 1 písm. c) môže colná správa poskytnúť alebo sprístupniť iným štátnym orgánom alebo osobám aj bez predchádzajúcej písomnej žiadosti; štátny orgán alebo osoba, ktorej sa údaje poskytli alebo sprístupnili, je povinná do troch dní po odpadnutí prekážky, ktorá bránila doručeniu písomnej žiadosti, predložiť písomnú žiadosť colnej správe.
...
Do zahraničia možno poskytovať osobné údaje aj bez písomnej žiadosti, ak tak ustanoví osobitný predpis[46a)](#poznamky.poznamka-46a) alebo medzinárodná zmluva[30)](#poznamky.poznamka-30).
...
Ak boli informácie a osobné údaje, ktoré colná správa prijala od orgánu členského štátu Európskej únie, poskytnuté s podmienkou osobitného spôsobu spracúvania, je colná správa touto podmienkou viazaná.

(3)

Colná správa poskytuje alebo sprístupňuje na účely predchádzania a odhaľovania trestnej činnosti, zisťovania páchateľov trestných činov a vyšetrovania trestných činov informácie a osobné údaje orgánu členského štátu Európskej únie
...
Ak informácia alebo osobný údaj, ktorý sa má poskytnúť alebo sprístupniť orgánu členského štátu Európskej únie, bol získaný služobnou činnosťou, ktorej predchádzal súhlas alebo príkaz súdu alebo prokurátora, colná správa na takéto poskytnutie alebo sprístupnenie potrebuje predchádzajúci súhlas súdu alebo prokurátora, na základe súhlasu alebo príkazu ktorého, bola informácia alebo osobný údaj získaný. Ak súd alebo prokurátor, na základe ktorého súhlasu alebo príkazu bola informácia alebo osobný údaj získaný, nepovolí poskytnutie informácie alebo osobného údaja orgánu členského štátu Európskej únie, colná správa mu poskytnutie odmietne.
...
Colná správa môže odmietnuť poskytnutie alebo sprístupnenie informácie alebo osobného údaja podľa odseku 3 písm. a), ak by poskytnutie
...
Colná správa na účely overenia zákonnosti spracúvania osobných údajov prijatých podľa [§ 54a](#paragraf-54a) vrátane vnútornej kontroly a zabezpečenia integrity a bezpečnosti osobných údajov vedie dokumentáciu o každom prijatí, poskytnutí alebo sprístupnení takýchto osobných údajov.

(2)

Colná správa môže osobné údaje prijaté podľa [§ 54a ods. 1](#paragraf-54a.odsek-1) ďalej spracúvať na iné účely, než na ktoré sa poskytli, len ak ide o
...
Colná správa môže požiadať príjemcu osobných údajov, ktorému poskytla osobné údaje podľa [§ 54a ods. 3](#paragraf-54a.odsek-3), aby ju oboznámil s ich spracúvaním. Ak orgán členského štátu, ktorý colnej správe poskytol osobné údaje podľa [§ 54a ods. 1](#paragraf-54a.odsek-1), požiada colnú správu, aby ho oboznámila so spracúvaním takýchto osobných údajov, colná správa je povinná jeho žiadosti vyhovieť.

(4)

Colná správa je oprávnená pri poskytnutí osobných údajov podľa [§ 54a ods. 3](#paragraf-54a.odsek-3) požiadať orgán členského štátu, aby neinformoval dotknutú osobu o spracúvaní týchto osobných údajov, ak ide o prípady uvedené v § 55 ods. 4.

(5)

Ak tento zákon alebo osobitný predpis ustanoví podmienky osobitného spôsobu spracúvania osobných údajov, colná správa tieto podmienky uvedie pri ich poskytnutí podľa [§ 54a ods. 3](#paragraf-54a.odsek-3).

(6)

Ak colná správa preverovaním alebo v priebehu spracúvania osobných údajov prijatých podľa [§ 54a ods. 1](#paragraf-54a.odsek-1) zistí, že osobné údaje nie sú potrebné na plnenie úloh colnej správy, bez zbytočného odkladu také osobné údaje zlikviduje alebo anonymizuje.[46c)](#poznamky.poznamka-46c)

(7)

Colná správa môže pri poskytovaní osobných údajov podľa [§ 54a ods. 3](#paragraf-54a.odsek-3) uviesť príjemcovi osobných údajov lehotu, po ktorej uplynutí je povinný takéto osobné údaje zlikvidovať, zablokovať alebo preveriť, či ich naďalej potrebuje.

(8)

Ak colná správa spracúva osobné údaje prijaté podľa [§ 54a ods. 1](#paragraf-54a.odsek-1), ktoré jej boli poskytnuté s uvedením lehoty, po ktorej uplynutí sa musia takéto osobné údaje zlikvidovať, zablokovať alebo preveriť, či sú na plnenie úloh colnej správy naďalej potrebné, colná správa je touto lehotou viazaná; to neplatí, ak v čase uplynutia lehoty sú takéto osobné údaje potrebné na prebiehajúce odhaľovanie trestných činov, zisťovanie páchateľov trestných činov, vyšetrovanie trestných činov alebo výkon trestov. Ak orgán členského štátu, ktorý poskytol osobné údaje, lehotu podľa prvej vety neuviedol, použije sa ustanovenie odseku 6 a [§ 52 ods. 8](#paragraf-52.odsek-8).
...
Colná správa môže poskytnúť alebo sprístupniť orgánom tretích štátov alebo medzinárodným orgánom osobné údaje prijaté podľa [§ 54a ods. 1](#paragraf-54a.odsek-1), len ak
...
Každý, kto svoju totožnosť preukáže hodnoverným spôsobom,[46d)](#poznamky.poznamka-46d) môže písomne požiadať colnú správu o
...
blokovanie osobných údajov o jeho osobe, ak ide o osobné údaje prijaté podľa [§ 54a ods. 1](#paragraf-54a.odsek-1).
...
Colná správa neposkytne dotknutej osobe informáciu prijatú od orgánu členského štátu Európskej únie podľa [§ 54a ods. 1](#paragraf-54a.odsek-1) o tom, aké osobné údaje o nej spracúva, ak tento orgán požiadal, aby dotknutá osoba nebola informovaná o spracúvaní takýchto osobných údajov alebo ak tak ustanovuje osobitný zákon.[46e)](#poznamky.poznamka-46e)
...
Ak colná správa žiadosti podľa odseku 1 písm. c) alebo d) nevyhovie, písomne to oznámi žiadateľovi do 30 dní od jej doručenia. Zároveň poučí žiadateľa o možnosti preskúmať jej postup podľa osobitného predpisu.[46f)](#poznamky.poznamka-46f)

(11)

Na konanie podľa odsekov 1 až 10 sa nevzťahujú všeobecné predpisy o správnom konaní.[47)](#poznamky.poznamka-47)
...
Zoznam osobných údajov o fyzických osobách zhromažďovaných a spracúvaných pri plnení úloh colnej správy vrátane osobných údajov prijímaných zo zahraničia a poskytovaných do zahraničia v rozsahu nevyhnutnom na ich plnenie je uvedený v [prílohe č. 2](#prilohy.priloha-priloha_c_2_k_zakonu_c_652_2004_z_z.oznacenie).
...
na účely uvedené v [§ 53](#paragraf-53) bude spracúvať osobitné kategórie osobných údajov.[54a)](#poznamky.poznamka-54a)
...
Limit výdavkov na stravovanie predvedenej osoby alebo zaistenej osoby vrátane použitého materiálu, ktoré znáša štát, je 70 % stravného poskytovaného pri pracovnej ceste v trvaní nad 18 hodín.[59)](#poznamky.poznamka-59) Ďalšie podrobnosti o stravovaní predvedenej osoby alebo zaistenej osoby ustanoví všeobecne záväzný právny predpis, ktorý vydá ministerstvo.

##### § 59b

##### Transpozičné ustanovenie

Týmto zákonom sa preberajú právne záväzné akty Európskej únie uvedené v [prílohe č. 3](#prilohy.priloha-priloha_c_3_k_zakonu_c_652_2004_z_z_v_zneni_neskorsich_predpisov.oznacenie).
