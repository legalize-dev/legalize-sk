...
v oblasti colnej politiky, osobitne colných formalít, colných sadzieb, colnej hodnoty, nomenklatúrneho zatrieďovania tovaru, pôvodu tovaru, štatistiky obchodu s tretími štátmi (ďalej len „colná štatistika“) a štatistiky obchodu medzi členskými štátmi Európskej únie,[5)](#poznamky.poznamka-5)

2.

v oblasti správy nepriamych daní,[6)](#poznamky.poznamka-6)

3.

v oblasti zisťovania zodpovednosti osôb za porušenie právnych predpisov,[7)](#poznamky.poznamka-7) ktorých vykonávanie je jej zverené týmto zákonom a inými všeobecne záväznými predpismi v oblasti colníctva (ďalej len „colný predpis“),

4.

ustanovené osobitným predpisom,[8)](#poznamky.poznamka-8)

c)

vykonáva dohľad nad dodržiavaním osobitných predpisov,[9)](#poznamky.poznamka-9)

d)

vykonáva ochranu určených objektov orgánov štátnej správy v colníctve (ďalej len „strážený objekt“) a ochranu poriadku v strážených objektoch; ochranu strážených objektov a poriadku v nich vykonávajú colníci.
...
Príslušník finančnej správy iného štátu môže podľa podmienok, v rozsahu a spôsobom ustanoveným medzinárodnou zmluvou[10aa)](#poznamky.poznamka-10aa) a týmto zákonom vykonávať na území Slovenskej republiky oprávnenia a povinnosti colníka.
...
Pôsobnosť ministerstva ako orgánu štátnej správy pre oblasť colníctva upravuje osobitný predpis.[11)](#poznamky.poznamka-11)

##### § 8

Postavenie, organizáciu, právomoc a pôsobnosť finančného riaditeľstva upravuje osobitný predpis.[11)](#poznamky.poznamka-11)
...
používa informačné systémy finančnej správy,[12a)](#poznamky.poznamka-12a)
...
rozhoduje v konaní o certifikácii elektronickej registračnej pokladnice podľa osobitného predpisu,[29a)](#poznamky.poznamka-29a)

c)

vykonáva technickú expertízu elektronickej registračnej pokladnice.[29b)](#poznamky.poznamka-29b)
...
Postavenie, organizáciu, právomoc a pôsobnosť Kriminálneho úradu finančnej správy upravuje osobitný predpis.[11)](#poznamky.poznamka-11)
...
Kto sa na výzvu podľa odseku 1 dostaví, má nárok na náhradu nutných výdavkov a na náhradu mzdy, ktorá mu preukázateľne ušla[36)](#poznamky.poznamka-36) (ďalej len „náhrada“). Náhradu poskytuje finančné riaditeľstvo. Nárok na náhradu nemá ten, kto sa dostavil iba vo vlastnom záujme alebo v dôsledku svojho protiprávneho konania.
...
Colník je oprávnený predviesť osobu na základe žiadosti[36a)](#poznamky.poznamka-36a) colného orgánu alebo správcu dane, ktorým je daňový úrad alebo colný úrad. Žiadosť o predvedenie musí obsahovať meno a priezvisko osoby, ktorá má byť predvedená, dátum narodenia a adresu trvalého pobytu, ustanovenie osobitného predpisu, na ktorého základe má byť osoba predvedená, a dôvod predvedenia. Colník je oprávnený predviesť osobu na účely colného konania alebo iného správneho konania pred colným orgánom aj bez žiadosti podľa prvej vety, ak tak ustanoví osobitný predpis.[36b)](#poznamky.poznamka-36b)
...
pristihnutú pri priestupku[22)](#poznamky.poznamka-22) páchanom v súvislosti s porušením colných predpisov, alebo pristihnutú pri priestupku páchanom v stráženom objekte, alebo u ktorej je podozrenie, že odňala tovar colnému dohľadu, alebo u ktorej je podozrenie, že porušila daňové predpisy, ak je to nevyhnutne potrebné na riadne zistenie veci,
...
v súvislosti s porušením colných predpisov alebo daňových predpisov, ak je to potrebné na zistenie jej totožnosti, na zabránenie úteku alebo zaistenie dôkazov,

2.

v stráženom objekte, ak je to potrebné na zistenie jej totožnosti, na zabránenie úteku alebo zaistenie dôkazov.
...
Colník Kriminálneho úradu finančnej správy je oprávnený osobe zaistenej podľa [§ 21 ods. 1](#paragraf-21.odsek-1), osobe zadržanej, osobe zatknutej, osobe podozrivej alebo obvinenej zo spáchania trestného činu v súvislosti s porušením colných predpisov alebo daňových predpisov v oblasti dane z pridanej hodnoty alebo spotrebných daní odobrať daktyloskopické odtlačky.
...
Ak je predmet zaistenia potrebný na vykonanie procesných úkonov, colník ho odovzdá colnému úradu alebo daňovému úradu alebo orgánom činným v trestnom konaní.
...
Prostriedky operatívno-pátracej činnosti na účely tohto zákona sú sledovanie osôb a vecí, cezhraničné sledovanie osôb podľa medzinárodnej zmluvy,[10aa)](#poznamky.poznamka-10aa) kontrolovaná dodávka,[43)](#poznamky.poznamka-43) krycie doklady, nástrahová a zabezpečovacia technika a využívanie osôb konajúcich v prospech finančnej správy.

(2)

Finančná správa je oprávnená použiť prostriedky operatívno-pátracej činnosti v prípadoch uvedených v [§ 29](#paragraf-29) a na odhaľovanie úmyselnej trestnej činnosti vrátane úmyselnej trestnej činnosti páchanej pracovníkmi finančnej správy pri výkone štátnej služby[43aa)](#poznamky.poznamka-43aa) alebo práce vo verejnom záujme[43ab)](#poznamky.poznamka-43ab).
...
Povolenie na cezhraničné sledovanie podľa medzinárodnej zmluvy[10aa)](#poznamky.poznamka-10aa) udeľuje prezident finančnej správy alebo ním poverená osoba; prezident finančnej správy alebo ním poverená osoba tiež žiada príslušný orgán iného štátu o povolenie na cezhraničné sledovanie podľa medzinárodnej zmluvy[10aa)](#poznamky.poznamka-10aa) na území tohto iného štátu.
...
Krycie doklady vydáva Policajný zbor podľa osobitného predpisu.[43a)](#poznamky.poznamka-43a) O ich vydanie žiada prezident finančnej správy.
...
zabránil násilnému vstupu nepovolaných osôb do strážených objektov, objektov finančnej správy alebo do objektov alebo na miesta, kde je vstup zakázaný.
...
pokúsi o násilný vstup do strážených objektov, objektov finančnej správy alebo do objektov alebo na miesta, kde je vstup zakázaný.
...
aby odvrátil nebezpečný útok, ktorý ohrozuje strážené objekty, objekty finančnej správy alebo objekty alebo miesta, kde je vstup zakázaný, po márnej výzve, aby sa upustilo od útoku,
...
nepovoliť vstup do stráženého objektu osobám, ktoré nepreukážu oprávnenosť vstupu do stráženého objektu, odmietnu preukázať svoju totožnosť alebo ktoré svoju totožnosť nemôžu preukázať; ustanovenia [§ 19 ods. 3 až 8](#paragraf-19.odsek-3) sa nepoužijú,
...
povoliť vstup so zbraňou do stráženého objektu len colníkom, príslušníkom Policajného zboru, príslušníkom Slovenskej informačnej služby, príslušníkom Vojenského spravodajstva, príslušníkom Národného bezpečnostného úradu a príslušníkom Vojenskej polície, ak plnia služobné úlohy,

e)

vyzvať osoby, ktoré vstupujú do stráženého objektu alebo sa v ňom nachádzajú, aby sa pri dôvodnom podozrení, že sú pod vplyvom alkoholu, podrobili kontrole na jeho požitie; ak sa osoby odmietnu podrobiť takejto kontrole alebo sú pod vplyvom alkoholu, je colník oprávnený takýmto osobám nepovoliť vstup do stráženého objektu alebo nepovoliť pohyb v stráženom objekte a prikázať im, aby opustili strážený objekt.
...
Ak je to nutné v záujme osobnej bezpečnosti colníkov v jednotke služobných zákrokov a osôb im blízkych,[35)](#poznamky.poznamka-35) colníci sú oprávnení použiť pri služobnom zákroku ochranné kukly. O použití ochranných kukiel rozhoduje riaditeľ Kriminálneho úradu finančnej správy alebo veliteľ zákroku.
...
Pri plnení úloh finančnej správy na účely trestného konania je finančná správa oprávnená spracúvať aj osobné údaje, ktoré nie sú uvedené v zozname osobných údajov podľa [§ 57 ods. 1](#paragraf-57.odsek-1).
...
Finančná správa na účely overenia zákonnosti spracúvania osobných údajov prijatých podľa [§ 54a](#paragraf-54a) vrátane vnútornej kontroly a zabezpečenia integrity a bezpečnosti osobných údajov vedie dokumentáciu o každom prijatí, poskytnutí alebo sprístupnení takýchto osobných údajov.

(2)

Finančná správa môže osobné údaje prijaté podľa [§ 54a ods. 1](#paragraf-54a.odsek-1) ďalej spracúvať na iné účely, než na ktoré sa poskytli, len ak ide o
...
Finančná správa môže požiadať príjemcu osobných údajov, ktorému poskytla osobné údaje podľa [§ 54a ods. 3](#paragraf-54a.odsek-3), aby ju oboznámil s ich spracúvaním. Ak orgán členského štátu, ktorý finančnej správe poskytol osobné údaje podľa [§ 54a ods. 1](#paragraf-54a.odsek-1), požiada finančnú správu, aby ho oboznámila so spracúvaním takýchto osobných údajov, finančná správa je povinná jeho žiadosti vyhovieť.

(4)

Finančná správa je oprávnená pri poskytnutí osobných údajov podľa [§ 54a ods. 3](#paragraf-54a.odsek-3) požiadať orgán členského štátu, aby neinformoval dotknutú osobu o spracúvaní týchto osobných údajov, ak ide o prípady uvedené v [§ 55 ods. 4](#paragraf-55.odsek-4).

(5)

Ak tento zákon alebo osobitný predpis ustanoví podmienky osobitného spôsobu spracúvania osobných údajov, finančná správa tieto podmienky uvedie pri ich poskytnutí podľa [§ 54a ods. 3](#paragraf-54a.odsek-3).

(6)

Ak finančná správa preverovaním alebo v priebehu spracúvania osobných údajov prijatých podľa [§ 54a ods. 1](#paragraf-54a.odsek-1) zistí, že osobné údaje nie sú potrebné na plnenie úloh finančnej správy, bez zbytočného odkladu také osobné údaje zlikviduje alebo anonymizuje.[46c)](#poznamky.poznamka-46c)

(7)

Finančná správa môže pri poskytovaní osobných údajov podľa [§ 54a ods. 3](#paragraf-54a.odsek-3) uviesť príjemcovi osobných údajov lehotu, po ktorej uplynutí je povinný takéto osobné údaje zlikvidovať, zablokovať alebo preveriť, či ich naďalej potrebuje.

(8)

Ak finančná správa spracúva osobné údaje prijaté podľa [§ 54a ods. 1](#paragraf-54a.odsek-1), ktoré jej boli poskytnuté s uvedením lehoty, po ktorej uplynutí sa musia takéto osobné údaje zlikvidovať, zablokovať alebo preveriť, či sú na plnenie úloh finančnej správy naďalej potrebné, finančná správa je touto lehotou viazaná; to neplatí, ak v čase uplynutia lehoty sú takéto osobné údaje potrebné na prebiehajúce odhaľovanie trestných činov, zisťovanie páchateľov trestných činov, vyšetrovanie trestných činov alebo výkon trestov. Ak orgán členského štátu, ktorý poskytol osobné údaje, lehotu podľa prvej vety neuviedol, použije sa ustanovenie odseku 6 a [§ 52 ods. 8](#paragraf-52.odsek-8).
...
Finančná správa môže poskytnúť alebo sprístupniť orgánom tretích štátov alebo medzinárodným orgánom osobné údaje prijaté podľa [§ 54a ods. 1](#paragraf-54a.odsek-1), len ak
...
Každý, kto svoju totožnosť preukáže hodnoverným spôsobom,[46d)](#poznamky.poznamka-46d) môže písomne požiadať finančnú správu o
...
Finančná správa neposkytne dotknutej osobe informáciu prijatú od orgánu členského štátu Európskej únie podľa [§ 54a ods. 1](#paragraf-54a.odsek-1) o tom, aké osobné údaje o nej spracúva, ak tento orgán požiadal, aby dotknutá osoba nebola informovaná o spracúvaní takýchto osobných údajov alebo ak tak ustanovuje osobitný zákon.[46e)](#poznamky.poznamka-46e)
...
Ak finančná správa žiadosti podľa odseku 1 písm. c) alebo d) nevyhovie, písomne to oznámi žiadateľovi do 30 dní od jej doručenia. Zároveň poučí žiadateľa o možnosti preskúmať jej postup podľa osobitného predpisu.[46f)](#poznamky.poznamka-46f)
...
Zoznam osobných údajov o fyzických osobách zhromažďovaných a spracúvaných pri plnení úloh finančnej správy vrátane osobných údajov prijímaných zo zahraničia a poskytovaných do zahraničia v rozsahu nevyhnutnom na ich plnenie je uvedený v [prílohe č. 2](#prilohy.priloha-priloha_c_2_k_zakonu_c_652_2004_z_z.oznacenie).

(2)

Účelom spracovania osobných údajov je plnenie úloh finančnej správy podľa tohto zákona alebo osobitného predpisu.[48)](#poznamky.poznamka-48)

(3)

Osobné údaje získavajú pracovníci finančnej správy pri plnení úloh podľa tohto zákona alebo podľa osobitného predpisu[48)](#poznamky.poznamka-48) cestou sprostredkovateľa, od oprávnených osôb podľa osobitného predpisu[46)](#poznamky.poznamka-46) a zo zahraničia, ak to ustanovuje medzinárodná zmluva.

(4)

Dotknuté osoby na účely spracovania osobných údajov v informačných systémoch finančnej správy podľa tohto zákona sú fyzické osoby, ktorých osobné údaje sú nevyhnutné na plnenie úloh finančnej správy podľa tohto zákona alebo podľa osobitného predpisu.[49)](#poznamky.poznamka-49)
...
Colníci sú povinní zachovávať mlčanlivosť o skutočnostiach, s ktorými sa oboznámili pri plnení úloh finančnej správy podľa tohto zákona alebo v súvislosti s nimi alebo podľa osobitného predpisu[19)](#poznamky.poznamka-19) a ktoré si v záujme právnických osôb a fyzických osôb vyžadujú, aby zostali utajené pred nepovolanou osobou.

(2)

Povinnosť mlčanlivosti sa nevzťahuje na skutočnosti, ktoré musia občania uviesť na uplatnenie svojich práv ani na oznámenie kriminality alebo inej protispoločenskej činnosti.[54b)](#poznamky.poznamka-54b) .
...
Ustanovenia odsekov 1 až 5 sa nepoužijú na skutočnosti, na ktoré sa vzťahuje daňové tajomstvo podľa osobitného predpisu.[58a)](#poznamky.poznamka-58a)
...
„3. Kriminálny úrad finančnej správy | Funkcia | Percentuálny podiel príplatku za riadenie mesačne | | --- | --- | | 3.01 Riaditeľ Kriminálneho úradu finančnej správy 3.02 Námestník riaditeľa Kriminálneho úradu finančnej správy 3.03 Vedúci pobočky Kriminálneho úradu finančnej správy 3.04 Zástupca vedúceho pobočky Kriminálneho úradu finančnej správy 3.05 Vedúci oddelenia 3.06 Zástupca vedúceho oddelenia | 20 % až 35% 15 % až 32% 9 % až 23% 7 % až 21 % 5 % až 17 % 5 % až 12 % |
