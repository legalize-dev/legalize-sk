...
Registrový úrad je Ministerstvo investícií, regionálneho rozvoja a informatizácie Slovenskej republiky (ďalej len "registrový úrad").
...
Register je verejný zoznam. Registrový úrad na základe písomnej žiadosti vydá výpis z registra v listinnej podobe alebo elektronickej podobe prostredníctvom Ústredného portálu verejnej správy podľa osobitného predpisu.[5aa)](#poznamky.poznamka-5aa) Výpis z registra obsahuje údaje zapísané v registri v deň jeho vydania.
...
Identifikačné číslo pridelí zoskupeniu Štatistický úrad Slovenskej republiky na žiadosť registrového úradu podľa osobitného predpisu.[6aa)](#poznamky.poznamka-6aa)
...
Registrový úrad zamietne návrh na zápis zoskupenia do registra, ak nie sú splnené podmienky podľa [§ 8 ods. 1](#paragraf-8.odsek-1), najneskôr do 30 dní od doručenia návrhu na zápis zoskupenia do registra.
...
do 6 mesiacov po skončení funkčného obdobia neboli zvolené nové orgány zoskupenia podľa [§ 15 písm. b)](#paragraf-15.pismeno-b) alebo [písm. c)](#paragraf-15.pismeno-c).
...
Registrový úrad uloží pokutu od 50 eur do 800 eur zoskupeniu, ktoré neoznámilo registrovému úradu zmenu zapisovaných údajov podľa [§ 8 ods. 2](#paragraf-8.odsek-2).
...
Úkony v konaní o udelení súhlasu s účasťou slovenského subjektu v zoskupení založenom na území členského štátu a o schválení navrhovaného dohovoru, v konaní o schválení zmeny dohovoru, v konaní podľa osobitného predpisu,[5)](#poznamky.poznamka-5) v konaní o zápise zoskupenia do registra, v konaní o uložení pokuty, v konaní o zápise zmien zapisovaných údajov v registri a v konaní o výmaze zoskupenia z registra možno vykonať len v listinnej podobe.

(3)

Za bezúhonnú sa na účely tohto zákona považuje fyzická osoba, ktorá nebola právoplatne odsúdená za trestný čin. Na účel preukázania bezúhonnosti fyzickej osoby, ktorá je štátnym občanom Slovenskej republiky, poskytne fyzická osoba údaje potrebné na vyžiadanie výpisu z registra trestov.[12)](#poznamky.poznamka-12) Údaje podľa druhej vety registrový úrad bezodkladne zašle v elektronickej podobe prostredníctvom elektronickej komunikácie Generálnej prokuratúre Slovenskej republiky na vydanie výpisu z registra trestov. Bezúhonnosť fyzickej osoby, ktorá nie je štátnym príslušníkom Slovenskej republiky, sa na účely tohto zákona preukazuje výpisom z registra trestov alebo iným rovnocenným dokladom nie starším ako tri mesiace, vydaným príslušným orgánom štátu, ktorého je fyzická osoba príslušníkom.
